...
- Clarified that this is a scalar-expression slice only: parameters/generics remain scalar-or-aggregate semantic values, and aggregate-to-aggregate operator expressions are future typed work that must define legal operators by aggregate type/shape before generation.
