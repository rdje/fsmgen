...
- This lifts the aggregate authoring contract from “previously declared only” to one real declarative-scope rule for the shipped `+constants` / `+enums` lane; whole hash-root packing still remains intentionally out of contract.
