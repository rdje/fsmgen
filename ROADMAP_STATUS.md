...
- Current next decision point:
  - Supported success now has a catalog-level behavior gate in addition to family-specific smoke: [t/296-regression-corpus-supported-behavior.t](/Users/richarddje/Documents/github/fsmgen/t/296-regression-corpus-supported-behavior.t) runs every `supported_smoke` entry through default pipeline/CLI, then runs every `strict_supported` entry through strict pipeline/CLI regardless of fixture family; [t/lib/FSM/Test/RegressionCorpus.pm](/Users/richarddje/Documents/github/fsmgen/t/lib/FSM/Test/RegressionCorpus.pm) marks every current protocol fixture and every current supported direct language-feature fixture as `strict_supported`; [t/247-protocol-fixture-regression-smoke.t](/Users/richarddje/Documents/github/fsmgen/t/247-protocol-fixture-regression-smoke.t) keeps extra protocol-specific smoke; [t/261-regression-corpus-supported-language-features.t](/Users/richarddje/Documents/github/fsmgen/t/261-regression-corpus-supported-language-features.t) keeps extra language-feature HDL-shape checks; and [t/248-regression-corpus-accounting.t](/Users/richarddje/Documents/github/fsmgen/t/248-regression-corpus-accounting.t) locks both the marker count and the rule that every supported protocol and direct language-feature fixture is strict-supported.
...
- The first positive strict-mode acceptance markers are now support-accounted too:
  ...
  - [t/248-regression-corpus-accounting.t](/Users/richarddje/Documents/github/fsmgen/t/248-regression-corpus-accounting.t) checks that strict-supported markers stay attached only to supported pipeline/CLI corpus assets, now records fourteen such markers, and requires every supported protocol fixture and every supported direct language-feature fixture to be strict-supported,
