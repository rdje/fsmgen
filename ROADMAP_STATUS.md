...
- Next decision point: the bounded typed-extension owner in [perl/FSM/Support/ExtensionContract.pm](/Users/richarddje/Documents/github/fsmgen/perl/FSM/Support/ExtensionContract.pm) now also publishes a grouped `name_family_map`, with direct regression coverage in [t/306-extension-contract.t](/Users/richarddje/Documents/github/fsmgen/t/306-extension-contract.t), so embedders can discover the bounded hook-name, context-accessor, and supported-source-kind families from one place without collecting those lists separately. The next honest `R13` move is another fresh audit, because the remaining public helper seams are now getting genuinely sparse.
