...
- Current next decision point:
  ...
  - The generated-child realization/source-loading pocket now lives in [perl/FSM/Composition/GeneratedChildRealizer.pm](/Users/richarddje/Documents/github/fsmgen/perl/FSM/Composition/GeneratedChildRealizer.pm), and the `?rtl` child realization pocket now lives in [perl/FSM/Composition/RTLChildRealizer.pm](/Users/richarddje/Documents/github/fsmgen/perl/FSM/Composition/RTLChildRealizer.pm), while [perl/FSM/Composition/RTLInterfaceLoader.pm](/Users/richarddje/Documents/github/fsmgen/perl/FSM/Composition/RTLInterfaceLoader.pm) stays the narrower owner of `.rtlif` metadata loading and validation; the next honest monolith-breakdown seam is now another remaining composition-shape coordination cluster or result/orchestration pocket.
