...
- Current next decision point:
  - Strict mode now has positive support-accounting markers in addition to rejection buckets: [t/lib/FSM/Test/RegressionCorpus.pm](/Users/richarddje/Documents/github/fsmgen/t/lib/FSM/Test/RegressionCorpus.pm) marks every current protocol fixture and every current supported direct language-feature fixture as `strict_supported`, [t/296-regression-corpus-strict-supported-behavior.t](/Users/richarddje/Documents/github/fsmgen/t/296-regression-corpus-strict-supported-behavior.t) runs every marked entry through strict pipeline/CLI regardless of fixture family, [t/247-protocol-fixture-regression-smoke.t](/Users/richarddje/Documents/github/fsmgen/t/247-protocol-fixture-regression-smoke.t) keeps extra protocol-specific smoke, [t/261-regression-corpus-supported-language-features.t](/Users/richarddje/Documents/github/fsmgen/t/261-regression-corpus-supported-language-features.t) keeps extra language-feature HDL-shape checks, and [t/248-regression-corpus-accounting.t](/Users/richarddje/Documents/github/fsmgen/t/248-regression-corpus-accounting.t) locks both the marker count and the rule that every supported protocol and direct language-feature fixture is strict-supported.
...
- The `strict_supported` marker now has one catalog-level behavior owner:
  - [t/296-regression-corpus-strict-supported-behavior.t](/Users/richarddje/Documents/github/fsmgen/t/296-regression-corpus-strict-supported-behavior.t) selects every marked `supported_smoke` entry from [t/lib/FSM/Test/RegressionCorpus.pm](/Users/richarddje/Documents/github/fsmgen/t/lib/FSM/Test/RegressionCorpus.pm),
  - runs each entry through `strict_mode => 1` and `bin/fsmgen --strict`,
  - checks expected direct module names, composition top/child modules, and recorded HDL-shape patterns,
  - and prevents future strict-supported entries from depending only on family-specific tests for positive strict acceptance.
Left:
...
- The first positive strict-mode acceptance markers are now support-accounted too:
  ...
  - [t/296-regression-corpus-strict-supported-behavior.t](/Users/richarddje/Documents/github/fsmgen/t/296-regression-corpus-strict-supported-behavior.t) treats `strict_supported` as the catalog-level behavior contract by running every marked entry through strict pipeline and strict CLI while checking recorded module/top/child-module and HDL-shape expectations,
