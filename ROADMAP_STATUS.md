...
- Current next decision point:
  ...
  - The matching aggregate-path ownership hardening is now also shipped: [perl/FSM/Composition/AggregatePathSupport.pm](/Users/richarddje/Documents/github/fsmgen/perl/FSM/Composition/AggregatePathSupport.pm) now owns declared aggregate path traversal for both explicit-link planning and provenance reporting, with [t/283-composition-aggregate-path-support.t](/Users/richarddje/Documents/github/fsmgen/t/283-composition-aggregate-path-support.t) locking shared success/failure semantics.
  - The next honest aggregate-type seams are now deeper type-directed aggregate member/index expression lowering, VHDL aggregate lowering, and public type/export surface stabilization rather than packed-width-only direct SystemVerilog declaration emission.
