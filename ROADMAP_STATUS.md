...
- Current next decision point:
  ...
  - The README/session-bootstrap import-tree sanity pass was rerun after the parameter/generic expression work: [docs/BIN_FSMGEN_IMPORT_TREE.md](/Users/richarddje/Documents/github/fsmgen/docs/BIN_FSMGEN_IMPORT_TREE.md) still measures `120` reachable project files and `119` reachable `.pm` packages, but now records [perl/FSM/ParameterValueSupport.pm](/Users/richarddje/Documents/github/fsmgen/perl/FSM/ParameterValueSupport.pm) as a singleton semantic-value owner and refreshes the current hotspot line counts after the bounded scalar-expression and aggregate-expression slices.
