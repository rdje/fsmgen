...
- Current next decision point:
  ...
  - The first SPECFORGE-facing capability-manifest bridge is now shipped: [bin/fsmgen](/Users/richarddje/Documents/github/fsmgen/bin/fsmgen) accepts `--capability-manifest`, emits schema-versioned JSON without an input `.fsm`, and builds that manifest through [perl/FSM/Support/CapabilityManifest.pm](/Users/richarddje/Documents/github/fsmgen/perl/FSM/Support/CapabilityManifest.pm) from [perl/FSM/Support/RegressionCorpus.pm](/Users/richarddje/Documents/github/fsmgen/perl/FSM/Support/RegressionCorpus.pm), while [t/297-capability-manifest.t](/Users/richarddje/Documents/github/fsmgen/t/297-capability-manifest.t) locks corpus-derived counts, strict-versus-compatibility metadata, stable diagnostic-code registry exposure, check-JSON command metadata, check-JSON corpus-coverage flags, normalized-semantic-JSON command metadata, normalized-semantic-JSON accepted/rejected corpus-coverage flags, and CLI JSON emission.
