...
- Current next decision point:
  ...
  - The direct SystemVerilog consolidated intermediate-signal emission family now also has an explicit owner in [perl/FSM/HDL/FlattenedDT/Backend/SystemVerilog/ConsolidatedIntermediateEmitter.pm](/Users/richarddje/Documents/github/fsmgen/perl/FSM/HDL/FlattenedDT/Backend/SystemVerilog/ConsolidatedIntermediateEmitter.pm), covering AST-factorized plus pre-scanned intermediate-signal merging, dependency-aware filtering, and final wire/assign emission before unified WEN/EN generation on the direct backend path.
