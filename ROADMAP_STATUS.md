...
- The bounded check-only JSON diagnostic bridge is now shipped:
  ...
  - and [t/297-capability-manifest.t](/Users/richarddje/Documents/github/fsmgen/t/297-capability-manifest.t) locks the manifest's bounded check-JSON command metadata, support-accounting object flag, expected-failure corpus-coverage flag, and most-specific-pattern classifier policy.
Left:
