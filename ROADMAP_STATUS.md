...
- Current next decision point:
  ...
  - The direct SystemVerilog intermediate runtime-recovery and metadata-normalization family now also has an explicit owner in [perl/FSM/HDL/FlattenedDT/Backend/SystemVerilog/IntermediateSignalRecoverySupport.pm](/Users/richarddje/Documents/github/fsmgen/perl/FSM/HDL/FlattenedDT/Backend/SystemVerilog/IntermediateSignalRecoverySupport.pm), covering runtime AST lookup, rendered-expression caching, dependency recovery, and width inference for the direct intermediate-signal path.
  - The paired direct SystemVerilog intermediate filter family in [perl/FSM/HDL/FlattenedDT/Backend/SystemVerilog/IntermediateSignalSupport.pm](/Users/richarddje/Documents/github/fsmgen/perl/FSM/HDL/FlattenedDT/Backend/SystemVerilog/IntermediateSignalSupport.pm) is now narrowed to filter policy over normalized metadata instead of owning recovery too.
  - The direct SystemVerilog consolidated intermediate preparation/normalization family now also has an explicit owner in [perl/FSM/HDL/FlattenedDT/Backend/SystemVerilog/ConsolidatedIntermediateSupport.pm](/Users/richarddje/Documents/github/fsmgen/perl/FSM/HDL/FlattenedDT/Backend/SystemVerilog/ConsolidatedIntermediateSupport.pm), covering AST-factorized, pre-scanned, and FSMGen-parsed intermediate-signal collection plus runtime metadata normalization on the direct backend path.
  - The direct SystemVerilog consolidated intermediate planning family now also has an explicit owner in [perl/FSM/HDL/FlattenedDT/Backend/SystemVerilog/ConsolidatedIntermediatePlanningSupport.pm](/Users/richarddje/Documents/github/fsmgen/perl/FSM/HDL/FlattenedDT/Backend/SystemVerilog/ConsolidatedIntermediatePlanningSupport.pm), covering dependency-map construction, dependency-aware rescue/filter planning, and dependency-safe emission ordering on the direct backend path.
  - The paired direct SystemVerilog consolidated intermediate-signal emission family in [perl/FSM/HDL/FlattenedDT/Backend/SystemVerilog/ConsolidatedIntermediateEmitter.pm](/Users/richarddje/Documents/github/fsmgen/perl/FSM/HDL/FlattenedDT/Backend/SystemVerilog/ConsolidatedIntermediateEmitter.pm) is now narrowed to final wire/assign emission from that extracted consolidated plan instead of keeping rescue/order helpers inline.
  - The iterative post-substitution factorization path now also has an explicit per-pass helper owner in [perl/FSM/HDL/Factorization/Fixpoint/PassSupport.pm](/Users/richarddje/Documents/github/fsmgen/perl/FSM/HDL/Factorization/Fixpoint/PassSupport.pm), covering primary intermediate lookup, deterministic pass signatures, second-pass name-collision recovery, and new-signal projection/debugging; the paired [perl/FSM/HDL/Factorization/Fixpoint.pm](/Users/richarddje/Documents/github/fsmgen/perl/FSM/HDL/Factorization/Fixpoint.pm) package is now narrowed to the loop, termination, and aggregate-result contract.
