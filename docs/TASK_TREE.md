...
| --- | --- | --- | --- | --- |
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.144` next AXI manager feature-completeness selector/audit after read single-beat multi-group queue-head response-demux | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
| `IAL1-VERIFICATION-CODE-GENERATION-FRONTIER` | `active` | `Verification code generation / IAL1` | `.3` select the first IAL1 verification observation/source-feature contract before any SV/UVM, VHDL-oriented, direct IAL2, or public artifact/report verification-code generation behavior | [docs/tasks/IAL1-VERIFICATION-CODE-GENERATION-FRONTIER.md](docs/tasks/IAL1-VERIFICATION-CODE-GENERATION-FRONTIER.md) |
...
| `Verification Code Generation` | `active IAL1-VERIFICATION-CODE-GENERATION-FRONTIER owns the first-class verification-generation lane; leaf .2 found existing IAL1 checks/properties sufficient for inline SV assertion projection but insufficient for first-class generated verification artifacts, so current frontier .3 selects an IAL1 verification observation/source-feature contract before SV/UVM, VHDL, direct IAL2, or public artifact/report behavior` |
