...
| --- | --- | --- | --- | --- |
| `CLAIM-VERIFICATION-ADOPTION` | `active` | `infra/evidence governance` | `.5.4.8` active for 49 AHB semantic-repair and exact-two/three requester-BUSY candidates | [task](docs/tasks/CLAIM-VERIFICATION-ADOPTION.md) |
