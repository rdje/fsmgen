...
| `HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE` | `active` | `verification architecture` | generator `.17.2.6.3` active; foundation `.1`, portable-SV `.2`, and portable-VHDL `.3` done; activate OSVVM `.17.2.6.3.4` next | [task](docs/tasks/HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE.md) |
