...
| `HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE` | `active` | `verification architecture` | generator `.17.2.6.3` active; foundation `.1` and profile children `.2`-`.5` done; family closure `.17.2.6.3.6` alone active | [task](docs/tasks/HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE.md) |
