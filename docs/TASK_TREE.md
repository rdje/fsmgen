...
| `ISF-SCHEDULING-BACKLOG-FRONTIER` | `active` | `R14` | current frontier (`.4.3`; keep repeat parent-exit drain after generated spawn fail-closed with a targeted diagnostic) | [docs/tasks/ISF-SCHEDULING-BACKLOG-FRONTIER.md](docs/tasks/ISF-SCHEDULING-BACKLOG-FRONTIER.md) |
