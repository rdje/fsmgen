...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.807` selected `IAL2-AHB-PIPELINED-ACTIVE-TRANSFER-AUDIT`; the clean selector commit `a1a6eec9a` handed the frontier to its active `.1` runtime audit. Decision 0020 remains proposed/inactive | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
| `IAL2-AHB-PIPELINED-ACTIVE-TRANSFER-AUDIT` | `active` | `IAL2 / AHB endpoint phase correctness` | `.1` runtime-proves two direct ready/OKAY NONSEQ/SEQ bus acceptances collapse to one internal admission/completion and selects pending `.2`, exact one-next-phase completion-boundary recapture contract selection; no behavior changes in `.1` | [docs/tasks/IAL2-AHB-PIPELINED-ACTIVE-TRANSFER-AUDIT.md](docs/tasks/IAL2-AHB-PIPELINED-ACTIVE-TRANSFER-AUDIT.md) |
...
| --- | --- | --- | --- | --- |
| `IAL2-AHB-PIPELINED-ACTIVE-TRANSFER-AUDIT` | `proposed` | `IAL2 / AHB endpoint phase correctness` | `.807` selects `.1` to runtime-prove consecutive active NONSEQ/SEQ address/data phases without an unselected, IDLE, or BUSY boundary; activation waits for the clean `.807` commit | [docs/tasks/IAL2-AHB-PIPELINED-ACTIVE-TRANSFER-AUDIT.md](docs/tasks/IAL2-AHB-PIPELINED-ACTIVE-TRANSFER-AUDIT.md) |
