...
| --- | --- | --- | --- | --- |
| `CLAIM-VERIFICATION-ADOPTION` | `active` | `infra/evidence governance` | `.2` done; `.3` implements and registers the bounded claim-record checker | [task](docs/tasks/CLAIM-VERIFICATION-ADOPTION.md) |
