...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.822` selects proposed exact-four requester BUSY counter-width readiness after the exact-one/two/three generic/profile cadence completed at 326/367/50 split 25/25 | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
...
| `IAL2-AHB-REQUESTER-EXACT-FOUR-BUSY-INSERTION-READINESS-AUDIT` | `active` | `IAL2 / AHB requester BUSY policy` | clean parent selector commit `db0990c9d` activates `.1` to resolve bounded width-three versus reusable minimum-width derivation after a 2,313-byte exact-four candidate fails closed at the intentional literal-2..3 boundary | [docs/tasks/IAL2-AHB-REQUESTER-EXACT-FOUR-BUSY-INSERTION-READINESS-AUDIT.md](docs/tasks/IAL2-AHB-REQUESTER-EXACT-FOUR-BUSY-INSERTION-READINESS-AUDIT.md) |
