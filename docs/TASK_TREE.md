...
| `BACKEND-LANGUAGE-PORTABILITY-CONTRACT-FRONTIER` | `active` | `Backend portability / public contracts` | `.2.3` select the portable in-memory API contract after `.2.2` completed the readiness audit | [docs/tasks/BACKEND-LANGUAGE-PORTABILITY-CONTRACT-FRONTIER.md](docs/tasks/BACKEND-LANGUAGE-PORTABILITY-CONTRACT-FRONTIER.md) |
