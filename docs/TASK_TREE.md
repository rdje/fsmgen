...
| --- | --- | --- | --- | --- |
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.137` report/static residue cleanup after generated runtime-validation multi-group queue-head scalar last-beat read-data | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
| `SEMANTIC-INTROSPECTION-MCP-FRONTIER` | `done` | `Embedding And Public APIs / AI integration` | complete (`.30`; immediate read-only semantic/MCP pass exhausted after catalog-backed source discovery; active priority returns to IAL2 `.136`) | [docs/tasks/SEMANTIC-INTROSPECTION-MCP-FRONTIER.md](docs/tasks/SEMANTIC-INTROSPECTION-MCP-FRONTIER.md) |
