...
| `COMPOSITION-TYPE-BACKLOG-EXHAUSTION` | `active` | Composition / Aggregate Types And Data | `COMPOSITION-TYPE-BACKLOG-EXHAUSTION.10` (`.9` deferred portable type-core widening behind one exact frontend type/inference/backend/VHDL/API contract; next aggregate member/index autogrowth selection) | [docs/tasks/COMPOSITION-TYPE-BACKLOG-EXHAUSTION.md](docs/tasks/COMPOSITION-TYPE-BACKLOG-EXHAUSTION.md) |
