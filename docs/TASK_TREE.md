...
| --- | --- | --- | --- | --- |
| `CLAIM-VERIFICATION-ADOPTION` | `active` | `infra/evidence governance` | `.5.4.9` active for 27 AHB arbitration and exact-three paired-composition candidates | [task](docs/tasks/CLAIM-VERIFICATION-ADOPTION.md) |
