...
| --- | --- | --- | --- | --- |
| `CLAIM-VERIFICATION-ADOPTION` | `active` | `infra/evidence governance` | `.5.6.8` active for 28 source-map and deterministic-randomness candidates on Chapter 16d lines 3092-3315 | [task](docs/tasks/CLAIM-VERIFICATION-ADOPTION.md) |
