...
| `BACKEND-LANGUAGE-PORTABILITY-CONTRACT-FRONTIER` | `active` | `Backend portability / public contracts` | `.2.8` active after `.2.7` selected current typed extensions as Perl-reference only for backend portability; select first implementation-language experiment next | [docs/tasks/BACKEND-LANGUAGE-PORTABILITY-CONTRACT-FRONTIER.md](docs/tasks/BACKEND-LANGUAGE-PORTABILITY-CONTRACT-FRONTIER.md) |
