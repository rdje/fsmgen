...
| `BIN-FSMGEN-IMPORT-TREE-JUL30-IDENTIFIER-REFRESH` | `active` | `bootstrap architecture maintenance` | `.1` active continuity-only; next action remeasures and synchronizes the 229-file / 228-package / 19-IAL2 identifier-era closure without behavior changes | [docs/tasks/BIN-FSMGEN-IMPORT-TREE-JUL30-IDENTIFIER-REFRESH.md](docs/tasks/BIN-FSMGEN-IMPORT-TREE-JUL30-IDENTIFIER-REFRESH.md) |
...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.839` complete; selected no-behavior identifier-era import-map child `.1` is active after clean selector commit `28d3e777a` | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
