...
| `COMPOSITION-TYPE-BACKLOG-EXHAUSTION` | `active` | Composition / Aggregate Types And Data | `COMPOSITION-TYPE-BACKLOG-EXHAUSTION.9` (`.8` deferred repeat-body child-activation widening behind one exact activation/CDC/outstanding-child/composition-wiring contract; next portable type-core selection) | [docs/tasks/COMPOSITION-TYPE-BACKLOG-EXHAUSTION.md](docs/tasks/COMPOSITION-TYPE-BACKLOG-EXHAUSTION.md) |
