...
| --- | --- | --- | --- | --- |
| `CLAIM-VERIFICATION-ADOPTION` | `active` | `infra/evidence governance` | `.5.2.4` done; `.5.3` next for the general-book group | [task](docs/tasks/CLAIM-VERIFICATION-ADOPTION.md) |
