...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.811` is active to ship the byte-identical two-subordinate exact-two `.ahb` alias at projected 320/361/44, with t1526 semantic/read-only MCP parity and shared t1525 runtime; current accounting remains 319/360/43 until implementation, while decision 0020 remains inactive | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
