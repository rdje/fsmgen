...
| --- | --- | --- | --- | --- |
| `DARWIN-INLINE-VERILATOR-RUNTIME-QUALIFICATION` | `active` | `verification infrastructure / runtime qualification` | `.3.1` bounded t1545 through the shared mechanism and sealed adapter; `.3.2` remains pending until the implementation commit is clean | [task](docs/tasks/DARWIN-INLINE-VERILATOR-RUNTIME-QUALIFICATION.md) |
