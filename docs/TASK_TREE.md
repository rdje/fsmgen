...
| `BACKEND-API-VALIDATION-FRONTIER` | `active` | Backends And Validation / Embedding And Public APIs | `BACKEND-API-VALIDATION-FRONTIER.74.1` (`.74` selected bounded external-RTL sized bitstring scalar VHDL generic-map actuals after `RESET_VALUE 8'hA5` remained fail-closed) | [docs/tasks/BACKEND-API-VALIDATION-FRONTIER.md](docs/tasks/BACKEND-API-VALIDATION-FRONTIER.md) |
