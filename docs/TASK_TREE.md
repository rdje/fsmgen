...
| `ISF-REMAINING-BROAD-FRONTIER` | `active` | `R14` | `ISF-REMAINING-BROAD-FRONTIER.11` (`.10` deferred remaining report/fixture/library widening to future exact owners; next broad item is CDC semantics) | [docs/tasks/ISF-REMAINING-BROAD-FRONTIER.md](docs/tasks/ISF-REMAINING-BROAD-FRONTIER.md) |
