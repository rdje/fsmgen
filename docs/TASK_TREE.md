...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.791` selects paired requester/subordinate BUSY composition readiness after finding aggregate requester-child JSON omits `busy_insertion`; `.792` active: audit report/runtime/source readiness while decision 0020 remains proposed/inactive | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
