...
| `KNOWLEDGE-CARD-SURFACE-ALLOWANCE-EXHAUSTION` | `active` | `infra/continuity` | `.1` done; premise withdrawn, `.2` makes both growth routes discoverable | [task](docs/tasks/KNOWLEDGE-CARD-SURFACE-ALLOWANCE-EXHAUSTION.md) |
