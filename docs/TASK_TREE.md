...
| `FSMGEN-HIR-ROADMAP-FRONTIER` | `active` | `architecture / high-level frontend IR` | clean v2-contract commit `f42fb033d` activates `.7` continuity-only for exact private SourceHIR concrete-control implementation/t1548; `.8` remains proposed | [docs/tasks/FSMGEN-HIR-ROADMAP-FRONTIER.md](docs/tasks/FSMGEN-HIR-ROADMAP-FRONTIER.md) |
