...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.807` handed the frontier to `IAL2-AHB-PIPELINED-ACTIVE-TRANSFER-AUDIT`; child `.2` now selects `.3` shared-generator one-slot phase recapture after its clean contract commit. Decision 0020 remains proposed/inactive | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
| `IAL2-AHB-PIPELINED-ACTIVE-TRANSFER-AUDIT` | `active` | `IAL2 / AHB endpoint phase correctness` | `.3` is complete in the working tree: one-slot subordinate phase retention plus generated requester address/data separation and retained fabric data ownership pass exact direct/paired/alias/accounting/docs gates; commit it cleanly before `.4` audits the distinct direct seed | [docs/tasks/IAL2-AHB-PIPELINED-ACTIVE-TRANSFER-AUDIT.md](docs/tasks/IAL2-AHB-PIPELINED-ACTIVE-TRANSFER-AUDIT.md) |
