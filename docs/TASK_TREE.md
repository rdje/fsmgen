...
| --- | --- | --- | --- | --- |
| `CLAIM-VERIFICATION-ADOPTION` | `active` | `infra/evidence governance` | `.5.5.5` active for 62 exact-four/two-window/generalized-range/repair Chapter 16c candidates on lines 2401-2640 | [task](docs/tasks/CLAIM-VERIFICATION-ADOPTION.md) |
