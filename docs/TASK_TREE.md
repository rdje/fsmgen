...
| --- | --- | --- | --- | --- |
| `LIVE-DOCUMENT-SIZE-CONTAINMENT-ADOPTION` | `active` | `infra/continuity / project-wide live-document lifecycle` | completed `.18` separates health targets from inclusive ceilings with downward ratchets and distinct increase authority; `.19` is next for verifier execution/driver reachability, while `.22` closes migration/retention evidence before wider reuse | [docs/tasks/LIVE-DOCUMENT-SIZE-CONTAINMENT-ADOPTION.md](docs/tasks/LIVE-DOCUMENT-SIZE-CONTAINMENT-ADOPTION.md) |
