...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.804` selects the existing requester WRAP-progression correctness audit as the next AHB owner after the complete paired BUSY family; the proposed audit activates only after `.804` commits cleanly. Decision 0020 remains proposed/inactive | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
...
| --- | --- | --- | --- | --- |
| `IAL2-AHB-REQUESTER-WRAP-PROGRESSION-AUDIT` | `proposed` | `IAL2 / AHB requester correctness` | `.804` selected `.1` as the next exact AHB owner: runtime-prove or disprove the sequential-clause risk that wrap-to-base is overwritten by base-plus-step. The paired BUSY family is complete, but activation waits for the clean post-`.804` pivot | [docs/tasks/IAL2-AHB-REQUESTER-WRAP-PROGRESSION-AUDIT.md](docs/tasks/IAL2-AHB-REQUESTER-WRAP-PROGRESSION-AUDIT.md) |
