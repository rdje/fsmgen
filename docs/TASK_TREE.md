...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.835` complete; selects proposed `BIN-FSMGEN-IMPORT-TREE-JUL29-REFRESH.1`, which remains unchanged until this selector commits cleanly | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
...
| --- | --- | --- | --- | --- |
| `BIN-FSMGEN-IMPORT-TREE-JUL29-REFRESH` | `proposed` | `bootstrap architecture maintenance` | `.835` selects `.1`; activation-time live closure is `228`/`227` and `IAL2: 19` versus the note's `213`/`212` and `IAL2: 5`; child remains untouched until the selector commits cleanly | [docs/tasks/BIN-FSMGEN-IMPORT-TREE-JUL29-REFRESH.md](docs/tasks/BIN-FSMGEN-IMPORT-TREE-JUL29-REFRESH.md) |
