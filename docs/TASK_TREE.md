...
| `HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE` | `active` | `verification architecture` | `.17.3.3` exact execution/checking matrix is complete; proposed `.17.3.4` is the next activation frontier for deterministic structural backend-emission measurement | [task](docs/tasks/HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE.md) |
