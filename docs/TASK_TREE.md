...
| --- | --- | --- | --- | --- |
| `ISF-COMPOSITIONAL-CONTROL-FLOW-ARCHITECTURE` | `active` | `R14` | current frontier (`.7.7`; select and migrate the next narrow validator gate after rule-trigger target domain validation) | [docs/tasks/ISF-COMPOSITIONAL-CONTROL-FLOW-ARCHITECTURE.md](docs/tasks/ISF-COMPOSITIONAL-CONTROL-FLOW-ARCHITECTURE.md) |
