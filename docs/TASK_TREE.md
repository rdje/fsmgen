...
| `IAL2-AHB-REQUESTER-EXACT-FOUR-BUSY-INSERTION-READINESS-AUDIT` | `active` | `IAL2 / AHB requester BUSY policy` | clean contract commit `58efc8aff` activates implementation `.3`: ship generic exact-four with literal-2..4 normalization, preserving minimum-width counter 2/2/3, assertion-enabled t1535, and 327/368/51 split 26/25 | [docs/tasks/IAL2-AHB-REQUESTER-EXACT-FOUR-BUSY-INSERTION-READINESS-AUDIT.md](docs/tasks/IAL2-AHB-REQUESTER-EXACT-FOUR-BUSY-INSERTION-READINESS-AUDIT.md) |
