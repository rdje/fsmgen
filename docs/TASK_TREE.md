...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.843` repairs the live ledger and ships eighth doctrine `TASK-TREE-INTEGRITY`; proposed `.844` is the next exact roadmap selector after this slice commits cleanly | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
