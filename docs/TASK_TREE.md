...
| `IAL2-AHB-SUBORDINATE-DEFAULT-PHASE-OUTPUT-ARBITRATION` | `active` | `IAL2 / AHB subordinate correctness` | `.1` audits exact direct/paired overlaps; `.2` selects five redundant generated writes only; clean contract `ef14893f5` activates `.3` to implement assertion-enabled direct/paired endpoint arbitration | [docs/tasks/IAL2-AHB-SUBORDINATE-DEFAULT-PHASE-OUTPUT-ARBITRATION.md](docs/tasks/IAL2-AHB-SUBORDINATE-DEFAULT-PHASE-OUTPUT-ARBITRATION.md) |
