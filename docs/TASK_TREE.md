...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | completed `.813` selects the AHB interconnect default/decode output-arbitration audit before more paired expansion; child `.1` is active after clean selector commit `347a85f80`; decision 0020 remains inactive | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
...
| `IAL2-AHB-INTERCONNECT-DEFAULT-DECODE-OUTPUT-ARBITRATION` | `active` | `IAL2 / AHB interconnect correctness` | active `.1` reproduces and maps the shipped default/mapped selector overlap, distinguishes AHB-generator from generic-lowering ownership, and selects the smallest repair contract without behavior changes | [docs/tasks/IAL2-AHB-INTERCONNECT-DEFAULT-DECODE-OUTPUT-ARBITRATION.md](docs/tasks/IAL2-AHB-INTERCONNECT-DEFAULT-DECODE-OUTPUT-ARBITRATION.md) |
