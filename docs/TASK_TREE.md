...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.838` complete at clean `b0bcb12b5`; selected `PROTOCOL-COMPOSITION-HDL-INSTANCE-IDENTIFIER-AUDIT.1` is now active continuity-only | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
...
| `PROTOCOL-COMPOSITION-HDL-INSTANCE-IDENTIFIER-AUDIT` | `active` | `HDL quality / protocol composition identifiers` | `.1` active from clean selector `b0bcb12b5`: inventory/probe AHB, APB, AXI, reusable-library, and actor-network instance-name producers and select one shared target-language-safe contract without behavior changes | [docs/tasks/PROTOCOL-COMPOSITION-HDL-INSTANCE-IDENTIFIER-AUDIT.md](docs/tasks/PROTOCOL-COMPOSITION-HDL-INSTANCE-IDENTIFIER-AUDIT.md) |
