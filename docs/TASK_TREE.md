...
| --- | --- | --- | --- | --- |
| `ISF-REPEAT-BODY-CHILD-ACTIVATION` | `active` | `R14` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.20` | [docs/tasks/ISF-REPEAT-BODY-CHILD-ACTIVATION.md](docs/tasks/ISF-REPEAT-BODY-CHILD-ACTIVATION.md) |
...
| Remaining repeat-body child activation widening: the selected multi-pending `await_any` plus mandatory same-body `await_all` drain subset, nested branch/loop activation, cross-domain activation, and broader outstanding-child semantics | `ISF-REPEAT-BODY-CHILD-ACTIVATION` |
