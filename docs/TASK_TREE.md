...
| --- | --- | --- | --- | --- |
| `CLAIM-VERIFICATION-ADOPTION` | `active` | `infra/evidence governance` | `.5.2.1` done; activate `.5.2.2` next from a clean boundary for nine foundational rationale candidates | [task](docs/tasks/CLAIM-VERIFICATION-ADOPTION.md) |
