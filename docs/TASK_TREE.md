...
| `HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE` | `active` | `verification architecture` | `.17.3.4.1` owns caller-sealed structural backend-emission measurement; `.17.3.4.2` separately owns exact resumable matrix publication | [task](docs/tasks/HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE.md) |
