...
| `IAL2-AXI-MANAGER-INITIATOR-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness / AXI initiator` | `.1`-.7 shipped/corrected AW; `.8`-.10 shipped single-beat W; `.11`-.14 shipped explicitly armed one-response B acceptance (300/341/341; t/1501). `.15`-.18 select, prove, contract, and ship bounded `(axi-write-request-composition ...)`: atomic aligned address32/AWID4/WDATA32/WSTRB4 capture, fixed AWLEN=0/AWSIZE=2/AWBURST=INCR, zero strobe, unchanged AW/W children plus completion-history coordinator, request-only aggregate done, three IAL1 schedules/three child IAL0 artifacts/one selected C4 top, support 301/342/342, and t/1502 generated-top proof at exact AW/W/done totals 3/3/3. `.19` selects bounded single-beat AW+W+B full-write transactor composition; `.20` active readiness audit resolves C4 topology, B arming, AWID/BID correlation, BRESP/status, and full-completion ownership. Deferred: capacity integration, multi-beat/burst, AR/R, decision-0020 transaction interface, back-to-back/outstanding/extended responses, aliases, verification output, backend variants/VHDL/direct, AHB/APB | [docs/tasks/IAL2-AXI-MANAGER-INITIATOR-FRONTIER.md](docs/tasks/IAL2-AXI-MANAGER-INITIATOR-FRONTIER.md) |
