...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.840` selected `MDBOOK-AHB-BUSY-COUNT-RESIDUE-SYNC.1`; that no-behavior child is complete in this commit, and the next clean action is a new parent selector | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
