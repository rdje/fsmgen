...
| `BACKEND-API-VALIDATION-FRONTIER` | `active` | Backends And Validation / Embedding And Public APIs | `BACKEND-API-VALIDATION-FRONTIER.29.1` (`.29` selected explicit vector sized-literal generic-default coverage after `.28.1`; lock the multi-bit VHDL generic path before broader aggregate/composition VHDL work) | [docs/tasks/BACKEND-API-VALIDATION-FRONTIER.md](docs/tasks/BACKEND-API-VALIDATION-FRONTIER.md) |
