...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.832` child is complete: concurrent-check intermediate substitution now preserves grouping and t1507 proves legal bit-2 behavior plus a separate all-assertion run; next clean action is a new parent selector | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
