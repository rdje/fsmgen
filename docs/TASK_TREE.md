...
| `BACKEND-API-VALIDATION-FRONTIER` | `active` | Backends And Validation / Embedding And Public APIs | `BACKEND-API-VALIDATION-FRONTIER.4.4.1` (`.4.4` selected `fsm/apb_tb.fsm`; next fix generated-child shared-datapath export-port bindings so APB composition can enter external validation smoke) | [docs/tasks/BACKEND-API-VALIDATION-FRONTIER.md](docs/tasks/BACKEND-API-VALIDATION-FRONTIER.md) |
