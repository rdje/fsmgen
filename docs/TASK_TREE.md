...
| --- | --- | --- | --- | --- |
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.2` select the first post-Valid-Ready AXI manager rule subset and pre-code contract, including any required IAL1/IAL0/SV prerequisites | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
