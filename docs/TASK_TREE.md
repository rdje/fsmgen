...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | completed `.814` selects proposed AHB subordinate output-arbitration audit `.1` as the next exact correctness owner after interconnect assertions shipped; activation waits for the clean selector commit and decision 0020 remains inactive | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
...
| `IAL2-AHB-SUBORDINATE-DEFAULT-PHASE-OUTPUT-ARBITRATION` | `active` | `IAL2 / AHB subordinate correctness` | `.1` independently reproduces direct/paired failures, maps 8/10/20-target generated variants and exact runtime overlap modes, keeps generic assertions authoritative, routes the distinct direct-seed gap, and clean audit commit `0dad690cb` activates generated-local contract `.2` | [docs/tasks/IAL2-AHB-SUBORDINATE-DEFAULT-PHASE-OUTPUT-ARBITRATION.md](docs/tasks/IAL2-AHB-SUBORDINATE-DEFAULT-PHASE-OUTPUT-ARBITRATION.md) |
