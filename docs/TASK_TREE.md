...
| --- | --- | --- | --- | --- |
| `PROJECT-DATA-LOCALITY-SAME-VOLUME-ADOPTION` | `active` | `infra/continuity / project data locality` | `.1` policy/doctrine and `.2` runtime/test storage migration are complete. `.3` is active for README/toolbox/fact-card/Knowledge Map synchronization, exact residue proof, final doctrine hardening, and closeout; legacy blobs remain frozen | [docs/tasks/PROJECT-DATA-LOCALITY-SAME-VOLUME-ADOPTION.md](docs/tasks/PROJECT-DATA-LOCALITY-SAME-VOLUME-ADOPTION.md) |
