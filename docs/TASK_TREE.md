...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | selected exact-two paired-BUSY child `.2` freezes one generic source/runtime/semantic-MCP contract and awaits clean commit before proposed `.3` implementation; decision 0020 remains inactive | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
...
| `IAL2-AHB-EXACT-TWO-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT` | `active` | `IAL2 / AHB requester-subordinate composition` | `.2` selects the long-form generic source, t1523 runtime plus normalized semantic/read-only MCP proof, projected 317/358/41 support, and proposed `.3` implementation after clean commit | [docs/tasks/IAL2-AHB-EXACT-TWO-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT.md](docs/tasks/IAL2-AHB-EXACT-TWO-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT.md) |
