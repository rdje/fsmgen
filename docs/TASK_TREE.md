...
| --- | --- | --- | --- | --- |
| `CLAIM-VERIFICATION-ADOPTION` | `active` | `infra/evidence governance` | `.5` partitioned; `.5.1` gates bounded candidate-review dispositions before the five surface/topic migrations | [task](docs/tasks/CLAIM-VERIFICATION-ADOPTION.md) |
