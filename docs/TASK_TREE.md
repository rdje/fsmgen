...
| `SUPPORTED-LANGUAGE-FEATURE-RHS-SIMPLIFICATION-EXPECTATION-SYNC` | `active` | `test integrity / generated HDL expression simplification` | `.1` classify and repair six stale simplification oracles across four supported-language corpus entries | [docs/tasks/SUPPORTED-LANGUAGE-FEATURE-RHS-SIMPLIFICATION-EXPECTATION-SYNC.md](docs/tasks/SUPPORTED-LANGUAGE-FEATURE-RHS-SIMPLIFICATION-EXPECTATION-SYNC.md) |
