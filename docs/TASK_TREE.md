...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.827` selects pending `.828`, the byte-identical two-window exact-four paired `.ahb` alias through existing suffix/lowering machinery, projected at 332/373/56 split 28/28; implementation waits for the clean selector commit | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
