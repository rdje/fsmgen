...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.828` complete: byte-identical two-window exact-four paired `.ahb` alias, exact support, and t1540 parity ship at 332/373/56 split 28/28 with t1539 as shared runtime; next clean-tree action is a new parent selector leaf | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
