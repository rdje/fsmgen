...
| --- | --- | --- | --- | --- |
| `CLAIM-VERIFICATION-ADOPTION` | `active` | `infra/evidence governance` | `.5.6.1` active for 8 HIAL/VIAL foundation, bridge, tooling, and runtime-direction candidates on Chapter 16d lines 1-931 | [task](docs/tasks/CLAIM-VERIFICATION-ADOPTION.md) |
