...
| --- | --- | --- | --- | --- |
| `CLAIM-VERIFICATION-ADOPTION` | `active` | `infra/evidence governance` | `.5.3` partitioned; `.5.3.1` active for 35 core-language/tooling candidates | [task](docs/tasks/CLAIM-VERIFICATION-ADOPTION.md) |
