...
| `ISF-COND` | `active` | `R14` | `ISF-COND.2` (`.1` done; `(cond …)` if/else-if/else priority chain — parser desugar to a negated-guard `when`-chain; target validated by simulation) | [docs/tasks/ISF-COND.md](docs/tasks/ISF-COND.md) |
