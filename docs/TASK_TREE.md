...
| `COMPOSITION-TYPE-BACKLOG-EXHAUSTION` | `active` | Composition / Aggregate Types And Data | `COMPOSITION-TYPE-BACKLOG-EXHAUSTION.4` (`.3` deferred shared-datapath widening behind an exact route/storage/protocol or adjacent prerequisite; next reusable standalone-DT selection) | [docs/tasks/COMPOSITION-TYPE-BACKLOG-EXHAUSTION.md](docs/tasks/COMPOSITION-TYPE-BACKLOG-EXHAUSTION.md) |
