...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.832` active after clean direct-VHDL reduction behavior commit `2879f22af`: select exactly one next roadmap-aligned owner without changing behavior | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
...
| `HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE` | `proposed` | `Verification code generation / intent architecture` | direct-VHDL reduction work is complete; retain typed bridge, portable/native semantics, SV/UVM and VHDL lowerings, simulator capability profiles, parity, scalability, and inert-skeleton migration for active parent selector `.832` to compare independently | [docs/tasks/HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE.md](docs/tasks/HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE.md) |
