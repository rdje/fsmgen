...
| `TASK-TREE-FROZEN-LEGACY-DOC-WORKFLOW-SYNC` | `active` | `infra/continuity / task-tree doctrine alignment` | `.1` active continuity-only after clean selector commit `dc055558c`; next action removes frozen-blob write/canonical instructions without editing the blobs | [docs/tasks/TASK-TREE-FROZEN-LEGACY-DOC-WORKFLOW-SYNC.md](docs/tasks/TASK-TREE-FROZEN-LEGACY-DOC-WORKFLOW-SYNC.md) |
...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.834` is complete through clean selector commit `dc055558c`; selected child `TASK-TREE-FROZEN-LEGACY-DOC-WORKFLOW-SYNC.1` is active continuity-only | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
