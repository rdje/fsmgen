...
| `BACKEND-LANGUAGE-PORTABILITY-CONTRACT-FRONTIER` | `active` | `Backend portability / public contracts` | `.2.5` active after `.2.4` selected the source catalog plus artifact sink host abstraction; select Perl-reference parity harness rules next | [docs/tasks/BACKEND-LANGUAGE-PORTABILITY-CONTRACT-FRONTIER.md](docs/tasks/BACKEND-LANGUAGE-PORTABILITY-CONTRACT-FRONTIER.md) |
