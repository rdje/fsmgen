...
| `HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE` | `active` | `verification architecture` | `.17.3.3.2.3.1` owns bounded reuse of projected random decisions after profile 23 exposed accepted-plan regeneration beyond the fixed stage timeout | [task](docs/tasks/HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE.md) |
