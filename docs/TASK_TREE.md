...
| `GITHUB-PUSH-OUTCOME-ASSURANCE` | `active` | `hosted CI` | `.6.2.2.20` locally repaired and qualified; consume remaining exact-SHA regression jobs | [task](docs/tasks/GITHUB-PUSH-OUTCOME-ASSURANCE.md) |
