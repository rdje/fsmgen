...
| `IAL2-AXI-MANAGER-INITIATOR-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness / AXI initiator` | `.1`-.7 shipped/corrected AW; `.8`-.10 shipped single-beat W; `.11`-.14 shipped explicitly armed B acceptance. `.15`-.18 ship bounded request-only `(axi-write-request-composition ...)` at support 301/342/342 with t/1502. `.19`-.22 ship bounded full-write composition at 302/343/343 with t/1503. `.23`-.26 select/audit/contract/ship `(axi-ar-driver ...)`: full address32/ID4/LEN8/SIZE3/BURST2 request, request-issued-only done, response exclusion, 15-port/six-state/three-priority schedule, exact 3/3 generated-HDL proof, t/1504 and support 303/344/344; `.27` active post-AR selector. Deferred: R acceptance/full read composition, response-beat obligations, request legality, capacity integration, multi-beat/burst, decision-0020 transaction interface, back-to-back/outstanding/extended attributes, aliases, verification output, backend variants/VHDL/direct, AHB/APB | [docs/tasks/IAL2-AXI-MANAGER-INITIATOR-FRONTIER.md](docs/tasks/IAL2-AXI-MANAGER-INITIATOR-FRONTIER.md) |
