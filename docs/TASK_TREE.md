...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.529` active after `.528` selected a protocol-neutral/non-AXI Valid-Ready `.ppif` example readiness audit; AXI is the first shipped profile/example, not the definition of IAL2 | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
