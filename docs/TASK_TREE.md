...
| --- | --- | --- | --- | --- |
| `CLAIM-VERIFICATION-ADOPTION` | `active` | `infra/evidence governance` | `.5.5.4` active for 71 direct-seed/exact-count progression Chapter 16c candidates on lines 2038-2400 | [task](docs/tasks/CLAIM-VERIFICATION-ADOPTION.md) |
