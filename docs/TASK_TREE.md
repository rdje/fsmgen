...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | child `.4` selects the byte-identical matching exact-two paired-BUSY `.ahb` alias contract with projected 318/359/42 and semantic/MCP parity; proposed `.5` owns data-only implementation after clean `.4`, and decision 0020 remains inactive | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
...
| `IAL2-AHB-EXACT-TWO-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT` | `active` | `IAL2 / AHB requester-subordinate composition` | `.4` selects the matching alias contract through existing suffix handling, projected 318/359/42, focused t1524 semantic/read-only MCP parity, and shared t1523 runtime; proposed `.5` implements only that alias after clean `.4` | [docs/tasks/IAL2-AHB-EXACT-TWO-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT.md](docs/tasks/IAL2-AHB-EXACT-TWO-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT.md) |
