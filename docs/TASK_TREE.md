...
| `BACKEND-API-VALIDATION-FRONTIER` | `active` | Backends And Validation / Embedding And Public APIs | `BACKEND-API-VALIDATION-FRONTIER.46.1` (`.46` selected normalized semantic composition child and generated-child entry schemas; publish bounded `semantic.composition.children[]` and `semantic.composition.generated_children[]` key families) | [docs/tasks/BACKEND-API-VALIDATION-FRONTIER.md](docs/tasks/BACKEND-API-VALIDATION-FRONTIER.md) |
