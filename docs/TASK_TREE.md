...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.812` selects proposed `IAL2-AHB-REQUESTER-EXACT-THREE-BUSY-INSERTION-READINESS-AUDIT.1`: the shipped width-two counter statically admits literal three, but assertion-enabled continuous/ready-low/grant-low runtime must prove exact three-event retirement before any public contract; decision 0020 remains inactive | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
...
| `IAL2-AHB-REQUESTER-EXACT-THREE-BUSY-INSERTION-READINESS-AUDIT` | `proposed` | `IAL2 / AHB requester BUSY policy` | `.1` will use a same-volume disposable candidate and assertion-enabled continuous/ready-low/grant-low generated HDL to prove or disprove exact-three reuse of the shipped width-two counter before any public contract or behavior | [docs/tasks/IAL2-AHB-REQUESTER-EXACT-THREE-BUSY-INSERTION-READINESS-AUDIT.md](docs/tasks/IAL2-AHB-REQUESTER-EXACT-THREE-BUSY-INSERTION-READINESS-AUDIT.md) |
...
| `IAL2-AHB-INTERCONNECT-DEFAULT-DECODE-OUTPUT-ARBITRATION` | `proposed` | `IAL2 / AHB interconnect correctness` | inactive; paired assertion enablement exposed overlapping interconnect default and mapped-decode output selectors; audit only after requester BUSY work dries out | [docs/tasks/IAL2-AHB-INTERCONNECT-DEFAULT-DECODE-OUTPUT-ARBITRATION.md](docs/tasks/IAL2-AHB-INTERCONNECT-DEFAULT-DECODE-OUTPUT-ARBITRATION.md) |
