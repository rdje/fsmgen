...
| `BIN-FSMGEN-IMPORT-TREE-JUL29-REFRESH` | `active` | `bootstrap architecture maintenance` | `.1` active continuity-only after clean selector commit `23a987e06`; next action remeasures and synchronizes the stale note/fact without runtime changes | [docs/tasks/BIN-FSMGEN-IMPORT-TREE-JUL29-REFRESH.md](docs/tasks/BIN-FSMGEN-IMPORT-TREE-JUL29-REFRESH.md) |
...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.835` complete through clean selector commit `23a987e06`; selected child `BIN-FSMGEN-IMPORT-TREE-JUL29-REFRESH.1` is active continuity-only | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
