...
| `IAL2-AHB-EXACT-THREE-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT` | `active` | `IAL2 / AHB paired requester-subordinate BUSY composition` | `.1` proves readiness; `.2` freezes one generic source/t1531/323/364/47 contract; `.3` active from clean `547d8102f` for exact data-only implementation | [docs/tasks/IAL2-AHB-EXACT-THREE-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT.md](docs/tasks/IAL2-AHB-EXACT-THREE-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT.md) |
