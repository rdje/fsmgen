...
| --- | --- | --- | --- | --- |
| `CLAIM-VERIFICATION-ADOPTION` | `active` | `infra/evidence governance` | `.5.3.3` done; `.5.3.4` active for 71 support-matrix/backlog candidates | [task](docs/tasks/CLAIM-VERIFICATION-ADOPTION.md) |
