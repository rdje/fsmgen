...
| --- | --- | --- | --- | --- |
| `CLAIM-VERIFICATION-ADOPTION` | `active` | `infra/evidence governance` | `.5.4.15` active for 46 shipped AXI IAL2 example candidates | [task](docs/tasks/CLAIM-VERIFICATION-ADOPTION.md) |
