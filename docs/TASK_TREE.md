...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | completed `.813` selected the AHB interconnect output-arbitration audit; child audit `.1` maps five one-window/seven two-window conflicts and active `.2` owns generator-local contract selection after clean audit commit `c32255645`; decision 0020 remains inactive | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
...
| `IAL2-AHB-INTERCONNECT-DEFAULT-DECODE-OUTPUT-ARBITRATION` | `active` | `IAL2 / AHB interconnect correctness` | `.1` is complete at `c32255645`; active `.2` freezes the generator-local mutually exclusive HSEL/HADDR and HREADY/HRESP/HRDATA arbitration contract, assertion-enabled runtime/preservation gates, resource boundary, and rollback before implementation | [docs/tasks/IAL2-AHB-INTERCONNECT-DEFAULT-DECODE-OUTPUT-ARBITRATION.md](docs/tasks/IAL2-AHB-INTERCONNECT-DEFAULT-DECODE-OUTPUT-ARBITRATION.md) |
