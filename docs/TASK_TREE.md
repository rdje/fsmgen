...
| --- | --- | --- | --- | --- |
| `CLAIM-VERIFICATION-ADOPTION` | `active` | `infra/evidence governance` | `.6` active for the complete current-surface audit and recoverable handoff | [task](docs/tasks/CLAIM-VERIFICATION-ADOPTION.md) |
