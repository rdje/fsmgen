...
| `IAL2-AXI-MANAGER-INITIATOR-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness / AXI initiator` | `.1`-.7 shipped/corrected AW; `.8`-.10 shipped single-beat W; `.11`-.14 selected/audited/shipped explicitly armed one-response B acceptance (300/341/341; t/1501 exact capture/cardinality proof). `.15`-.17 select, prove, and contract a bounded `(axi-write-request-composition ...)`: atomic aligned address32/AWID4/WDATA32/WSTRB4 capture, fixed AWLEN=0/AWSIZE=2/AWBURST=INCR, zero strobe preserved, unchanged AW/W children plus rule-only completion-history coordinator, request-only aggregate done, three IAL1 schedules/three child IAL0 artifacts/one selected C4 top; exact source/schema/report/diagnostics/support t/1502 owner fixed. `.18` active implementation. Deferred: B/capacity/full transactor, multi-beat/burst, AR/R, decision-0020 transaction interface, back-to-back/outstanding/extended responses, aliases, verification output, backend variants/VHDL/direct, AHB/APB | [docs/tasks/IAL2-AXI-MANAGER-INITIATOR-FRONTIER.md](docs/tasks/IAL2-AXI-MANAGER-INITIATOR-FRONTIER.md) |
