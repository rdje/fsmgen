...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.834` and selected child `TASK-TREE-FROZEN-LEGACY-DOC-WORKFLOW-SYNC.1` are complete; next clean action is a new parent selector | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
