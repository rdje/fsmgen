...
| `GITHUB-PUSH-OUTCOME-ASSURANCE` | `active` | `hosted CI` | `.6.2.2.18` consume the final three terminal shards and restore ordinary-job runtime headroom before repaired-push authorization | [task](docs/tasks/GITHUB-PUSH-OUTCOME-ASSURANCE.md) |
