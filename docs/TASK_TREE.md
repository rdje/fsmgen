...
| `HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE` | `active` | `verification architecture` | repair parent `.17.2.6.2` active; `.17.2.6.2.2` alone owns sealed reusable OSVVM provider verification | [task](docs/tasks/HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE.md) |
