...
| `HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE` | `active` | `verification architecture` | generator `.17.2.6.3` active; foundation `.17.2.6.3.1` done; portable-SV `.17.2.6.3.2` activation next | [task](docs/tasks/HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE.md) |
