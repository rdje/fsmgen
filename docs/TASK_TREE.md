...
| `IAL2-AHB-REQUESTER-EXACT-FOUR-BUSY-INSERTION-READINESS-AUDIT` | `active` | `IAL2 / AHB requester BUSY policy` | clean audit commit `74d91347e` activates no-behavior `.2` to freeze literal-2..4, minimum-width derivation, exact identities, preservation, and implementation ownership after `.1` proved assertion-enabled `4->3->2->1->0` runtime | [docs/tasks/IAL2-AHB-REQUESTER-EXACT-FOUR-BUSY-INSERTION-READINESS-AUDIT.md](docs/tasks/IAL2-AHB-REQUESTER-EXACT-FOUR-BUSY-INSERTION-READINESS-AUDIT.md) |
