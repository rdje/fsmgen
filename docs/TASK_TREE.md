...
| --- | --- | --- | --- | --- |
| `CLAIM-VERIFICATION-ADOPTION` | `active` | `infra/evidence governance` | `.5.3.1` done; `.5.3.2` active for 43 intent/actor/transaction candidates | [task](docs/tasks/CLAIM-VERIFICATION-ADOPTION.md) |
