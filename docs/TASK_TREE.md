...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.829` complete in clean commit `a2750d8a6`: selects generalized literal AHB requester BUSY-count readiness `.1`, now active at unchanged 332/373/56 split 28/28 | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
| `IAL2-AHB-REQUESTER-GENERALIZED-BUSY-COUNT-RANGE-READINESS-AUDIT` | `active` | `IAL2 / AHB requester BUSY insertion` | `.1` active after clean selector commit `a2750d8a6`; choose and prove one reusable finite literal `busy-beats` range above four with width-transition/runtime/diagnostic coverage, without an exact-count fixture cadence | [docs/tasks/IAL2-AHB-REQUESTER-GENERALIZED-BUSY-COUNT-RANGE-READINESS-AUDIT.md](docs/tasks/IAL2-AHB-REQUESTER-GENERALIZED-BUSY-COUNT-RANGE-READINESS-AUDIT.md) |
