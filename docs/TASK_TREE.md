...
| `ISF-SCHEDULING-BACKLOG-FRONTIER` | `active` | `R14` | current frontier (`.7.2`; keep source-authored ATL group endpoints fail-closed with targeted diagnostics) | [docs/tasks/ISF-SCHEDULING-BACKLOG-FRONTIER.md](docs/tasks/ISF-SCHEDULING-BACKLOG-FRONTIER.md) |
