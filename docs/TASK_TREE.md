...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.839` selects proposed no-behavior `BIN-FSMGEN-IMPORT-TREE-JUL30-IDENTIFIER-REFRESH.1`; the selected child remains inactive until a clean follow-up activation | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
