...
| `IAL2-MDBOOK-COHERENCE-AXI-COVERAGE` | `active` | `IAL2 mdBook alignment` | `.4` done; `.5` documents read-data, burst-length, RLAST validation, and output banks | [task](docs/tasks/IAL2-MDBOOK-COHERENCE-AXI-COVERAGE.md) |
