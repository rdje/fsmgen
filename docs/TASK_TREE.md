...
| `IAL2-PROTOCOL-PLATFORM-INTENT-EXPLORATION` | `active` | IAL2 horizon exploration | current frontier (`.2`; write the first non-code protocol/platform intent evaluation note before any IAL2 source or lowering implementation) | [docs/tasks/IAL2-PROTOCOL-PLATFORM-INTENT-EXPLORATION.md](docs/tasks/IAL2-PROTOCOL-PLATFORM-INTENT-EXPLORATION.md) |
