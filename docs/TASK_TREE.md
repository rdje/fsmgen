...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.836` complete at clean `06c03e6bf`; selected child `PUBLIC-SYNC-TEST-DRIFT-REPAIR` has `.1`-.2 complete and `.3` active continuity-only | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
| `PUBLIC-SYNC-TEST-DRIFT-REPAIR` | `active` | `public-contract, specification, and focused-test synchronization` | `.1` complete at `012660f90`; `.2` complete at `4ba108b3d` with exact 332/332 index and guarded 295-file ISF pass; `.3` active continuity-only for the one stale t1474 diagnostic assertion | [docs/tasks/PUBLIC-SYNC-TEST-DRIFT-REPAIR.md](docs/tasks/PUBLIC-SYNC-TEST-DRIFT-REPAIR.md) |
