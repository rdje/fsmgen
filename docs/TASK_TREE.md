...
| --- | --- | --- | --- | --- |
| `CLAIM-VERIFICATION-ADOPTION` | `active` | `infra/evidence governance` | `.1` done; `.2` installs the locally authoritative standard and discovery routes | [task](docs/tasks/CLAIM-VERIFICATION-ADOPTION.md) |
