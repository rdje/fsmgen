...
| --- | --- | --- | --- | --- |
| `CLAIM-VERIFICATION-ADOPTION` | `active` | `infra/evidence governance` | `.5.2.3` done; `.5.2.4` active for the final 12 checking-scale root candidates | [task](docs/tasks/CLAIM-VERIFICATION-ADOPTION.md) |
