...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | selected exact-two paired-BUSY child `.1` proves runtime/lowering readiness and awaits clean commit before `.2` public contract activation; future semantics require bounded JSON/read-only MCP exposure, and decision 0020 remains inactive | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
...
| `IAL2-AHB-EXACT-TWO-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT` | `active` | `IAL2 / AHB requester-subordinate composition` | `.1` proves two qualified BUSY events, stable requester/subordinate/interconnect ownership, one resumed SEQ, four beats, and `44332211`; proposed `.2` selects the generic public contract after clean `.1` | [docs/tasks/IAL2-AHB-EXACT-TWO-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT.md](docs/tasks/IAL2-AHB-EXACT-TWO-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT.md) |
