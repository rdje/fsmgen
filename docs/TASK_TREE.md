...
| `MDBOOK-AHB-ALIAS-PUBLIC-SURFACE-SYNC` | `done` | `roadmap/documentation alignment` | complete (`.1`; stale mdBook language-surface and backlog prose now list `.ahb` with shipped bounded aliases and keep pre-`.700` unsupported wording historical) | [docs/tasks/MDBOOK-AHB-ALIAS-PUBLIC-SURFACE-SYNC.md](docs/tasks/MDBOOK-AHB-ALIAS-PUBLIC-SURFACE-SYNC.md) |
| `IAL2-AXI-MANAGER-INITIATOR-FRONTIER` | `done` | `IAL2 / SV-backed feature completeness / AXI initiator` | `.1`-.7 shipped/corrected AW; `.8`-.10 shipped single-beat W; `.11`-.14 shipped explicitly armed B acceptance. `.15`-.18 ship bounded request-only write composition; `.19`-.22 ship bounded full-write composition. `.23`-.26 ship `(axi-ar-driver ...)` with t/1504 exact 3/3 proof. `.27`-.30 ship `(axi-r-beat-acceptor ...)` with t/1505 exact raw 3/3 proof. `.31`-.34 ship fixed-single `(axi-read-transaction-composition ...)` with unchanged AR/R, 27-port three-child C4, support 305/346/346, and t/1506 exact 5/4/5/4 proof. `.35`-.38 select, audit, contract, and ship additive `(axi-read-burst4-transaction-composition ...)`: LEN3/SIZE2/INCR, aligned 16-byte 4-KiB guard, raw beat event/index, sticky RID+RLAST sequence, count-authoritative drain, unchanged AR/R reuse, 20-port ten-rule coordinator, 29-port three-child C4 at 48 nets/46 links, support 306/347/347, and t/1507 exact 4/13/4/13/3 proof. `.39`-.42 select, audit, contract, and ship additive `(axi-w-burst4-driver ...)`: four explicit data32/strobe4 tuples, continuous WVALID, WLAST 0/0/0/1, beat event/index2 plus final done, exact 18-port/30-signal zero-state seven-rule actor, one ISF/FSM entry, support 307/348/348, and t/1508 exact 14/14/3 proof. `.43`-.45 select, audit, and contract additive `(axi-write-burst4-request-composition ...)`: unchanged AW/W-burst4 children, renderer-safe aligned 16-byte/4-KiB guard, LEN3/SIZE2/INCR, exact 29-port/57-signal six-rule join coordinator, direct W beat event/index, request-only completion, 29-signal/3-child/66-net/46-declared-link/52-resolved-link C4, support target 308/349/349, and exact t1509 5/18/18/4 proof. `.46` ships the selected fixed-four AW+W request composition at support 308/349/349 with exact t1509 5/18/18/4 proof; tree complete. Deferred: fixed-four B/full transaction, generalized dynamic/narrow/wrap/unaligned bursts, packed/streaming payloads, response/output-bank aggregation, capacity integration, decision-0020 transaction interface, back-to-back/outstanding/queues/demux/interleaving, malformed-subordinate recovery, aliases, verification output, backend variants/VHDL/direct, AHB/APB | [docs/tasks/IAL2-AXI-MANAGER-INITIATOR-FRONTIER.md](docs/tasks/IAL2-AXI-MANAGER-INITIATOR-FRONTIER.md) |
| `ISF-MULTIBIT-LOOP-PREDICATE-TRUTHINESS-REPAIR` | `done` | `R14 / ISF lowering correctness` | complete (`.1`-.2; bare known-width multi-bit `while`/`until` predicates use nonzero truthiness at entry/retest, and the public AHB requester completes generated-HDL SINGLE/INCR4 with exact 1/4 accepted beats and no terminal-count underflow) | [docs/tasks/ISF-MULTIBIT-LOOP-PREDICATE-TRUTHINESS-REPAIR.md](docs/tasks/ISF-MULTIBIT-LOOP-PREDICATE-TRUTHINESS-REPAIR.md) |
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.830` done through clean selector `f67705356`; selected named-drive child is now through audit `.1` and contract `.2`, which selects proposed `.3` while IAL2 behavior/accounting remain unchanged | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
| `IAL2-AHB-REQUESTER-GENERALIZED-BUSY-COUNT-RANGE-READINESS-AUDIT` | `done` | `IAL2 / AHB requester BUSY insertion` | complete `.1`-.3: readiness, frozen contract, canonical decimal 2..16 admission, numeric residue, t1541 5/8/16 all-assertion runtime, no per-count fixture/support entry, same-volume verification migration, and unchanged 332/373/56 split 28/28 | [docs/tasks/IAL2-AHB-REQUESTER-GENERALIZED-BUSY-COUNT-RANGE-READINESS-AUDIT.md](docs/tasks/IAL2-AHB-REQUESTER-GENERALIZED-BUSY-COUNT-RANGE-READINESS-AUDIT.md) |
| `IAL2-AHB-EXACT-THREE-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT` | `done` | `IAL2 / AHB paired requester-subordinate BUSY composition` | complete `.1`-.3: readiness, frozen contract, generic source/support, exact 3 IAL1/4 IAL0 artifacts, normalized semantic/read-only MCP parity, assertion-enabled t1531 5/4/1/3/1/`44332211`, and 323/364/47 split 24/23 | [docs/tasks/IAL2-AHB-EXACT-THREE-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT.md](docs/tasks/IAL2-AHB-EXACT-THREE-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT.md) |
| `IAL2-AHB-TWO-SUBORDINATE-EXACT-THREE-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT` | `done` | `IAL2 / AHB paired requester-subordinate BUSY composition` | complete `.1`-.3: readiness, contract, generic source/support, exact 4 IAL1/5 IAL0 artifacts, normalized semantic/read-only MCP parity, assertion-enabled t1533 10/8/2/6/2 runtime, and 325/366/49 split 25/24 | [docs/tasks/IAL2-AHB-TWO-SUBORDINATE-EXACT-THREE-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT.md](docs/tasks/IAL2-AHB-TWO-SUBORDINATE-EXACT-THREE-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT.md) |
| `IAL2-AHB-PIPELINED-ACTIVE-TRANSFER-AUDIT` | `done` | `IAL2 / AHB endpoint phase correctness` | `.8` ships Q-named `<-` direct completion capture through the existing four states; t1520 proves exact success/ERROR/SEQ/IDLE retention and t1519 preserves the generated family | [docs/tasks/IAL2-AHB-PIPELINED-ACTIVE-TRANSFER-AUDIT.md](docs/tasks/IAL2-AHB-PIPELINED-ACTIVE-TRANSFER-AUDIT.md) |
| `IAL2-AHB-REQUESTER-MULTI-BUSY-INSERTION-READINESS-AUDIT` | `done` | `IAL2 / AHB requester BUSY policy` | complete `.1`-.7: repaired exact-one event cardinality, shipped optional `(busy-beats 2)` generic plus byte-identical `.ahb` alias, 316/357/40 support, t1522 semantic/MCP parity, and shared assertion-enabled t1521 runtime | [docs/tasks/IAL2-AHB-REQUESTER-MULTI-BUSY-INSERTION-READINESS-AUDIT.md](docs/tasks/IAL2-AHB-REQUESTER-MULTI-BUSY-INSERTION-READINESS-AUDIT.md) |
| `IAL2-AHB-EXACT-TWO-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT` | `done` | `IAL2 / AHB requester-subordinate composition` | complete `.1`-.8: one-/two-subordinate exact-two readiness, contract, generic source/support, t1525 two-window runtime, normalized semantic/read-only MCP parity, and 319/360/43 accounting ship; the separately owned matching alias then shipped in parent `.811` at 320/361/44 | [docs/tasks/IAL2-AHB-EXACT-TWO-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT.md](docs/tasks/IAL2-AHB-EXACT-TWO-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT.md) |
| `IAL2-AHB-REQUESTER-EXACT-THREE-BUSY-INSERTION-READINESS-AUDIT` | `done` | `IAL2 / AHB requester BUSY policy` | complete `.1`-.5: prove width-two exact-three runtime, select/ship generic then byte-identical alias, exact support/semantic parity, t1528 shared runtime, t1529 alias proof, and 322/363/46 split 23/23; parent `.813` now selects the interconnect arbitration audit | [docs/tasks/IAL2-AHB-REQUESTER-EXACT-THREE-BUSY-INSERTION-READINESS-AUDIT.md](docs/tasks/IAL2-AHB-REQUESTER-EXACT-THREE-BUSY-INSERTION-READINESS-AUDIT.md) |
| `IAL2-AHB-REQUESTER-EXACT-FOUR-BUSY-INSERTION-READINESS-AUDIT` | `done` | `IAL2 / AHB requester BUSY policy` | complete `.1`-.5: prove width-three exact-four runtime, select/ship generic then byte-identical alias, minimum widths 2/2/3, exact support/semantic parity, t1535 shared runtime, t1536 alias proof, and 328/369/52 split 26/26; next selection returns to pending parent `.823` | [docs/tasks/IAL2-AHB-REQUESTER-EXACT-FOUR-BUSY-INSERTION-READINESS-AUDIT.md](docs/tasks/IAL2-AHB-REQUESTER-EXACT-FOUR-BUSY-INSERTION-READINESS-AUDIT.md) |
| `IAL2-AHB-EXACT-FOUR-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT` | `done` | `IAL2 / AHB paired requester-subordinate BUSY composition` | complete `.1`-.3: readiness, frozen contract, generic source/support, exact 3 IAL1/4 IAL0 artifacts, normalized semantic/read-only MCP parity, repository-local assertion-enabled t1537 5/4/1/4/1/`44332211`, and 329/370/53 split 27/26 | [docs/tasks/IAL2-AHB-EXACT-FOUR-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT.md](docs/tasks/IAL2-AHB-EXACT-FOUR-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT.md) |
| `IAL2-AHB-TWO-SUBORDINATE-EXACT-FOUR-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT` | `done` | `IAL2 / AHB paired requester-subordinate BUSY composition` | complete `.1`-.3: readiness, frozen contract, generic source/support, exact 4 IAL1/5 IAL0 artifacts, normalized semantic/read-only MCP parity, repository-local assertion-enabled t1539 10/8/2/8/2/`44332211`/`88776655`, and 331/372/55 split 28/27 | [docs/tasks/IAL2-AHB-TWO-SUBORDINATE-EXACT-FOUR-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT.md](docs/tasks/IAL2-AHB-TWO-SUBORDINATE-EXACT-FOUR-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT.md) |
| `ISF-RULE-TRANSACTION-OUTPUT-PRIORITY-ENFORCEMENT` | `active` | `ISF / scheduler and output-selector correctness` | `.2` done: selects proposed `.3` for exact-one-local-caller bidirectional target-local priority and ambiguous-caller fail-closed behavior; SV/Verilog are executable gates, while separate proposed VHDL reduction task owns the discovered invalid `(|drive_start)` residue; pending clean contract commit | [docs/tasks/ISF-RULE-TRANSACTION-OUTPUT-PRIORITY-ENFORCEMENT.md](docs/tasks/ISF-RULE-TRANSACTION-OUTPUT-PRIORITY-ENFORCEMENT.md) |
| `IAL2-AHB-INTERCONNECT-DEFAULT-DECODE-OUTPUT-ARBITRATION` | `done` | `IAL2 / AHB interconnect correctness` | complete `.1`-.3: exact overlap audit, complementary decode/exclusive response contract, assertion-clean generated fabric, direct one-/two-window t1530, paired preservation, truthful RAM verification, docs/Knowledge Map, and same-volume cleanup | [docs/tasks/IAL2-AHB-INTERCONNECT-DEFAULT-DECODE-OUTPUT-ARBITRATION.md](docs/tasks/IAL2-AHB-INTERCONNECT-DEFAULT-DECODE-OUTPUT-ARBITRATION.md) |
| `IAL2-AHB-SUBORDINATE-DEFAULT-PHASE-OUTPUT-ARBITRATION` | `done` | `IAL2 / AHB subordinate correctness` | complete `.1`-.3: exact audit, five-write generated-IAL1 repair, assertion-enabled base/rich direct plus six one-/two-window paired gates, preserved public/semantic/MCP surfaces, truthful RAM evidence, and separate direct-seed boundary | [docs/tasks/IAL2-AHB-SUBORDINATE-DEFAULT-PHASE-OUTPUT-ARBITRATION.md](docs/tasks/IAL2-AHB-SUBORDINATE-DEFAULT-PHASE-OUTPUT-ARBITRATION.md) |
| `IAL0-AHB-DIRECT-SUBORDINATE-OUTPUT-ARBITRATION` | `done` | `IAL0 / AHB direct-seed correctness` | complete `.1`-.2: exact four-write repair, retained unsupported HREADYOUT/HRDATA owners, emitted implicit-zero baselines, assertion-enabled t1520, unchanged exact runtime/public boundaries, truthful RAM evidence, and same-volume cleanup | [docs/tasks/IAL0-AHB-DIRECT-SUBORDINATE-OUTPUT-ARBITRATION.md](docs/tasks/IAL0-AHB-DIRECT-SUBORDINATE-OUTPUT-ARBITRATION.md) |
| `IAL2-AHB-REQUESTER-WRAP-PROGRESSION-AUDIT` | `done` | `IAL2 / AHB requester correctness` | `.1` runtime-confirmed the historical wrap-base skip; `.2` repairs the generated requester and both direct-seed paths, with exact generated-HDL WRAP4/8/16 progression and preservation proof | [docs/tasks/IAL2-AHB-REQUESTER-WRAP-PROGRESSION-AUDIT.md](docs/tasks/IAL2-AHB-REQUESTER-WRAP-PROGRESSION-AUDIT.md) |
| `IAL2-NEW-PROTOCOL-SUPPORT-WORKFLOW-CAPTURE` | `done` | `IAL2 / protocol onboarding documentation` | complete (`.1`; captured reusable new-protocol support workflow from AXI/APB experience, including evidence, readiness, contract, implementation, samples, support accounting, diagnostics, docs, Knowledge Map, gates, and commit closeout) | [docs/tasks/IAL2-NEW-PROTOCOL-SUPPORT-WORKFLOW-CAPTURE.md](docs/tasks/IAL2-NEW-PROTOCOL-SUPPORT-WORKFLOW-CAPTURE.md) |
...
| `IAL1-VERIFICATION-CODE-GENERATION-FRONTIER` | `done` | `Verification code generation / IAL1` | complete (`.11` shipped the VHDL observation package output; `.6` selected no direct `.ppif` verification-output route for the current lane) | [docs/tasks/IAL1-VERIFICATION-CODE-GENERATION-FRONTIER.md](docs/tasks/IAL1-VERIFICATION-CODE-GENERATION-FRONTIER.md) |
| `HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE` | `proposed` | `Verification code generation / intent architecture` | remains inactive after completed `.830` selects the narrower proven named-drive selector-priority audit; retain typed bridge, portable/native semantics, SV/UVM and VHDL lowerings, simulator capability profiles, parity, scalability, and inert-skeleton migration for a later clean selector | [docs/tasks/HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE.md](docs/tasks/HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE.md) |
...
| `BACKEND-LANGUAGE-PORTABILITY-CONTRACT-FRONTIER` | `done` | `Backend portability / public contracts` | complete through `.3.3`; the Rust/Rust-Wasm smoke now has one direct `.fsm` check result proven against the Perl oracle, and future backend-language work needs a new exact owner leaf | [docs/tasks/BACKEND-LANGUAGE-PORTABILITY-CONTRACT-FRONTIER.md](docs/tasks/BACKEND-LANGUAGE-PORTABILITY-CONTRACT-FRONTIER.md) |
| `DIRECT-VHDL-REDUCTION-EXPRESSION-LOWERING` | `proposed` | `Backends And Validation / direct VHDL correctness` | inactive; named-drive contract probing found direct VHDL leaks scalar SystemVerilog reduction syntax `(|drive_start)` instead of translating or rejecting it; `.1` owns the exact reduction-family audit after a later clean selector | [docs/tasks/DIRECT-VHDL-REDUCTION-EXPRESSION-LOWERING.md](docs/tasks/DIRECT-VHDL-REDUCTION-EXPRESSION-LOWERING.md) |
...
| `BIN-FSMGEN-IMPORT-TREE-JUN28-REFRESH` | `done` | bootstrap architecture maintenance | complete (`.1`; refreshed stale measured line counts after APB generalized register-set timing; topology remains `213` total / `212` `.pm`) | [docs/tasks/BIN-FSMGEN-IMPORT-TREE-JUN28-REFRESH.md](docs/tasks/BIN-FSMGEN-IMPORT-TREE-JUN28-REFRESH.md) |
...
| --- | --- | --- | --- | --- |
| `BIN-FSMGEN-IMPORT-TREE-JUL29-REFRESH` | `proposed` | `bootstrap architecture maintenance` | `.1` re-measure and synchronize the maintained import-tree note after startup found the saved `213`/`212` and `IAL2: 5` snapshot behind the live `227`/`226` and `IAL2: 19` closure; no runtime change | [docs/tasks/BIN-FSMGEN-IMPORT-TREE-JUL29-REFRESH.md](docs/tasks/BIN-FSMGEN-IMPORT-TREE-JUL29-REFRESH.md) |
| `MDBOOK-VHDL-INTRODUCTION-BOUNDARY-SYNC` | `proposed` | `roadmap/documentation alignment / VHDL` | `.1` align Chapter 00 and Chapter 10 wording with Chapter 14's bounded shipped direct/composition VHDL subset while preserving full-backend/GHDL deferrals; no behavior change | [docs/tasks/MDBOOK-VHDL-INTRODUCTION-BOUNDARY-SYNC.md](docs/tasks/MDBOOK-VHDL-INTRODUCTION-BOUNDARY-SYNC.md) |
| `TASK-TREE-FROZEN-LEGACY-DOC-WORKFLOW-SYNC` | `proposed` | `infra/continuity / task-tree doctrine alignment` | `.1` remove active task-tree workflow instructions to write the four decision-0007-frozen prose blobs and route state through task-trees, decisions, bounded Memory, mdBook, and git | [docs/tasks/TASK-TREE-FROZEN-LEGACY-DOC-WORKFLOW-SYNC.md](docs/tasks/TASK-TREE-FROZEN-LEGACY-DOC-WORKFLOW-SYNC.md) |
| `PROTOCOL-COMPOSITION-HDL-INSTANCE-IDENTIFIER-AUDIT` | `proposed` | `HDL quality / protocol composition identifiers` | `.1` inventory generated child instance names and target-language reserved words after `.794` had to rename AHB `interconnect` to legal `fabric`; APB still selects the risky identifier, so a shared policy audit remains inactive until ongoing work dries out | [docs/tasks/PROTOCOL-COMPOSITION-HDL-INSTANCE-IDENTIFIER-AUDIT.md](docs/tasks/PROTOCOL-COMPOSITION-HDL-INSTANCE-IDENTIFIER-AUDIT.md) |
| `PUBLIC-SYNC-TEST-DRIFT-REPAIR` | `proposed` | `public-contract, specification, and focused-test synchronization` | `.1` restore the verification-observation public presence key (t/1131), `.2` bring the ISF spec focused-test index beyond stale t/1453 (t/1250), then `.3` synchronize t/1474's old `.ahb` wrong-object diagnostic with the already-shipped two-subordinate aggregate wording; all proven pre-existing and unrelated to loop/requester completion changes; inactive until ongoing AHB work dries out | [docs/tasks/PUBLIC-SYNC-TEST-DRIFT-REPAIR.md](docs/tasks/PUBLIC-SYNC-TEST-DRIFT-REPAIR.md) |
| `ISF-ASSERT-NESTED-BITWISE-PRECEDENCE-REPAIR` | `proposed` | `R14 / generated verification correctness` | `ISF-ASSERT-NESTED-BITWISE-PRECEDENCE-REPAIR.1` root-cause concurrent-property intermediate inlining that emits `high & bit3 | bit2` for parsed `high & (bit3 | bit2)`, causing the shipped AXI read assertion to reject legal address `0x00000004`; select a general AST-preserving repair plus t/1410-t/1412 and assertion-enabled t/1507 coverage; discovered during AXI `.44`, behavior admission is correct and the write candidate uses a renderer-safe equivalent | [docs/tasks/ISF-ASSERT-NESTED-BITWISE-PRECEDENCE-REPAIR.md](docs/tasks/ISF-ASSERT-NESTED-BITWISE-PRECEDENCE-REPAIR.md) |
| `MDBOOK-RUSTDOC-NON-RUST-FENCE-REPAIR` | `proposed` | `documentation validation / mdBook` | `MDBOOK-RUSTDOC-NON-RUST-FENCE-REPAIR.1` label exactly four pre-existing plain-text diagram fences as text so `mdbook test docs/book` stops compiling Unicode/pseudocode as Rust; HTML build already passes; discovered during AXI `.22`, not caused by it | [docs/tasks/MDBOOK-RUSTDOC-NON-RUST-FENCE-REPAIR.md](docs/tasks/MDBOOK-RUSTDOC-NON-RUST-FENCE-REPAIR.md) |
...
| `FSMGEN-END-TO-END-LARGE-DESIGN-SCALABILITY` | `proposed` | `performance/scalability / end-to-end design capacity` | parked foundational requirement: `.1` must select measurable big/really-big workload, correctness-oracle, resource-profile, budget, graceful-failure, and regression-gate contracts before any benchmark claim or implementation; completed `.830` selects the narrower proven named-drive correctness audit first | [docs/tasks/FSMGEN-END-TO-END-LARGE-DESIGN-SCALABILITY.md](docs/tasks/FSMGEN-END-TO-END-LARGE-DESIGN-SCALABILITY.md) |
