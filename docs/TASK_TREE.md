...
| `SEMANTIC-INTROSPECTION-MCP-FRONTIER` | `active` | `Embedding And Public APIs / AI integration` | `.16` MCP sampling/elicitation boundary | [docs/tasks/SEMANTIC-INTROSPECTION-MCP-FRONTIER.md](docs/tasks/SEMANTIC-INTROSPECTION-MCP-FRONTIER.md) |
