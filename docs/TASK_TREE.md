...
| --- | --- | --- | --- | --- |
| `ISF-COMPOSITIONAL-CONTROL-FLOW-ARCHITECTURE` | `active` | `R14` | current frontier (`.8.12`; accept the until-contained single-pending pending-spawn local-do await_any subset) | [docs/tasks/ISF-COMPOSITIONAL-CONTROL-FLOW-ARCHITECTURE.md](docs/tasks/ISF-COMPOSITIONAL-CONTROL-FLOW-ARCHITECTURE.md) |
