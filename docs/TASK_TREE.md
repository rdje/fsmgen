...
| `ISF-PROPERTY-SAMPLED-VALUE` | `active` | `R14` | `ISF-PROPERTY-SAMPLED-VALUE.2` (`.1` select done) — `(stable/changed/rose/fell SIG)` sampled-value predicates in `assert/assume/cover` | [docs/tasks/ISF-PROPERTY-SAMPLED-VALUE.md](docs/tasks/ISF-PROPERTY-SAMPLED-VALUE.md) |
