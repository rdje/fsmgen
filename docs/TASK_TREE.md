...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | exact-four requester generic/profile surfaces now ship at 328/369/52 split 26/26 with t1536 parity and shared t1535 runtime; pending `.823` selects the next exact owner only after the clean child commit | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
