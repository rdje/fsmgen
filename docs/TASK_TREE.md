...
| `GITHUB-PUSH-OUTCOME-ASSURANCE` | `active` | `hosted CI` | `.6.2.2.18.2` isolate hosted outliers/providers and schedule corpus matrices | [task](docs/tasks/GITHUB-PUSH-OUTCOME-ASSURANCE.md) |
