...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.528` active after `.527` synchronized public `.ppif` surfaces with the IAL2 protocol/platform generality guardrail; AXI is the first shipped profile/example, not the definition of IAL2 | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
