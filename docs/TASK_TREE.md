...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.837` complete: selects proposed `MDBOOK-RUSTDOC-NON-RUST-FENCE-REPAIR.1` as the exact four-annotation full-book doctest repair; child activation waits for this selector to commit cleanly | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
