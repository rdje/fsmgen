...
| `IAL2-AXI-MANAGER-INITIATOR-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness / AXI initiator` | `.1`-.7 shipped/corrected AW; `.8`-.10 shipped single-beat W; `.11`-.14 shipped explicitly armed B acceptance. `.15`-.18 ship bounded request-only write composition; `.19`-.22 ship bounded full-write composition. `.23`-.26 ship `(axi-ar-driver ...)` at support 303/344/344 with t/1504 exact 3/3 proof. `.27` selects the armed one-transfer R acceptor; `.28` proves its RID4/RDATA32/RRESP2/RLAST1, 13-port/six-state/raw-capture/beat-only boundary and exact 3/3 executable feasibility; `.29` active contract selection. Deferred: full read composition, ARLEN/RLAST/ID/status transaction semantics, capacity integration, multi-beat, decision-0020 transaction interface, back-to-back/outstanding, aliases, verification output, backend variants/VHDL/direct, AHB/APB | [docs/tasks/IAL2-AXI-MANAGER-INITIATOR-FRONTIER.md](docs/tasks/IAL2-AXI-MANAGER-INITIATOR-FRONTIER.md) |
