...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.778` active; implement the matching endpoint AHB subordinate BUSY-park `.ahb` profile alias `ppif/ahb_lite_subordinate_byte_lane_hburst_seq_busy_park.ahb` (`.777` selected it as a data-only mirror: support identity `intent.ahb_profile_alias_subordinate_byte_lane_hburst_seq_busy_park`, focused `t/1495`, `t/248` 292→293/333→334) | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
