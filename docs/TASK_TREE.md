...
| `IAL2-AXI-MANAGER-INITIATOR-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness / AXI initiator` | `.1`-.7 shipped/corrected AW; `.8`-.10 shipped single-beat W; `.11`-.14 shipped explicitly armed one-response B acceptance (300/341/341; t/1501). `.15`-.18 ship bounded `(axi-write-request-composition ...)` with aligned atomic request capture, fixed LEN0/SIZE2/INCR, unchanged AW/W children, request-only done, support 301/342/342, and t/1502 exact 3/3/3 proof. `.19` selects bounded single-beat AW+W+B full-write composition. `.20` proves the safe flat five-child C4 boundary: nested request top rejected by active child-root contract; private request handoff reuses unchanged AW/W/request coordinator plus B; new zero-state response coordinator arms after request done, retains AWID/BID match, exports raw BRESP and distinct request/full completion. `.21` active exact contract selection. Deferred: capacity integration, multi-beat/burst, AR/R, decision-0020 transaction interface, back-to-back/outstanding/extended responses, aliases, verification output, backend variants/VHDL/direct, AHB/APB | [docs/tasks/IAL2-AXI-MANAGER-INITIATOR-FRONTIER.md](docs/tasks/IAL2-AXI-MANAGER-INITIATOR-FRONTIER.md) |
