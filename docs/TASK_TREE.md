...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | exact-three generic requester `.3` ships at 321/362/45 split 23/22; completed `.4` selects active `.5`, the matching byte-identical `.ahb` alias at projected 322/363/46 split 23/23 with t1529 parity and shared t1528 runtime; activation changes no behavior; decision 0020 remains inactive | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
...
| `IAL2-AHB-REQUESTER-EXACT-THREE-BUSY-INSERTION-READINESS-AUDIT` | `active` | `IAL2 / AHB requester BUSY policy` | `.3` ships generic exact-three at 321/362/45; `.4` selects active `.5`, the byte-identical `.ahb` alias implementation with exact support/semantic identity, projected 322/363/46 split 23/23, focused t1529 parity, and shared t1528 runtime; activation changes no behavior | [docs/tasks/IAL2-AHB-REQUESTER-EXACT-THREE-BUSY-INSERTION-READINESS-AUDIT.md](docs/tasks/IAL2-AHB-REQUESTER-EXACT-THREE-BUSY-INSERTION-READINESS-AUDIT.md) |
