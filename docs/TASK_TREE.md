...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.818` complete: byte-identical one-subordinate exact-three paired `.ahb` alias, focused t1532 parity, shared t1531 runtime, and current 324/365/48 split 24/24; next clean action is a parent-frontier selector | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
