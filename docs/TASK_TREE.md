...
| --- | --- | --- | --- | --- |
| `CLAIM-VERIFICATION-ADOPTION` | `active` | `infra/evidence governance` | `.4` done; `.5` splits and migrates the 1,417 owned claim candidates by governed surface | [task](docs/tasks/CLAIM-VERIFICATION-ADOPTION.md) |
