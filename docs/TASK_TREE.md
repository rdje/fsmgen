...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.841` selects proposed no-behavior `FSMGEN-HIR-ROADMAP-FRONTIER.2`; the selected child remains inactive until a clean follow-up activation | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
...
| --- | --- | --- | --- | --- |
| `FSMGEN-HIR-ROADMAP-FRONTIER` | `proposed` | `architecture / high-level frontend IR` | `.841` selects `.2` to choose the first source-facing HIR architecture boundary; activation waits for the clean selector commit | [docs/tasks/FSMGEN-HIR-ROADMAP-FRONTIER.md](docs/tasks/FSMGEN-HIR-ROADMAP-FRONTIER.md) |
