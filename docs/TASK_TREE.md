...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.802` selected the byte-identical two-subordinate paired AHB BUSY `.ahb` alias contract; `.803` is active for direct data-only implementation with 314/355 accounting targets and retained t1515 runtime. Decision 0020 remains proposed/inactive | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
