...
| `BACKEND-API-VALIDATION-FRONTIER` | `active` | Backends And Validation / Embedding And Public APIs | `BACKEND-API-VALIDATION-FRONTIER.72.1` (`.72` selected direct VHDL signed scalar addition/subtraction/multiplication RHS lowering after supported composition VHDL reached 4/4 and GHDL stayed unavailable) | [docs/tasks/BACKEND-API-VALIDATION-FRONTIER.md](docs/tasks/BACKEND-API-VALIDATION-FRONTIER.md) |
