...
| `ISF-CONDITIONAL-CHILD-ACTIVATION` | `active` | `R14` | `ISF-CONDITIONAL-CHILD-ACTIVATION.6` (`.1`-`.5b` done) | [docs/tasks/ISF-CONDITIONAL-CHILD-ACTIVATION.md](docs/tasks/ISF-CONDITIONAL-CHILD-ACTIVATION.md) |
