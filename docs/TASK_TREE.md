...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.810` selects proposed `.811` byte-identical two-subordinate exact-two `.ahb` alias implementation at projected 320/361/44, with t1526 semantic/read-only MCP parity and shared t1525 runtime; activate only after clean `.810`, while decision 0020 remains inactive | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
