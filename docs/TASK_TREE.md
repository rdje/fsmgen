...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.836` complete: selects proposed `PUBLIC-SYNC-TEST-DRIFT-REPAIR.1` as the smallest public-contract gate repair; child activation waits for this selector to commit cleanly | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
