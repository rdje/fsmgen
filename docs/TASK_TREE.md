...
| --- | --- | --- | --- | --- |
| `CLAIM-VERIFICATION-ADOPTION` | `active` | `infra/evidence governance` | `.5.4.7` active for 40 foundational AHB endpoint/interconnect/HBURST/BUSY candidates | [task](docs/tasks/CLAIM-VERIFICATION-ADOPTION.md) |
