...
| --- | --- | --- | --- | --- |
| `CLAIM-VERIFICATION-ADOPTION` | `active` | `infra/evidence governance` | `.5.4.1` active for 65 AXI-manager-core/dynamic-identity candidates | [task](docs/tasks/CLAIM-VERIFICATION-ADOPTION.md) |
