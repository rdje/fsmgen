...
| `BACKEND-API-VALIDATION-FRONTIER` | `active` | Backends And Validation / Embedding And Public APIs | `BACKEND-API-VALIDATION-FRONTIER.46` (`.45.1` shipped normalized semantic lowered-RTL shared-datapath contributor drive-intent entry schemas; select the next exact backend/API/public-export edge) | [docs/tasks/BACKEND-API-VALIDATION-FRONTIER.md](docs/tasks/BACKEND-API-VALIDATION-FRONTIER.md) |
