...
| `IAL0-AHB-DIRECT-SUBORDINATE-OUTPUT-ARBITRATION` | `active` | `IAL0 / AHB direct-seed correctness` | clean contract `454767c15` activates `.2`: remove exactly access HREADYOUT/HRESP/HRDATA zero writes plus unsupported HRESP zero, retain exclusive unsupported HREADYOUT/HRDATA, then remove only t1520 `--no-assert`; activation is documentation-only | [docs/tasks/IAL0-AHB-DIRECT-SUBORDINATE-OUTPUT-ARBITRATION.md](docs/tasks/IAL0-AHB-DIRECT-SUBORDINATE-OUTPUT-ARBITRATION.md) |
