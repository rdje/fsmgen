...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.779` active; select the next AHB feature-completeness slice after the endpoint BUSY-park `.ppif/.ahb` family completed (`.778` shipped `ppif/ahb_lite_subordinate_byte_lane_hburst_seq_busy_park.ahb` — byte-identical mirror, `intent.ahb_profile_alias_subordinate_byte_lane_hburst_seq_busy_park`, focused `t/1495`, `t/248` 293/334) | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
