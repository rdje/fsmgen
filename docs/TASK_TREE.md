...
| --- | --- | --- | --- | --- |
| `ISF-SCHEDULING-BACKLOG-FRONTIER` | `active` | `R14` | current frontier (`.2.1`; track all seven user-requested ISF scheduling/control-flow backlog bullets; first selected leaf audits direct `(on ...)` activation parameter override semantics before any behavior change) | [docs/tasks/ISF-SCHEDULING-BACKLOG-FRONTIER.md](docs/tasks/ISF-SCHEDULING-BACKLOG-FRONTIER.md) |
