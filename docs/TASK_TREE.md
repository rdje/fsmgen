...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.532` active after `.531` shipped `ppif/valid_ready_handshake.ppif` as the first protocol-neutral/non-AXI Valid-Ready `.ppif` sample | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
