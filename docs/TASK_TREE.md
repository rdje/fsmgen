...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | child `.1`-.3 ships generic two-window exact-three composition at 325/366/49 split 25/24; clean behavior commit `1a73bc65e` activates no-behavior selector `.820` | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
