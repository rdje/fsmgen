...
| `TASK-ACCEPTANCE-PORTABLE-DOCTRINE` | `active` | `infra/continuity / doctrine enforcement` | `.1` contract and `.2` checker/registry/9-group probes complete; active `.3` registers `TASK-ACCEPTANCE` and synchronizes toolbox/bootstrap/commit/mdBook/decision/fact surfaces | [docs/tasks/TASK-ACCEPTANCE-PORTABLE-DOCTRINE.md](docs/tasks/TASK-ACCEPTANCE-PORTABLE-DOCTRINE.md) |
