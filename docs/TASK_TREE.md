...
| `LIVE-DOCUMENT-SIZE-CONTAINMENT-ADOPTION` | `proposed` | `infra/continuity / project-wide live-document lifecycle` | `.1` pending clean activation; `.2` will implement the common registry/checker before separately committed ledger, task, book, roadmap, generated-index, frozen-lifecycle-consumer, and steady-state recalibration leaves | [docs/tasks/LIVE-DOCUMENT-SIZE-CONTAINMENT-ADOPTION.md](docs/tasks/LIVE-DOCUMENT-SIZE-CONTAINMENT-ADOPTION.md) |
