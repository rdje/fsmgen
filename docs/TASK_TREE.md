...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | child requester-BUSY tree `.7` now ships the byte-identical exact-two `.ahb` alias at 316/357/40 with semantic/MCP parity and shared t1521 runtime; next parent selector must start only after the clean child commit; decision 0020 remains proposed/inactive | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
