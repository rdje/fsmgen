...
| `PUBLIC-SYNC-TEST-DRIFT-REPAIR` | `active` | `public-contract, specification, and focused-test synchronization` | `.1` complete at `012660f90`; `.2` active continuity-only for exactly five missing ISF focused-test links and zero extras; `.3` remains pending | [docs/tasks/PUBLIC-SYNC-TEST-DRIFT-REPAIR.md](docs/tasks/PUBLIC-SYNC-TEST-DRIFT-REPAIR.md) |
