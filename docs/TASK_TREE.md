...
| --- | --- | --- | --- | --- |
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.109` next same-ID queue behavior expansion audit/selector after shipped read burst-last and write depth-2 queue-head behavior | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
...
| `SEMANTIC-INTROSPECTION-MCP-FRONTIER` | `proposed` | Embedding And Public APIs / AI integration | `.1` owner capture complete; proposed `.2` semantic-introspection API/MCP contract selector; no implementation active | [docs/tasks/SEMANTIC-INTROSPECTION-MCP-FRONTIER.md](docs/tasks/SEMANTIC-INTROSPECTION-MCP-FRONTIER.md) |
