...
| `FSMGEN-HIR-ROADMAP-FRONTIER` | `active` | `architecture / high-level frontend IR` | `.3` freezes the exact closed private v1 object/API/provenance/diagnostic/renderer/t1547/golden contract; `.4` remains proposed for separate clean implementation activation | [docs/tasks/FSMGEN-HIR-ROADMAP-FRONTIER.md](docs/tasks/FSMGEN-HIR-ROADMAP-FRONTIER.md) |
