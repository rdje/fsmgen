...
| --- | --- | --- | --- | --- |
| `CLAIM-VERIFICATION-ADOPTION` | `active` | `infra/evidence governance` | `.3` done; `.4` inventories actionable claims and derived constants on mandatory/current surfaces | [task](docs/tasks/CLAIM-VERIFICATION-ADOPTION.md) |
