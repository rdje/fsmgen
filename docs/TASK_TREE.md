...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.825` ships the byte-identical exact-four paired `.ahb` alias with t1538 parity, shared t1537 runtime, and 330/371/54 split 27/27; pending `.826` resumes no-behavior next-owner selection after the clean commit | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
