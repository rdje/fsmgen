...
| `BIN-FSMGEN-IMPORT-TREE-JUN05-REFRESH` | `active` | bootstrap architecture maintenance | `.1` done; `.2` pending — refresh stale ISF import-tree line-count measurements after the 2026-06-05 bootstrap audit; topology unchanged (`196` total / `195` `.pm`) | [docs/tasks/BIN-FSMGEN-IMPORT-TREE-JUN05-REFRESH.md](docs/tasks/BIN-FSMGEN-IMPORT-TREE-JUN05-REFRESH.md) |
