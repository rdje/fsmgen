...
| `IAL1-VERIFICATION-CODE-GENERATION-FRONTIER` | `active` | `Verification code generation / IAL1` | `.3` done; SV/UVM output selector `.4` waits until the selected observation metadata prerequisite ships | [docs/tasks/IAL1-VERIFICATION-CODE-GENERATION-FRONTIER.md](docs/tasks/IAL1-VERIFICATION-CODE-GENERATION-FRONTIER.md) |
| `ISF-VERIFICATION-OBSERVATION-METADATA` | `active` | `Verification code generation / IAL1 source feature` | `.1` implement actor-level passive `(observe NAME (role passive_monitor) (signals SIG...))` metadata and schedule JSON projection | [docs/tasks/ISF-VERIFICATION-OBSERVATION-METADATA.md](docs/tasks/ISF-VERIFICATION-OBSERVATION-METADATA.md) |
