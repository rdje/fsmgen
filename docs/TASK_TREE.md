...
| `IAL2-AHB-EXACT-FOUR-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT` | `proposed` | `IAL2 / AHB paired requester-subordinate BUSY composition` | `.1` pending clean parent-selector commit; then prove one-window exact-four strict/artifact/semantic-MCP/assertion runtime and projected 329/370/53 accounting before public behavior | [docs/tasks/IAL2-AHB-EXACT-FOUR-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT.md](docs/tasks/IAL2-AHB-EXACT-FOUR-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT.md) |
