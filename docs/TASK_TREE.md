...
| --- | --- | --- | --- | --- |
| `CLAIM-VERIFICATION-ADOPTION` | `active` | `infra/evidence governance` | `.5.4.2` active for 11 foundational profile/APB candidates | [task](docs/tasks/CLAIM-VERIFICATION-ADOPTION.md) |
