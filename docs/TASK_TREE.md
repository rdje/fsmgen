...
| --- | --- | --- | --- | --- |
| `ISF-SCHEDULING-BACKLOG-FRONTIER` | `active` | `R14` | current frontier (`.3.1`; direct `(on ...)` override branch closed as fail-closed/labeled-entry regression; next leaf is `while -> when -> repeat -> local do`) | [docs/tasks/ISF-SCHEDULING-BACKLOG-FRONTIER.md](docs/tasks/ISF-SCHEDULING-BACKLOG-FRONTIER.md) |
