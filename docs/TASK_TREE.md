...
| --- | --- | --- | --- | --- |
| `ISF-REPEAT-BODY-CHILD-ACTIVATION` | `active` | `R14` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.17` | [docs/tasks/ISF-REPEAT-BODY-CHILD-ACTIVATION.md](docs/tasks/ISF-REPEAT-BODY-CHILD-ACTIVATION.md) |
...
| Remaining repeat-body child activation widening: multi-pending `await_any`, sample-before/after-do timing, nested branch/loop activation, cross-domain activation, and broader outstanding-child semantics | `ISF-REPEAT-BODY-CHILD-ACTIVATION` |
