...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.788` active: implement the `.787`-selected additive bounded requester-side AHB single BUSY-beat insertion source; loop-truthiness and exact terminal-burst completion prerequisites are committed and resolved | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
