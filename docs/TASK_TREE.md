...
| `IAL2-AXI-MANAGER-INITIATOR-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness / AXI initiator` | `.1`-.7 shipped/corrected AW; `.8`-.10 shipped single-beat W; `.11`-.14 shipped explicitly armed B acceptance. `.15`-.18 ship bounded request-only `(axi-write-request-composition ...)` at support 301/342/342 with t/1502. `.19`-.22 select, audit, contract, and ship bounded `(axi-write-transaction-composition ...)`: flat five-child C4/private request handoff/post-request B arm, distinct request/full completion, retained AWID/BID match, raw BRESP, exact support 302/343/343, and four-subtest t/1503 generated-top proof. `.23` selects and `.24` audits a bounded standalone AXI4 manager AR address-channel driver: full address32/ID4/LEN8/SIZE3/BURST2 request tuple, request-issued-only done, corrected six-state accept-over-launch schedule; `.25` active contract selection. Deferred: R acceptance/full read composition, response-beat obligations, request legality, capacity integration, multi-beat/burst, decision-0020 transaction interface, back-to-back/outstanding/extended attributes, aliases, verification output, backend variants/VHDL/direct, AHB/APB | [docs/tasks/IAL2-AXI-MANAGER-INITIATOR-FRONTIER.md](docs/tasks/IAL2-AXI-MANAGER-INITIATOR-FRONTIER.md) |
