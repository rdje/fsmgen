...
| `FSMGEN-HIR-ROADMAP-FRONTIER` | `active` | `architecture / high-level frontend IR` | clean audit commit `5d018edbd` activates `.6` continuity-only for exact private concrete-control-to-IAL1 boundary/golden selection; `.7` and `.8` remain proposed | [docs/tasks/FSMGEN-HIR-ROADMAP-FRONTIER.md](docs/tasks/FSMGEN-HIR-ROADMAP-FRONTIER.md) |
