...
| `IAL2-AHB-EXACT-FOUR-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT` | `active` | `IAL2 / AHB paired requester-subordinate BUSY composition` | `.1` proves readiness; `.2` freezes one generic source/t1537/329/370/53 contract; `.3` active from clean `d54dc8afb` for exact data-only implementation | [docs/tasks/IAL2-AHB-EXACT-FOUR-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT.md](docs/tasks/IAL2-AHB-EXACT-FOUR-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT.md) |
