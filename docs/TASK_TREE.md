...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `blocked` | `IAL2 / SV-backed feature completeness` | `.705` blocked; awaiting an approved AHB/AHB-Lite source artifact before source-fact extraction or seed contract selection | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
