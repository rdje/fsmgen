...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.822` selected exact-four requester readiness; generic exact-four now ships at 327/368/51 split 26/25 and the child tree reserves a separate proposed `.4` matching-alias contract selector | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
...
| `IAL2-AHB-REQUESTER-EXACT-FOUR-BUSY-INSERTION-READINESS-AUDIT` | `active` | `IAL2 / AHB requester BUSY policy` | `.3` ships generic exact-four with literal-2..4 normalization, preserving minimum-width counter 2/2/3, assertion-enabled t1535, and 327/368/51 split 26/25; proposed `.4` selects the separate matching `.ahb` alias contract next | [docs/tasks/IAL2-AHB-REQUESTER-EXACT-FOUR-BUSY-INSERTION-READINESS-AUDIT.md](docs/tasks/IAL2-AHB-REQUESTER-EXACT-FOUR-BUSY-INSERTION-READINESS-AUDIT.md) |
