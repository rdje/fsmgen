...
| `FSMGEN-HIR-ROADMAP-FRONTIER` | `active` | `architecture / high-level frontend IR` | clean architecture commit `f0e88e9f7` activates `.3` continuity-only; next action freezes the exact private v1 object/diagnostic/renderer contract before code | [docs/tasks/FSMGEN-HIR-ROADMAP-FRONTIER.md](docs/tasks/FSMGEN-HIR-ROADMAP-FRONTIER.md) |
...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.841` is complete through clean selector commit `b4e66c067`; selected HIR child `.2` chose private SourceHIR and `.3` is active continuity-only | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
