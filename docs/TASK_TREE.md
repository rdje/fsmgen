...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.808` selects proposed `IAL2-AHB-REQUESTER-MULTI-BUSY-INSERTION-READINESS-AUDIT`; its `.1` no-behavior audit may activate only after the clean `.808` commit. Decision 0020 remains proposed/inactive | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
...
| `IAL2-AHB-REQUESTER-MULTI-BUSY-INSERTION-READINESS-AUDIT` | `proposed` | `IAL2 / AHB requester BUSY policy` | selected by `.808`; pending `.1` audits ready-accepted multiple BUSY presentations, ready-low hold behavior, and bounded counter lowering without changing shipped behavior | [docs/tasks/IAL2-AHB-REQUESTER-MULTI-BUSY-INSERTION-READINESS-AUDIT.md](docs/tasks/IAL2-AHB-REQUESTER-MULTI-BUSY-INSERTION-READINESS-AUDIT.md) |
