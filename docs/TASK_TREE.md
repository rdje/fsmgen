...
| `R11-DIRECT-BACKEND-COORDINATION-FRONTIER` | `active` | `R11` | `R11-DIRECT-BACKEND-COORDINATION-FRONTIER.2` pending; project top-level direct state/standalone-DT enable wires into direct `StructuralRTLIR` nets without rerouting HDL emission | [docs/tasks/R11-DIRECT-BACKEND-COORDINATION-FRONTIER.md](docs/tasks/R11-DIRECT-BACKEND-COORDINATION-FRONTIER.md) |
