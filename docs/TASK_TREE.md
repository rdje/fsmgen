...
| `MDBOOK-AHB-BUSY-COUNT-RESIDUE-SYNC` | `active` | `roadmap/documentation alignment / IAL2 AHB requester` | `.1` active continuity-only after clean selector commit `6e1c73d8c`; next action corrects only Chapter 16c's stale counts-beyond-four residue | [docs/tasks/MDBOOK-AHB-BUSY-COUNT-RESIDUE-SYNC.md](docs/tasks/MDBOOK-AHB-BUSY-COUNT-RESIDUE-SYNC.md) |
...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.840` is complete through clean selector commit `6e1c73d8c`; selected child `MDBOOK-AHB-BUSY-COUNT-RESIDUE-SYNC.1` is active continuity-only | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
