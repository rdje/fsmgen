...
| --- | --- | --- | --- | --- |
| `ISF-SCHEDULING-BACKLOG-FRONTIER` | `active` | `R14` | current frontier (`.4.1`; `while -> when -> repeat -> plain local do` shipped; next leaf selects the first outstanding-child lifetime rule beyond mandatory repeat re-entry drain) | [docs/tasks/ISF-SCHEDULING-BACKLOG-FRONTIER.md](docs/tasks/ISF-SCHEDULING-BACKLOG-FRONTIER.md) |
