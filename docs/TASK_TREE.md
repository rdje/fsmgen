...
| `IAL2-AHB-INTERCONNECT-DEFAULT-DECODE-OUTPUT-ARBITRATION` | `active` | `IAL2 / AHB interconnect correctness` | `.1` is complete at `c32255645`; completed `.2` selects complementary per-window and exclusive global response modes, direct-fabric assertion gate t1530, retained paired `--no-assert` boundary, and proposed implementation `.3` | [docs/tasks/IAL2-AHB-INTERCONNECT-DEFAULT-DECODE-OUTPUT-ARBITRATION.md](docs/tasks/IAL2-AHB-INTERCONNECT-DEFAULT-DECODE-OUTPUT-ARBITRATION.md) |
