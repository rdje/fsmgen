...
| --- | --- | --- | --- | --- |
| `CLAIM-VERIFICATION-ADOPTION` | `active` | `infra/evidence governance` | `.5.4.11` active for 32 two-subordinate exact-four and generalized BUSY-range candidates | [task](docs/tasks/CLAIM-VERIFICATION-ADOPTION.md) |
