...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.824` active from clean `c42347a5e`; compare the matching exact-four paired alias, two-window exact-four, broader AHB, HIAL/VIAL, verification, portability, priority, and scale owners before selecting exactly one | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
