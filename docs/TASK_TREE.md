...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.818` active from clean selector `c70fe528f` for the byte-identical one-subordinate exact-three paired `.ahb` alias at projected 324/365/48 split 24/24; no alias behavior ships in activation | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
