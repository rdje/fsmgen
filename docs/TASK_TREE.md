...
| `TASK-ACCEPTANCE-PORTABLE-DOCTRINE` | `active` | `infra/continuity / doctrine enforcement` | `.1` complete: TASK_ACCEPTANCE.md and decision 0026 select data-only path/signature registries plus fresh box-scoped index evidence; active `.2` implements the checker, FSMGen declarations, and probes | [docs/tasks/TASK-ACCEPTANCE-PORTABLE-DOCTRINE.md](docs/tasks/TASK-ACCEPTANCE-PORTABLE-DOCTRINE.md) |
