...
| `HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE` | `active` | `verification architecture` | `.17.3.5.1.1` repairs portable-SV backward-phase successor scheduling before `.17.3.5.1` resumes runtime materialization/lifecycle selection | [task](docs/tasks/HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE.md) |
