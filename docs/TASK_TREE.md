...
| `ISF-REMAINING-BROAD-FRONTIER` | `active` | `R14` | `ISF-REMAINING-BROAD-FRONTIER.10` (`.9.1` shipped property-only `(past SIG [N])`; next broad item is schedule-report storage classes, fixture promotion, or reusable-library coverage) | [docs/tasks/ISF-REMAINING-BROAD-FRONTIER.md](docs/tasks/ISF-REMAINING-BROAD-FRONTIER.md) |
