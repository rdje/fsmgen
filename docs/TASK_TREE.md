...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.824` selects pending `.825`, a byte-identical exact-four paired `.ahb` alias with t1538 parity, shared t1537 runtime, and projected 330/371/54 split 27/27; activate only after clean selector commit | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
