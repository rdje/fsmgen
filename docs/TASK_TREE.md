...
| --- | --- | --- | --- | --- |
| `CLAIM-VERIFICATION-ADOPTION` | `active` | `infra/evidence governance` | `.5.3` done; `.5.4` active to partition 557 protocol-profile/integration candidates | [task](docs/tasks/CLAIM-VERIFICATION-ADOPTION.md) |
