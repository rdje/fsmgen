...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.832` selects the nested-bitwise concurrent-assertion tree; clean audit `628ca0c33` activates child `.2` continuity-only for the one-branch substitution-grouping repair and assertion-enabled AXI proof | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
...
| `ISF-ASSERT-NESTED-BITWISE-PRECEDENCE-REPAIR` | `active` | `R14 / generated verification correctness` | `.2` active continuity-only after clean audit `628ca0c33`: group every rendered inline-intermediate replacement, reconcile t1410-t1412/t1544, and enable t1507 with legal `0x00000004` while preserving admission and all unrelated behavior | [docs/tasks/ISF-ASSERT-NESTED-BITWISE-PRECEDENCE-REPAIR.md](docs/tasks/ISF-ASSERT-NESTED-BITWISE-PRECEDENCE-REPAIR.md) |
