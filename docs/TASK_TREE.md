...
| --- | --- | --- | --- | --- |
| `AGGREGATE-AUTOGROWTH-FROM-USAGE` | `active` | `aggregate types and data` | `AGGREGATE-AUTOGROWTH-FROM-USAGE.4` | [docs/tasks/AGGREGATE-AUTOGROWTH-FROM-USAGE.md](docs/tasks/AGGREGATE-AUTOGROWTH-FROM-USAGE.md) |
