...
| `IAL2-AHB-REQUESTER-EXACT-THREE-BUSY-INSERTION-READINESS-AUDIT` | `active` | `IAL2 / AHB requester BUSY policy` | `.3` ships generic exact-three with literal range 2..3, direct counter/runtime/semantic/MCP proof, truthful reports, and 321/362/45 accounting; pending `.4` separately owns matching `.ahb` alias contract selection | [docs/tasks/IAL2-AHB-REQUESTER-EXACT-THREE-BUSY-INSERTION-READINESS-AUDIT.md](docs/tasks/IAL2-AHB-REQUESTER-EXACT-THREE-BUSY-INSERTION-READINESS-AUDIT.md) |
