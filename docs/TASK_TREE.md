...
| `IAL2-AXI-MANAGER-INITIATOR-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness / AXI initiator` | `.1`-.7 shipped/corrected AW; `.8`-.10 shipped single-beat W. `.11` selected B response acceptance; `.12` audited/proved explicit one-response arm, eager BREADY, BID4/BRESP2 capture, stable outputs, and later done. `.13` selected exact additive contract: `(axi-b-response-acceptor ...)`, AxiBResponseAcceptor, schema/source/module/support identities, command arm + bus/captured response bindings, six-state accept-over-arm schedule, t/1501 and 300/341/341 targets. `.14` active: atomic parser/generator/source/support/manifest/test/book implementation with generated-HDL cardinality/capture proof. Later AW+W composition must reuse generated children plus a coordinator. Deferred: AW+W/full transactor, back-to-back/outstanding/extended responses, multi-beat/burst, AR/R, capacity integration, decision-0020 transaction interface, aliases, verification output, backend variants/VHDL/direct, AHB/APB | [docs/tasks/IAL2-AXI-MANAGER-INITIATOR-FRONTIER.md](docs/tasks/IAL2-AXI-MANAGER-INITIATOR-FRONTIER.md) |
