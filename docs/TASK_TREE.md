...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.840` selects proposed no-behavior `MDBOOK-AHB-BUSY-COUNT-RESIDUE-SYNC.1`; the selected child remains inactive until a clean follow-up activation | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
