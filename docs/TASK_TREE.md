...
| `IAL2-AHB-PIPELINED-ACTIVE-TRANSFER-AUDIT` | `active` | `IAL2 / AHB endpoint phase correctness` | `.5` is complete in the working tree: atomic no-queue direct NONSEQ/SEQ capture/dispatch, live-HWDATA ownership, exact t1520 repair targets, preservation, and rollback are frozen; commit cleanly before `.6` implementation | [docs/tasks/IAL2-AHB-PIPELINED-ACTIVE-TRANSFER-AUDIT.md](docs/tasks/IAL2-AHB-PIPELINED-ACTIVE-TRANSFER-AUDIT.md) |
