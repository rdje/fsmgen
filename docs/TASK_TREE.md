...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.821` ships the byte-identical two-window exact-three `.ahb` alias at 326/367/50 split 25/25 with t1534 parity and t1533 shared runtime; clean behavior commit `db402fd9d` activates `.822` to select the next exact roadmap owner | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
