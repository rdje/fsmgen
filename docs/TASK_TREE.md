...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.835` and selected child `BIN-FSMGEN-IMPORT-TREE-JUL29-REFRESH.1` are complete; the director-requested README landing-page reduction is the next exact continuity owner to activate | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
