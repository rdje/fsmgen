...
| `CI-PPIF-VERIFY-HDL-TOOL-DEPENDENCY-REPAIR` | `active` | `CI / regression integrity` | `.1` guard PPIF CLI `--verify-hdl` tests with the existing external-tool availability policy after GitHub run `27621526955` failed without Verilator/Yosys | [docs/tasks/CI-PPIF-VERIFY-HDL-TOOL-DEPENDENCY-REPAIR.md](docs/tasks/CI-PPIF-VERIFY-HDL-TOOL-DEPENDENCY-REPAIR.md) |
