...
| --- | --- | --- | --- | --- |
| `ISF-REPEAT-BODY-CHILD-ACTIVATION` | `active` | `R14` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.6` | [docs/tasks/ISF-REPEAT-BODY-CHILD-ACTIVATION.md](docs/tasks/ISF-REPEAT-BODY-CHILD-ACTIVATION.md) |
...
| Remaining repeat-body child activation widening: multi-pending `await_any`, repeat-body `do`, nested branch/loop activation, cross-domain activation, and sample-after-spawn timing | `ISF-REPEAT-BODY-CHILD-ACTIVATION` |
