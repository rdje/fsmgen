...
| `FSMGEN-HIR-ROADMAP-FRONTIER` | `active` | `architecture / high-level frontend IR` | `.2` selects private pre-IAL `SourceHIR`, an internal Perl builder, canonical PPIF handoff, and the byte-identical valid-ready golden; `.3` is proposed to freeze the exact v1 contract before code | [docs/tasks/FSMGEN-HIR-ROADMAP-FRONTIER.md](docs/tasks/FSMGEN-HIR-ROADMAP-FRONTIER.md) |
...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.841` is complete through clean selector commit `b4e66c067`; selected HIR child `.2` has chosen private SourceHIR and `.3` remains proposed | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
