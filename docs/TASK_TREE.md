...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | exact-three requester generic plus byte-identical alias now ship at 322/363/46 split 23/23 with t1529 parity and shared t1528 runtime; pending `.813` selects the next exact post-alias owner after clean child completion; decision 0020 remains inactive | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
...
| `IAL2-AHB-REQUESTER-EXACT-THREE-BUSY-INSERTION-READINESS-AUDIT` | `done` | `IAL2 / AHB requester BUSY policy` | complete `.1`-.5: prove width-two exact-three runtime, select/ship generic then byte-identical alias, exact support/semantic parity, t1528 shared runtime, t1529 alias proof, and 322/363/46 split 23/23; next selection returns to parent `.813` | [docs/tasks/IAL2-AHB-REQUESTER-EXACT-THREE-BUSY-INSERTION-READINESS-AUDIT.md](docs/tasks/IAL2-AHB-REQUESTER-EXACT-THREE-BUSY-INSERTION-READINESS-AUDIT.md) |
