...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.816` selects proposed one-subordinate generic exact-three paired-BUSY readiness audit `.1` after assertion-clean fabric/endpoints/direct seed; no behavior changes, aliases/two-window/broader policy and decision 0020 remain separate | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
| `IAL2-AHB-EXACT-THREE-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT` | `active` | `IAL2 / AHB paired requester-subordinate BUSY composition` | `.1` active from clean selector `bc3d9eaf1`; audit assertion-enabled one-subordinate generic candidate, exact artifacts/runtime/semantic-MCP/public identities, and projected 323/364/47 accounting before behavior | [docs/tasks/IAL2-AHB-EXACT-THREE-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT.md](docs/tasks/IAL2-AHB-EXACT-THREE-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT.md) |
...
| `HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE` | `proposed` | `Verification code generation / intent architecture` | inactive; define current synthesizable IAL0/1/2 as HIAL and audit a peer pure-verification VIAL, its layer topology, typed language-neutral bridge, portable fixture semantics, native extension model, SV/UVM and VHDL verification lowerings, parity, scalability, and migration from shipped inert skeletons; parking does not pivot active IAL2 priority | [docs/tasks/HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE.md](docs/tasks/HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE.md) |
