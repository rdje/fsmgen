...
| `IAL1-VERIFICATION-CODE-GENERATION-FRONTIER` | `active` | `Verification code generation / IAL1` | `.2` audit IAL1 verification-source sufficiency, missing IAL1 verification-specific features, SV/UVM and VHDL target prerequisites, and IAL2 routing before any verification code generation | [docs/tasks/IAL1-VERIFICATION-CODE-GENERATION-FRONTIER.md](docs/tasks/IAL1-VERIFICATION-CODE-GENERATION-FRONTIER.md) |
