...
| `SEMANTIC-INTROSPECTION-MCP-FRONTIER` | `active` | `Embedding And Public APIs / AI integration` | `.29` source discovery implementation | [docs/tasks/SEMANTIC-INTROSPECTION-MCP-FRONTIER.md](docs/tasks/SEMANTIC-INTROSPECTION-MCP-FRONTIER.md) |
