...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.531` active after `.530` selected `(profile valid-ready)` and `ppif/valid_ready_handshake.ppif` for the first protocol-neutral/non-AXI Valid-Ready `.ppif` sample | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
