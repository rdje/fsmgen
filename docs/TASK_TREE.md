...
| `IAL2-AXI-MANAGER-INITIATOR-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness / AXI initiator` | `.1`-.7 shipped/corrected AW; `.8`-.10 shipped single-beat W; `.11`-.14 selected/audited/shipped explicitly armed one-response B acceptance (300/341/341; t/1501 exact capture/cardinality proof). `.15` selects a bounded single-beat AW+W write-request composition using unchanged generated AW/W children, a distinct completion-history coordinator, and a generated structural top; B remains separate. `.16` proves the safe boundary: atomically capture aligned address32/AWID4/WDATA32/WSTRB4, structurally fix AWLEN=0/AWSIZE=2/AWBURST=INCR, preserve zero strobe, launch both children once, join independent done history, emit request-only aggregate done, and select a three-IAL1/three-child-IAL0/one-top artifact contract. Scratch strict/schedule/lint and simultaneous/AW-first/W-first/payload/misalignment proofs pass. `.17` active exact public-contract selection. Deferred: B/capacity/full transactor, multi-beat/burst, AR/R, decision-0020 transaction interface, back-to-back/outstanding/extended responses, aliases, verification output, backend variants/VHDL/direct, AHB/APB | [docs/tasks/IAL2-AXI-MANAGER-INITIATOR-FRONTIER.md](docs/tasks/IAL2-AXI-MANAGER-INITIATOR-FRONTIER.md) |
