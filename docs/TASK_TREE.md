...
| `KNOWLEDGE-MAP-ADOPT` | `active` | infra/continuity | `KNOWLEDGE-MAP-ADOPT.2` (`.1` select done) — adopt the Knowledge Map retrieval layer (question→fact index over durable facts; additive to `MEMORY_ARCHITECTURE.md`) | [docs/tasks/KNOWLEDGE-MAP-ADOPT.md](docs/tasks/KNOWLEDGE-MAP-ADOPT.md) |
