...
| `PUBLIC-SYNC-TEST-DRIFT-REPAIR` | `active` | `public-contract, specification, and focused-test synchronization` | `.1` complete at `012660f90`; `.2` complete with an exact 332/332 focused-test index and guarded 295-file ISF pass; `.3` remains pending until the clean `.2` commit | [docs/tasks/PUBLIC-SYNC-TEST-DRIFT-REPAIR.md](docs/tasks/PUBLIC-SYNC-TEST-DRIFT-REPAIR.md) |
