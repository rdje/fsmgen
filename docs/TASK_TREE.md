...
| `SEMANTIC-INTROSPECTION-MCP-FRONTIER` | `active` | `Embedding And Public APIs / AI integration` | `.5` MCP adapter protocol/client compatibility and source-query envelope hardening | [docs/tasks/SEMANTIC-INTROSPECTION-MCP-FRONTIER.md](docs/tasks/SEMANTIC-INTROSPECTION-MCP-FRONTIER.md) |
