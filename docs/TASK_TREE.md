...
| `LIVE-DOCUMENT-LINE-TARGET-CALIBRATION` | `active` | `infra/continuity` | `.2` done; `.3` sweeps the remaining surfaces' target pairs | [task](docs/tasks/LIVE-DOCUMENT-LINE-TARGET-CALIBRATION.md) |
