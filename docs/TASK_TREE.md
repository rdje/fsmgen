...
| --- | --- | --- | --- | --- |
| `CLAIM-VERIFICATION-ADOPTION` | `active` | `infra/evidence governance` | `.5.6` active to partition and review the 288 HIAL/VIAL verification-architecture candidates in Chapter 16d | [task](docs/tasks/CLAIM-VERIFICATION-ADOPTION.md) |
