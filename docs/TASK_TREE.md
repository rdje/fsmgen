...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.834` selects proposed no-behavior `TASK-TREE-FROZEN-LEGACY-DOC-WORKFLOW-SYNC.1`; next clean action is selector commit, then child activation | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
...
| `TASK-TREE-FROZEN-LEGACY-DOC-WORKFLOW-SYNC` | `proposed` | `infra/continuity / task-tree doctrine alignment` | selected by parent `.834`; `.1` removes active task-tree workflow instructions to write the four decision-0007-frozen prose blobs; activation waits for the clean selector commit | [docs/tasks/TASK-TREE-FROZEN-LEGACY-DOC-WORKFLOW-SYNC.md](docs/tasks/TASK-TREE-FROZEN-LEGACY-DOC-WORKFLOW-SYNC.md) |
