...
| `IAL2-AHB-REQUESTER-EXACT-FOUR-BUSY-INSERTION-READINESS-AUDIT` | `proposed` | `IAL2 / AHB requester BUSY policy` | parent `.822` selects `.1` to resolve bounded width-three versus reusable minimum-width derivation after a 2,313-byte exact-four candidate fails closed at the intentional literal-2..3 boundary | [docs/tasks/IAL2-AHB-REQUESTER-EXACT-FOUR-BUSY-INSERTION-READINESS-AUDIT.md](docs/tasks/IAL2-AHB-REQUESTER-EXACT-FOUR-BUSY-INSERTION-READINESS-AUDIT.md) |
