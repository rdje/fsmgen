...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.838` complete at clean `b0bcb12b5`; selected identifier audit `.1` is complete and proposed `.2` is the next clean activation | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
...
| `PROTOCOL-COMPOSITION-HDL-INSTANCE-IDENTIFIER-AUDIT` | `active` | `HDL quality / protocol composition identifiers` | `.1` complete: decision 0027 selects portable keyword-union validation, authored fail-closed diagnostics, and deterministic generated allocation; `.2` is proposed for implementation | [docs/tasks/PROTOCOL-COMPOSITION-HDL-INSTANCE-IDENTIFIER-AUDIT.md](docs/tasks/PROTOCOL-COMPOSITION-HDL-INSTANCE-IDENTIFIER-AUDIT.md) |
