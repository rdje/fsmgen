...
| `IAL2-MDBOOK-COHERENCE-AXI-COVERAGE` | `active` | `roadmap/documentation alignment / IAL2 mdBook` | `.1` audit and bounded backfill-plan selection | [task](docs/tasks/IAL2-MDBOOK-COHERENCE-AXI-COVERAGE.md) |
