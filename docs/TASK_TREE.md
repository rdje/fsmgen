...
| --- | --- | --- | --- | --- |
| `CLAIM-VERIFICATION-ADOPTION` | `active` | `infra/evidence governance` | `.5.5.1` active for 6 guided/mode-map Chapter 16c candidates on lines 1-1176 | [task](docs/tasks/CLAIM-VERIFICATION-ADOPTION.md) |
