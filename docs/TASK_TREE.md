...
| `BACKEND-API-VALIDATION-FRONTIER` | `active` | Backends And Validation / Embedding And Public APIs | `BACKEND-API-VALIDATION-FRONTIER.4.7` (`.4.6.1` deferred `fsm/generic_fifo.fsm` as an expected failure; next resolve or explicitly defer `fsm/lte_digital_rf.fsm`) | [docs/tasks/BACKEND-API-VALIDATION-FRONTIER.md](docs/tasks/BACKEND-API-VALIDATION-FRONTIER.md) |
