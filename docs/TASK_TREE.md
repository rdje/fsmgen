...
| `IAL2-MDBOOK-COHERENCE-AXI-COVERAGE` | `active` | `IAL2 mdBook alignment` | `.5` done; `.6` runs the final AXI corpus/documentation coherence proof | [task](docs/tasks/IAL2-MDBOOK-COHERENCE-AXI-COVERAGE.md) |
