...
| --- | --- | --- | --- | --- |
| `LIVE-DOCUMENT-SIZE-CONTAINMENT-ADOPTION` | `active` | `infra/continuity / project-wide live-document lifecycle` | `.27` portable guide complete; `.12` waits on director-deferred `.26`; no PNT-eligible containment leaf | [docs/tasks/LIVE-DOCUMENT-SIZE-CONTAINMENT-ADOPTION.md](docs/tasks/LIVE-DOCUMENT-SIZE-CONTAINMENT-ADOPTION.md) |
...
| `SUPPORTED-SMOKE-PPIF-PIPELINE-CLI-ORACLE-SPLIT` | `active` | `test integrity / IAL2 PPIF support accounting` | `.1.2.2` bound index 116's multi-static AXI direct-backend CPU path, then complete the guarded t296 matrix | [docs/tasks/SUPPORTED-SMOKE-PPIF-PIPELINE-CLI-ORACLE-SPLIT.md](docs/tasks/SUPPORTED-SMOKE-PPIF-PIPELINE-CLI-ORACLE-SPLIT.md) |
