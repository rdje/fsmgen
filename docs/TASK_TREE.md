...
| `README-STATIC-LANDING-PAGE` | `active` | `infra/continuity / entry-point documentation` | `.1` activates the measured 2,353-line / 377,853-byte reduction contract; `.2` is active to reduce and truth-sync the GitHub landing page before `.3` adds the project-neutral tracked maintenance standard and ratchets mechanical growth control | [docs/tasks/README-STATIC-LANDING-PAGE.md](docs/tasks/README-STATIC-LANDING-PAGE.md) |
