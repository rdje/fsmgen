...
| `IAL2-AXI-MANAGER-INITIATOR-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness / AXI initiator` | `.1`-.7 shipped/corrected AW; `.8`-.10 shipped single-beat W; `.11`-.14 shipped explicitly armed B acceptance. `.15`-.18 ship bounded request-only `(axi-write-request-composition ...)` at support 301/342/342 with t/1502. `.19` selects bounded AW+W+B full write; `.20` proves flat five-child C4/private request handoff/post-request B arm/AWID-BID/raw BRESP/distinct completion boundary. `.21` freezes exact `(axi-write-transaction-composition ...)` AXI4 manager contract: address32/AWID4/data32/strobe4, fixed LEN0/SIZE2/INCR/WLAST1, unchanged AW/W/request/B leaves, seven-rule transaction coordinator, five IAL1 schedules/six IAL0 artifacts, support target 302/343/343, t/1503. `.22` active implementation. Deferred: capacity integration, multi-beat/burst, AR/R, decision-0020 transaction interface, back-to-back/outstanding/extended responses, aliases, verification output, backend variants/VHDL/direct, AHB/APB | [docs/tasks/IAL2-AXI-MANAGER-INITIATOR-FRONTIER.md](docs/tasks/IAL2-AXI-MANAGER-INITIATOR-FRONTIER.md) |
