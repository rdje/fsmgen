...
| --- | --- | --- | --- | --- |
| `CLAIM-VERIFICATION-ADOPTION` | `active` | `infra/evidence governance` | `.5.6.2` active for 16 portable-VHDL and OSVVM provider candidates on Chapter 16d lines 932-1355 | [task](docs/tasks/CLAIM-VERIFICATION-ADOPTION.md) |
