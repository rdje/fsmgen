...
| `KNOWLEDGE-CARD-SURFACE-ALLOWANCE-EXHAUSTION` | `active` | `infra/continuity` | `.1` audits the exact binding rule and repair routes | [task](docs/tasks/KNOWLEDGE-CARD-SURFACE-ALLOWANCE-EXHAUSTION.md) |
