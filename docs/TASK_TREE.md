...
| `ISF-CONDITIONAL-CHILD-ACTIVATION` | `active` | `R14` | `ISF-CONDITIONAL-CHILD-ACTIVATION.5a` (`.1`-`.4` done) | [docs/tasks/ISF-CONDITIONAL-CHILD-ACTIVATION.md](docs/tasks/ISF-CONDITIONAL-CHILD-ACTIVATION.md) |
