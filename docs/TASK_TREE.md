...
| `DIRECT-VHDL-REDUCTION-EXPRESSION-LOWERING` | `active` | `Backends And Validation / direct VHDL correctness` | `.1` active after clean selector `5f904d2d2`; audit scalar/vector unary OR/AND/XOR semantics and select exact translation or deterministic rejection without behavior changes | [docs/tasks/DIRECT-VHDL-REDUCTION-EXPRESSION-LOWERING.md](docs/tasks/DIRECT-VHDL-REDUCTION-EXPRESSION-LOWERING.md) |
