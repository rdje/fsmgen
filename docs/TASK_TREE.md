...
| `IAL2-AHB-REQUESTER-EXACT-THREE-BUSY-INSERTION-READINESS-AUDIT` | `active` | `IAL2 / AHB requester BUSY policy` | `.3` ships generic exact-three at 321/362/45; `.4` selects pending `.5`, the byte-identical `.ahb` alias implementation with exact support/semantic identity, projected 322/363/46 split 23/23, focused t1529 parity, and shared t1528 runtime | [docs/tasks/IAL2-AHB-REQUESTER-EXACT-THREE-BUSY-INSERTION-READINESS-AUDIT.md](docs/tasks/IAL2-AHB-REQUESTER-EXACT-THREE-BUSY-INSERTION-READINESS-AUDIT.md) |
