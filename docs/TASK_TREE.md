...
| --- | --- | --- | --- | --- |
| `CLAIM-VERIFICATION-ADOPTION` | `active` | `infra/evidence governance` | `.5.3.2` done; `.5.3.3` active for 68 control/data/composition/lowering candidates | [task](docs/tasks/CLAIM-VERIFICATION-ADOPTION.md) |
