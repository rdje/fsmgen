...
| --- | --- | --- | --- | --- |
| `CLAIM-VERIFICATION-ADOPTION` | `active` | `infra/evidence governance` | `.5.2` partitioned; `.5.2.1` dispositions the 33 non-rationale root policy/index candidates | [task](docs/tasks/CLAIM-VERIFICATION-ADOPTION.md) |
