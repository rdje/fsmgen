...
| `IAL1-VERIFICATION-CODE-GENERATION-FRONTIER` | `active` | `Verification code generation / IAL1` | `.10` select the first VHDL-oriented verification artifact under the shape-only validation substrate selected by `.9` | [docs/tasks/IAL1-VERIFICATION-CODE-GENERATION-FRONTIER.md](docs/tasks/IAL1-VERIFICATION-CODE-GENERATION-FRONTIER.md) |
