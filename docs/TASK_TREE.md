...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | child `.3` ships the generic exact-two paired-BUSY source at 317/358/41 with t1523 runtime and semantic/MCP parity; proposed `.4` selects or rejects its matching `.ahb` alias after `.3` commits cleanly, and decision 0020 remains inactive | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
...
| `IAL2-AHB-EXACT-TWO-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT` | `active` | `IAL2 / AHB requester-subordinate composition` | `.3` ships the selected long-form generic source, t1523 runtime plus normalized semantic/read-only MCP proof, and 317/358/41 support; proposed `.4` owns matching alias contract selection after clean `.3`, while two-subordinate exact-two remains separate | [docs/tasks/IAL2-AHB-EXACT-TWO-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT.md](docs/tasks/IAL2-AHB-EXACT-TWO-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT.md) |
