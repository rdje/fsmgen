...
| `IAL2-AXI-MANAGER-INITIATOR-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness / AXI initiator` | `.1`-.7 shipped/corrected AW; `.8`-.10 shipped single-beat W; `.11`-.14 selected/audited/shipped explicitly armed one-response B acceptance (300/341/341; t/1501 exact capture/cardinality proof). `.15` selects a bounded single-beat AW+W write-request composition using unchanged generated AW/W children, a distinct completion-history coordinator, and a generated structural top; B remains separate. It gates the latent coherence risk that arbitrary AWLEN describes AWLEN+1 beats while W emits one beat/WLAST=1. `.16` active readiness audit: select the legal fixed/fail-closed AWLEN/AWSIZE/AWBURST/lane policy, aggregate command/busy/done, coordinator schedule, child wiring, artifact/report/CLI contract, diagnostics, executable simultaneous/AW-first/W-first proof, and implementation owners. Deferred: B/capacity/full transactor, multi-beat/burst, AR/R, decision-0020 transaction interface, back-to-back/outstanding/extended responses, aliases, verification output, backend variants/VHDL/direct, AHB/APB | [docs/tasks/IAL2-AXI-MANAGER-INITIATOR-FRONTIER.md](docs/tasks/IAL2-AXI-MANAGER-INITIATOR-FRONTIER.md) |
