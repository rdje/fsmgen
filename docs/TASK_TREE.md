...
| --- | --- | --- | --- | --- |
| `ISF-REPEAT-BODY-CHILD-ACTIVATION` | `active` | `R14` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.18` | [docs/tasks/ISF-REPEAT-BODY-CHILD-ACTIVATION.md](docs/tasks/ISF-REPEAT-BODY-CHILD-ACTIVATION.md) |
...
| Remaining repeat-body child activation widening: the selected sample-before/after-do timing subset, multi-pending `await_any`, nested branch/loop activation, cross-domain activation, and broader outstanding-child semantics | `ISF-REPEAT-BODY-CHILD-ACTIVATION` |
