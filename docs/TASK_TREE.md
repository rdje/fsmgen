...
| `HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE` | `active` | `verification architecture` | `.17.3.5.1` must activate proposed `.1.3` to close portable-SV non-await parallel-child admission/lowering before runtime materialization/lifecycle selection resumes | [task](docs/tasks/HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE.md) |
