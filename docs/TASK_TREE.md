...
| `IAL1-VERIFICATION-CODE-GENERATION-FRONTIER` | `active` | `Verification code generation / IAL1` | `.7` select public CLI, artifact layout, report/manifest, support-accounting, and validation gates for the selected passive UVM monitor skeleton package | [docs/tasks/IAL1-VERIFICATION-CODE-GENERATION-FRONTIER.md](docs/tasks/IAL1-VERIFICATION-CODE-GENERATION-FRONTIER.md) |
...
| `Verification Code Generation` | `active IAL1-VERIFICATION-CODE-GENERATION-FRONTIER owns the first-class verification-generation lane; .3 selected actor-level passive observation metadata, ISF-VERIFICATION-OBSERVATION-METADATA.1 shipped it, and .4 selected a passive UVM monitor skeleton package; .7 must select public CLI/artifact/report/support-accounting behavior before implementation emits SV/UVM files` |
