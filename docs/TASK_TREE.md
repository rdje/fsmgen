...
| `FSMGEN-HIR-ROADMAP-FRONTIER` | `active` | `architecture / high-level frontend IR` | clean private second-route commit `8876adb0b` activates `.8` continuity-only for the evidence-based promotion/continued-private/narrowing/retirement audit | [docs/tasks/FSMGEN-HIR-ROADMAP-FRONTIER.md](docs/tasks/FSMGEN-HIR-ROADMAP-FRONTIER.md) |
