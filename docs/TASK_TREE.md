...
| --- | --- | --- | --- | --- |
| `CLAIM-VERIFICATION-ADOPTION` | `active` | `infra/evidence governance` | `.5.4.12` active for 17 AHB integration and public-synchronization candidates | [task](docs/tasks/CLAIM-VERIFICATION-ADOPTION.md) |
