...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.224` select the next exact IAL2 owner after generated dynamic write ID behavior | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
| `DOCTRINE-ENFORCEMENT-ADOPTION` | `active` | `infra/continuity/doctrine enforcement` | `.1` adopt the PGEN doctrine-enforcement standard and create the FSMGEN toolbox catalog | [docs/tasks/DOCTRINE-ENFORCEMENT-ADOPTION.md](docs/tasks/DOCTRINE-ENFORCEMENT-ADOPTION.md) |
