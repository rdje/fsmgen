...
| --- | --- | --- | --- | --- |
| `CLAIM-VERIFICATION-ADOPTION` | `active` | `infra/evidence governance` | `.5.3.4` done; `.5.3.5` active for 51 blueprint/platform/reference candidates | [task](docs/tasks/CLAIM-VERIFICATION-ADOPTION.md) |
