...
| --- | --- | --- | --- | --- |
| `DARWIN-INLINE-VERILATOR-RUNTIME-QUALIFICATION` | `active` | `verification infrastructure / runtime qualification` | `.3.2.2.5` active; pre-push test/book/cleanup evidence is green, next commit the exact candidate and perform the authorized exceptional push plus hosted qualification | [task](docs/tasks/DARWIN-INLINE-VERILATOR-RUNTIME-QUALIFICATION.md) |
