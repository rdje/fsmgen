...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.828` active from clean selector commit `bc29c2e49`; ship only the byte-identical two-window exact-four paired `.ahb` alias, exact support and t1540 parity at projected 332/373/56 split 28/28, with t1539 as shared runtime | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
