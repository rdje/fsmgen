...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.797` selected `.798`, the active two-subordinate paired AHB BUSY readiness audit; a four-child candidate composes, but the audit must settle two-window runtime proof and contradictory BUSY residue wording. Decision 0020 remains proposed/inactive | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
