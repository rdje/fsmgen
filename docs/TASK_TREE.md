...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.806` aligns current mdBook/behavior/fact truth with six shipped aggregate/paired aliases and adds t1518; after its clean commit, PNT selects the next exact AHB owner. Decision 0020 and the boundary-free audit remain proposed/inactive | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
