...
| `README-STATIC-LANDING-PAGE` | `active` | `infra/continuity / entry-point documentation` | `.2` reduces README.md from 2,353 lines / 377,853 bytes to a verified 242-line / 9,566-byte stable landing page and truth-syncs roadmap/bootstrap/mdBook navigation; `.3` is active to add the project-neutral tracked maintenance standard and ratchet mechanical growth control | [docs/tasks/README-STATIC-LANDING-PAGE.md](docs/tasks/README-STATIC-LANDING-PAGE.md) |
...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.835` and selected child `BIN-FSMGEN-IMPORT-TREE-JUL29-REFRESH.1` are complete; director-requested continuity work proceeds under active `README-STATIC-LANDING-PAGE` before the next IAL2 selector | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
