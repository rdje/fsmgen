...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | completed `.809` selects proposed one-subordinate exact-two paired-BUSY readiness after a successful three-child static probe; future semantics require bounded JSON/read-only MCP exposure; child activates only after clean `.809`; decision 0020 remains inactive | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
...
| `IAL2-AHB-EXACT-TWO-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT` | `proposed` | `IAL2 / AHB requester-subordinate composition` | inactive until clean `.809`; `.1` will runtime-audit one exact-two requester plus one BUSY-parking subordinate, two qualified BUSY events, stable phase/storage ownership, one resumed SEQ, semantic/MCP future boundary, and no shipped behavior | [docs/tasks/IAL2-AHB-EXACT-TWO-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT.md](docs/tasks/IAL2-AHB-EXACT-TWO-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT.md) |
