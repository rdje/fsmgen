...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | clean HIR completion commit `24fbf3882` activates `.842` continuity-only to reconcile and select the next exact PNT-eligible owner without implicitly activating the public builder | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
