...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | child `.5` ships the byte-identical matching exact-two paired-BUSY `.ahb` alias at 318/359/42 with semantic/MCP parity; proposed `.6` owns the no-behavior two-subordinate exact-two readiness audit after clean `.5`, and decision 0020 remains inactive | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
...
| `IAL2-AHB-EXACT-TWO-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT` | `active` | `IAL2 / AHB requester-subordinate composition` | `.5` ships the byte-identical matching alias at 318/359/42 with focused t1524 semantic/read-only MCP parity and shared t1523 runtime; proposed `.6` audits two-subordinate exact-two readiness only after clean `.5` | [docs/tasks/IAL2-AHB-EXACT-TWO-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT.md](docs/tasks/IAL2-AHB-EXACT-TWO-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT.md) |
