...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.838` complete at clean `b0bcb12b5`; identifier audit `.1` is complete and implementation `.2` is active continuity-only | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
...
| `PROTOCOL-COMPOSITION-HDL-INSTANCE-IDENTIFIER-AUDIT` | `active` | `HDL quality / protocol composition identifiers` | `.1` complete; `.2` active from clean `53a54c6c9` to implement decision 0027's portable authored/generated child-label contract | [docs/tasks/PROTOCOL-COMPOSITION-HDL-INSTANCE-IDENTIFIER-AUDIT.md](docs/tasks/PROTOCOL-COMPOSITION-HDL-INSTANCE-IDENTIFIER-AUDIT.md) |
