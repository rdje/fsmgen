...
| `FSMGEN-HIR-ROADMAP-FRONTIER` | `active` | `architecture / high-level frontend IR` | `.5` keeps the healthy one-schema IAL2 prototype private; proposed `.6` next selects the exact concrete-control-to-IAL1 boundary, `.7` implements it, and `.8` re-audits promotion | [docs/tasks/FSMGEN-HIR-ROADMAP-FRONTIER.md](docs/tasks/FSMGEN-HIR-ROADMAP-FRONTIER.md) |
