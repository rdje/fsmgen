...
| `ISF-SPEC-TEST-INDEX-SYNC` | `active` | `R14` | `.3` repairs the exact t/1639 authoritative focused-test link before the pending push gate | [task](docs/tasks/ISF-SPEC-TEST-INDEX-SYNC.md) |
