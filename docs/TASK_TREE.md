...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.807` handed the frontier to `IAL2-AHB-PIPELINED-ACTIVE-TRANSFER-AUDIT`; that child now closes through `.8`, so the next clean-tree PNT action is a parent no-behavior selector. Decision 0020 remains proposed/inactive | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
