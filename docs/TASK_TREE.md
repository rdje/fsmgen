...
| `ISF-FIELD-STRUCTURED-STORAGE-FRONTIER` | `active` | `R14 / ISF storage metadata` | `.3` select the next field-structured storage residual or close the frontier after scalar field metadata shipped | [docs/tasks/ISF-FIELD-STRUCTURED-STORAGE-FRONTIER.md](docs/tasks/ISF-FIELD-STRUCTURED-STORAGE-FRONTIER.md) |
