...
| `BACKEND-LANGUAGE-PORTABILITY-CONTRACT-FRONTIER` | `active` | `Backend portability / public contracts` | `.2.3` blocked on focused `t/301` corpus verification after drafting the portable in-memory API candidate | [docs/tasks/BACKEND-LANGUAGE-PORTABILITY-CONTRACT-FRONTIER.md](docs/tasks/BACKEND-LANGUAGE-PORTABILITY-CONTRACT-FRONTIER.md) |
