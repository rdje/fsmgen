...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.807` selects the existing `IAL2-AHB-PIPELINED-ACTIVE-TRANSFER-AUDIT` after current truth repair; the audit remains proposed until `.807` commits cleanly. Decision 0020 remains proposed/inactive | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
