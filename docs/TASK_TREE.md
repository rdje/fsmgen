...
| --- | --- | --- | --- | --- |
| `ISF-REPEAT-BODY-CHILD-ACTIVATION` | `active` | `R14` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.16` | [docs/tasks/ISF-REPEAT-BODY-CHILD-ACTIVATION.md](docs/tasks/ISF-REPEAT-BODY-CHILD-ACTIVATION.md) |
...
| Remaining repeat-body child activation widening: the selected repeat-body generated-child `do` subset, multi-pending `await_any`, sample-before/after-do timing, nested branch/loop activation, and cross-domain activation | `ISF-REPEAT-BODY-CHILD-ACTIVATION` |
