...
| `HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE` | `active` | `verification architecture` | `.17.3.5.1` next activates `.17.3.5.1.2` to repair the separately proven portable-SV direct-drive omission before runtime materialization/lifecycle selection resumes | [task](docs/tasks/HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE.md) |
