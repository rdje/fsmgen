...
| `HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE` | `active` | `verification architecture` | `.17.2.4.2` one-million random boundary complete; scenario qualification/limit ladder next | [task](docs/tasks/HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE.md) |
...
| `GITHUB-PUSH-OUTCOME-ASSURANCE` | `active` | `hosted CI` | `.7` post-push policy done; `.6.2` qualifies the next authorized push | [task](docs/tasks/GITHUB-PUSH-OUTCOME-ASSURANCE.md) |
