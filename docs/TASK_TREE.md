...
| `HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE` | `active` | `verification architecture` | `.17.3.2` exact adapter-mode alignment passes a guarded first profile; commit the focused fix, then resume the clean guarded 108-profile capture | [task](docs/tasks/HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE.md) |
