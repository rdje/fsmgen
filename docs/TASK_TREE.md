...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | completed `.815` selected the now-complete direct IAL0 AHB arbitration tree; assertion-clean `.2` retires t1520's final audited AHB `--no-assert` boundary, and the next parent selector waits for its clean behavior commit; decision 0020 remains inactive | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
