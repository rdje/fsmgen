...
| `HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE` | `active` | `verification architecture` | generator `.17.2.6.3` active; foundation `.1`, portable-SV `.2`, portable-VHDL `.3`, OSVVM `.4`, and native UVM `.5` done; family closure `.17.2.6.3.6` proposed next | [task](docs/tasks/HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE.md) |
