...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.844` selects proposed no-behavior `HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE.1`; the selected audit remains inactive until a separate clean commit | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
...
| `HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE` | `proposed` | `Verification code generation / intent architecture` | parent `.844` selects proposed audit `.1`; typed bridge, portable/native semantics, SV/UVM and VHDL lowerings, simulator profiles, parity, scalability, and inert-skeleton migration remain unchanged until separate activation | [docs/tasks/HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE.md](docs/tasks/HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE.md) |
