...
| `IAL2-AHB-SUBORDINATE-DEFAULT-PHASE-OUTPUT-ARBITRATION` | `active` | `IAL2 / AHB subordinate correctness` | `.1` audits exact direct/paired overlaps; `.2` selects five redundant generated writes only—capture/hold HRESP+HRDATA and retire HRDATA—and freezes assertion-enabled direct/paired implementation `.3` without changing behavior | [docs/tasks/IAL2-AHB-SUBORDINATE-DEFAULT-PHASE-OUTPUT-ARBITRATION.md](docs/tasks/IAL2-AHB-SUBORDINATE-DEFAULT-PHASE-OUTPUT-ARBITRATION.md) |
