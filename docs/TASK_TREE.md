...
| --- | --- | --- | --- | --- |
| `ISF-CROSS-DOMAIN-ACTIVATION-VIA-CROSSING` | `active` | `R14` | `ISF-CROSS-DOMAIN-ACTIVATION-VIA-CROSSING.4` (`.1`/`.2`/`.3` done) | [docs/tasks/ISF-CROSS-DOMAIN-ACTIVATION-VIA-CROSSING.md](docs/tasks/ISF-CROSS-DOMAIN-ACTIVATION-VIA-CROSSING.md) |
