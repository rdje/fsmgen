...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.826`'s selected child tree is complete at 331/372/55 split 28 `.ppif`/27 `.ahb`; the next exact parent selector may be created/activated only after the clean child behavior commit | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
