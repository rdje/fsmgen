...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.240` generate dynamic runtime beat-count/RLAST validation over generated dynamic last-beat read-data | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
| `ISF-FIELD-STRUCTURED-STORAGE-RESPONSE` | `active` | `Downstream ISF handoff / ISF storage metadata` | `.2` edit the tracked FSMGen response to SPECFORGE's declarative field-structured storage request | [docs/tasks/ISF-FIELD-STRUCTURED-STORAGE-RESPONSE.md](docs/tasks/ISF-FIELD-STRUCTURED-STORAGE-RESPONSE.md) |
