...
| `ISF-FIELD-STRUCTURED-STORAGE-FRONTIER` | `active` | `R14 / ISF storage metadata` | `.1` audit readiness and select the first declarative field-structured storage contract | [docs/tasks/ISF-FIELD-STRUCTURED-STORAGE-FRONTIER.md](docs/tasks/ISF-FIELD-STRUCTURED-STORAGE-FRONTIER.md) |
