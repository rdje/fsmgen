...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | complete through `.521`; public ISF contract summaries now match the `.520` mixed queue multi-beat behavior; current PNT owner has moved to `IAL1-VERIFICATION-CODE-GENERATION-FRONTIER.6` after the VHDL observation package output shipped | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
...
| `IAL1-VERIFICATION-CODE-GENERATION-FRONTIER` | `active` | `Verification code generation / IAL1` | `.6` audit whether future verification generation needs a direct IAL2 route now that `.11` shipped the selected inert VHDL observation package target | [docs/tasks/IAL1-VERIFICATION-CODE-GENERATION-FRONTIER.md](docs/tasks/IAL1-VERIFICATION-CODE-GENERATION-FRONTIER.md) |
