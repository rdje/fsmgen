...
| `HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE` | `active` | `verification architecture` | repair parent `.17.2.6.2` active; `.17.2.6.2.3` done, `.17.2.6.2.4` active for native-UVM negotiation | [task](docs/tasks/HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE.md) |
