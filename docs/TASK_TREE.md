...
| --- | --- | --- | --- | --- |
| `ISF-REPEAT-BODY-CHILD-ACTIVATION` | `active` | `R14` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.10` | [docs/tasks/ISF-REPEAT-BODY-CHILD-ACTIVATION.md](docs/tasks/ISF-REPEAT-BODY-CHILD-ACTIVATION.md) |
...
| Remaining repeat-body child activation widening: multi-pending `await_any`, repeat-body do bindings/domain metadata, plain local do targeting already generated children, spawn-after-sample ordering, sample-before/after-do timing, nested branch/loop activation, and cross-domain activation | `ISF-REPEAT-BODY-CHILD-ACTIVATION` |
