...
| --- | --- | --- | --- | --- |
| `DARWIN-INLINE-VERILATOR-RUNTIME-QUALIFICATION` | `active` | `verification infrastructure / runtime qualification` | `.3.2.2.3` consumes every remaining job from the still-running exact failed push and closes its root-cause partition | [task](docs/tasks/DARWIN-INLINE-VERILATOR-RUNTIME-QUALIFICATION.md) |
