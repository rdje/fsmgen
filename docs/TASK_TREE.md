...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.825` active from clean selector `5b601fffc`; ship the byte-identical exact-four paired `.ahb` alias with t1538 parity, shared t1537 runtime, and 330/371/54 split 27/27 | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
