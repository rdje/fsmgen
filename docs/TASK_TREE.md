...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.805` selects `.806`, a current AHB mdBook/behavior/fact alias-truthfulness repair, before the existing boundary-free active-transfer audit; `.806` remains pending until `.805` commits cleanly. Decision 0020 remains proposed/inactive | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
