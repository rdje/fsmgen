...
| `GITHUB-PUSH-OUTCOME-ASSURANCE` | `active` | `hosted CI` | `.6.2.2.22` closes terminal failure inventory; request fresh repair-push authorization | [task](docs/tasks/GITHUB-PUSH-OUTCOME-ASSURANCE.md) |
