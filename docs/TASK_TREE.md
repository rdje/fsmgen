...
| `HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE` | `active` | `verification architecture` | `.17.2.5.2` active; `.17.2.5.2.2` model ladders done; proposed `.17.2.5.2.3` owns scoreboard ladders next | [task](docs/tasks/HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE.md) |
