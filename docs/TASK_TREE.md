...
| `IAL2-AHB-REQUESTER-WRAP-PROGRESSION-AUDIT` | `active` | `IAL2 / AHB requester correctness` | `.1` runtime-confirms byte WRAP4 start 3 presents `3,1,2,3` instead of `3,0,1,2`; `.2` is selected to repair the shared WRAP4/8/16 generated requester and direct seed with increment-then-wrap sequencing | [docs/tasks/IAL2-AHB-REQUESTER-WRAP-PROGRESSION-AUDIT.md](docs/tasks/IAL2-AHB-REQUESTER-WRAP-PROGRESSION-AUDIT.md) |
