...
| --- | --- | --- | --- | --- |
| `CLAIM-VERIFICATION-ADOPTION` | `active` | `infra/evidence governance` | `.5.2.1` done; `.5.2.2` active for nine foundational rationale candidates | [task](docs/tasks/CLAIM-VERIFICATION-ADOPTION.md) |
