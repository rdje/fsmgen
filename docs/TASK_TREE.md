...
| --- | --- | --- | --- | --- |
| `ISF-ASSERT-NESTED-BITWISE-PRECEDENCE-REPAIR` | `proposed` | `R14 / generated verification correctness` | `.1`-.2 complete the semantic repair; proposed inactive `.3` owns t1502's stale pre-grouping exact AXI write-request assertion-text expectation found by later preservation testing | [docs/tasks/ISF-ASSERT-NESTED-BITWISE-PRECEDENCE-REPAIR.md](docs/tasks/ISF-ASSERT-NESTED-BITWISE-PRECEDENCE-REPAIR.md) |
