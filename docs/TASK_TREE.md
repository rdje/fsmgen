...
| --- | --- | --- | --- | --- |
| `ISF-SPECFORGE-REPORTED-STAGE-CONTRACT-BUGS` | `active` | `R14` | `ISF-SPECFORGE-REPORTED-STAGE-CONTRACT-BUGS.1` | [docs/tasks/ISF-SPECFORGE-REPORTED-STAGE-CONTRACT-BUGS.md](docs/tasks/ISF-SPECFORGE-REPORTED-STAGE-CONTRACT-BUGS.md) |
