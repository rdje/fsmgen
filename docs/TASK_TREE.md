...
| `BACKEND-API-VALIDATION-FRONTIER` | `active` | Backends And Validation / Embedding And Public APIs | `BACKEND-API-VALIDATION-FRONTIER.37.1` (`.37` selected aggregate-output roots as an explicit direct VHDL fail-closed boundary; next lock that exact leaf) | [docs/tasks/BACKEND-API-VALIDATION-FRONTIER.md](docs/tasks/BACKEND-API-VALIDATION-FRONTIER.md) |
