...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | clean selector commit `f3585f98d` activates `.821`, the byte-identical two-window exact-three `.ahb` alias at projected 326/367/50 split 25/25 with t1534 parity and t1533 shared runtime | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
