...
| `ISF-SCHEDULING-BACKLOG-FRONTIER` | `active` | `R14` | current frontier (`.6.1`; select the first fan-in/fan-out event-join source shape) | [docs/tasks/ISF-SCHEDULING-BACKLOG-FRONTIER.md](docs/tasks/ISF-SCHEDULING-BACKLOG-FRONTIER.md) |
