...
| --- | --- | --- | --- | --- |
| `RHS-LOGIC-SIMPLIFICATION-FRONTIER` | `done` | `HDL quality / expression minimization` | complete (`.1`; generated RHS ASTs now simplify through a shared width-safe logic-equivalence pass before HDL rendering, and StructuralRTLIR records store the simplified RHS AST) | [docs/tasks/RHS-LOGIC-SIMPLIFICATION-FRONTIER.md](docs/tasks/RHS-LOGIC-SIMPLIFICATION-FRONTIER.md) |
...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.184` select next slice after report-only raw-`ARLEN` burst-length over multiple/mixed depth-3 queue-head scalar last-beat read-data | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
