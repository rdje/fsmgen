...
| --- | --- | --- | --- | --- |
| `CLAIM-VERIFICATION-ADOPTION` | `active` | `infra/evidence governance` | `.5.4.6` active for 28 expanded APB register-bound candidates | [task](docs/tasks/CLAIM-VERIFICATION-ADOPTION.md) |
