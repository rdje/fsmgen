...
| --- | --- | --- | --- | --- |
| `CLAIM-VERIFICATION-ADOPTION` | `active` | `infra/evidence governance` | `.5.4.3` active for 35 APB width/sideband/status/timing candidates | [task](docs/tasks/CLAIM-VERIFICATION-ADOPTION.md) |
