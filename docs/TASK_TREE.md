...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.826` active from clean exact-four paired alias commit `40b8ead71`; compare two-window exact-four, broader AHB, HIAL/VIAL, verification, portability, priority, and scale owners before selecting exactly one | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
