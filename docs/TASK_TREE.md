...
| `README-STATIC-LANDING-PAGE` | `done` | `infra/continuity / entry-point documentation` | complete `.1`-.3: README.md became a verified 244-line / 9,679-byte stable landing page; decision 0024 established deterministic line/byte regrowth prevention, now refined by decision 0038 and the active empirical-adoption slice | [docs/tasks/README-STATIC-LANDING-PAGE.md](docs/tasks/README-STATIC-LANDING-PAGE.md) |
