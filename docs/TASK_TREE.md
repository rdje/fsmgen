...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | child-tree `.6` completes the disposable four-child two-subordinate exact-two proof across static, semantic/read-only MCP, and generated-HDL surfaces; proposed `.7` owns public-contract selection after clean `.6`, while 318/359/42 remains current and decision 0020 remains inactive | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
...
| `IAL2-AHB-EXACT-TWO-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT` | `active` | `IAL2 / AHB requester-subordinate composition` | `.6` completes its disposable four-child proof across both windows with exact-two qualified events, normalized semantic/real read-only MCP parity, and no required repair; proposed `.7` owns no-behavior generic public-contract selection after clean `.6` | [docs/tasks/IAL2-AHB-EXACT-TWO-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT.md](docs/tasks/IAL2-AHB-EXACT-TWO-PAIRED-BUSY-COMPOSITION-READINESS-AUDIT.md) |
