...
| `SEMANTIC-INTROSPECTION-MCP-FRONTIER` | `active` | `Embedding And Public APIs / AI integration` | `.30` post-source-discovery next-frontier selection | [docs/tasks/SEMANTIC-INTROSPECTION-MCP-FRONTIER.md](docs/tasks/SEMANTIC-INTROSPECTION-MCP-FRONTIER.md) |
