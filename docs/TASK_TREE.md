...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | exact-three `.2` selects proposed generic implementation `.3`: bounded literals 2..3, unchanged width-two lowering, projected 321/362/45 split 23/22; current support remains 320/361/44 until `.3`, and decision 0020 remains inactive | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
...
| `IAL2-AHB-REQUESTER-EXACT-THREE-BUSY-INSERTION-READINESS-AUDIT` | `active` | `IAL2 / AHB requester BUSY policy` | `.2` selects proposed `.3` generic exact-three implementation with literal range 2..3, exact identities/report/runtime gates, projected 321/362/45, and a later separate alias; no behavior changes until `.3` activates | [docs/tasks/IAL2-AHB-REQUESTER-EXACT-THREE-BUSY-INSERTION-READINESS-AUDIT.md](docs/tasks/IAL2-AHB-REQUESTER-EXACT-THREE-BUSY-INSERTION-READINESS-AUDIT.md) |
