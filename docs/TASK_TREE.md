...
| `GITHUB-PUSH-OUTCOME-ASSURANCE` | `active` | `hosted CI` | `.6.2.2.18.3` close failed-run inventory and repeat downstream/mdBook lockstep | [task](docs/tasks/GITHUB-PUSH-OUTCOME-ASSURANCE.md) |
