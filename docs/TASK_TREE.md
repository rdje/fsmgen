...
| `IASIM-EXECUTABLE-REFERENCE-SEMANTICS` | `proposed` | `HIAL/VIAL / native executable Intent Abstraction semantics / signoff` | `.1` defines IASIM's HDL-independent semantic authority, audits the current HIAL/VIAL executable boundaries, and selects the independent conformance/signoff proof stack before any engine implementation | [docs/tasks/IASIM-EXECUTABLE-REFERENCE-SEMANTICS.md](docs/tasks/IASIM-EXECUTABLE-REFERENCE-SEMANTICS.md) |
