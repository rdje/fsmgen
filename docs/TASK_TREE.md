...
| `GITHUB-PUSH-OUTCOME-ASSURANCE` | `active` | `hosted CI` | `.6.2.2.18.1` repair and case-shard the three monolithic supported-corpus audits | [task](docs/tasks/GITHUB-PUSH-OUTCOME-ASSURANCE.md) |
