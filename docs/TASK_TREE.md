...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.801` ships the generic two-subordinate paired AHB BUSY composition with exact status/control generated-HDL proof and 313/354 support accounting; `.802` is active to select the next exact AHB owner. Decision 0020 remains proposed/inactive | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
