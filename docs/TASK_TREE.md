...
| `MDBOOK-VHDL-INTRODUCTION-BOUNDARY-SYNC` | `active` | `roadmap/documentation alignment / VHDL` | `.1` active continuity-only after clean parent selector commit `191a65151`; next action aligns Chapters 00/10 with Chapter 14's bounded shipped VHDL boundary | [docs/tasks/MDBOOK-VHDL-INTRODUCTION-BOUNDARY-SYNC.md](docs/tasks/MDBOOK-VHDL-INTRODUCTION-BOUNDARY-SYNC.md) |
...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.833` is complete through clean selector commit `191a65151`; selected child `MDBOOK-VHDL-INTRODUCTION-BOUNDARY-SYNC.1` is active continuity-only | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
