...
| `HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE` | `active` | `verification architecture` | `.16` unavailable; `.17.1` selected scale; `.17.7` repairs a stale containment oracle, then `.17.6` aligns support limits | [task](docs/tasks/HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE.md) |
