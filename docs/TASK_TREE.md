...
| `ISF-FIELD-STRUCTURED-STORAGE-FRONTIER` | `active` | `R14 / ISF storage metadata` | `.5` select the next field-structured storage residual or close the frontier after support-accounting promotion | [docs/tasks/ISF-FIELD-STRUCTURED-STORAGE-FRONTIER.md](docs/tasks/ISF-FIELD-STRUCTURED-STORAGE-FRONTIER.md) |
