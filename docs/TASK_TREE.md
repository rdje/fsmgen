...
| `ISF-FIELD-STRUCTURED-STORAGE-FRONTIER` | `active` | `R14 / ISF storage metadata` | `.2` implement metadata-only declarative fields on scalar actor-owned storage variables | [docs/tasks/ISF-FIELD-STRUCTURED-STORAGE-FRONTIER.md](docs/tasks/ISF-FIELD-STRUCTURED-STORAGE-FRONTIER.md) |
