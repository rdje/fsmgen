...
| --- | --- | --- | --- | --- |
| `CLAIM-VERIFICATION-ADOPTION` | `active` | `infra/evidence governance` | `.5.6.9` active for 24 exact-plan-byte and execution-scale summary candidates on Chapter 16d lines 3316-3518 | [task](docs/tasks/CLAIM-VERIFICATION-ADOPTION.md) |
