...
| `IAL2-AHB-PIPELINED-ACTIVE-TRANSFER-AUDIT` | `active` | `IAL2 / AHB endpoint phase correctness` | `.4` is complete in the working tree: t1520 proves the distinct direct seed drops active phases accepted on successful/final-ERROR completion edges; commit it cleanly before `.5` selects the exact direct-seed contract and `.6` implements it | [docs/tasks/IAL2-AHB-PIPELINED-ACTIVE-TRANSFER-AUDIT.md](docs/tasks/IAL2-AHB-PIPELINED-ACTIVE-TRANSFER-AUDIT.md) |
