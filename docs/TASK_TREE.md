...
| `GITHUB-PUSH-OUTCOME-ASSURANCE` | `active` | `hosted CI` | `.6.2.2.19` locally repaired and qualified; commit it, then consume active exact-SHA regression run | [task](docs/tasks/GITHUB-PUSH-OUTCOME-ASSURANCE.md) |
