...
| `ISF-SPECFORGE-PHASE-MEMBERSHIP-RESPONSE` | `active` | `Downstream ISF handoff / verification-generation alignment` | `.2` edit the tracked FSMGen response to SPECFORGE's transaction phase-membership/value/order request | [docs/tasks/ISF-SPECFORGE-PHASE-MEMBERSHIP-RESPONSE.md](docs/tasks/ISF-SPECFORGE-PHASE-MEMBERSHIP-RESPONSE.md) |
