...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.814` and the generated AHB subordinate output-arbitration tree are complete; `.815` is active from clean behavior commit `1eec6253d` plus HIAL/VIAL parking commit `64f056b12` to select the next exact owner; direct IAL0 arbitration and decision 0020 remain inactive candidates | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
...
| `IAL0-AHB-DIRECT-SUBORDINATE-OUTPUT-ARBITRATION` | `proposed` | `IAL0 / AHB direct-seed correctness` | inactive; assertion-enabled t1520 exposes separate access/read/ERROR conditional output overrides in `fsm/ahb_lite_subordinate.fsm`; activate only through a later clean-boundary selector after generated endpoint priority | [docs/tasks/IAL0-AHB-DIRECT-SUBORDINATE-OUTPUT-ARBITRATION.md](docs/tasks/IAL0-AHB-DIRECT-SUBORDINATE-OUTPUT-ARBITRATION.md) |
