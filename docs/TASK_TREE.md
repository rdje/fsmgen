...
| --- | --- | --- | --- | --- |
| `CLAIM-VERIFICATION-ADOPTION` | `active` | `infra/evidence governance` | `.5.4.14` active for 40 backend/validation/public-API backlog candidates | [task](docs/tasks/CLAIM-VERIFICATION-ADOPTION.md) |
