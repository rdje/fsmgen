...
| `COMPOSITION-TYPE-BACKLOG-EXHAUSTION` | `active` | Composition / Aggregate Types And Data | `COMPOSITION-TYPE-BACKLOG-EXHAUSTION.8` (`.7` deferred activation parameter/value-binding widening behind one exact activation/binding contract; next repeat-body child-activation selection) | [docs/tasks/COMPOSITION-TYPE-BACKLOG-EXHAUSTION.md](docs/tasks/COMPOSITION-TYPE-BACKLOG-EXHAUSTION.md) |
