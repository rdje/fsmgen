...
| `IAL2-AHB-REQUESTER-MULTI-BUSY-INSERTION-READINESS-AUDIT` | `active` | `IAL2 / AHB requester BUSY policy` | `.5` ships optional `(busy-beats 2)`, its generic source/counter/report/t1521 runtime; pending `.6` selects the matching `.ahb` alias after clean commit | [docs/tasks/IAL2-AHB-REQUESTER-MULTI-BUSY-INSERTION-READINESS-AUDIT.md](docs/tasks/IAL2-AHB-REQUESTER-MULTI-BUSY-INSERTION-READINESS-AUDIT.md) |
