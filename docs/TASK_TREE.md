...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.817` selects pending `.818`, the byte-identical one-subordinate exact-three paired `.ahb` alias at projected 324/365/48 split 24/24; activate only after the selector commits cleanly | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
