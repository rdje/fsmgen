...
| --- | --- | --- | --- | --- |
| `CLAIM-VERIFICATION-ADOPTION` | `active` | `infra/evidence governance` | `.5.7` active for zero-open reconciliation and governed-constant revalidation | [task](docs/tasks/CLAIM-VERIFICATION-ADOPTION.md) |
