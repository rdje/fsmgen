...
| `IAL2-AXI-MANAGER-INITIATOR-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness / AXI initiator` | `.1`-.7 shipped/corrected AW; `.8`-.10 shipped single-beat W; `.11`-.14 shipped explicitly armed B acceptance. `.15`-.18 ship bounded request-only write composition; `.19`-.22 ship bounded full-write composition. `.23`-.26 ship `(axi-ar-driver ...)` with t/1504 exact 3/3 proof. `.27`-.30 select, audit, contract, and ship `(axi-r-beat-acceptor ...)` at support 304/345/345 with t/1505 exact raw RID4/RDATA32/RRESP2/RLAST1 3/3 proof. `.31`-.34 select, audit, contract, and ship `(axi-read-transaction-composition ...)`: unchanged AR/R, zero-state seven-rule coordinator, fixed LEN0/SIZE2/INCR, raw RID4/RDATA32/RRESP2/RLAST1 plus ID/last status, 27-port/three-child C4 at 41 nets/44 links, support 305/346/346, and t/1506 exact 5/4/5/4 proof. `.35` selects multi-beat read; `.36` proves and `.37` freezes additive `(axi-read-burst4-transaction-composition ...)`: LEN3/SIZE2/INCR, aligned 16-byte 4-KiB guard, raw beat event/index, sticky RID+RLAST sequence, count-authoritative drain, unchanged AR/R reuse, 20-port ten-rule coordinator, 29-port three-child C4 at 48 nets/46 links, support target 306/347/347, and t/1507 4/13/4/13/3 proof; `.38` active implementation. Deferred: multi-beat write, generalized dynamic/narrow/wrap/unaligned bursts, response/output-bank aggregation, capacity integration, decision-0020 transaction interface, back-to-back/outstanding/queues/demux/interleaving, malformed-subordinate recovery, aliases, verification output, backend variants/VHDL/direct, AHB/APB | [docs/tasks/IAL2-AXI-MANAGER-INITIATOR-FRONTIER.md](docs/tasks/IAL2-AXI-MANAGER-INITIATOR-FRONTIER.md) |
