...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.836` selected `PUBLIC-SYNC-TEST-DRIFT-REPAIR`; that `.1`-.4 child is complete in this commit, and the next clean action is a new parent selector | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
