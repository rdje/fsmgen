...
| --- | --- | --- | --- | --- |
| `ISF-COMPOSITIONAL-CONTROL-FLOW-ARCHITECTURE` | `active` | `R14` | current frontier (`.8.33`; remove the loop-contained fanout cap by exact region/effect proof instead of another fixed-width allow-list) | [docs/tasks/ISF-COMPOSITIONAL-CONTROL-FLOW-ARCHITECTURE.md](docs/tasks/ISF-COMPOSITIONAL-CONTROL-FLOW-ARCHITECTURE.md) |
