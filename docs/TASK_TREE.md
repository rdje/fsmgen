...
| --- | --- | --- | --- | --- |
| `CLAIM-VERIFICATION-ADOPTION` | `active` | `infra/evidence governance` | `.5.6.7` active for 45 execution-type, binding, and route-reachability candidates on Chapter 16d lines 2846-3091 | [task](docs/tasks/CLAIM-VERIFICATION-ADOPTION.md) |
