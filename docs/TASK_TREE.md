...
| `SEMANTIC-INTROSPECTION-MCP-FRONTIER` | `active` | `Embedding And Public APIs / AI integration` | `.19` MCP per-tool outputSchema boundary | [docs/tasks/SEMANTIC-INTROSPECTION-MCP-FRONTIER.md](docs/tasks/SEMANTIC-INTROSPECTION-MCP-FRONTIER.md) |
