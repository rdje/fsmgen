...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.821` ships the byte-identical two-window exact-three `.ahb` alias at 326/367/50 split 25/25 with t1534 parity and t1533 shared runtime; proposed `.822` owns the next selector after the clean behavior commit | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
