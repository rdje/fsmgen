...
| `HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE` | `active` | `verification architecture` | repair parent `.17.2.6.2` active; `.17.2.6.2.3` done, proposed `.17.2.6.2.4` owns native-UVM negotiation | [task](docs/tasks/HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE.md) |
