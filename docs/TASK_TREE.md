...
| `GITHUB-PUSH-OUTCOME-ASSURANCE` | `active` | `hosted CI` | `.6.2.2` consume the final three terminal shard results, then request repaired-push authorization | [task](docs/tasks/GITHUB-PUSH-OUTCOME-ASSURANCE.md) |
