...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.837` complete at clean `9e3308e5c`; selected child `MDBOOK-RUSTDOC-NON-RUST-FENCE-REPAIR.1` is now active continuity-only | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
...
| `MDBOOK-RUSTDOC-NON-RUST-FENCE-REPAIR` | `active` | `documentation validation / mdBook` | `.1` active from clean selector `9e3308e5c`: label exactly four pre-existing plain-text diagram fences as `text`, preserve their content, and restore full-book doctests | [docs/tasks/MDBOOK-RUSTDOC-NON-RUST-FENCE-REPAIR.md](docs/tasks/MDBOOK-RUSTDOC-NON-RUST-FENCE-REPAIR.md) |
