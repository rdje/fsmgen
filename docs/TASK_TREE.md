...
| `ISF-FIELD-STRUCTURED-STORAGE-FRONTIER` | `active` | `R14 / ISF storage metadata` | `.4` promote scalar storage-field metadata to a file-backed support-accounted public sample | [docs/tasks/ISF-FIELD-STRUCTURED-STORAGE-FRONTIER.md](docs/tasks/ISF-FIELD-STRUCTURED-STORAGE-FRONTIER.md) |
