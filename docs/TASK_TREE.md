...
| `TASK-ACCEPTANCE-PORTABLE-DOCTRINE` | `active` | `infra/continuity / doctrine enforcement` | active `.1`: select a neutral data-only project-declared evidence-signature contract before implementing or registering the missing `TASK-ACCEPTANCE` gate | [docs/tasks/TASK-ACCEPTANCE-PORTABLE-DOCTRINE.md](docs/tasks/TASK-ACCEPTANCE-PORTABLE-DOCTRINE.md) |
