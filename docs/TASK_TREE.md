...
| `IAL2-FEATURE-COMPLETENESS-FRONTIER` | `active` | `IAL2 / SV-backed feature completeness` | `.836` complete at clean `06c03e6bf`; selected child `PUBLIC-SYNC-TEST-DRIFT-REPAIR` has `.1`-.3 complete and `.4` active continuity-only | [docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md](docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md) |
| `PUBLIC-SYNC-TEST-DRIFT-REPAIR` | `active` | `public-contract, specification, and focused-test synchronization` | `.1`-.3 complete through `ce891bbd7`; `.4` active continuity-only for the exact four stale t1475/t1482 generated-IAL0 priority-mask expectations | [docs/tasks/PUBLIC-SYNC-TEST-DRIFT-REPAIR.md](docs/tasks/PUBLIC-SYNC-TEST-DRIFT-REPAIR.md) |
