...
| `IAL1-VERIFICATION-CODE-GENERATION-FRONTIER` | `active` | `Verification code generation / IAL1` | `.11` implement the selected inert VHDL observation package target after `.10` selected it | [docs/tasks/IAL1-VERIFICATION-CODE-GENERATION-FRONTIER.md](docs/tasks/IAL1-VERIFICATION-CODE-GENERATION-FRONTIER.md) |
