...
| `IAL2-MDBOOK-COHERENCE-AXI-COVERAGE` | `active` | `IAL2 mdBook alignment` | `.4` unblocked: document same-ID ordering, mixed populations, and response demux | [task](docs/tasks/IAL2-MDBOOK-COHERENCE-AXI-COVERAGE.md) |
