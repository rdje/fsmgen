...
| --- | --- | --- | --- | --- |
| `CLAIM-VERIFICATION-ADOPTION` | `active` | `infra/evidence governance` | `.5.6.5` active for 28 execution-binding, topology, scenario, and operation candidates on Chapter 16d lines 2277-2537 | [task](docs/tasks/CLAIM-VERIFICATION-ADOPTION.md) |
