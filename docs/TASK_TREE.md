...
| --- | --- | --- | --- | --- |
| `LIVE-DOCUMENT-SIZE-CONTAINMENT-ADOPTION` | `active` | `infra/continuity / project-wide live-document lifecycle` | completed `.20` adds opt-in lifecycle-scoped currency without global date heuristics; `.21` is the next review-selected correction for typed routes/indexes/evidence maps, while `.22` closes migration/retention evidence before wider reuse | [docs/tasks/LIVE-DOCUMENT-SIZE-CONTAINMENT-ADOPTION.md](docs/tasks/LIVE-DOCUMENT-SIZE-CONTAINMENT-ADOPTION.md) |
