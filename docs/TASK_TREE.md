...
| `FSMGEN-HIR-ROADMAP-FRONTIER` | `active` | `architecture / high-level frontend IR` | `.4` implements the private three-package SourceHIR valid-ready path with exact t1547 golden/downstream equivalence; `.5` remains proposed for evidence-based promotion/retirement audit | [docs/tasks/FSMGEN-HIR-ROADMAP-FRONTIER.md](docs/tasks/FSMGEN-HIR-ROADMAP-FRONTIER.md) |
