...
| --- | --- | --- | --- | --- |
| `R11-REUSABLE-MODULE-CONTRACT-FRONTIER-AUDIT` | `active` | `R11` | `R11-REUSABLE-MODULE-CONTRACT-FRONTIER-AUDIT.2` | [docs/tasks/R11-REUSABLE-MODULE-CONTRACT-FRONTIER-AUDIT.md](docs/tasks/R11-REUSABLE-MODULE-CONTRACT-FRONTIER-AUDIT.md) |
...
| `Aggregate Types And Data` | `completed RICHER-AGGREGATE-OPERATORS tree for semantic parameter/generic aggregate operator widening; completed AGGREGATE-AUTOGROWTH-FROM-USAGE tree for bounded automatic aggregate growth; completed BACKEND-OWNED-STRUCT-RECORD-DEFAULT-LOWERING tree for exact-contract Verilog-family structured-lowering audit; future task tree required for broader aggregate lowering, VHDL aggregate support, or public type/export APIs outside those trees` |
