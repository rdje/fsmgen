...
| `HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE` | `active` | `verification architecture` | `.15.7` active for combined exact OSVVM 2026.05 plus GHDL 6.0.0 LLVM-JIT qualification after completed materialization/emission `.15.6`; NEXSIM-dependent `.13.3` director-deferred | [task](docs/tasks/HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE.md) |
