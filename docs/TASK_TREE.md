...
| `ISF-REMAINING-BROAD-FRONTIER` | `active` | `R14` | `ISF-REMAINING-BROAD-FRONTIER.2` (`.7.1` shipped loop-control false-edge dynamic-wait splitting; next = select exact ATL expansion leaf before ATL behavior changes) | [docs/tasks/ISF-REMAINING-BROAD-FRONTIER.md](docs/tasks/ISF-REMAINING-BROAD-FRONTIER.md) |
