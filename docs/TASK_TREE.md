...
| `HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE` | `active` | `verification architecture` | decision `0083` closes `.17.3.5.1`; activate `.17.3.5.2` for authored 10,000/15,000-record portable materialization and its versioned oracle | [task](docs/tasks/HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE.md) |
