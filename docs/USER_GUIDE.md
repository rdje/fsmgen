...
- Scalar parameter expressions may use scalar leaves from list/record aggregates, including nested leaves and aggregate parameter defaults such as `P_LIST[0]`; whole aggregate roots and aggregate subtrees remain blocked as scalar expression operands.
