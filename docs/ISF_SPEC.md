...
- Accepted parser output exposes drives as a hash of shell entries keyed by
  ...
  in the generated drive DT. Body RHS expressions recursively substitute drive
  formals with the generated drive payload signals before DT emission. Drive
  body RHS expression operator-position enum members and enum members as drive
...
- Inline transaction drive assignments such as `(drive inline_mode (mode_out
  ...
  targets and inline drive RHS expression operator-position enum members remain
  deferred.
