...
one source-child event wait and one sink-child event wait. Extra route-child
waits must stay fail-closed until a later contract selects event
fan-in/fan-out, repeated wait sequencing, route-level wait storage, muxing,
