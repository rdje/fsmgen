...
`BACKEND-API-VALIDATION-FRONTIER.94`, which selects the next exact backend/API
edge after bounded APB/C4 generated-FSM multi-bit sized-bitstring VHDL generic
maps shipped.
...
and multi-bit sized bitstring actuals, full aggregate VHDL
