...
`IAL2-FEATURE-COMPLETENESS-FRONTIER.266`; `.267` owns public contract
selection before any behavior-bearing widening. Broader concrete same-ID queues, group-local
