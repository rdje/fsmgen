...
`BACKEND-API-VALIDATION-FRONTIER.96`, which selects the next exact backend/API
edge after bounded APB/C4 generated-FSM resolved package-backed VHDL generic
maps shipped.
...
package-backed actuals, full aggregate VHDL
