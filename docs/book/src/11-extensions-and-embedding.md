...
`BACKEND-API-VALIDATION-FRONTIER.91.1`, which implements the bounded APB/C4
generated-FSM scalar expression VHDL generic-map edge selected by `.91`.
...
generic maps beyond the selected scalar expression edge, full aggregate VHDL
