...
lowering and same-width vector addition/subtraction RHS/chain lowering,
without leaking SystemVerilog module or `always_*` forms. That is still a
scoped scaffold, not a full VHDL backend promise.
