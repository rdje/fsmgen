...
`BACKEND-API-VALIDATION-FRONTIER.81`, which selects the next exact backend/API
edge after bounded C2 generated-FSM multi-bit sized bitstring VHDL generic-map
actuals shipped in `.80.1`.
