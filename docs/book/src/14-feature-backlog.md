...
`BACKEND-API-VALIDATION-FRONTIER.116` selects the next exact backend/API edge
after signed vector negative numeric-literal multiplication lowering shipped.
...
numeric-literal division/modulo remain deferred. Completed implementation
