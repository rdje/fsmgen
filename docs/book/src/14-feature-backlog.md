...
`BACKEND-API-VALIDATION-FRONTIER.91` selects the next exact backend/API edge
after bounded APB/C4 generated-FSM scalar integer VHDL generic-map actuals
shipped in `.90.1`.
...
APB/C4 generic maps beyond shipped scalar integer actuals,
