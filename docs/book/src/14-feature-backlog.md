...
`BACKEND-API-VALIDATION-FRONTIER.92.1` implements the next exact backend/API
edge selected by `.92`: bounded APB/C4 generated-FSM one-bit VHDL generic-map
actuals.
...
APB/C4 generic maps beyond the selected one-bit edge,
