...
generics in the maintained aggregate-parameter comparison fixture, and
...
The active next direct VHDL leaf owns only scalar addition RHS lowering; broader
scalar arithmetic remains separate backlog.
