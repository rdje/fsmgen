...
`BACKEND-API-VALIDATION-FRONTIER.97.1` locks the C3 external-RTL non-packed
aggregate VHDL generic-map boundary after APB/C4 non-packed aggregate
...
packed literal under the active `.97.1` hardening owner,
