...
`BACKEND-API-VALIDATION-FRONTIER.93.1` implements the next exact backend/API
edge selected by `.93`: bounded APB/C4 generated-FSM multi-bit sized-bitstring
VHDL generic-map actuals.
...
APB/C4 generic maps beyond the selected multi-bit sized-bitstring edge,
