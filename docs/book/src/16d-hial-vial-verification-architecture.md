...
| portable VHDL | `T=128` | `T=512` | reference and emitted `T=29,508` limit; atomic `T=29,509` rejection |
| OSVVM-qualified VHDL | `T=128` | `T=512` | reference and emitted `T=29,508` limit; portable-foundation `T=29,509` rejection |
