...
Revision `037e56f09` seals 22 profiles; profile 23, `random_attempts/limit_v1`, fails validation. Projection/materialization under two family and controller reruns needs eight searches: one guarded million-attempt search measured 61.094573 seconds, yielding a 488.756584-second lower bound within 300 seconds. Guard and atomic publication stay active. Decision `0079` selects a private bounded transcript: projection searches once; known excess builds no list/map/IR/report; accepted materialization consumes the record. The same-volume revision archive holds 22 reports/2,609,009 bytes; independent reconstruction yields digest `6dbfa2d02f7eee0332881074628d50d2b454fe94ac241137a11d7c651c162d90` and no active execution/raw/staging residue. Reruns, identities, limits, timeouts, and nonclaims stay unchanged; implementation/fresh matrix remain pending.
