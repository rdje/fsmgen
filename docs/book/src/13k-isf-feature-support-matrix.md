...
Prior-active-await_any same-domain generated-do spawn-after-do remains
fail-closed; static-parameter and bound prior-active-await_any spawn-after-do are shipped.
...
top-level when-body nested repeat generated do with static params and bind handoffs after multi-pending await_any while generated nested spawn pending before same-body await_all drain subset, top-level when-body nested repeat generated do with static params and bind handoffs after multi-pending await_any then generated spawn before same-body await_all drain subset
