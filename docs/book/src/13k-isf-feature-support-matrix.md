...
variants, override-specialized contract-window lowering after activation-site
parameter overrides, runtime-signal or expression contract windows, min/max
windows, and global implication contracts remain backlog.
...
- Temporal contracts beyond the top-level bounded eventual subset, including
  override-specialized contract-window lowering after activation-site
  parameter overrides, runtime-signal or expression windows, global
