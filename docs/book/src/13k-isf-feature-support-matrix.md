...
- Rule-trigger output bindings for direct/local targets, explicit
  snapshot-vs-live binding timing selection, additional binding reports beyond
  endpoint-kind and binding-timing metadata, and broader static binding
  conflict diagnostics are not shipped.
