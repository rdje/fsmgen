...
prior-active-await_any local-do, plain generated-child, and static-parameter
generated-do spawn-after-do with a second post-spawn await_any are shipped
for the documented when-body and switch-branch drain subsets; a second
post-spawn await_any in bound and same-domain generated-do prior-observation
