...
handoff, starts the later generated spawn, advances directly to the mandatory
same-body await_all drain, and leaves a second post-spawn await_any in this
prior-observation shape fail-closed.
...
Prior-active-await_any static-parameter, bound, and same-domain generated-do
spawn-after-do are shipped for the documented direct-to-await_all drain
subsets; a second post-spawn await_any in those prior-observation shapes
remains fail-closed.
