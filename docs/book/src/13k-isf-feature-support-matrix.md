...
- Cross-domain repeat-body `do`, generated or spawned nested activation
  beyond the documented top-level when/switch generated-child do cases, broader
