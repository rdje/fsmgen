...
A new spawn after same-domain generated do before drain, generated-child-do
spawn-after-do with post-do await_any, and local-do spawn-after-do with
post-do await_any remain fail-closed.
