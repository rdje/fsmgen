...
report projection, and fail-closed unsupported round-robin combinations. This
...
`rule_slot`/`round_robin`, bounded `output_bundle`/`round_robin`, and bounded
`transaction_start`/`round_robin` subsets can gate a whole bound rule DT for
