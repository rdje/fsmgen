...
prior-active-await_any local-do and plain generated-child spawn-after-do with a second post-spawn await_any are shipped for the documented when-body and
switch-branch drain subsets; a second post-spawn await_any in specialized generated-do prior-observation shapes remains fail-closed.
