...
generated-do, and bound generated-do spawn-after-do with a second post-spawn
await_any are shipped for the documented when-body and switch-branch drain
subsets; a second post-spawn await_any in same-domain generated-do
