...
Prior-active-await_any local-do spawn-after-do with a second post-spawn
await_any is shipped for the documented when-body and switch-branch drain
subsets; a second post-spawn await_any in generated-do prior-observation
shapes remains fail-closed.
