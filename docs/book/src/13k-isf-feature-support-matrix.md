...
- Blocking `do`, `await_any`, nested `while`, nested `until`, `stage`,
  `contract`, and spawn `(domain ...)` inside repeat bodies remain outside the
