...
multi-route subset or one exact matching top-input/child-input vector width for
the vector subset; vector pin-ingress multi-route sets remain deferred.
