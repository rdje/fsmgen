...
Prior-active-await_any bound/same-domain generated-do spawn-after-do remains
fail-closed; static-parameter prior-active-await_any spawn-after-do is shipped.
