...
pre-trigger drive calls. Generated-handoff remapping or reuse, fan-in/fan-out
data routing, route mux/storage, child-to-pin multi-route egress, CDC/reset
remapping, ready/backpressure, payload protocols,
