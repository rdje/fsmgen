...
output-drive/always-block body consumer modeling remains deferred. Direct
...
Direct VHDL backend/reroute work remains outside that projection and is
deferred by `R11-DIRECT-STRUCTURAL-VHDL-REROUTING.1` until the
SystemVerilog-backed IAL0/IAL1/IAL2 path is feature complete. The direct SystemVerilog top
