...
handoffs pending for the later drain. Domain-qualified generated do, new spawn
after that do before the drain, and await-any-after-do forms remain rejected.
