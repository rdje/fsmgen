...
set before the later drain. Top-level `when` body and top-level `switch`
...
generated-spawn done set live for the later drain. Bound/domain-qualified
generated do while pending, new spawn after the generated do before the
drain, and await-any-after-do forms remain fail-closed.
