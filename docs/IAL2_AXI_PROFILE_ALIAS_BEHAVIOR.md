...
does not add `.chi`, `.ace`, `.ahb`, `.apb`, `.atb`, `.smbus`, or `.i2s`, and
does not allow direct IAL2-to-IAL0 lowering.
...
- `.chi`, `.ace`, `.ahb`, `.apb`, `.atb`, `.smbus`, `.i2s`, `.pif`, and `.ppi`
  are known IAL2 alias candidates but remain unsupported; and
