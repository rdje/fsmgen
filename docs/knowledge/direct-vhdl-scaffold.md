...
multiplication and scalar multiplication chains lower to one-bit `and`
semantics, while same-width vector `NAME + NAME` assignments and same-width
multi-operand addition chains become
