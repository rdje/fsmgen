...
answers:
  ...
  - "what is IAL2-FEATURE-COMPLETENESS-FRONTIER.8?"
date: 2026-06-12
status: current
tags: [ial2, axi, manager, id-family, static-validation, task-tree]
evidence: docs/AXI_IAL2_MANAGER_ID_FAMILY_SUBSET_SELECTION.md; docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md; docs/TASK_TREE.md; docs/book/src/14-feature-backlog.md; README.md; ROADMAP_V2.md
reverify: rg -n 'ID-family|id-families|IAL2-FEATURE-COMPLETENESS-FRONTIER\\.8|A5\\.1|A5\\.1\\.1|A5\\.5|A5\\.6' docs/AXI_IAL2_MANAGER_ID_FAMILY_SUBSET_SELECTION.md docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md docs/TASK_TREE.md docs/book/src/14-feature-backlog.md README.md ROADMAP_V2.md
---
...
`IAL2-FEATURE-COMPLETENESS-FRONTIER.8` is the active readiness audit. It must
decide whether the implementation should be an additive capacity/status
extension, a broader manager object, or a prerequisite IAL1/IAL0/SV substrate
slice. ID allocation, per-transaction user-ID validation, same-ID ordering,
