...
reverify: rg -n 'protocol-specific reusable|must not share one multi-peripheral interconnect/decode logic block|AXI/AHB applicability|parameter/generic' docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md MEMORY.md
---
...
remain deferred behind separate exact owners. APB, AXI, and AHB must not be
modeled as sharing one multi-peripheral interconnect/decode logic block.
