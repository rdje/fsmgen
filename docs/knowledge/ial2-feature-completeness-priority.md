...
reverify: rg -n 'IAL2-FEATURE-COMPLETENESS-FRONTIER\\.215|IAL2-FEATURE-COMPLETENESS-FRONTIER\\.216|POST_COUNTED_GROUP_LOCAL_ENQUEUE_NEXT_SLICE_SELECTION|dynamic same-ID|per_id_issue_order_queues|VHDL backend/reroute' docs/TASK_TREE.md docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md docs/AXI_IAL2_MANAGER_POST_COUNTED_GROUP_LOCAL_ENQUEUE_NEXT_SLICE_SELECTION.md README.md ROADMAP_V2.md docs/book/src/14-feature-backlog.md
---

The current feature-completeness priority is IAL2 on the
SystemVerilog-backed path.

Current frontier: `IAL2-FEATURE-COMPLETENESS-FRONTIER.216`, readiness audit
for dynamic same-ID issue-order queues beyond selected counted concrete-ID
queue-head groups.
