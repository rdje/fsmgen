...
surface without changing public behavior and selected
`IAL2-FEATURE-COMPLETENESS-FRONTIER.152`, readiness audit for read-data over
generated read single-beat depth-3 queue-head response-demux. The active IAL2
frontier is `.152`. Write or burst-last depth-3 response-demux, multiple or
