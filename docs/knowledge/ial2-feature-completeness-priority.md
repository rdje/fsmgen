...
support-account the sample. `.157` is the next feature-completeness selector.
Write depth-3, read-data over read burst-last depth-3, burst-length/runtime or
multi-beat over read burst-last depth-3, multiple or mixed depth-3 groups,
