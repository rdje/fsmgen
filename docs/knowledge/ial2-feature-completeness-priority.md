...
surface updates. Write depth-3, burst-length/runtime or multi-beat over read
burst-last depth-3, multiple or mixed depth-3 groups, same-family mixed
auto-ID, group-local enqueue widening, packed burst-vector outputs, alternate
