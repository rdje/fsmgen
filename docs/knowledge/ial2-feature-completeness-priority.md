...
`IAL2-FEATURE-COMPLETENESS-FRONTIER.138`, the next AXI manager
feature-completeness selector. Deeper queues, same-family mixed auto-ID, write
or read single-beat multi-group queue-head behavior, packed burst-vector
