...
`.160` is the next selector after `.159`. Write depth-3, burst-length/runtime
or multi-beat over read burst-last depth-3, multiple or mixed depth-3 groups,
