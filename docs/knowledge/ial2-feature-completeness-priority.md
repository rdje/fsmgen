...
reverify: rg -n 'IAL2-FEATURE-COMPLETENESS-FRONTIER\\.216|IAL2-FEATURE-COMPLETENESS-FRONTIER\\.217|DYNAMIC_SAME_ID_ISSUE_ORDER_READINESS_AUDIT|dynamic/user transaction-ID|dynamic user-ID arbitration|VHDL backend/reroute' docs/TASK_TREE.md docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md docs/AXI_IAL2_MANAGER_DYNAMIC_SAME_ID_ISSUE_ORDER_READINESS_AUDIT.md README.md ROADMAP_V2.md docs/book/src/14-feature-backlog.md
---

The current feature-completeness priority is IAL2 on the
SystemVerilog-backed path.

Current frontier: `IAL2-FEATURE-COMPLETENESS-FRONTIER.217`, public
dynamic/user transaction-ID contract selection before generalized per-ID
issue-order queues.
