...
read single-beat. The active frontier is
`IAL2-FEATURE-COMPLETENESS-FRONTIER.143`. Deeper queues, same-family mixed
auto-ID, read-data over read single-beat multi-group queue-head behavior,
