...
The current PNT frontier is `IAL2-FEATURE-COMPLETENESS-FRONTIER.109`, an
audit/selector for the next safe same-ID queue behavior expansion. Read
`single-beat`, deeper/multiple groups, same-family mixed auto-ID, read-data
