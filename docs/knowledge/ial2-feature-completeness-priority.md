...
reverify: rg -n 'IAL2-FEATURE-COMPLETENESS-FRONTIER\\.233|IAL2-FEATURE-COMPLETENESS-FRONTIER\\.234|DYNAMIC_READ_DATA_READINESS_AUDIT|scalar dynamic read-data|bounded_dynamic_read_rid_rlast_demux_contract|VHDL backend/reroute' docs/TASK_TREE.md docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md docs/AXI_IAL2_MANAGER_DYNAMIC_READ_DATA_READINESS_AUDIT.md README.md ROADMAP_V2.md docs/book/src/14-feature-backlog.md
---

The current active project priority is
`IAL2-FEATURE-COMPLETENESS-FRONTIER.234`, direct bounded implementation of
scalar dynamic read-data capture over generated single-active dynamic read
response-demux on the SystemVerilog-backed path.
