...
generated read burst-last concrete same-ID queue-head groups. The current PNT
frontier is `.126`. Generated read-data over multiple groups, deeper queues,
