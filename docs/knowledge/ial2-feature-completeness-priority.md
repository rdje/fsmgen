...
reverify: rg -n 'IAL2-FEATURE-COMPLETENESS-FRONTIER\\.230|IAL2-FEATURE-COMPLETENESS-FRONTIER\\.231|DYNAMIC_READ_RLAST_TRANSACTION_ID_CAPTURE_CONTRACT_SELECTION|bounded_dynamic_read_rid_rlast_demux_contract|VHDL backend/reroute' docs/TASK_TREE.md docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md docs/AXI_IAL2_MANAGER_DYNAMIC_READ_RLAST_TRANSACTION_ID_CAPTURE_CONTRACT_SELECTION.md README.md ROADMAP_V2.md docs/book/src/14-feature-backlog.md
---
...
the SystemVerilog-backed path. `.230` selected that implementation owner after
choosing the public `response-demux.read` burst-last contract for one dynamic
read transaction.
