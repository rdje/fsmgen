...
for the sample. The active frontier is
`IAL2-FEATURE-COMPLETENESS-FRONTIER.144`, the next selector/audit. Deeper
queues, same-family mixed auto-ID, read-data over read single-beat
