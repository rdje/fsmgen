...
coverage gate. Deeper
queues, same-family mixed auto-ID, write or read single-beat multi-group
queue-head behavior, packed burst-vector outputs, alternate payload assembly,
