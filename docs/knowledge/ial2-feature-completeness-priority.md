...
The current PNT frontier is `.125`, the next exact IAL2 feature-completeness
selector after multi-group queue-head demux. Read-data over multiple groups,
deeper queues, same-family mixed auto-ID, write or read single-beat
