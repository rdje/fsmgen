...
`IAL2-FEATURE-COMPLETENESS-FRONTIER.94` owns the next PNT frontier:
selecting the public AXI same-ID issue-order queue policy contract before
parser/report metadata or generated queue behavior.
