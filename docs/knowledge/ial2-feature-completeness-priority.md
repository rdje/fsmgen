...
`issue-order-queue` behavior. `.523` selected that implementation after a
readiness audit found the remaining fail-closed boundary local to the mixed
queue planner/materializer/report/test surfaces.
