...
reports two duplicate concrete write-ID groups while still remaining
...
active frontier is `IAL2-FEATURE-COMPLETENESS-FRONTIER.140`. Deeper queues,
same-family mixed auto-ID, read single-beat multi-group queue-head behavior,
