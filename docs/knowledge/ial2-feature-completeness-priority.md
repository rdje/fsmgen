...
`IAL2-FEATURE-COMPLETENESS-FRONTIER.75` owns the next PNT frontier: selecting
the next AXI manager feature-completeness slice after generated multi-beat
read-data output-bank behavior.
