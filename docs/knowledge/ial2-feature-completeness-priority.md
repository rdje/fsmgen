...
strict check/semantic JSON support-account the sample. The active IAL2
frontier is `.154`, the next feature-completeness selector after depth-3
read-data. Write or burst-last depth-3 response-demux, multiple or mixed
