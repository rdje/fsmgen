...
reverify: rg -n 'IAL2-FEATURE-COMPLETENESS-FRONTIER\\.136|IAL2-FEATURE-COMPLETENESS-FRONTIER\\.137|POST_MULTI_GROUP_QUEUE_HEAD_RUNTIME_VALIDATION_NEXT_SLICE_SELECTION|support residue cleanup|runtime-validation multi-group queue-head scalar|read_multi_group_last_beat_same_id_queue_head_burst_length_runtime_assertion|support-detail string|focused PPIF/parser assertion|generated_read_burst_last_queue_head_demux|VHDL backend/reroute' docs/TASK_TREE.md docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md docs/AXI_IAL2_MANAGER_POST_MULTI_GROUP_QUEUE_HEAD_RUNTIME_VALIDATION_NEXT_SLICE_SELECTION.md docs/AXI_IAL2_MANAGER_MULTI_GROUP_QUEUE_HEAD_RUNTIME_VALIDATION_BEHAVIOR.md README.md ROADMAP_V2.md docs/book/src/14-feature-backlog.md
---
...
wording for that exact behavior. Deeper queues, same-family mixed auto-ID,
