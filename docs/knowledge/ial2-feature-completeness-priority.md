...
multi-beat reassembly/output/aggregation deferred. The active frontier is
`IAL2-FEATURE-COMPLETENESS-FRONTIER.166`, the next feature-completeness
selector after depth-3 runtime-validation behavior.
