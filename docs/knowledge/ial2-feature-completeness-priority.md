...
reverify: rg -n 'IAL2-FEATURE-COMPLETENESS-FRONTIER\\.231|IAL2-FEATURE-COMPLETENESS-FRONTIER\\.232|DYNAMIC_READ_RLAST_TRANSACTION_ID_CAPTURE_BEHAVIOR|bounded_dynamic_read_rid_rlast_demux_contract|VHDL backend/reroute' docs/TASK_TREE.md docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md docs/AXI_IAL2_MANAGER_DYNAMIC_READ_RLAST_TRANSACTION_ID_CAPTURE_BEHAVIOR.md README.md ROADMAP_V2.md docs/book/src/14-feature-backlog.md
---

The current active project priority is
`IAL2-FEATURE-COMPLETENESS-FRONTIER.232`, selector for the next exact IAL2
feature-completeness owner after `.231` shipped bounded dynamic read
