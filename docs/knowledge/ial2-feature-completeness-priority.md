...
next feature-completeness selector. Runtime beat-count/`RLAST` multi-group
scalar validation, deeper queues, same-family mixed auto-ID, write or read
single-beat multi-group queue-head behavior, packed burst-vector outputs,
