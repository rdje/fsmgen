...
The current PNT frontier is `.122`. Deeper/multiple groups, same-family
mixed auto-ID, packed burst-vector outputs, alternate payload assembly, direct
