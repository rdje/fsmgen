...
`IAL2-FEATURE-COMPLETENESS-FRONTIER.72` owns the next PNT frontier:
parser/report metadata and static validation for the public AXI multi-beat
read-data reassembly/output contract.
...
static validation for that syntax.
