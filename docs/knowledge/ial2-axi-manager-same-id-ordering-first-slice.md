...
reverify: rg -n 'IAL2-FEATURE-COMPLETENESS-FRONTIER\\.35|same_id_ordering|auto_id_same_id_avoidance|avoid_same_id_concurrency|axi0_w0_w1_auto_id_unique_active_id|IAL2-FEATURE-COMPLETENESS-FRONTIER\\.36' docs/AXI_IAL2_MANAGER_SAME_ID_ORDERING_FIRST_SLICE.md perl/FSM/IAL2/ProtocolIntent/AxiManagerCapacityStatus.pm t/1437-axi-ial2-manager-capacity-status-generator.t t/1436-ial2-ppif-parser-cli.t docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md docs/book/src/14-feature-backlog.md README.md ROADMAP_V2.md
---
...
and VHDL remain future exact-owner work. `.36` is the next selector.
