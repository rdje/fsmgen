...
`r0`, `r1`, and `r2`. Runtime beat-count/`RLAST` validation for the same
mixed shape remains non-public after `.200` and now fails closed as separately
owned. `.200` selects `.201`, a readiness audit for that mixed runtime
validation boundary.
