...
evidence: docs/IAL2_APB_PPIF_COMPLETER_BEHAVIOR.md; ppif/apb_completer.ppif; perl/FSM/Adapter/IAL2/PPIF.pm; perl/FSM/IAL2/ProtocolIntent/ApbCompleter.pm; perl/FSM/Support/RegressionCorpus.pm; t/1471-ial2-apb-completer.t; t/248-regression-corpus-accounting.t; docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md; docs/TASK_TREE.md; MEMORY.md; README.md; ROADMAP_V2.md; docs/book/src/14-feature-backlog.md
...
`.apb` remains requester-transfer only in this slice. APB interconnect/
composition, APB completer `.apb` alias exposure, sidebands, alternate widths,
