...
reverify: rg -n "Protocol/Platform Intent|Direct `IAL2 -> IAL0` lowering is forbidden|.pif|.ppi|.ppif|.axi" docs/decisions/0014-protocol-platform-intent-surface-and-layered-lowering.md
---

Future IAL2 must use a protocol/platform-generic file surface. Protocol-specific
extensions such as `.axi` are rejected because IAL2 must apply to AXI, CHI,
ACE, AHB, APB, ATB, and future protocols.
