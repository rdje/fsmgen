...
reverify: rg -n 'IAL2-FEATURE-COMPLETENESS-FRONTIER\.97|IAL2-FEATURE-COMPLETENESS-FRONTIER\.98|IAL2-FEATURE-COMPLETENESS-FRONTIER\.99|admitted_request_boundary|admitted request|admitted per-transaction|can_accept|queue-head response demux|generated_queue_behavior' docs/AXI_IAL2_MANAGER_SAME_ID_ISSUE_ORDER_QUEUE_ADMITTED_ENQUEUE_BOUNDARY_AUDIT.md docs/AXI_IAL2_MANAGER_SAME_ID_ISSUE_ORDER_QUEUE_ADMITTED_REQUEST_PULSES_FIRST_SLICE.md docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md docs/TASK_TREE.md README.md ROADMAP_V2.md docs/book/src/14-feature-backlog.md
---
...
queue-head response demux ship. The active frontier is now
