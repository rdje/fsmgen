...
reverify: rg -n 'transaction event dispatch|direction fan-in|IAL2-FEATURE-COMPLETENESS-FRONTIER\\.14|IAL2-FEATURE-COMPLETENESS-FRONTIER\\.15|per-transaction request|per-transaction event provenance|ID allocation' docs/AXI_IAL2_MANAGER_TRANSACTION_EVENT_DISPATCH_SELECTION.md docs/AXI_IAL2_MANAGER_TRANSACTION_EVENT_DISPATCH_READINESS_AUDIT.md docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md docs/TASK_TREE.md docs/book/src/14-feature-backlog.md README.md ROADMAP_V2.md
---
