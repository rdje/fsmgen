...
title: Exact-two AHB requester BUSY behavior ships on one additive generic PPIF source
answers:
...
evidence: docs/IAL2_AHB_REQUESTER_EXACT_TWO_BUSY_EVENT_BEHAVIOR.md; ppif/ahb_requester_busy_insert_two.ppif; perl/FSM/Adapter/IAL2/PPIF.pm; perl/FSM/IAL2/ProtocolIntent/AhbRequester.pm; perl/FSM/Support/RegressionCorpus.pm; t/1521-ial2-ahb-requester-two-busy-insert.t; t/data/ahb_requester_two_busy_insert_tb.svt; docs/tasks/IAL2-AHB-REQUESTER-MULTI-BUSY-INSERTION-READINESS-AUDIT.md
...
The report uses numeric `busy_insertion.beats=2`. Assertion-enabled t/1521
proves continuous, 32-clock ready-low, and 32-clock grant-low cases with exactly
two qualified BUSY events and four data beats. The current corpus is 315
protocol / 356 supported+strict and the AHB IAL2 inventory is 39 paths. No
exact-two `.ahb` alias or paired exact-two source ships yet.
