...
evidence: docs/tasks/FSMGEN-HIR-ROADMAP-FRONTIER.md; docs/FSMGEN_SOURCE_HIR_ARCHITECTURE_SELECTION.md; docs/decisions/0028-source-facing-hir-is-a-distinct-private-pre-ial-layer.md; docs/TASK_TREE.md; ROADMAP_V2.md; docs/book/src/14-feature-backlog.md; MEMORY.md; docs/IR_POLICY.md; docs/tasks/FSMGEN-IR-AUDIT.md; docs/tasks/IAL2-HOST-LANGUAGE-BUILDER-FRONTIER.md
reverify: rg -n 'FSMGEN-HIR-ROADMAP-FRONTIER|FSM::IR::SourceHIR|valid_ready_handshake\.ppif|private|IAL2 -> IAL1 -> IAL0' docs/tasks/FSMGEN-HIR-ROADMAP-FRONTIER.md docs/FSMGEN_SOURCE_HIR_ARCHITECTURE_SELECTION.md docs/TASK_TREE.md ROADMAP_V2.md docs/book/src/14-feature-backlog.md MEMORY.md
---
