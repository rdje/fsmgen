...
The active PNT frontier is now `IAL2-FEATURE-COMPLETENESS-FRONTIER.123`, a
readiness audit for multiple independent read burst-last depth-2 concrete
same-ID queue-head response-demux groups. Read-data over multiple groups,
