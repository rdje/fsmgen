...
65,536-byte compact IPC. The final clean repaired campaign seals all owned
profiles and both manifests, and a separate guarded process reloads the exact complete identity; performance, support, capacity, parity, IASIM, and API claims remain closed.
