...
That evidence is not yet an IAL2 contract. FSMGen still rejects `.apb`, has no
APB `.ppif` sample, and has no APB IAL2 report or support-accounting identity.
