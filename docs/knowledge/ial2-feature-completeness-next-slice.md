...
title: IAL2 feature completeness next slice is post-single-beat same-ID queue expansion audit
answers:
...
reverify: rg -n 'IAL2-FEATURE-COMPLETENESS-FRONTIER\\.110|IAL2-FEATURE-COMPLETENESS-FRONTIER\\.111|generated_read_single_beat_queue_head_demux|generated_write_bid_queue_head_demux|generated_read_burst_last_queue_head_demux|common semantic core' docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md docs/TASK_TREE.md docs/AXI_IAL2_MANAGER_READ_SINGLE_BEAT_SAME_ID_QUEUE_HEAD_RESPONSE_DEMUX_BEHAVIOR.md docs/book/src/14-feature-backlog.md README.md ROADMAP_V2.md docs/knowledge/ial2-common-vs-profile-factoring.md
---
...
The next active leaf is `IAL2-FEATURE-COMPLETENESS-FRONTIER.111`. It owns the
post-read-single-beat same-ID queue behavior expansion audit/selector before
any broader behavior changes.
...
and read single-beat depth-2 two-transaction shapes. Read-data consumption,
deeper or multiple groups, same-family mixed auto-ID, direct backend, and VHDL
remain deferred.
