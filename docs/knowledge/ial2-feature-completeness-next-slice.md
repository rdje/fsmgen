...
title: IAL2 feature completeness next slice is multi-beat read-data readiness
answers:
...
reverify: rg -n 'IAL2-FEATURE-COMPLETENESS-FRONTIER\\.72|IAL2-FEATURE-COMPLETENESS-FRONTIER\\.73|MULTI_BEAT_READ_DATA_METADATA_FIRST_SLICE|capture-scope multi-beat|multi_beat_reassembly_generated_behavior' docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md docs/TASK_TREE.md docs/AXI_IAL2_MANAGER_MULTI_BEAT_READ_DATA_METADATA_FIRST_SLICE.md docs/book/src/14-feature-backlog.md README.md ROADMAP_V2.md
---
...
contract selector, and multi-beat parser/report metadata first slice, the
next active leaf is `IAL2-FEATURE-COMPLETENESS-FRONTIER.73`.
...
payload reassembly and output lanes remain deferred. The active leaf is
