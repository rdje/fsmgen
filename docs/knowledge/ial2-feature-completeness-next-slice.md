...
title: IAL2 feature completeness next slice is mixed dynamic/static demux readiness
answers:
...
The remaining local response-ownership gap is mixed dynamic/static
...
ownership/assertion contract is selected first.
