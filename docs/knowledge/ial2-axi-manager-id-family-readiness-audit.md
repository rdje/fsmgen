...
evidence: docs/AXI_IAL2_MANAGER_ID_FAMILY_READINESS_AUDIT.md; docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md; docs/TASK_TREE.md; docs/book/src/14-feature-backlog.md; README.md; ROADMAP_V2.md
reverify: rg -n 'id_families|id-families|IAL2-FEATURE-COMPLETENESS-FRONTIER\\.9|generated \\.isf|generated \\.fsm|HDL unchanged|additive' docs/AXI_IAL2_MANAGER_ID_FAMILY_READINESS_AUDIT.md docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md docs/TASK_TREE.md docs/book/src/14-feature-backlog.md README.md ROADMAP_V2.md
---
...
`IAL2-FEATURE-COMPLETENESS-FRONTIER.9` is the active implementation leaf. It
must add public `(id-families ...)` syntax, a separate sample,
support-accounting entry, additive report `id_families`, fail-closed
diagnostics, mdBook/Knowledge Map sync, and focused tests.
