...
The next active leaf is `IAL2-FEATURE-COMPLETENESS-FRONTIER.77`, parser/report
metadata and static validation for this selected contract. Generated scalar
aggregation behavior, width-3 AXI responses, direct backend lowering, and VHDL
remain deferred.
