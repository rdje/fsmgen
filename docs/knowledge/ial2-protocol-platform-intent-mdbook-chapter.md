...
evidence: docs/book/src/16-ial2-protocol-platform-intent.md; docs/book/src/SUMMARY.md; docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md; docs/IAL2_AXI_APB_AHB_TRIMODE_MDBOOK_COVERAGE_AUDIT.md
reverify: rg -n 'IAL2 Protocol And Platform Intent|IAL2 source -> generated IAL1 \.isf -> generated IAL0 \.fsm -> HDL|Guided mode|More-control mode|Raw/full-control mode|fsm/amba_requester\.fsm|16-ial2-protocol-platform-intent' docs/book/src/16-ial2-protocol-platform-intent.md docs/book/src/SUMMARY.md docs/tasks/IAL2-FEATURE-COMPLETENESS-FRONTIER.md
---
...
surfaces with selected profile aliases. AHB is documented as current direct
`fsm/amba_requester.fsm` AMBA requester coverage only; AHB `.ppif`, `.ahb`,
generated AHB `.isf`, generated AHB `.fsm`, AHB profile aliases, and full AHB
manager behavior are not shipped.
