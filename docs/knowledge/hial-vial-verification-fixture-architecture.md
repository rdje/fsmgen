...
64-MiB runtime capture limits. Completed `.17.8` preserves the decisions
`0055`/`0056` selection audit while recording that execution as current
authority; `.17.2` may consume the aligned `backend_limits`.
