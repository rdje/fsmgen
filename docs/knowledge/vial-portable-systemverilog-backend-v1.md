...
answers:
  ...
  - "is the VIAL SystemVerilog backend implemented yet?"
...
artifacts. It is not implemented until proposed `.10` is separately activated
and completed.
