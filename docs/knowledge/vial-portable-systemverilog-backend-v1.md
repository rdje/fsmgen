...
planning/artifact, backend/trace, and exact runtime/result children. Active
`.10.1` owns the public capabilities/check/normal-terse source surfaces first.
No implementation ships during decomposition.
