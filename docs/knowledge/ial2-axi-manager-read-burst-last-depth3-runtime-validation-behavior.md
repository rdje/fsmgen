...
`IAL2-FEATURE-COMPLETENESS-FRONTIER.166` is the next selector. Multi-beat over
...
assembly, direct backend, and VHDL remain deferred behind future owned leaves.
