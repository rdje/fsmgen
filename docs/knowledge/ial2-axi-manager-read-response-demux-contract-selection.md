...
demux behavior readiness and selected direct bounded single-beat
implementation with no new IAL1/IAL0/SystemVerilog prerequisite.
`IAL2-FEATURE-COMPLETENESS-FRONTIER.41` is the generated read behavior owner.
