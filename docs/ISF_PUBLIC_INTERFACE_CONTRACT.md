...
`await_all` drain. Bound/domain-qualified generated do while pending, prior
or later `await_any` around that generated do, and new spawn after that
generated do before the drain remain outside the public shipped subset.
...
- Transaction control-flow behavior beyond shipped static/symbolic actor
  ...
  generated nested spawns are pending before that same later drain.
