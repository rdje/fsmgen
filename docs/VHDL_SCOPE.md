...
- Active follow-up: implement direct VHDL `logic signed` internal declaration
  lowering under `BACKEND-API-VALIDATION-FRONTIER.55.1`; signed ports and
  signed arithmetic semantics remain separate future edges.
