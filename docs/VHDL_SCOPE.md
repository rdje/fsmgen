...
- Composition VHDL is shipped only for the bounded C3 external-RTL
  ...
  expression and multi-bit sized bitstring generic maps.
  Broader
  ...
  sized bitstring actuals, VHDL package
...
3. **Composition structural emission from typed structural RTL IR**
   ...
   - Render VHDL concurrent auxiliary assignments, generated standalone-DT
     ...
     sized bitstring generic maps for the bounded C2 generated-FSM family
...
- Shipped bounded C2 generated-FSM multi-bit sized bitstring generic-map actual
  ...
  `RESET_VALUE => "10100101"` before the generated child port map, while
  generated-FSM one-bit and aggregate actuals remain deferred.
...
- Shipped the bounded APB/C4 generated-FSM child composition VHDL top under
  ...
  generated-FSM scalar-integer/scalar-expression/multi-bit sized-bitstring
  generic-map fixtures, VHDL package
...
- Focused direct VHDL generation tests cover pipeline and CLI routing,
  ...
  bounded C2 generated-FSM scalar integer, scalar expression, and multi-bit
  sized bitstring VHDL generic-map generation,
