...
- `2026-05-19`: Recorded post-closure ATL scalar pin-egress fixture
  ...
  metadata, and plain/strict HDL coverage.
- `2026-05-19`: Recorded post-closure ATL resolved-child pin-egress fixture
  promotion through strict schedule JSON, parent/child/top `.fsm` artifacts,
  generated child output role preservation, generated-top data wiring, and
  plain/strict HDL coverage.
