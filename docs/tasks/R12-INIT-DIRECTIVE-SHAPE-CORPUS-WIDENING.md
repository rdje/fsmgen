...
- ID: `R12-INIT-DIRECTIVE-SHAPE-CORPUS-WIDENING.2`
  ...
  Verification: `perl -Iperl -c` for touched support/tests; focused init-directive shape tests; corpus accounting/behavior tests; manifest/check-json/semantic-json corpus gates; supported corpus gates; `git diff --check`; `mdbook build docs/book`
  Commit: `R12-INIT-DIRECTIVE-SHAPE-CORPUS-WIDENING.2: widen init-directive shape corpus`

## Current Frontier

| Order | Leaf | Status | Why next |
| --- | --- | --- | --- |
| 1 | `closed` | `done` | `R12-INIT-DIRECTIVE-SHAPE-CORPUS-WIDENING.2` shipped the selected init-directive shape corpus widening. |
...
| `2026-05-20` | `R12-INIT-DIRECTIVE-SHAPE-CORPUS-WIDENING.2` | `perl -Iperl -c` for touched support/tests; focused init-directive shape tests; corpus accounting/behavior tests; manifest/check-json/semantic-json corpus gates; supported corpus gates; `git diff --check`; `mdbook build docs/book` | `passed` |
...
| `R12-INIT-DIRECTIVE-SHAPE-CORPUS-WIDENING.2` | `R12-INIT-DIRECTIVE-SHAPE-CORPUS-WIDENING.2: widen init-directive shape corpus` | Adds three maintained init-directive shape expected-failure entries. |

## Changelog

- `2026-05-20`: Created task tree and selected the next implementation
  frontier.
- `2026-05-20`: Shipped the selected init-directive shape corpus widening and
