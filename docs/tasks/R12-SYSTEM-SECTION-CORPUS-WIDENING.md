...
| --- | --- | --- | --- |
| 1 | `R12-SYSTEM-SECTION-CORPUS-WIDENING.2` | `pending` | R12 still needs wider expected-failure coverage beyond current language-contract families, and focused system-section tests already define targeted rejection behavior. |
...
| `R12-SYSTEM-SECTION-CORPUS-WIDENING.2` | `pending` | `pending` |
