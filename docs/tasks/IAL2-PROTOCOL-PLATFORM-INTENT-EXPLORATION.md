...
| 2 | `IAL2-PROTOCOL-PLATFORM-INTENT-EXPLORATION.2` | `pending` | A non-code evaluation note is the smallest safe next step because IAL2 is not yet justified as a source/lowering implementation. |
...
- Whether IAL2 should become a source language, a protocol library format, a
  capture/report workflow, or stay deferred remains open and is the subject of
  `.2`.
...
| `.2` | `pending` | Pending evaluation note. |
