...
| --- | --- | --- | --- |
| 1 | `IAL2-FEATURE-COMPLETENESS-FRONTIER.50` | `pending` | `.49` selected public burst/`RLAST` completion contract selection before parser/report metadata or generated behavior changes. |
