...
| --- | --- | --- | --- |
| 1 | `IAL2-FEATURE-COMPLETENESS-FRONTIER.61` | `pending` | `.60` shipped generated last-beat RDATA/RRESP capture; select the next exact AXI manager feature-completeness owner from the remaining read-data/per-ID/full-manager residue. |
