...
| --- | --- | --- | --- |
| 1 | `IAL2-FEATURE-COMPLETENESS-FRONTIER.53` | `pending` | `.52` found no lower-layer prerequisite and selected direct generated burst-last/`RLAST` completion behavior. |
