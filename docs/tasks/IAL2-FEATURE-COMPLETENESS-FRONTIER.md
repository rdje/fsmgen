...
| --- | --- | --- | --- |
| 1 | `IAL2-FEATURE-COMPLETENESS-FRONTIER.64` | `pending` | `.63` shipped report-only ARLEN burst-length metadata; select the next exact owner before generated ARLEN capture, validation, storage, reassembly, or backend behavior. |
