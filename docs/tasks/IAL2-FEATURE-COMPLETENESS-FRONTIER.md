...
| --- | --- | --- | --- |
| 1 | `IAL2-FEATURE-COMPLETENESS-FRONTIER.66` | `pending` | `.65` found no new substrate prerequisite; implement generated raw-ARLEN capture before beat-count validation, storage/reassembly, or backend behavior. |
