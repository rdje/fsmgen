...
| --- | --- | --- | --- |
| 1 | `IAL2-FEATURE-COMPLETENESS-FRONTIER.70` | `pending` | `.69` shipped generated beat-count/RLAST runtime validation; the remaining read-data and manager work now needs a selector before any further behavior changes. |
