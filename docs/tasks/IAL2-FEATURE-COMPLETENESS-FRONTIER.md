...
| --- | --- | --- | --- |
| 1 | `IAL2-FEATURE-COMPLETENESS-FRONTIER.36` | `pending` | `.35` shipped bounded auto-ID same-ID avoidance, so the next exact IAL2 feature-completeness slice must be selected before further behavior changes. |
