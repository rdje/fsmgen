...
| --- | --- | --- | --- |
| 1 | `IAL2-FEATURE-COMPLETENESS-FRONTIER.51` | `pending` | `.50` selected the additive `response-scope burst-last` plus one-bit `last-signal` contract; parser/report metadata and static validation must ship before generated behavior. |
