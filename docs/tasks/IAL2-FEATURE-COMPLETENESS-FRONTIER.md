...
| --- | --- | --- | --- |
| 1 | `IAL2-FEATURE-COMPLETENESS-FRONTIER.71` | `pending` | `.70` selected public multi-beat read-data reassembly/output contract selection before any parser, generator, HDL, sample, or validation behavior changes. |
