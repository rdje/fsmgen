...
| --- | --- | --- | --- |
| 1 | `IAL2-FEATURE-COMPLETENESS-FRONTIER.54` | `pending` | `.53` shipped generated burst-last/`RLAST` completion behavior; the next AXI manager feature-completeness owner must be selected before more behavior changes. |
