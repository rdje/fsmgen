...
| --- | --- | --- | --- |
| 1 | `IAL2-FEATURE-COMPLETENESS-FRONTIER.59` | `pending` | `.58` shipped parser/report metadata and static validation for last-beat read-data; generated last-beat capture behavior still needs a readiness audit before implementation. |
