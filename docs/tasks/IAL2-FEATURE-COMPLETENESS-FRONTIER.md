...
| --- | --- | --- | --- |
| 1 | `IAL2-FEATURE-COMPLETENESS-FRONTIER.65` | `pending` | `.64` selected a readiness audit before generated ARLEN burst-length capture to fix request-event/storage/report boundaries before behavior changes. |
