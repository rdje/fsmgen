...
| --- | --- | --- | --- |
| 1 | `IAL2-FEATURE-COMPLETENESS-FRONTIER.57` | `pending` | `.56` selected public burst read-data contract selection before parser/report metadata, generated behavior, per-ID queues, or broader manager work. |
