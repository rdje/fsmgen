...
| --- | --- | --- | --- |
| 1 | `IAL2-FEATURE-COMPLETENESS-FRONTIER.68` | `pending` | `.67` found the lower layers ready for generated validation but preserved `validation report-only` as no-runtime-check behavior; select the explicit public runtime-validation contract before parser/report metadata or behavior changes. |
