...
| --- | --- | --- | --- |
| 1 | `IAL2-FEATURE-COMPLETENESS-FRONTIER.58` | `pending` | `.57` selected explicit last-beat read-data parser/report metadata before generated capture behavior or full multi-beat reassembly. |
