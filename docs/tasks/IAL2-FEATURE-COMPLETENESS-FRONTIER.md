...
| --- | --- | --- | --- |
| 1 | `IAL2-FEATURE-COMPLETENESS-FRONTIER.56` | `pending` | `.55` aligned generated `RLAST` report prose; select the next public read-data/burst owner before more behavior changes. |
