...
| --- | --- | --- | --- |
| 1 | `IAL2-FEATURE-COMPLETENESS-FRONTIER.67` | `pending` | `.66` shipped raw ARLEN capture; audit expected-beat arithmetic and RLAST/missing/extra-beat validation before implementing counters, assertions, reassembly, or backend behavior. |
