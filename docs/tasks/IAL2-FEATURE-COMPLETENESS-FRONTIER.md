...
| --- | --- | --- | --- |
| 1 | `IAL2-FEATURE-COMPLETENESS-FRONTIER.62` | `pending` | `.61` selected public AXI burst read-data beat-count/depth contract selection as the next exact owner before full reassembly, per-beat outputs, RRESP aggregation, or per-ID queues. |
