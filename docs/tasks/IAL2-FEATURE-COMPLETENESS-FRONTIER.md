...
| --- | --- | --- | --- |
| 1 | `IAL2-FEATURE-COMPLETENESS-FRONTIER.55` | `pending` | `.54` found stale generated report prose after generated `RLAST` behavior; align report/static text before larger AXI manager feature work. |
