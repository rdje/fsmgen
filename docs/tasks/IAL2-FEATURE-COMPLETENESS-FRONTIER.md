...
| --- | --- | --- | --- |
| 1 | `IAL2-FEATURE-COMPLETENESS-FRONTIER.72` | `pending` | `.71` selected the public multi-beat read-data reassembly/output contract; parser/report metadata and static validation now own the next safe slice before generated storage or HDL behavior. |
