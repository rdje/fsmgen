...
| --- | --- | --- | --- |
| 1 | `IAL2-FEATURE-COMPLETENESS-FRONTIER.60` | `pending` | `.59` found no new IAL1/IAL0/SystemVerilog prerequisite; implement generated last-beat RDATA/RRESP capture behavior for the `.58` contract. |
