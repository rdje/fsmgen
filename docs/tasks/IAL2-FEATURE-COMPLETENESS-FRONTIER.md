...
| --- | --- | --- | --- |
| 1 | `IAL2-FEATURE-COMPLETENESS-FRONTIER.69` | `pending` | `.68` selected `(validation runtime-assertion)` / `runtime_assertion` and requires parser support plus generated runtime assertions to ship together so the public runtime-validation mode is behavior-bearing. |
