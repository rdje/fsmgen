...
| --- | --- | --- | --- |
| 1 | `R12-UPDATE-SHORTHAND-CORPUS-WIDENING.2` | `pending` | Focused tests already cover these update-shorthand failures; the maintained corpus does not yet carry them as stable support-accounting entries. |
...
| `R12-UPDATE-SHORTHAND-CORPUS-WIDENING.2` | `pending` | Implementation leaf pending. |
