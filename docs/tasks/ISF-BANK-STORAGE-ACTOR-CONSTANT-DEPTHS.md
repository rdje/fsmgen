...
| --- | --- | --- | --- |
| 1 | `ISF-BANK-STORAGE-ACTOR-CONSTANT-DEPTHS.2` | `pending` | `The bank-width constant tree is closed; implementation can now widen bank depth scalarization under task-tree ownership.` |
...
| --- | --- | --- |
| `ISF-BANK-STORAGE-ACTOR-CONSTANT-DEPTHS.1` | `this commit: ISF-BANK-STORAGE-ACTOR-CONSTANT-DEPTHS.1: select bank storage actor-constant depths` | `selects actor-constant bank storage depth support` |
| `ISF-BANK-STORAGE-ACTOR-CONSTANT-DEPTHS.2` | `pending` | `pending` |
