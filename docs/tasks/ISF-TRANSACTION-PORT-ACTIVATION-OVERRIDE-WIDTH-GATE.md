...
| --- | --- | --- | --- |
| 1 | `ISF-TRANSACTION-PORT-ACTIVATION-OVERRIDE-WIDTH-GATE.1` | `pending` | Selects the gate-widening slice before code change. |
| 2 | `ISF-TRANSACTION-PORT-ACTIVATION-OVERRIDE-WIDTH-GATE.2` | `pending` | Ships the validator gate and regression after `.1` lands. |
...
| --- | --- | --- | --- |
| `2026-05-27` | `ISF-TRANSACTION-PORT-ACTIVATION-OVERRIDE-WIDTH-GATE.1` | TBD | TBD |
| `2026-05-27` | `ISF-TRANSACTION-PORT-ACTIVATION-OVERRIDE-WIDTH-GATE.2` | TBD | TBD |

## Commit Log

| Leaf | Commit subject or reference | Notes |
| --- | --- | --- |
| `ISF-TRANSACTION-PORT-ACTIVATION-OVERRIDE-WIDTH-GATE.1` | `ISF-TRANSACTION-PORT-ACTIVATION-OVERRIDE-WIDTH-GATE.1: select transaction port activation-override width gate` | `pending commit hash` |
