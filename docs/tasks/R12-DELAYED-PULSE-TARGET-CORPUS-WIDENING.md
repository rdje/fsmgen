...
- ID: `R12-DELAYED-PULSE-TARGET-CORPUS-WIDENING.2`
  ...
  Verification: `perl -Iperl -c` for touched support/tests; focused delayed-pulse boundary tests; corpus accounting/behavior tests; manifest/check-json/semantic-json corpus gates; supported corpus gates; `git diff --check`; `mdbook build docs/book`
  Commit: `R12-DELAYED-PULSE-TARGET-CORPUS-WIDENING.2: widen delayed-pulse target corpus`

## Current Frontier

| Order | Leaf | Status | Why next |
| --- | --- | --- | --- |
| 1 | `closed` | `done` | `R12-DELAYED-PULSE-TARGET-CORPUS-WIDENING.2` shipped the selected delayed-pulse target corpus widening. |
...
| `2026-05-20` | `R12-DELAYED-PULSE-TARGET-CORPUS-WIDENING.2` | `perl -Iperl -c` for touched support/tests; focused delayed-pulse boundary tests; corpus accounting/behavior tests; manifest/check-json/semantic-json corpus gates; supported corpus gates; `git diff --check`; `mdbook build docs/book` | `passed` |
...
| `R12-DELAYED-PULSE-TARGET-CORPUS-WIDENING.2` | `R12-DELAYED-PULSE-TARGET-CORPUS-WIDENING.2: widen delayed-pulse target corpus` | Adds three maintained delayed-pulse LHS target expected-failure entries. |

## Changelog

- `2026-05-20`: Created task tree and selected the next implementation
  frontier.
- `2026-05-20`: Added maintained expected-failure entries for indexed,
  range-sliced, and pair-form indexed delayed-pulse LHS targets, then closed
  the tree.
