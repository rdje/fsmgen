# ISF-REPEAT-GENDO-BOUND-SPAWN-AFTER-DO-POST-AWAITANY: Bound Generated Do Then Spawn Then AwaitAny Before Drain

## Metadata

- Tree ID: `ISF-REPEAT-GENDO-BOUND-SPAWN-AFTER-DO-POST-AWAITANY`
- Status: `done`
- Roadmap lane: `R14`
- Created: `2026-05-26`
...
inside a top-level `when` body or top-level `switch` branch may run a bound
...
- Do not allow same-domain generated-do variants of do-then-spawn-then-
  `await_any`.
...
- `when`-contained and `switch`-contained nested repeat bodies accept the
  selected source shape: initial generated `(spawn ...)`, bound generated
  `(do child (params ...) (bind ...))`, later generated `(spawn ...)`,
...
- The generated do instance preserves its static generated-top parameter
  override and generated-top input/output binding handoffs.
...
- Existing rejection coverage for same-domain, prior-`await_any`,
...
- ID: `ISF-REPEAT-GENDO-BOUND-SPAWN-AFTER-DO-POST-AWAITANY`
  Status: `done`
  Goal: `Ship bound generated do followed by generated spawn, post-spawn await_any, and same-body drain.`
  Children: `ISF-REPEAT-GENDO-BOUND-SPAWN-AFTER-DO-POST-AWAITANY.1`

- ID: `ISF-REPEAT-GENDO-BOUND-SPAWN-AFTER-DO-POST-AWAITANY.1`
  Status: `done`
  Goal: `Implement and document the when/switch bound generated-do do-then-spawn post-await_any analogue.`
  Acceptance: `Focused when/switch coverage proves accepted lowering, generated do done ordering, parameter override and binding handoff preservation, later generated spawn scheduling, post-spawn await_any observation, and mandatory-drain semantics while same-domain, prior-await_any, and unsupported forms remain fail-closed.`
  ...
  Commit: `ISF-REPEAT-GENDO-BOUND-SPAWN-AFTER-DO-POST-AWAITANY.1: ship bound generated-do post-spawn awaitany`

## Current Frontier

| Order | Leaf | Status | Why next |
| --- | --- | --- | --- |
| 1 | `ISF-REPEAT-GENDO-BOUND-SPAWN-AFTER-DO-POST-AWAITANY.1` | `done` | Shipped the bound generated-do do-then-spawn post-`await_any` surface while keeping same-domain and prior-active-`await_any` variants deferred. |
...
| --- | --- | --- |
| `2026-05-26` | `ISF-REPEAT-GENDO-BOUND-SPAWN-AFTER-DO-POST-AWAITANY.1` | `perl -Iperl -c perl/FSM/Scheduler/ISF/LoweringIR.pm`; `perl -Iperl -c t/1215-isf-spawn-parameter-binding.t`; `prove -Iperl t/1215-isf-spawn-parameter-binding.t`; `perl -Iperl -c t/1305-isf-book-feature-matrix-audit.t`; `prove -Iperl t/1305-isf-book-feature-matrix-audit.t t/1250-isf-spec-focused-test-index-audit.t t/1144-isf-public-tested-by-metadata-audit.t`; `prove -Iperl t/1202-isf-repeat-clause-boundary.t t/1215-isf-spawn-parameter-binding.t t/1216-isf-generated-composition-top.t t/1255-isf-schedule-report-golden-matrix.t`; `./bin/ci-regression isf --no-book`; `mdbook build docs/book`; `git diff --check` | `pass`; focused t/1215 `Files=1, Tests=78`; book/public audits `Files=3, Tests=369`; broader repeat/child regression `Files=4, Tests=92`; ISF CI regression `Files=275, Tests=1818` |

## Commit Log

| Leaf | Commit subject or reference | Notes |
| --- | --- | --- |
| `ISF-REPEAT-GENDO-BOUND-SPAWN-AFTER-DO-POST-AWAITANY.1` | `ISF-REPEAT-GENDO-BOUND-SPAWN-AFTER-DO-POST-AWAITANY.1: ship bound generated-do post-spawn awaitany` | `pending commit` |

## Changelog

- `2026-05-26`: Created active R14 task tree and selected the bound
  generated-do do-then-spawn post-`await_any` before same-body `await_all`
  drain analogue.
- `2026-05-26`: Shipped the bound generated-do do-then-spawn post-spawn
