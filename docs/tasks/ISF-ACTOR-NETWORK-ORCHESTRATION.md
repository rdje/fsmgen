...
| --- | --- | --- | --- |
| 1 | `ISF-ACTOR-NETWORK-ORCHESTRATION.9.71` | `active` | `.9.70` hardened generated-handoff collisions around the generated-child route; the next leaf must select one bounded ATL widening or hardening slice before code. |
