...
| --- | --- | --- | --- |
| 1 | `ISF-ACTOR-NETWORK-ORCHESTRATION.9.77` | `active` | `.9.76` made generated-child route terms a precise mdBook support boundary; the next leaf must select one bounded ATL widening or hardening slice before code. |
