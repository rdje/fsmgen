...
| --- | --- | --- | --- |
| 1 | `ISF-ACTOR-NETWORK-ORCHESTRATION.9.11` | `active` | `.9.10` promoted the single-actor trigger/event wait fixture; the next ATL behavior must be selected before further implementation. |
