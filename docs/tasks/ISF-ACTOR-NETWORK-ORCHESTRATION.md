...
| --- | --- | --- | --- |
| 1 | `ISF-ACTOR-NETWORK-ORCHESTRATION.9.78` | `active` | `.9.77` selected ATL design-proposal synchronization so the live proposal reflects the latest route hardening and mdBook route-term support boundary. |
