...
| --- | --- | --- | --- |
| 1 | `ISF-ACTOR-NETWORK-ORCHESTRATION.9.91` | `active` | `.9.90` selected route source-expression boundary hardening while preserving dedicated book and handoff ATL concept anchors. |
