...
| --- | --- | --- | --- |
| 1 | `ISF-ACTOR-NETWORK-ORCHESTRATION.9.42` | `active` | `.9.41` selected scalar-width fail-closed hardening for generated-child actor-to-actor route endpoints before any wider payload work. |
