...
| --- | --- | --- | --- |
| 1 | `ISF-ACTOR-NETWORK-ORCHESTRATION.9.82` | `active` | `.9.81` selected an mdBook feature-support matrix truth sync after finding older backlog wording for generated-child actor-to-actor routes. |
