...
| --- | --- | --- | --- |
| 1 | `ISF-ACTOR-NETWORK-ORCHESTRATION.9.21` | `active` | `.9.20` shipped metadata-only qualified type resolution; select the next generated child/artifact or binding boundary before code. |
