...
| --- | --- | --- | --- |
| 1 | `ISF-ACTOR-NETWORK-ORCHESTRATION.9.66` | `active` | `.9.65` selected boundary-body simplicity hardening before activation-body samples or completion payloads are claimed. |
...
- No blocker for active `.9.66`. It must add only the selected
  boundary-body simplicity hardening before claiming activation-body samples,
  completion payloads, local setup/cleanup, route continuation, storage,
