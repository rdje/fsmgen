...
| --- | --- | --- | --- |
| 1 | `ISF-ACTOR-NETWORK-ORCHESTRATION.9.83` | `active` | `.9.82` synchronized the mdBook feature-support matrix with the shipped generated-child actor-to-actor route and explicit non-support boundaries. |
