...
| --- | --- | --- | --- |
| 1 | `ISF-ACTOR-NETWORK-ORCHESTRATION.9.76` | `active` | `.9.75` selected a mdBook precision pass so generated-child route terms become a term-by-term support boundary rather than only prose markers. |
