...
| --- | --- | --- | --- |
| 1 | `ISF-ACTOR-NETWORK-ORCHESTRATION.9.74` | `active` | `.9.73` selected a mdBook route-term audit so the dedicated generated-child route terminology section cannot drift out of the user-facing book. |
