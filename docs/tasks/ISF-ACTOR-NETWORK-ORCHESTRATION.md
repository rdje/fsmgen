...
| --- | --- | --- | --- |
| 1 | `ISF-ACTOR-NETWORK-ORCHESTRATION.9.84` | `active` | `.9.83` selected a docs/audit sync for remaining stale reserved-route wording in the composition chapter, downstream handoff, and backlog. |
