...
| 10 | `.10` | `pending` | Exhaustion audit / close-out for any remaining deeper combinations. |
...
| `.9` | `ISF-NESTED-CROSS-DOMAIN-ACTIVATION.9: nested when-repeat cross-domain do` | `implementation slice` |
