...
- ID: `ISF-TYPE-AGGREGATE-PARITY.34`
  Status: `pending`
  Goal: `choose the next remaining enum or aggregate value/update context after named drive body aggregate RHS values`
...
| --- | --- | --- | --- |
| 1 | `ISF-TYPE-AGGREGATE-PARITY.34` | `pending` | The next enum or aggregate value/update context can be selected after named drive body aggregate RHS values are stable. |
...
- Which enum or aggregate value/update context should ship after named drive
  body aggregate RHS values? The current frontier selects this for
