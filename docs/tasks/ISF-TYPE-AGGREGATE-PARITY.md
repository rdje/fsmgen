...
- ID: `ISF-TYPE-AGGREGATE-PARITY.33`
  Status: `pending`
  Goal: `choose the next remaining enum or aggregate value/update context after transaction condition aggregate expression operands`
...
| --- | --- | --- | --- |
| 1 | `ISF-TYPE-AGGREGATE-PARITY.33` | `pending` | The next enum or aggregate value/update context can be selected after transaction condition aggregate expression operands are stable. |
...
- Which enum or aggregate value/update context should ship after transaction
  condition aggregate expression operands? The current frontier selects this
  for `ISF-TYPE-AGGREGATE-PARITY.33`.
