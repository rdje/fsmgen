...
- ID: `HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE.17.2.4.2`
  ...
  Verification: `ArchitectureScaleExecutionGraph now owns binding, topology, fiber, type, map, random/replay, and exact one-/four-MiB plan candidates. The exact plans use the frozen checked-AHB route and unchanged public binder: 2,974/12,166 genuine resets plus referenced semantic scenario/endpoint names produce exactly 1,048,576/4,194,304 canonical bytes. The four-MiB qualification contains one scenario/root-live fiber, seven types, 22 bindings, six events, and 12,183 unique maps; endpoint alias ready_out_q remains live through coverpoint ready_sampled on the real HREADYOUT binding. Source/SemanticIR/bridge/workload/plan identities, reset topology, source spans, public capability isolation, mutation rejection, and unfinished-level closure are frozen. Paired focused t1609/t1610 and the guarded 13-file/59-test impact matrix pass. Earlier binding/topology/fiber/type/map/random evidence remains unchanged. The leaf remains active for the exact sixteen-MiB plan, higher random levels, final qualification, and cleanup slices; no public capability/support or capacity claim changes.`
  Commit: `HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE.17.2.4.2: generate exact four-MiB execution plan`
