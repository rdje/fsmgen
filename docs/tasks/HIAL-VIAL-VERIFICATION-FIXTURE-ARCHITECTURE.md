...
- ID: `HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE.17.2.5.2.6`
  ...
  Verification: `Clean fault predecessor be6878984 completes all four fault shapes and leaves the workspace handoff-ready. Decision 0073 and the existing checking-state contract select .17.2.5.2.6 alone for the compact Boolean random-occurrence renderer, exact 1,024 accepted generated/replayed gate, 32,768 full-route plan rejection, RAM-guarded 8,440/8,441 adjacent plan boundary, preflight-dominated 65,536 outcome, and exact 65,537 random-occurrence rejection, with keyed-value/replay identity, mutation, deterministic rerun, and same-volume cleanup proofs. Task index, bounded Memory, mdBook, and Knowledge Map fact agree on this frontier; final qualification remains proposed. Activation changes no code, test, config, generated artifact, parser, IR, evaluator, backend, support, performance, capacity, or product behavior.`
  Commit: `HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE.17.2.5.2.6: activate random and replay checking`
