...
- ID: `HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE.17.2.6`
  ...
  Verification: `Decision 0075 closes read-only selection .1 with one checked-AHB anchored operation recipe and profile-local outcomes. Portable SV accepts T=21/1,024/4,096/6,319 and rejects 6,320 at the 16-MiB source cap. Portable VHDL and OSVVM select T=21/128/512/29,508 and adjacent portable-foundation rejection at 29,509, subject to separately owned validator, provider, and source-map repairs. Native UVM accepts only its T=21 selected gallery; T=22 is the adjacent unsupported shape and must fail negotiation before artifact creation. Five repair slices under proposed .2 precede generator .3; no behavior changes in selection.`
...
- ID: `HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE.17.2.6.2`
  ...
  Verification: `Clean selection predecessor 0a3a2a05f activates this repair parent and decomposes decision 0075's five defects without changing implementation. Child .1 is complete through clean commit c3810ba8a: one-pass metadata and source-line indexes preserve exact T=21/128/512 output and validate accepted T=29,508 twice inside the selected ceiling while T=29,509 retains exact atomic rejection. Child .2 alone is now active for one sealed reusable OSVVM provider-verification result; map translation, native-UVM negotiation, and family qualification remain ordered proposed siblings.`
...
- ID: `HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE.17.2.6.2.2`
  ...
  Verification: `Clean portable-VHDL predecessor c3810ba8a activates this leaf alone. Implementation must first capture RED evidence for repeated recursive verification, then seal one exact result to the matching provider/source identity and evaluation without admitting caller-forged or cross-evaluation reuse. No implementation or product behavior changes in activation.`
  Commit: `HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE.17.2.6.2.2: activate sealed OSVVM provider verification`
...
source-map anchoring plus the accepted boundary proof; `.17.2.6.2.2` alone is
active for reusable sealed OSVVM provider verification.
