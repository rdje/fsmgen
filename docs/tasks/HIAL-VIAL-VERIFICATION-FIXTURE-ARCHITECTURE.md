...
- ID: `HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE.17.2.5.2.5`
  ...
  Verification: `Clean coverage predecessor 4af387042 completes all eight coverage shapes and leaves the workspace handoff-ready. Decisions 0072 and 0073 plus the existing checking-state contract select .17.2.5.2.5 alone for the 32/1,024/4,096 accepted fault ladder, exact 4,097 resource rejection, arm/apply/expire/restoration semantics, reinjection/overlap/mutation negatives, deterministic rerun, and same-volume cleanup. Task index, bounded Memory, mdBook, and Knowledge Map fact agree on this frontier; random/replay and final qualification remain proposed. Activation changes no code, test, config, generated artifact, parser, IR, evaluator, backend, support, performance, capacity, or product behavior.`
  Commit: `HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE.17.2.5.2.5: activate fault checking ladders`
