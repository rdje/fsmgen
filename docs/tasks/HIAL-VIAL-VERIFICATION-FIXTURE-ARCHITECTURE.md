...
- ID: `HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE.17.2.5.2.4`
  ...
  Verification: `Clean scoreboard predecessor 416c79473 owns and verifies all eight scoreboard shapes. This documentation-only transition activates .17.2.5.2.4 alone for decision-0073 reachable coverpoint/static-domain source recipes, decision-0072 envelope outcomes, exact packed hit vectors, illegal/ignore/order negatives, deterministic rerun, and same-volume cleanup. Fault, random/replay, and final qualification siblings remain proposed; no code, test, config, generated artifact, parser, IR, evaluator, backend, support, performance, capacity, or product behavior changes in activation.`
  Commit: `HIAL-VIAL-VERIFICATION-FIXTURE-ARCHITECTURE.17.2.5.2.4: activate coverage checking ladders`
