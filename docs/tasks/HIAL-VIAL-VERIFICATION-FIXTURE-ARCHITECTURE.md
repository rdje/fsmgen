...
source-map anchoring plus the accepted boundary proof; completed `.17.2.6.2.2`
now provides callback-scoped sealed OSVVM provider verification. Source-map
translation `.17.2.6.2.3` is the next clean activation.
