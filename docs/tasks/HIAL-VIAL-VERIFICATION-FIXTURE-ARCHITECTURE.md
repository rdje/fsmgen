...
to `.17.4`. Its remaining slices are the binding, type, and map levels, final
qualification, and cleanup, after which proposed `.17.2.5` through `.17.2.7`
and measurement `.17.3` follow.
