...
execution-type levels, the source-map levels, final qualification, and cleanup
follow, after which proposed `.17.2.5` through `.17.2.7` and measurement `.17.3`
come next.
