...
routed to `.17.4`. `.17.2.4.2` is unblocked and owns implementation, final
qualification, and cleanup, after which proposed `.17.2.5` through `.17.2.7` and
measurement `.17.3` come next.
