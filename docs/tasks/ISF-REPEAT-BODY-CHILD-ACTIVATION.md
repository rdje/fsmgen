...
- ID: `ISF-REPEAT-BODY-CHILD-ACTIVATION.77`
  Status: `done`
  Goal: `Select the next repeat-body child activation subset.`
  Acceptance: `Task tree, roadmap, and book backlog select top-level when-body nested repeat local '(do child)' after a prior multi-pending '(await_any done)' observation as the next bounded implementation subset; the selected source shape is a repeat directly inside a top-level when body with multiple generated '(spawn child as inst [(params ...)] [(bind ...)] [(domain NAME)])' sites, then '(await_any done)', then local '(do child)' while those generated spawns remain pending, and then a later same-body '(await_all done)' drain before the nested repeat check can loop; generated do after prior multi-pending await_any, switch-contained analogue, await_any after the do, new spawn after the do before drain, cross-domain activation, deeper branch/loop nesting, and broader outstanding-child semantics remain deferred.`
  Verification: `mdbook build docs/book; prove -l t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t Files=2, Tests=242; git diff --check`
  Commit: `ISF-REPEAT-BODY-CHILD-ACTIVATION.77: select when repeat local do after await_any`

- ID: `ISF-REPEAT-BODY-CHILD-ACTIVATION.78`
  Status: `done`
  Goal: `Ship when-body nested repeat local do after prior multi-pending await_any before mandatory await_all drain if selected.`
  Acceptance: `Top-level when bodies accept nested '(repeat COUNT ... (spawn child as a ...) (spawn child as b ...) (await_any done) (do local_child) (await_all done) ...)' only when the do target is local to the parent scheduled module and a later same-body await_all drains every outstanding generated nested spawn before the nested repeat check can loop; lowering keeps the generated-spawn done set live after await_any and through the local do, waits for the local child's fresh done pulse, preserves source-order samples around spawn/await_any/do/await_all, and keeps generated do after prior multi-pending await_any, switch-contained analogue, await_any after the do, new spawn after the do before drain, cross-domain activation, deeper branch/loop nesting, and broader outstanding-child semantics fail-closed.`
  Verification: `syntax checks; touched repeat/spawn test Files=1, Tests=41; touched repeat/spawn/doc checks Files=4, Tests=428; focused activation/domain/doc suite Files=13, Tests=470; mdbook build docs/book; ./bin/ci-regression isf --no-book Files=227, Tests=1241; git diff --check`
  Commit: `ISF-REPEAT-BODY-CHILD-ACTIVATION.78: implement when repeat local do after await_any`

- ID: `ISF-REPEAT-BODY-CHILD-ACTIVATION.79`
  Status: `done`
  Goal: `Select the next repeat-body child activation subset.`
  Acceptance: `Task tree, roadmap, and book backlog select top-level switch-branch nested repeat local '(do child)' after a prior multi-pending '(await_any done)' observation as the next bounded implementation subset; the selected source shape is a repeat directly inside a top-level switch branch with multiple generated '(spawn child as inst [(params ...)] [(bind ...)] [(domain NAME)])' sites, then '(await_any done)', then local '(do child)' while those generated spawns remain pending, and then a later same-body '(await_all done)' drain before the nested repeat check can loop; generated do after prior multi-pending await_any, await_any after the do, new spawn after the do before drain, cross-domain activation, deeper branch/loop nesting, and broader outstanding-child semantics remain deferred.`
  Verification: `mdbook build docs/book; prove -l t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t Files=2, Tests=247; git diff --check`
  Commit: `ISF-REPEAT-BODY-CHILD-ACTIVATION.79: select switch repeat local do after await_any`

- ID: `ISF-REPEAT-BODY-CHILD-ACTIVATION.80`
  Status: `done`
  Goal: `Ship switch-branch nested repeat local do after prior multi-pending await_any before mandatory await_all drain if selected.`
  Acceptance: `Top-level switch branches accept nested '(repeat COUNT ... (spawn child as a ...) (spawn child as b ...) (await_any done) (do local_child) (await_all done) ...)' only when the do target is local to the parent scheduled module and a later same-body await_all drains every outstanding generated nested spawn before the nested repeat check can loop; lowering keeps the generated-spawn done set live after await_any and through the local do, waits for the local child's fresh done pulse, preserves source-order samples around spawn/await_any/do/await_all, and keeps generated do after prior multi-pending await_any, await_any after the do, new spawn after the do before drain, cross-domain activation, deeper branch/loop nesting, and broader outstanding-child semantics fail-closed.`
  Verification: `syntax checks; touched repeat/spawn test Files=1, Tests=42; touched repeat/spawn/doc checks Files=4, Tests=434; focused activation/domain/doc suite Files=13, Tests=476; mdbook build docs/book; ./bin/ci-regression isf --no-book Files=227, Tests=1247; git diff --check`
  Commit: `ISF-REPEAT-BODY-CHILD-ACTIVATION.80: implement switch repeat local do after await_any`

- ID: `ISF-REPEAT-BODY-CHILD-ACTIVATION.81`
  Status: `done`
  Goal: `Select the next repeat-body child activation subset.`
  Acceptance: `Task tree, roadmap, and book backlog select top-level when-body nested repeat plain generated-child '(do child)' after a prior multi-pending '(await_any done)' observation as the next bounded implementation subset; the selected source shape is a repeat directly inside a top-level when body with multiple generated '(spawn child as inst [(params ...)] [(bind ...)] [(domain NAME)])' sites, then '(await_any done)', then plain generated-child '(do child)' for a target already emitted as a generated child by another activation site, and then a later same-body '(await_all done)' drain before the nested repeat check can loop; parameterized, bound, or domain-qualified generated do after prior multi-pending await_any, switch-contained analogue, await_any after the do, new spawn after the do before drain, cross-domain activation, deeper branch/loop nesting, and broader outstanding-child semantics remain deferred.`
  Verification: `mdbook build docs/book; prove -l t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t Files=2, Tests=252; git diff --check`
  Commit: `ISF-REPEAT-BODY-CHILD-ACTIVATION.81: select when repeat generated-child do after await_any`

- ID: `ISF-REPEAT-BODY-CHILD-ACTIVATION.82`
  Status: `done`
  Goal: `Ship when-body nested repeat generated-child do after prior multi-pending await_any before mandatory await_all drain if selected.`
  Acceptance: `Top-level when bodies accept nested '(repeat COUNT ... (spawn child as a ...) (spawn child as b ...) (await_any done) (do generated_child) (await_all done) ...)' only when the plain do target is already emitted as a generated child by another activation site and a later same-body await_all drains every outstanding generated nested spawn before the nested repeat check can loop; lowering keeps the generated-spawn done set live after await_any and through the generated-child do, waits for the generated do instance's fresh done handoff, preserves source-order samples around spawn/await_any/do/await_all, and keeps parameterized, bound, or domain-qualified generated do after prior multi-pending await_any, switch-contained analogue, await_any after the do, new spawn after the do before drain, cross-domain activation, deeper branch/loop nesting, and broader outstanding-child semantics fail-closed.`
  Verification: `syntax checks; touched repeat/spawn test Files=1, Tests=43; touched repeat/spawn/doc checks Files=4, Tests=440; focused activation/domain/doc suite Files=13, Tests=482; mdbook build docs/book; ./bin/ci-regression isf --no-book Files=227, Tests=1253; git diff --check`
  Commit: `ISF-REPEAT-BODY-CHILD-ACTIVATION.82: implement when repeat generated-child do after await_any`

- ID: `ISF-REPEAT-BODY-CHILD-ACTIVATION.83`
  Status: `done`
  Goal: `Select the next repeat-body child activation subset.`
  Acceptance: `Task tree, roadmap, and book backlog select top-level switch-branch nested repeat plain generated-child '(do child)' after a prior multi-pending '(await_any done)' observation as the next bounded implementation subset; the selected source shape is a repeat directly inside a top-level switch branch with multiple generated '(spawn child as inst [(params ...)] [(bind ...)] [(domain NAME)])' sites, then '(await_any done)', then plain generated-child '(do child)' for a target already emitted as a generated child by another activation site, and then a later same-body '(await_all done)' drain before the nested repeat check can loop; parameterized, bound, or domain-qualified generated do after prior multi-pending await_any, await_any after the do, new spawn after the do before drain, cross-domain activation, deeper branch/loop nesting, and broader outstanding-child semantics remain deferred.`
  Verification: `mdbook build docs/book; prove -l t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t Files=2, Tests=257; git diff --check`
  Commit: `ISF-REPEAT-BODY-CHILD-ACTIVATION.83: select switch repeat generated-child do after await_any`

- ID: `ISF-REPEAT-BODY-CHILD-ACTIVATION.84`
  Status: `done`
  Goal: `Ship switch-branch nested repeat generated-child do after prior multi-pending await_any before mandatory await_all drain if selected.`
  Acceptance: `Top-level switch branches accept nested '(repeat COUNT ... (spawn child as a ...) (spawn child as b ...) (await_any done) (do generated_child) (await_all done) ...)' only when the plain do target is already emitted as a generated child by another activation site and a later same-body await_all drains every outstanding generated nested spawn before the nested repeat check can loop; lowering keeps the generated-spawn done set live after await_any and through the generated-child do, waits for the generated do instance's fresh done handoff, preserves source-order samples around spawn/await_any/do/await_all, and keeps parameterized, bound, or domain-qualified generated do after prior multi-pending await_any, await_any after the do, new spawn after the do before drain, cross-domain activation, deeper branch/loop nesting, and broader outstanding-child semantics fail-closed.`
  Verification: `syntax checks; touched repeat/spawn test Files=1, Tests=44; touched repeat/spawn/doc checks Files=4, Tests=446; focused activation/domain/doc suite Files=13, Tests=488; mdbook build docs/book; ./bin/ci-regression isf --no-book Files=227, Tests=1259; git diff --check`
  Commit: `ISF-REPEAT-BODY-CHILD-ACTIVATION.84: implement switch repeat generated-child do after await_any`

- ID: `ISF-REPEAT-BODY-CHILD-ACTIVATION.85`
  Status: `done`
  Goal: `Select the next repeat-body child activation subset.`
  Acceptance: `Task tree, roadmap, and book backlog select top-level when-body nested repeat generated blocking '(do child (params ...))' after a prior multi-pending '(await_any done)' observation as the next bounded implementation subset; the selected source shape is a repeat directly inside a top-level when body with multiple generated '(spawn child as inst [(params ...)] [(bind ...)] [(domain NAME)])' sites, then '(await_any done)', then static-parameter generated '(do child (params ...))' while those generated spawns remain pending, and then a later same-body '(await_all done)' drain before the nested repeat check can loop; bind handoffs, domain metadata, the switch-contained analogue, await_any after the do, new spawn after the do before drain, cross-domain activation, deeper branch/loop nesting, and broader outstanding-child semantics remain deferred.`
  Verification: `mdbook build docs/book; prove -l t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t Files=2, Tests=262; git diff --check`
  Commit: `ISF-REPEAT-BODY-CHILD-ACTIVATION.85: select when repeat parameterized do after await_any`

- ID: `ISF-REPEAT-BODY-CHILD-ACTIVATION.86`
  Status: `done`
  Goal: `Ship when-body nested repeat static-parameter generated do after prior multi-pending await_any before mandatory await_all drain if selected.`
  Acceptance: `Top-level when bodies accept nested '(repeat COUNT ... (spawn child as a ...) (spawn child as b ...) (await_any done) (do generated_child (params ...)) (await_all done) ...)' only when the generated do uses static parameter overrides and a later same-body await_all drains every outstanding generated nested spawn before the nested repeat check can loop; lowering keeps the generated-spawn done set live after await_any and through the generated do, applies the generated do instance's static parameter overrides once in the generated top, waits for that generated do instance's fresh done handoff, preserves source-order samples around spawn/await_any/do/await_all, and keeps bind handoffs, domain metadata, the switch-contained analogue, await_any after the do, new spawn after the do before drain, cross-domain activation, deeper branch/loop nesting, and broader outstanding-child semantics fail-closed.`
  Verification: `syntax checks; touched repeat/spawn test Files=1, Tests=45; touched repeat/spawn/doc checks Files=4, Tests=452; focused activation/domain/doc suite Files=13, Tests=494; mdbook build docs/book; ./bin/ci-regression isf --no-book Files=227, Tests=1265; git diff --check`
  Commit: `ISF-REPEAT-BODY-CHILD-ACTIVATION.86: implement when repeat parameterized do after await_any`

- ID: `ISF-REPEAT-BODY-CHILD-ACTIVATION.87`
  Status: `done`
  Goal: `Select the next repeat-body child activation subset.`
  Acceptance: `Task tree, roadmap, and book backlog select top-level switch-branch nested repeat generated blocking '(do child (params ...))' after a prior multi-pending '(await_any done)' observation as the next bounded implementation subset; the selected source shape is a repeat directly inside a top-level switch branch with multiple generated '(spawn child as inst [(params ...)] [(bind ...)] [(domain NAME)])' sites, then '(await_any done)', then static-parameter generated '(do child (params ...))' while those generated spawns remain pending, and then a later same-body '(await_all done)' drain before the nested repeat check can loop; bind handoffs, domain metadata, await_any after the do, new spawn after the do before drain, cross-domain activation, deeper branch/loop nesting, and broader outstanding-child semantics remain deferred.`
  Verification: `mdbook build docs/book; prove -l t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t Files=2, Tests=267; git diff --check`
  Commit: `ISF-REPEAT-BODY-CHILD-ACTIVATION.87: select switch repeat parameterized do after await_any`

- ID: `ISF-REPEAT-BODY-CHILD-ACTIVATION.88`
  Status: `done`
  Goal: `Ship switch-branch nested repeat static-parameter generated do after prior multi-pending await_any before mandatory await_all drain if selected.`
  Acceptance: `Top-level switch branches accept nested '(repeat COUNT ... (spawn child as a ...) (spawn child as b ...) (await_any done) (do generated_child (params ...)) (await_all done) ...)' only when the generated do uses static parameter overrides and a later same-body await_all drains every outstanding generated nested spawn before the nested repeat check can loop; lowering keeps the generated-spawn done set live after await_any and through the generated do, applies the generated do instance's static parameter overrides once in the generated top, waits for that generated do instance's fresh done handoff, preserves source-order samples around spawn/await_any/do/await_all, and keeps bind handoffs, domain metadata, await_any after the do, new spawn after the do before drain, cross-domain activation, deeper branch/loop nesting, and broader outstanding-child semantics fail-closed.`
  Verification: `syntax checks; touched repeat/spawn test Files=1, Tests=46; touched repeat/spawn/doc checks Files=4, Tests=458; focused activation/domain/doc suite Files=13, Tests=500; mdbook build docs/book; ./bin/ci-regression isf --no-book Files=227, Tests=1271; git diff --check`
  Commit: `ISF-REPEAT-BODY-CHILD-ACTIVATION.88: implement switch repeat parameterized do after await_any`

- ID: `ISF-REPEAT-BODY-CHILD-ACTIVATION.89`
  Status: `done`
  Goal: `Select the next repeat-body child activation subset.`
  Acceptance: `Task tree, roadmap, and book backlog select top-level when-body nested repeat generated blocking '(do child (params ...) (bind ...))' after a prior multi-pending '(await_any done)' observation as the next bounded implementation subset; the selected source shape is a repeat directly inside a top-level when body with multiple generated '(spawn child as inst [(params ...)] [(bind ...)] [(domain NAME)])' sites, then '(await_any done)', then static-parameter generated '(do child (params ...) (bind ...))' while those generated spawns remain pending, and then a later same-body '(await_all done)' drain before the nested repeat check can loop; domain metadata, the switch-contained bound analogue, await_any after the do, new spawn after the do before drain, cross-domain activation, deeper branch/loop nesting, and broader outstanding-child semantics remain deferred.`
  Verification: `mdbook build docs/book; prove -l t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t Files=2, Tests=272; git diff --check`
  Commit: `ISF-REPEAT-BODY-CHILD-ACTIVATION.89: select when repeat bound do after await_any`

- ID: `ISF-REPEAT-BODY-CHILD-ACTIVATION.90`
  Status: `done`
  Goal: `Ship when-body nested repeat bound generated do after prior multi-pending await_any before mandatory await_all drain if selected.`
  Acceptance: `Top-level when bodies accept nested '(repeat COUNT ... (spawn child as a ...) (spawn child as b ...) (await_any done) (do generated_child (params ...) (bind ...)) (await_all done) ...)' only when the generated do uses static parameter overrides plus generated-top input/output binding handoffs and a later same-body await_all drains every outstanding generated nested spawn before the nested repeat check can loop; lowering keeps the generated-spawn done set live after await_any and through the generated do, applies static parameter overrides and binding handoffs once for the generated do instance in the generated top, waits for that generated do instance's fresh done handoff, preserves source-order samples around spawn/await_any/do/await_all, and keeps domain metadata, the switch-contained bound analogue, await_any after the do, new spawn after the do before drain, cross-domain activation, deeper branch/loop nesting, and broader outstanding-child semantics fail-closed.`
  Verification: `syntax checks; touched repeat/spawn test Files=1, Tests=47; touched repeat/spawn/doc checks Files=4, Tests=464; focused activation/domain/doc suite Files=13, Tests=506; mdbook build docs/book; ./bin/ci-regression isf --no-book Files=227, Tests=1277; git diff --check`
  Commit: `ISF-REPEAT-BODY-CHILD-ACTIVATION.90: implement when repeat bound do after await_any`

- ID: `ISF-REPEAT-BODY-CHILD-ACTIVATION.91`
  Status: `done`
  Goal: `Select the next repeat-body child activation subset.`
  Acceptance: `Task tree, roadmap, and book backlog select the switch-contained bound generated-do after prior multi-pending await_any analogue as the next bounded implementation subset; the selected source shape is a repeat directly inside a top-level switch branch with multiple generated '(spawn child as inst [(params ...)] [(bind ...)] [(domain NAME)])' sites, then '(await_any done)', then static-parameter generated '(do child (params ...) (bind ...))' while those generated spawns remain pending, and then a later same-body '(await_all done)' drain before the nested repeat check can loop; domain metadata after prior await_any, await_any after the do, new spawn after the do before drain, cross-domain activation, deeper branch/loop nesting, and broader outstanding-child semantics remain deferred.`
  Verification: `mdbook build docs/book; prove -l t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t Files=2, Tests=277; git diff --check`
  Commit: `ISF-REPEAT-BODY-CHILD-ACTIVATION.91: select switch repeat bound do after await_any`

- ID: `ISF-REPEAT-BODY-CHILD-ACTIVATION.92`
  Status: `done`
  Goal: `Ship switch-branch nested repeat bound generated do after prior multi-pending await_any before mandatory await_all drain if selected.`
  Acceptance: `Top-level switch branches accept nested '(repeat COUNT ... (spawn child as a ...) (spawn child as b ...) (await_any done) (do generated_child (params ...) (bind ...)) (await_all done) ...)' only when the generated do uses static parameter overrides plus generated-top input/output binding handoffs and a later same-body await_all drains every outstanding generated nested spawn before the nested repeat check can loop; lowering keeps the generated-spawn done set live after await_any and through the generated do, applies static parameter overrides and binding handoffs once for the generated do instance in the generated top, waits for that generated do instance's fresh done handoff, preserves source-order samples around spawn/await_any/do/await_all, and keeps domain metadata after prior await_any, await_any after the do, new spawn after the do before drain, cross-domain activation, deeper branch/loop nesting, and broader outstanding-child semantics fail-closed.`
  Verification: `syntax checks; touched repeat/spawn test Files=1, Tests=48; touched repeat/spawn/doc checks Files=4, Tests=470; focused activation/domain/doc suite Files=13, Tests=512; mdbook build docs/book; ./bin/ci-regression isf --no-book Files=227, Tests=1283; git diff --check`
  Commit: `ISF-REPEAT-BODY-CHILD-ACTIVATION.92: implement switch repeat bound do after await_any`

- ID: `ISF-REPEAT-BODY-CHILD-ACTIVATION.93`
  Status: `done`
  Goal: `Select the next repeat-body child activation subset.`
  Acceptance: `Task tree, roadmap, and book backlog select top-level when-body nested repeat generated blocking '(do child (params ...) [(bind ...)] (domain NAME))' after a prior multi-pending '(await_any done)' observation as the next bounded implementation subset; the selected source shape is a repeat directly inside a top-level when body with multiple generated '(spawn child as inst [(params ...)] [(bind ...)] [(domain NAME)])' sites, then '(await_any done)', then same-domain static-parameter generated '(do child (params ...) [(bind ...)] (domain NAME))' while those generated spawns remain pending, and then a later same-body '(await_all done)' drain before the nested repeat check can loop; the selected contract records declared same-domain ownership metadata for the deterministic generated do instance and generated child instances without implying CDC or cross-domain activation; the switch-contained domain analogue, await_any after the do, new spawn after the do before drain, cross-domain activation, deeper branch/loop nesting, and broader outstanding-child semantics remain deferred.`
  Verification: `mdbook build docs/book; prove -l t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t Files=2, Tests=282; git diff --check`
  Commit: `ISF-REPEAT-BODY-CHILD-ACTIVATION.93: select when repeat domain do after await_any`

- ID: `ISF-REPEAT-BODY-CHILD-ACTIVATION.94`
  Status: `done`
  Goal: `Ship when-body nested repeat same-domain generated do after prior multi-pending await_any before mandatory await_all drain if selected.`
  Acceptance: `Top-level when bodies accept nested '(repeat COUNT ... (spawn child as a ...) (spawn child as b ...) (await_any done) (do generated_child (params ...) [(bind ...)] (domain NAME)) (await_all done) ...)' only when NAME is the declared same-domain owner for the parent transaction and generated children, the generated do uses static parameter overrides plus optional generated-top input/output binding handoffs, and a later same-body await_all drains every outstanding generated nested spawn before the nested repeat check can loop; lowering keeps the generated-spawn done set live after await_any and through the generated do, records same-domain metadata for the generated do instance in generated-composition and schedule-report clock-domain summaries, waits for that generated do instance's fresh done handoff, preserves source-order samples around spawn/await_any/do/await_all, and keeps the switch-contained domain analogue, await_any after the do, new spawn after the do before drain, cross-domain activation, deeper branch/loop nesting, and broader outstanding-child semantics fail-closed.`
  Verification: `syntax checks; touched repeat/spawn test Files=1, Tests=49; touched repeat/spawn/doc checks Files=4, Tests=475; focused activation/domain/doc suite Files=13, Tests=517; mdbook build docs/book; ./bin/ci-regression isf --no-book Files=227, Tests=1288; git diff --check`
  Commit: `ISF-REPEAT-BODY-CHILD-ACTIVATION.94: implement when repeat domain do after await_any`

- ID: `ISF-REPEAT-BODY-CHILD-ACTIVATION.95`
  Status: `done`
  Goal: `Select the next repeat-body child activation subset.`
  Acceptance: `Task tree, roadmap, and book backlog select top-level switch-branch nested repeat generated blocking '(do child (params ...) [(bind ...)] (domain NAME))' after a prior multi-pending '(await_any done)' observation as the next bounded implementation subset; the selected source shape is a repeat directly inside a top-level switch branch with multiple generated '(spawn child as inst [(params ...)] [(bind ...)] [(domain NAME)])' sites, then '(await_any done)', then same-domain static-parameter generated '(do child (params ...) [(bind ...)] (domain NAME))' while those generated spawns remain pending, and then a later same-body '(await_all done)' drain before the nested repeat check can loop; the selected contract mirrors the shipped when-contained domain proof and records declared same-domain ownership metadata for the deterministic generated do instance and generated child instances without implying CDC or cross-domain activation; await_any after the do, new spawn after the do before drain, cross-domain activation, deeper branch/loop nesting, and broader outstanding-child semantics remain deferred.`
  Verification: `mdbook build docs/book; prove -l t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t Files=2, Tests=286; git diff --check`
  Commit: `ISF-REPEAT-BODY-CHILD-ACTIVATION.95: select switch repeat domain do after await_any`

- ID: `ISF-REPEAT-BODY-CHILD-ACTIVATION.96`
  Status: `done`
  Goal: `Ship switch-branch nested repeat same-domain generated do after prior multi-pending await_any before mandatory await_all drain if selected.`
  Acceptance: `Top-level switch branches accept nested '(repeat COUNT ... (spawn child as a ...) (spawn child as b ...) (await_any done) (do generated_child (params ...) [(bind ...)] (domain NAME)) (await_all done) ...)' only when NAME is the declared same-domain owner for the parent transaction and generated children, the generated do uses static parameter overrides plus optional generated-top input/output binding handoffs, and a later same-body await_all drains every outstanding generated nested spawn before the nested repeat check can loop; lowering keeps the generated-spawn done set live after await_any and through the generated do, records same-domain metadata for the generated do instance in generated-composition and schedule-report clock-domain summaries, waits for that generated do instance's fresh done handoff, preserves source-order samples around spawn/await_any/do/await_all, and keeps await_any after the do, new spawn after the do before drain, cross-domain activation, deeper branch/loop nesting, and broader outstanding-child semantics fail-closed.`
  Verification: `syntax checks; touched repeat/spawn test Files=1, Tests=50; touched repeat/spawn/doc checks Files=4, Tests=480; focused activation/domain/doc suite Files=13, Tests=522; mdbook build docs/book; ./bin/ci-regression isf --no-book Files=227, Tests=1293; git diff --check`
  Commit: `ISF-REPEAT-BODY-CHILD-ACTIVATION.96: implement switch repeat domain do after await_any`

- ID: `ISF-REPEAT-BODY-CHILD-ACTIVATION.97`
  Status: `done`
  Goal: `Select the next repeat-body child activation subset.`
  Acceptance: `Task tree, roadmap, and book backlog select top-level when-body nested repeat local '(do child)' followed by post-do multi-pending '(await_any done)' and then mandatory same-body '(await_all done)' as the next bounded implementation subset; the selected source shape is a repeat directly inside a top-level when body with multiple generated '(spawn child as inst [(params ...)] [(bind ...)] [(domain NAME)])' sites, then local blocking '(do child)' while those generated spawns remain pending, then '(await_any done)' as an observation point after the local do, and then a later same-body '(await_all done)' drain before the nested repeat check can loop; the local child remains in the parent scheduled module, the await_any observes only the pending generated spawns and does not clear them, and switch-contained post-do await_any, generated-do post-do await_any, new spawn after the do before drain, cross-domain activation, deeper branch/loop nesting, and broader outstanding-child semantics remain deferred.`
  Verification: `mdbook build docs/book; prove -l t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t Files=2, Tests=290; git diff --check`
  Commit: `ISF-REPEAT-BODY-CHILD-ACTIVATION.97: select when repeat local do before await_any`

- ID: `ISF-REPEAT-BODY-CHILD-ACTIVATION.98`
  Status: `done`
  Goal: `Ship when-body nested repeat local do before post-do multi-pending await_any before mandatory await_all drain if selected.`
  Acceptance: `Top-level when bodies accept nested '(repeat COUNT ... (spawn child as a ...) (spawn child as b ...) (do local_child) (await_any done) (await_all done) ...)' only when the do target is local to the parent scheduled module, the await_any appears after that local do while the generated spawns are still pending, and a later same-body await_all drains every outstanding generated nested spawn before the nested repeat check can loop; lowering waits for the local child's fresh done pulse before evaluating the post-do await_any observation, keeps every generated-spawn done handoff live through the local do and await_any, preserves source-order samples around spawn/do/await_any/await_all, and keeps switch-contained post-do await_any, generated-do post-do await_any, new spawn after the do before drain, cross-domain activation, deeper branch/loop nesting, and broader outstanding-child semantics fail-closed.`
  Verification: `syntax checks; touched repeat/spawn test Files=1, Tests=51; doc audits Files=2, Tests=295; focused activation/domain/doc suite Files=13, Tests=528; mdbook build docs/book; ./bin/ci-regression isf --no-book Files=227, Tests=1299; git diff --check`
  Commit: `ISF-REPEAT-BODY-CHILD-ACTIVATION.98: implement when repeat local do before await_any`

- ID: `ISF-REPEAT-BODY-CHILD-ACTIVATION.99`
  Status: `done`
  Goal: `Select the next repeat-body child activation subset.`
  Acceptance: `Task tree, roadmap, and book backlog select top-level switch-branch nested repeat local '(do child)' followed by post-do multi-pending '(await_any done)' and then mandatory same-body '(await_all done)' as the next bounded implementation subset; the selected source shape is a repeat directly inside a top-level switch branch with multiple generated '(spawn child as inst [(params ...)] [(bind ...)] [(domain NAME)])' sites, then local blocking '(do child)' while those generated spawns remain pending, then '(await_any done)' as an observation point after the local do, and then a later same-body '(await_all done)' drain before the nested repeat check can loop; the local child remains in the parent scheduled module, the await_any observes only the pending generated spawns and does not clear them, and generated-do post-do await_any, new spawn after the do before drain, cross-domain activation, deeper branch/loop nesting, and broader outstanding-child semantics remain deferred.`
  Verification: `mdbook build docs/book; prove -l t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t Files=2, Tests=295; git diff --check`
  Commit: `ISF-REPEAT-BODY-CHILD-ACTIVATION.99: select switch repeat local do before await_any`

- ID: `ISF-REPEAT-BODY-CHILD-ACTIVATION.100`
  Status: `done`
  Goal: `Ship switch-branch nested repeat local do before post-do multi-pending await_any before mandatory await_all drain if selected.`
  Acceptance: `Top-level switch branches accept nested '(repeat COUNT ... (spawn child as a ...) (spawn child as b ...) (do local_child) (await_any done) (await_all done) ...)' only when the do target is local to the parent scheduled module, the await_any appears after that local do while the generated spawns are still pending, and a later same-body await_all drains every outstanding generated nested spawn before the nested repeat check can loop; lowering waits for the local child's fresh done pulse before evaluating the post-do await_any observation, keeps every generated-spawn done handoff live through the local do and await_any, preserves source-order samples around spawn/do/await_any/await_all, and keeps generated-do post-do await_any, new spawn after the do before drain, cross-domain activation, deeper branch/loop nesting, and broader outstanding-child semantics fail-closed.`
  Verification: `syntax checks; touched repeat/spawn test Files=1, Tests=52; focused repeat/spawn/doc checks Files=3, Tests=352; mdbook build docs/book; ./bin/ci-regression isf --no-book Files=227, Tests=1305; git diff --check`
  Commit: `ISF-REPEAT-BODY-CHILD-ACTIVATION.100: implement switch repeat local do before await_any`

- ID: `ISF-REPEAT-BODY-CHILD-ACTIVATION.101`
  Status: `done`
  Goal: `Select the next repeat-body child activation subset.`
  Acceptance: `Task tree, roadmap, and book backlog select top-level when-body nested repeat plain generated-child '(do child)' followed by post-do multi-pending '(await_any done)' and then mandatory same-body '(await_all done)' as the next bounded implementation subset; the selected source shape is a repeat directly inside a top-level when body with multiple generated '(spawn child as inst [(params ...)] [(bind ...)] [(domain NAME)])' sites, then plain generated-child blocking '(do child)' while those generated spawns remain pending, then '(await_any done)' as an observation point after the generated-child do, and then a later same-body '(await_all done)' drain before the nested repeat check can loop; the generated-child do target is already emitted as a generated child by another activation site, the post-do await_any observes only the pending generated spawns and does not clear them, and static-parameter generated do, bind handoffs, domain metadata, the switch-contained generated-child analogue, new spawn after the do before drain, cross-domain activation, deeper branch/loop nesting, and broader outstanding-child semantics remain deferred.`
  Verification: `mdbook build docs/book; prove -l t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t Files=2, Tests=300; git diff --check`
  Commit: `ISF-REPEAT-BODY-CHILD-ACTIVATION.101: select when repeat generated-child do before await_any`

- ID: `ISF-REPEAT-BODY-CHILD-ACTIVATION.102`
  Status: `done`
  Goal: `Ship when-body nested repeat generated-child do before post-do multi-pending await_any before mandatory await_all drain if selected.`
  Acceptance: `Top-level when bodies accept nested '(repeat COUNT ... (spawn child as a ...) (spawn child as b ...) (do generated_child) (await_any done) (await_all done) ...)' only when the do target is already emitted as a generated child by another activation site, the await_any appears after that generated-child do while the generated spawns are still pending, and a later same-body await_all drains every outstanding generated nested spawn before the nested repeat check can loop; lowering waits for the generated-child do instance's fresh done handoff before evaluating the post-do await_any observation, keeps every generated-spawn done handoff live through the generated-child do and await_any, preserves source-order samples around spawn/do/await_any/await_all, and keeps static-parameter generated do, bind handoffs, domain metadata, switch-contained generated-child post-do await_any, new spawn after the do before drain, cross-domain activation, deeper branch/loop nesting, and broader outstanding-child semantics fail-closed.`
  Verification: `syntax checks; touched repeat/spawn test Files=1, Tests=53; focused repeat/spawn/doc checks Files=3, Tests=358; mdbook build docs/book; ./bin/ci-regression isf --no-book Files=227, Tests=1311; git diff --check`
  Commit: `ISF-REPEAT-BODY-CHILD-ACTIVATION.102: implement when repeat generated-child do before await_any`

- ID: `ISF-REPEAT-BODY-CHILD-ACTIVATION.103`
  Status: `done`
  Goal: `Select the next repeat-body child activation subset.`
  Acceptance: `Task tree, roadmap, and book backlog select top-level switch-branch nested repeat plain generated-child '(do child)' followed by post-do multi-pending '(await_any done)' and then mandatory same-body '(await_all done)' as the next bounded implementation subset; the selected source shape is a repeat directly inside a top-level switch branch with multiple generated '(spawn child as inst [(params ...)] [(bind ...)] [(domain NAME)])' sites, then plain generated-child blocking '(do child)' while those generated spawns remain pending, then '(await_any done)' as an observation point after the generated-child do, and then a later same-body '(await_all done)' drain before the nested repeat check can loop; the generated-child do target is already emitted as a generated child by another activation site, the post-do await_any observes only the pending generated spawns and does not clear them, and static-parameter generated do, bind handoffs, domain metadata, new spawn after the do before drain, cross-domain activation, deeper branch/loop nesting, and broader outstanding-child semantics remain deferred.`
  Verification: `mdbook build docs/book; prove -l t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t Files=2, Tests=305; git diff --check`
  Commit: `ISF-REPEAT-BODY-CHILD-ACTIVATION.103: select switch repeat generated-child do before await_any`

- ID: `ISF-REPEAT-BODY-CHILD-ACTIVATION.104`
  Status: `done`
  Goal: `Ship switch-branch nested repeat generated-child do before post-do multi-pending await_any before mandatory await_all drain if selected.`
  Acceptance: `Top-level switch branches accept nested '(repeat COUNT ... (spawn child as a ...) (spawn child as b ...) (do generated_child) (await_any done) (await_all done) ...)' only when the do target is already emitted as a generated child by another activation site, the await_any appears after that generated-child do while the generated spawns are still pending, and a later same-body await_all drains every outstanding generated nested spawn before the nested repeat check can loop; lowering waits for the generated-child do instance's fresh done handoff before evaluating the post-do await_any observation, keeps every generated-spawn done handoff live through the generated-child do and await_any, preserves source-order samples around spawn/do/await_any/await_all, and keeps static-parameter generated do, bind handoffs, domain metadata, new spawn after the do before drain, cross-domain activation, deeper branch/loop nesting, and broader outstanding-child semantics fail-closed.`
  Verification: `syntax checks; touched repeat/spawn test Files=1, Tests=54; focused repeat/spawn/doc checks Files=3, Tests=364; mdbook build docs/book; ./bin/ci-regression isf --no-book Files=227, Tests=1317; git diff --check`
  Commit: `ISF-REPEAT-BODY-CHILD-ACTIVATION.104: implement switch repeat generated-child do before await_any`

- ID: `ISF-REPEAT-BODY-CHILD-ACTIVATION.105`
  Status: `done`
  Goal: `Select the next repeat-body child activation subset.`
  Acceptance: `Task tree, roadmap, and book backlog select top-level when-body nested repeat generated blocking '(do child (params ...))' followed by post-do multi-pending '(await_any done)' and then mandatory same-body '(await_all done)' as the next bounded implementation subset; the selected source shape is a repeat directly inside a top-level when body with multiple generated '(spawn child as inst [(params ...)] [(bind ...)] [(domain NAME)])' sites, then static-parameter generated blocking '(do child (params ...))' while those generated spawns remain pending, then '(await_any done)' as an observation point after the generated do, and then a later same-body '(await_all done)' drain before the nested repeat check can loop; the generated do uses only static parameter overrides and no bind or domain subclauses, the post-do await_any observes only the pending generated spawns and does not clear them, and bind handoffs, domain metadata, the switch-contained static-parameter analogue, new spawn after the do before drain, cross-domain activation, deeper branch/loop nesting, and broader outstanding-child semantics remain deferred.`
  Verification: `mdbook build docs/book; prove -l t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t Files=2, Tests=310; git diff --check`
  Commit: `ISF-REPEAT-BODY-CHILD-ACTIVATION.105: select when repeat parameterized do before await_any`

- ID: `ISF-REPEAT-BODY-CHILD-ACTIVATION.106`
  Status: `done`
  Goal: `Ship when-body nested repeat generated do with static params before post-do multi-pending await_any before mandatory await_all drain if selected.`
  Acceptance: `Top-level when bodies accept nested '(repeat COUNT ... (spawn child as a ...) (spawn child as b ...) (do generated_child (params ...)) (await_any done) (await_all done) ...)' only when the generated do uses static parameter overrides, the await_any appears after that generated do while the generated spawns are still pending, and a later same-body await_all drains every outstanding generated nested spawn before the nested repeat check can loop; lowering waits for the generated do instance's fresh done handoff before evaluating the post-do await_any observation, keeps every generated-spawn done handoff live through the generated do and await_any, preserves source-order samples around spawn/do/await_any/await_all, and keeps bind handoffs, domain metadata, switch-contained static-parameter generated-do post-do await_any, new spawn after the do before drain, cross-domain activation, deeper branch/loop nesting, and broader outstanding-child semantics fail-closed.`
  Verification: `syntax checks; touched repeat/spawn test Files=1, Tests=55; focused repeat/spawn/doc checks Files=3, Tests=370; mdbook build docs/book; ./bin/ci-regression isf --no-book Files=227, Tests=1323; git diff --check`
  Commit: `ISF-REPEAT-BODY-CHILD-ACTIVATION.106: implement when repeat parameterized do before await_any`

- ID: `ISF-REPEAT-BODY-CHILD-ACTIVATION.107`
  Status: `done`
  Goal: `Select the next repeat-body child activation subset.`
  Acceptance: `Task tree, roadmap, and book backlog select top-level switch-branch nested repeat generated blocking '(do child (params ...))' followed by post-do multi-pending '(await_any done)' and then mandatory same-body '(await_all done)' as the next bounded implementation subset; the selected source shape is a repeat directly inside a top-level switch branch with multiple generated '(spawn child as inst [(params ...)] [(bind ...)] [(domain NAME)])' sites, then static-parameter generated blocking '(do child (params ...))' while those generated spawns remain pending, then '(await_any done)' as an observation point after the generated do, and then a later same-body '(await_all done)' drain before the nested repeat check can loop; the generated do uses only static parameter overrides and no bind or domain subclauses, the post-do await_any observes only the pending generated spawns and does not clear them, and bind handoffs, domain metadata, new spawn after the do before drain, cross-domain activation, deeper branch/loop nesting, and broader outstanding-child semantics remain deferred.`
  Verification: `mdbook build docs/book; prove -l t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t Files=2, Tests=320; git diff --check`
  Commit: `ISF-REPEAT-BODY-CHILD-ACTIVATION.107: select switch repeat parameterized do before await_any`

- ID: `ISF-REPEAT-BODY-CHILD-ACTIVATION.108`
  Status: `done`
  Goal: `Ship switch-branch nested repeat generated do with static params before post-do multi-pending await_any before mandatory await_all drain if selected.`
  Acceptance: `Top-level switch branches accept nested '(repeat COUNT ... (spawn child as a ...) (spawn child as b ...) (do generated_child (params ...)) (await_any done) (await_all done) ...)' only when the generated do uses static parameter overrides, the await_any appears after that generated do while the generated spawns are still pending, and a later same-body await_all drains every outstanding generated nested spawn before the nested repeat check can loop; lowering waits for the generated do instance's fresh done handoff before evaluating the post-do await_any observation, keeps every generated-spawn done handoff live through the generated do and await_any, preserves source-order samples around spawn/do/await_any/await_all, and keeps bind handoffs, domain metadata, new spawn after the do before drain, cross-domain activation, deeper branch/loop nesting, and broader outstanding-child semantics fail-closed.`
  Verification: `syntax checks; touched repeat/spawn test Files=1, Tests=56; focused repeat/spawn/doc checks Files=3, Tests=376; mdbook build docs/book; ./bin/ci-regression isf --no-book Files=227, Tests=1329; git diff --check`
  Commit: `ISF-REPEAT-BODY-CHILD-ACTIVATION.108: implement switch repeat parameterized do before await_any`

- ID: `ISF-REPEAT-BODY-CHILD-ACTIVATION.109`
  Status: `done`
  Goal: `Select the next repeat-body child activation subset.`
  Acceptance: `Task tree, roadmap, and book backlog select top-level when-body nested repeat generated blocking '(do child (params ...) (bind ...))' followed by post-do multi-pending '(await_any done)' and then mandatory same-body '(await_all done)' as the next bounded implementation subset; the selected source shape is a repeat directly inside a top-level when body with multiple generated '(spawn child as inst [(params ...)] [(bind ...)] [(domain NAME)])' sites, then static-parameter generated blocking '(do child (params ...) (bind ...))' while those generated spawns remain pending, then '(await_any done)' as an observation point after the generated do, and then a later same-body '(await_all done)' drain before the nested repeat check can loop; the generated do uses static parameter overrides and input/output bind handoffs but no domain subclause, the post-do await_any observes only the pending generated spawns and does not clear them, and same-domain metadata, switch-contained bound generated-do post-do await_any, new spawn after the do before drain, cross-domain activation, deeper branch/loop nesting, and broader outstanding-child semantics remain deferred.`
  Verification: `mdbook build docs/book; prove -l t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t; git diff --check`
  Commit: `ISF-REPEAT-BODY-CHILD-ACTIVATION.109: select when repeat bound do before await_any`

- ID: `ISF-REPEAT-BODY-CHILD-ACTIVATION.110`
  Status: `done`
  Goal: `Ship when-body nested repeat generated do with static params and bind handoffs before post-do multi-pending await_any before mandatory await_all drain if selected.`
  Acceptance: `Top-level when bodies accept nested '(repeat COUNT ... (spawn child as a ...) (spawn child as b ...) (do generated_child (params ...) (bind ...)) (await_any done) (await_all done) ...)' only when the generated do uses static parameter overrides plus input/output bind handoffs, the await_any appears after that generated do while the generated spawns are still pending, and a later same-body await_all drains every outstanding generated nested spawn before the nested repeat check can loop; lowering waits for the generated do instance's fresh done handoff before evaluating the post-do await_any observation, wires generated-top input/output binding handoffs for the generated do instance, keeps every generated-spawn done handoff live through the generated do and await_any, preserves source-order samples around spawn/do/await_any/await_all, and keeps domain metadata, switch-contained bound generated-do post-do await_any, new spawn after the do before drain, cross-domain activation, deeper branch/loop nesting, and broader outstanding-child semantics fail-closed.`
  Verification: `syntax checks; touched repeat/spawn test Files=1, Tests=57; focused repeat/spawn/doc checks Files=3, Tests=385; mdbook build docs/book; ./bin/ci-regression isf --no-book Files=227, Tests=1338; git diff --check`
  Commit: `ISF-REPEAT-BODY-CHILD-ACTIVATION.110: implement when repeat bound do before await_any`

- ID: `ISF-REPEAT-BODY-CHILD-ACTIVATION.111`
  Status: `pending`
  Goal: `Select the next repeat-body child activation subset.`
  Acceptance: `Task tree, roadmap, and book backlog select one bounded remaining repeat-body child activation subset before any further implementation; candidate frontiers include domain metadata on generated-do post-do await_any, the switch-contained bound generated-do post-do await_any analogue, new spawn after the do before drain, cross-domain activation, deeper branch/loop nesting, and broader outstanding-child lifetime semantics.`
...
| 77 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.77` | `done` | Selected when-contained local do after prior multi-pending await_any before mandatory await_all drain. |
| 78 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.78` | `done` | Shipped the selected when-contained await_any-before-local-do subset. |
| 79 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.79` | `done` | Selected switch-contained local do after prior multi-pending await_any before mandatory await_all drain. |
| 80 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.80` | `done` | Shipped the selected switch-contained await_any-before-local-do subset. |
| 81 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.81` | `done` | Selected when-contained generated-child do after prior multi-pending await_any before mandatory await_all drain. |
| 82 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.82` | `done` | Shipped the selected when-contained generated-child await_any-before-do subset. |
| 83 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.83` | `done` | Selected switch-contained generated-child do after prior multi-pending await_any before mandatory await_all drain. |
| 84 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.84` | `done` | Shipped the selected switch-contained generated-child await_any-before-do subset. |
| 85 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.85` | `done` | Selected when-contained static-parameter generated do after prior multi-pending await_any before mandatory await_all drain. |
| 86 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.86` | `done` | Shipped the selected when-contained static-parameter generated-do await_any-before-do subset. |
| 87 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.87` | `done` | Selected switch-contained static-parameter generated do after prior multi-pending await_any before mandatory await_all drain. |
| 88 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.88` | `done` | Shipped the selected switch-contained static-parameter generated-do await_any-before-do subset. |
| 89 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.89` | `done` | Selected when-contained bound generated do after prior multi-pending await_any before mandatory await_all drain. |
| 90 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.90` | `done` | Shipped the selected when-contained bound generated-do await_any-before-do subset. |
| 91 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.91` | `done` | Selected switch-contained bound generated do after prior multi-pending await_any before mandatory await_all drain. |
| 92 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.92` | `done` | Shipped the selected switch-contained bound generated-do await_any-before-do subset. |
| 93 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.93` | `done` | Selected when-contained same-domain generated do after prior multi-pending await_any before mandatory await_all drain. |
| 94 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.94` | `done` | Shipped the selected when-contained same-domain generated-do await_any-before-do subset. |
| 95 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.95` | `done` | Selected switch-contained same-domain generated do after prior multi-pending await_any before mandatory await_all drain. |
| 96 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.96` | `done` | Shipped the selected switch-contained same-domain generated-do await_any-before-do subset. |
| 97 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.97` | `done` | Selected when-contained local do before post-do multi-pending await_any before mandatory await_all drain. |
| 98 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.98` | `done` | Shipped the selected when-contained local-do-before-post-do-await_any subset. |
| 99 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.99` | `done` | Selected switch-contained local do before post-do multi-pending await_any before mandatory await_all drain. |
| 100 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.100` | `done` | Shipped the selected switch-contained local-do-before-post-do-await_any subset. |
| 101 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.101` | `done` | Selected when-contained generated-child do before post-do multi-pending await_any before mandatory await_all drain. |
| 102 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.102` | `done` | Shipped the selected when-contained generated-child-do-before-post-do-await_any subset. |
| 103 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.103` | `done` | Selected switch-contained generated-child do before post-do multi-pending await_any before mandatory await_all drain. |
| 104 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.104` | `done` | Shipped the selected switch-contained generated-child-do-before-post-do-await_any subset. |
| 105 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.105` | `done` | Selected when-contained static-parameter generated do before post-do multi-pending await_any before mandatory await_all drain. |
| 106 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.106` | `done` | Shipped the selected when-contained static-parameter generated-do-before-post-do-await_any subset. |
| 107 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.107` | `done` | Selected switch-contained static-parameter generated do before post-do multi-pending await_any before mandatory await_all drain. |
| 108 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.108` | `done` | Shipped the selected switch-contained static-parameter generated-do-before-post-do-await_any subset. |
...
| 111 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.111` | `pending` | Selects the next bounded repeat-body child activation subset before further implementation. |
...
- `2026-05-18`: Leaf `.110` shipped top-level when-body nested repeat
  ...
  before the observation, generated-top input/output binding handoffs are
  wired for that lexical do site, and the pending generated-spawn done set
  remains live for the later same-body `(await_all done)` drain.
- `2026-05-18`: Leaf `.111` is the next selection frontier. It must choose
  one bounded remaining repeat-body child activation subset before any
  additional implementation; domain metadata on generated-do post-do
  `await_any`, the switch-contained bound analogue, new spawn after the do
  before drain, cross-domain activation, deeper branch/loop nesting, and
  broader outstanding-child semantics remain unselected.
- `2026-05-18`: Leaf `.104` shipped top-level switch-branch nested repeat
  plain generated-child `(do child)` before post-do multi-pending
  `(await_any done)`, with the generated do instance's fresh done handoff
  required before the observation and the pending generated-spawn done set
  left live for the later same-body `(await_all done)` drain.
- `2026-05-18`: Leaf `.105` is the next selection frontier. It must choose
  one bounded remaining repeat-body child activation subset before any
  additional implementation; static-parameter generated-do post-do
  `await_any`, bind handoffs, domain metadata, new spawn after the do before
  the drain, cross-domain activation, deeper nesting, and broader
  outstanding-child semantics remain unselected.
- `2026-05-18`: Leaf `.105` selects top-level when-body nested repeat
  generated blocking `(do child (params ...))` before post-do multi-pending
  `(await_any done)` as the next bounded implementation subset. The selected
  contract uses static parameter overrides only, requires the generated do
  instance's fresh done handoff before the observation, leaves the pending
  generated-spawn done set live for the later same-body `(await_all done)`
  drain, and keeps bind handoffs, domain metadata, the switch-contained
  analogue, new spawn after the do before the drain, cross-domain activation,
  deeper nesting, and broader outstanding-child semantics deferred.
...
- `2026-05-18`: Leaf `.77` is the next selection frontier and must choose the
  next bounded repeat-body child activation subset before any further code
  changes.
- `2026-05-18`: Leaf `.77` selects top-level when-body nested repeat local
  `(do child)` after a prior multi-pending `(await_any done)` observation and
  before a mandatory later same-body `(await_all done)` drain. The selected
  contract keeps the generated-spawn done set live after the observation and
  through the local do, then drains it before nested repeat re-entry.
- `2026-05-18`: Leaf `.78` is the next implementation frontier. It must keep
  generated `do` after prior multi-pending `await_any`, the switch-contained
  analogue, `await_any` after the do, new nested spawn after the do before
  drain, cross-domain activation, deeper branch/loop nesting, and broader
  outstanding-child semantics fail-closed.
- `2026-05-18`: Leaf `.78` shipped the when-contained local do after prior
  multi-pending `await_any` subset. The generated-spawn done set remains live
  through the observation and local do, the local child waits on its own fresh
  done pulse, and a later same-body `await_all` drains every pending generated
  child before nested repeat re-entry.
- `2026-05-18`: Leaf `.79` is the next selection frontier and must choose the
  next bounded repeat-body child activation subset before any further code
  changes.
- `2026-05-18`: Leaf `.79` selects top-level switch-branch nested repeat
  local `(do child)` after a prior multi-pending `(await_any done)`
  observation and before a mandatory later same-body `(await_all done)` drain.
  The selected contract mirrors the shipped when-contained local-do proof:
  the generated-spawn done set stays live after the observation and through
  the local do, then drains before nested repeat re-entry.
- `2026-05-18`: Leaf `.80` is the next implementation frontier. It must keep
  generated `do` after prior multi-pending `await_any`, `await_any` after the
  do, new nested spawn after the do before drain, cross-domain activation,
  deeper branch/loop nesting, and broader outstanding-child semantics
  fail-closed.
- `2026-05-18`: Leaf `.80` shipped the selected switch-contained local do
  after prior multi-pending `await_any` subset. The generated-spawn done set
  remains live through the observation and local do, the local child waits on
  its own fresh done pulse, and a later same-body `await_all` drains every
  pending generated child before nested repeat re-entry.
- `2026-05-18`: Leaf `.81` is the next selection frontier and must choose the
  next bounded repeat-body child activation subset before any further code
  changes.
- `2026-05-18`: Leaf `.81` selects top-level when-body nested repeat plain
  generated-child `(do child)` after a prior multi-pending `(await_any done)`
  observation and before a mandatory later same-body `(await_all done)` drain.
  The selected contract keeps the generated-spawn done set live after the
  observation and through the generated do instance, then drains it before
  nested repeat re-entry.
- `2026-05-18`: Leaf `.82` is the next implementation frontier. It must keep
  parameterized, bound, or domain-qualified generated `do` after prior
  multi-pending `await_any`, the switch-contained analogue, `await_any` after
  the do, new nested spawn after the do before drain, cross-domain activation,
  deeper branch/loop nesting, and broader outstanding-child semantics
  fail-closed.
- `2026-05-18`: Leaf `.82` shipped the selected top-level when-body nested
  repeat plain generated-child `(do child)` after prior multi-pending
  `(await_any done)` subset. The generated-spawn done set remains live after
  the observation and through the generated do instance, the generated do
  waits on its own fresh done handoff, and a later same-body `await_all`
  drains every pending generated child before nested repeat re-entry.
- `2026-05-18`: Leaf `.83` is the next selection frontier and must choose the
  next bounded repeat-body child activation subset before any further code
  changes.
- `2026-05-18`: Leaf `.83` selects top-level switch-branch nested repeat plain
  generated-child `(do child)` after a prior multi-pending `(await_any done)`
  observation and before a mandatory later same-body `(await_all done)` drain.
  The selected contract mirrors the shipped when-contained generated-child
  proof: the generated-spawn done set stays live after the observation and
  through the generated do instance, then drains before nested repeat
  re-entry.
- `2026-05-18`: Leaf `.84` is the next implementation frontier. It must keep
  parameterized, bound, or domain-qualified generated `do` after prior
  multi-pending `await_any`, `await_any` after the do, new nested spawn after
  the do before drain, cross-domain activation, deeper branch/loop nesting,
  and broader outstanding-child semantics fail-closed.
- `2026-05-18`: Leaf `.84` shipped the selected top-level switch-branch
  nested repeat plain generated-child `(do child)` after prior multi-pending
  `(await_any done)` subset. The generated-spawn done set remains live after
  the observation and through the generated do instance, the generated do
  waits on its own fresh done handoff, and a later same-body `await_all`
  drains every pending generated child before nested repeat re-entry.
- `2026-05-18`: Leaf `.85` is the next selection frontier and must choose the
  next bounded repeat-body child activation subset before any further code
  changes.
- `2026-05-18`: Leaf `.85` selects top-level when-body nested repeat
  generated blocking `(do child (params ...))` after a prior multi-pending
  `(await_any done)` observation and before a mandatory later same-body
  `(await_all done)` drain. The selected contract keeps the generated-spawn
  done set live after the observation and through the generated do instance,
  applies static parameter overrides once in the generated top, then drains
  every pending generated child before nested repeat re-entry.
- `2026-05-18`: Leaf `.86` is the next implementation frontier. It must keep
  bind handoffs, domain metadata, the switch-contained analogue, `await_any`
  after the do, new nested spawn after the do before drain, cross-domain
  activation, deeper branch/loop nesting, and broader outstanding-child
  semantics fail-closed.
- `2026-05-18`: Leaf `.86` shipped the selected top-level when-body nested
  repeat generated blocking `(do child (params ...))` after prior
  multi-pending `(await_any done)` subset. The generated-spawn done set
  remains live after the observation and through the static-parameter
  generated do instance, the generated do waits on its own fresh done handoff,
  static parameter overrides are applied once in the generated top, and a
  later same-body `await_all` drains every pending generated child before
  nested repeat re-entry.
- `2026-05-18`: Leaf `.87` is the next selection frontier and must choose the
  next bounded repeat-body child activation subset before any further
  behavior-bearing implementation.
- `2026-05-18`: Leaf `.87` selects top-level switch-branch nested repeat
  generated blocking `(do child (params ...))` after a prior multi-pending
  `(await_any done)` observation and before a mandatory later same-body
  `(await_all done)` drain. The selected contract mirrors the shipped
  when-contained static-parameter generated-do await-any-before-do proof:
  keep the generated-spawn done set live after the observation and through
  the generated do instance, apply static parameter overrides once in the
  generated top, then drain every pending generated child before nested repeat
  re-entry.
- `2026-05-18`: Leaf `.88` is the next implementation frontier. It must keep
  bind handoffs, domain metadata, `await_any` after the do, new nested spawn
  after the do before drain, cross-domain activation, deeper branch/loop
  nesting, and broader outstanding-child semantics fail-closed.
- `2026-05-18`: Leaf `.88` shipped the selected top-level switch-branch
  nested repeat generated blocking `(do child (params ...))` after prior
  multi-pending `(await_any done)` subset. The generated-spawn done set
  remains live after the observation and through the static-parameter
  generated do instance, the generated do waits on its own fresh done handoff,
  static parameter overrides are applied once in the generated top, and a
  later same-body `await_all` drains every pending generated child before
  nested repeat re-entry.
- `2026-05-18`: Leaf `.89` is the next selection frontier and must choose the
  next bounded repeat-body child activation subset before any further
  behavior-bearing implementation.
- `2026-05-18`: Leaf `.89` selects top-level when-body nested repeat
  generated blocking `(do child (params ...) (bind ...))` after a prior
  multi-pending `(await_any done)` observation and before a mandatory later
  same-body `(await_all done)` drain. The selected contract extends the
  shipped static-parameter generated-do await-any-before-do proof with
  generated-top input/output binding handoffs owned by the deterministic
  generated do instance.
- `2026-05-18`: Leaf `.90` is the next implementation frontier. It must keep
  domain metadata, the switch-contained bound analogue, `await_any` after the
  do, new nested spawn after the do before drain, cross-domain activation,
  deeper branch/loop nesting, and broader outstanding-child semantics
  fail-closed.
- `2026-05-18`: Leaf `.93` selected top-level when-body nested repeat
  generated blocking `(do child (params ...) [(bind ...)] (domain NAME))`
  after a prior multi-pending `(await_any done)` observation and before a
  mandatory later same-body `(await_all done)` drain. The selected contract
  records same-domain ownership metadata for the generated do instance and
  generated nested spawns without implying CDC or cross-domain activation.
- `2026-05-18`: Leaf `.94` is the next implementation frontier. It must keep
  the switch-contained domain analogue, `await_any` after the do, new nested
  spawn after the do before drain, cross-domain activation, deeper
  branch/loop nesting, and broader outstanding-child semantics fail-closed.
- `2026-05-18`: Leaf `.94` shipped the selected top-level when-body nested
  repeat same-domain generated `(do child (params ...) [(bind ...)]
  (domain NAME))` after prior multi-pending `(await_any done)` subset. The
  generated-spawn done set remains live after the observation and through the
  same-domain generated do instance, the generated do waits on its own fresh
  done handoff, declared same-domain metadata is retained in
  generated-composition/domain partition and schedule-report clock-domain
  summaries, and a later same-body `await_all` drains every pending generated
  child before nested repeat re-entry.
- `2026-05-18`: Leaf `.95` is the next selection frontier and must choose the
  next bounded repeat-body child activation subset before any further
  behavior-bearing implementation.
- `2026-05-18`: Leaf `.95` selects top-level switch-branch nested repeat
  generated blocking `(do child (params ...) [(bind ...)] (domain NAME))`
  after a prior multi-pending `(await_any done)` observation and before a
  mandatory later same-body `(await_all done)` drain. The selected contract
  mirrors the shipped when-contained domain proof: the generated-spawn done
  set stays live after the observation and through the same-domain generated
  do instance, then drains before nested repeat re-entry while preserving
  declared ownership metadata without implying CDC or cross-domain activation.
- `2026-05-18`: Leaf `.96` is the next implementation frontier. It must keep
  `await_any` after the do, new nested spawn after the do before drain,
  cross-domain activation, deeper branch/loop nesting, and broader
  outstanding-child semantics fail-closed.
- `2026-05-18`: Leaf `.96` shipped the selected top-level switch-branch
  nested repeat same-domain generated `(do child (params ...) [(bind ...)]
  (domain NAME))` after prior multi-pending `(await_any done)` subset. The
  generated-spawn done set remains live after the observation and through the
  same-domain generated do instance, the generated do waits on its own fresh
  done handoff, declared same-domain metadata is retained in
  ...
  summaries, and a later same-body `await_all` drains every pending generated
  child before nested repeat re-entry.
- `2026-05-18`: Leaf `.97` is the next selection frontier and must choose the
  next bounded repeat-body child activation subset before any further
  behavior-bearing implementation.
- `2026-05-18`: Leaf `.97` selects top-level when-body nested repeat local
  `(do child)` followed by post-do multi-pending `(await_any done)` as the
  next bounded subset. The selected source shape keeps multiple generated
  spawns pending, runs only a local blocking do in the parent scheduled
  module, observes the pending generated spawns with `await_any` after that
  local do, and still requires a later same-body `(await_all done)` drain
  before nested repeat re-entry.
- `2026-05-18`: Leaf `.98` is the next implementation frontier. It must keep
  ...
  nesting, and broader outstanding-child semantics fail-closed.
- `2026-05-18`: Leaf `.98` shipped the selected top-level when-body nested
  repeat local `(do child)` before post-do multi-pending `(await_any done)`
  subset. Lowering waits for the local child's fresh done pulse before the
  observation, keeps every generated-spawn done handoff live through the local
  do and post-do `await_any`, and still requires the later same-body
  `(await_all done)` drain before nested repeat re-entry.
- `2026-05-18`: Leaf `.99` is the next selection frontier and must choose the
  next bounded repeat-body child activation subset before any further
  behavior-bearing implementation.
- `2026-05-18`: Leaf `.99` selects top-level switch-branch nested repeat
  local `(do child)` followed by post-do multi-pending `(await_any done)` as
  the next bounded subset. The selected source shape mirrors the shipped
  when-contained leaf: multiple generated spawns stay pending, only a local
  blocking do runs in the parent scheduled module, the post-do `await_any`
  observes that generated-spawn set, and a later same-body `(await_all done)`
  still drains every pending generated child before nested repeat re-entry.
- `2026-05-18`: Leaf `.100` is the next implementation frontier. It must keep
  generated-do post-do `await_any`, new spawn after the do before drain,
  cross-domain activation, deeper branch/loop nesting, and broader
  outstanding-child semantics fail-closed.
- `2026-05-18`: Leaf `.100` shipped the selected top-level switch-branch
  nested repeat local `(do child)` before post-do multi-pending
  `(await_any done)` subset. Lowering waits for the local child's fresh done
  pulse before the observation, keeps every generated-spawn done handoff live
  through the local do and post-do `await_any`, and still requires the later
  same-body `(await_all done)` drain before nested repeat re-entry.
- `2026-05-18`: Leaf `.101` is the next selection frontier and must choose
  exactly one remaining repeat-body child activation subset before any
  further behavior-bearing implementation.
- `2026-05-18`: Leaf `.101` selects top-level when-body nested repeat plain
  generated-child `(do child)` followed by post-do multi-pending
  `(await_any done)` as the next bounded subset. The selected source shape
  keeps multiple generated spawns pending, runs a deterministic generated-child
  do instance, observes the pending generated spawns with `await_any` after
  that do, and still requires a later same-body `(await_all done)` drain
  before nested repeat re-entry.
- `2026-05-18`: Leaf `.102` is the next implementation frontier. It must keep
  ...
  drain, cross-domain activation, deeper branch/loop nesting, and broader
  outstanding-child semantics fail-closed.
- `2026-05-18`: Leaf `.102` shipped the selected top-level when-body nested
  repeat plain generated-child `(do child)` before post-do multi-pending
  `(await_any done)` subset. Lowering waits for the generated do instance's
  fresh done handoff before the observation, keeps every generated-spawn done
  handoff live through the generated-child do and post-do `await_any`, and
  still requires the later same-body `(await_all done)` drain before nested
  repeat re-entry.
- `2026-05-18`: Leaf `.103` is the next selection frontier and must choose
  exactly one remaining repeat-body child activation subset before any
  further behavior-bearing implementation.
- `2026-05-18`: Leaf `.103` selects top-level switch-branch nested repeat
  plain generated-child `(do child)` followed by post-do multi-pending
  `(await_any done)` as the next bounded subset. The selected source shape
  mirrors the shipped when-contained generated-child leaf: multiple generated
  spawns stay pending, a deterministic generated-child do instance runs, the
  post-do `await_any` observes that generated-spawn set, and a later same-body
  `(await_all done)` still drains every pending generated child before nested
  repeat re-entry.
- `2026-05-18`: Leaf `.104` is the next implementation frontier. It must keep
  static-parameter generated do, bind handoffs, domain metadata, new spawn
  after the do before drain, cross-domain activation, deeper branch/loop
  nesting, and broader outstanding-child semantics fail-closed.
- `2026-05-18`: Leaf `.104` shipped the selected top-level switch-branch
  nested repeat plain generated-child `(do child)` before post-do
  multi-pending `(await_any done)` subset. Lowering waits for the generated
  do instance's fresh done handoff before the observation, keeps every
  generated-spawn done handoff live through the generated-child do and
  post-do `await_any`, and still requires the later same-body
  `(await_all done)` drain before nested repeat re-entry.
- `2026-05-18`: Leaf `.105` is the next selection frontier and must choose
  exactly one remaining repeat-body child activation subset before any
  further behavior-bearing implementation.
- `2026-05-18`: Leaf `.105` selects top-level when-body nested repeat
  static-parameter generated `(do child (params ...))` followed by post-do
  multi-pending `(await_any done)` as the next bounded subset. The selected
  source shape keeps multiple generated spawns pending, runs a deterministic
  static-parameter generated do instance, observes the pending generated
  spawns with `await_any` after that do, and still requires a later same-body
  `(await_all done)` drain before nested repeat re-entry.
- `2026-05-18`: Leaf `.106` is the next implementation frontier. It must keep
  bind handoffs, domain metadata, switch-contained static-parameter generated
  do before post-do `await_any`, new spawn after the do before drain,
  cross-domain activation, deeper branch/loop nesting, and broader
  outstanding-child semantics fail-closed.
- `2026-05-18`: Leaf `.106` shipped the selected top-level when-body nested
  repeat static-parameter generated `(do child (params ...))` before post-do
  multi-pending `(await_any done)` subset. Lowering waits for the generated
  do instance's fresh done handoff before the observation, keeps static
  generated-top parameter binding, keeps every generated-spawn done handoff
  live through the generated do and post-do `await_any`, and still requires
  the later same-body `(await_all done)` drain before nested repeat re-entry.
- `2026-05-18`: Leaf `.107` is the next selection frontier and must choose
  exactly one remaining repeat-body child activation subset before any
  further behavior-bearing implementation.
- `2026-05-18`: Leaf `.107` selects top-level switch-branch nested repeat
  static-parameter generated `(do child (params ...))` followed by post-do
  multi-pending `(await_any done)` as the next bounded subset. The selected
  source shape mirrors the shipped when-contained static-parameter leaf:
  multiple generated spawns stay pending, a deterministic static-parameter
  generated do instance runs, the post-do `await_any` observes that
  generated-spawn set, and a later same-body `(await_all done)` still drains
  every pending generated child before nested repeat re-entry.
- `2026-05-18`: Leaf `.108` is the next implementation frontier. It must keep
  bind handoffs, domain metadata, new spawn after the do before drain,
  cross-domain activation, deeper branch/loop nesting, and broader
  outstanding-child semantics fail-closed.
- `2026-05-18`: Leaf `.108` shipped the selected top-level switch-branch
  nested repeat static-parameter generated `(do child (params ...))` before
  post-do multi-pending `(await_any done)` subset. Lowering waits for the
  generated do instance's fresh done handoff before the observation, keeps
  static generated-top parameter binding, keeps every generated-spawn done
  handoff live through the generated do and post-do `await_any`, and still
  requires the later same-body `(await_all done)` drain before nested repeat
  re-entry.
- `2026-05-18`: Leaf `.109` is the next selection frontier and must choose
  exactly one remaining repeat-body child activation subset before any
  further behavior-bearing implementation.
- `2026-05-18`: Leaf `.109` selects top-level when-body nested repeat
  static-parameter generated `(do child (params ...) (bind ...))` followed
  by post-do multi-pending `(await_any done)` as the next bounded subset.
  The selected source shape extends the shipped when-contained static-
  parameter post-do `await_any` leaf with generated-top input/output binding
  handoffs for the generated do instance while preserving the same pending
  generated-spawn observation and later same-body `(await_all done)` drain.
- `2026-05-18`: Leaf `.110` is the next implementation frontier. It must
  keep domain metadata, switch-contained bound generated-do post-do
  `await_any`, new spawn after the do before drain, cross-domain activation,
  deeper branch/loop nesting, and broader outstanding-child semantics
  fail-closed.
...
| `2026-05-18` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.77` | `mdbook build docs/book`; `prove -l t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `git diff --check` | `book, book/doc audits (Files=2, Tests=242), and diff checks passed after selecting top-level when-body nested repeat local do after prior multi-pending await_any before mandatory await_all drain` |
| `2026-05-18` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.78` | `perl -Iperl -c perl/FSM/Scheduler/ISF/LoweringIR.pm`; `perl -Iperl -c t/1215-isf-spawn-parameter-binding.t`; `perl -Iperl -c t/1304-isf-repeat-body-doc-truth-audit.t`; `perl -Iperl -c t/1305-isf-book-feature-matrix-audit.t`; `perl -Iperl -c t/1307-isf-loop-body-doc-truth-audit.t`; `prove -l t/1215-isf-spawn-parameter-binding.t`; `prove -l t/1304-isf-repeat-body-doc-truth-audit.t t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `prove -l t/1103-isf-switch-branch-exits.t t/1215-isf-spawn-parameter-binding.t t/1177-isf-do-child-done-pulse.t t/1184-isf-child-transaction-target-boundary.t t/1203-isf-await-sync-clause-boundary.t t/1204-isf-child-composition-clause-boundary.t t/1241-isf-transaction-port-bindings.t t/1242-isf-port-binding-conflict-semantics.t t/1243-isf-port-binding-schedule-report.t t/1247-isf-clock-domain-partition.t t/1304-isf-repeat-body-doc-truth-audit.t t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `mdbook build docs/book`; `./bin/ci-regression isf --no-book`; `git diff --check` | `syntax, touched repeat/spawn test (Files=1, Tests=41), touched repeat/spawn/doc checks (Files=4, Tests=428), focused activation/domain/doc suite (Files=13, Tests=470), book build, full ISF gate (Files=227, Tests=1241), and diff check passed` |
| `2026-05-18` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.79` | `mdbook build docs/book`; `prove -l t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `git diff --check` | `book, book/doc audits (Files=2, Tests=247), and diff checks passed after selecting top-level switch-branch nested repeat local do after prior multi-pending await_any before mandatory await_all drain` |
| `2026-05-18` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.80` | `perl -Iperl -c perl/FSM/Scheduler/ISF/LoweringIR.pm`; `perl -Iperl -c t/1215-isf-spawn-parameter-binding.t`; `perl -Iperl -c t/1305-isf-book-feature-matrix-audit.t`; `perl -Iperl -c t/1307-isf-loop-body-doc-truth-audit.t`; `prove -l t/1215-isf-spawn-parameter-binding.t`; `prove -l t/1304-isf-repeat-body-doc-truth-audit.t t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `prove -l t/1215-isf-spawn-parameter-binding.t t/1304-isf-repeat-body-doc-truth-audit.t t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `prove -l t/1103-isf-switch-branch-exits.t t/1215-isf-spawn-parameter-binding.t t/1177-isf-do-child-done-pulse.t t/1184-isf-child-transaction-target-boundary.t t/1203-isf-await-sync-clause-boundary.t t/1204-isf-child-composition-clause-boundary.t t/1241-isf-transaction-port-bindings.t t/1242-isf-port-binding-conflict-semantics.t t/1243-isf-port-binding-schedule-report.t t/1247-isf-clock-domain-partition.t t/1304-isf-repeat-body-doc-truth-audit.t t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `mdbook build docs/book`; `./bin/ci-regression isf --no-book`; `git diff --check` | `syntax, touched repeat/spawn test (Files=1, Tests=42), touched repeat/spawn/doc checks (Files=4, Tests=434), focused activation/domain/doc suite (Files=13, Tests=476), book build, full ISF gate (Files=227, Tests=1247), and diff check passed` |
| `2026-05-18` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.81` | `mdbook build docs/book`; `prove -l t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `git diff --check` | `book, book/doc audits (Files=2, Tests=252), and diff checks passed after selecting top-level when-body nested repeat generated-child do after prior multi-pending await_any before mandatory await_all drain` |
| `2026-05-18` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.82` | `perl -Iperl -c perl/FSM/Scheduler/ISF/LoweringIR.pm`; `perl -Iperl -c t/1215-isf-spawn-parameter-binding.t`; `perl -Iperl -c t/1304-isf-repeat-body-doc-truth-audit.t`; `perl -Iperl -c t/1305-isf-book-feature-matrix-audit.t`; `perl -Iperl -c t/1307-isf-loop-body-doc-truth-audit.t`; `prove -l t/1215-isf-spawn-parameter-binding.t`; `prove -l t/1304-isf-repeat-body-doc-truth-audit.t t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `prove -l t/1103-isf-switch-branch-exits.t t/1215-isf-spawn-parameter-binding.t t/1177-isf-do-child-done-pulse.t t/1184-isf-child-transaction-target-boundary.t t/1203-isf-await-sync-clause-boundary.t t/1204-isf-child-composition-clause-boundary.t t/1241-isf-transaction-port-bindings.t t/1242-isf-port-binding-conflict-semantics.t t/1243-isf-port-binding-schedule-report.t t/1247-isf-clock-domain-partition.t t/1304-isf-repeat-body-doc-truth-audit.t t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `mdbook build docs/book`; `./bin/ci-regression isf --no-book`; `git diff --check` | `syntax, touched repeat/spawn test (Files=1, Tests=43), touched repeat/spawn/doc checks (Files=4, Tests=440), focused activation/domain/doc suite (Files=13, Tests=482), book build, full ISF gate (Files=227, Tests=1253), and diff check passed` |
| `2026-05-18` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.83` | `mdbook build docs/book`; `prove -l t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `git diff --check` | `book, book/doc audits (Files=2, Tests=257), and diff checks passed after selecting top-level switch-branch nested repeat generated-child do after prior multi-pending await_any before mandatory await_all drain` |
| `2026-05-18` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.84` | `perl -Iperl -c perl/FSM/Scheduler/ISF/LoweringIR.pm`; `perl -Iperl -c t/1215-isf-spawn-parameter-binding.t`; `perl -Iperl -c t/1304-isf-repeat-body-doc-truth-audit.t`; `perl -Iperl -c t/1305-isf-book-feature-matrix-audit.t`; `perl -Iperl -c t/1307-isf-loop-body-doc-truth-audit.t`; `prove -l t/1215-isf-spawn-parameter-binding.t t/1304-isf-repeat-body-doc-truth-audit.t t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `prove -l t/1103-isf-switch-branch-exits.t t/1215-isf-spawn-parameter-binding.t t/1177-isf-do-child-done-pulse.t t/1184-isf-child-transaction-target-boundary.t t/1203-isf-await-sync-clause-boundary.t t/1204-isf-child-composition-clause-boundary.t t/1241-isf-transaction-port-bindings.t t/1242-isf-port-binding-conflict-semantics.t t/1243-isf-port-binding-schedule-report.t t/1247-isf-clock-domain-partition.t t/1304-isf-repeat-body-doc-truth-audit.t t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `mdbook build docs/book`; `./bin/ci-regression isf --no-book`; `git diff --check` | `syntax, touched repeat/spawn test (Files=1, Tests=44), touched repeat/spawn/doc checks (Files=4, Tests=446), focused activation/domain/doc suite (Files=13, Tests=488), book build, full ISF gate (Files=227, Tests=1259), and diff check passed` |
| `2026-05-18` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.85` | `mdbook build docs/book`; `prove -l t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `git diff --check` | `book, book/doc audits (Files=2, Tests=262), and diff checks passed after selecting top-level when-body nested repeat generated do with static parameter overrides after prior multi-pending await_any before mandatory await_all drain` |
| `2026-05-18` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.86` | `perl -Iperl -c perl/FSM/Scheduler/ISF/LoweringIR.pm`; `perl -Iperl -c t/1215-isf-spawn-parameter-binding.t`; `perl -Iperl -c t/1304-isf-repeat-body-doc-truth-audit.t`; `perl -Iperl -c t/1305-isf-book-feature-matrix-audit.t`; `perl -Iperl -c t/1307-isf-loop-body-doc-truth-audit.t`; `prove -l t/1215-isf-spawn-parameter-binding.t`; `prove -l t/1215-isf-spawn-parameter-binding.t t/1304-isf-repeat-body-doc-truth-audit.t t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `prove -l t/1103-isf-switch-branch-exits.t t/1215-isf-spawn-parameter-binding.t t/1177-isf-do-child-done-pulse.t t/1184-isf-child-transaction-target-boundary.t t/1203-isf-await-sync-clause-boundary.t t/1204-isf-child-composition-clause-boundary.t t/1241-isf-transaction-port-bindings.t t/1242-isf-port-binding-conflict-semantics.t t/1243-isf-port-binding-schedule-report.t t/1247-isf-clock-domain-partition.t t/1304-isf-repeat-body-doc-truth-audit.t t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `mdbook build docs/book`; `./bin/ci-regression isf --no-book`; `git diff --check` | `syntax, touched repeat/spawn test (Files=1, Tests=45), touched repeat/spawn/doc checks (Files=4, Tests=452), focused activation/domain/doc suite (Files=13, Tests=494), book build, full ISF gate (Files=227, Tests=1265), and diff check passed` |
| `2026-05-18` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.87` | `mdbook build docs/book`; `prove -l t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `git diff --check` | `book, book/doc audits (Files=2, Tests=267), and diff checks passed after selecting top-level switch-branch nested repeat generated do with static parameter overrides after prior multi-pending await_any before mandatory await_all drain` |
| `2026-05-18` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.88` | `perl -Iperl -c perl/FSM/Scheduler/ISF/LoweringIR.pm`; `perl -Iperl -c t/1215-isf-spawn-parameter-binding.t`; `perl -Iperl -c t/1304-isf-repeat-body-doc-truth-audit.t`; `perl -Iperl -c t/1305-isf-book-feature-matrix-audit.t`; `perl -Iperl -c t/1307-isf-loop-body-doc-truth-audit.t`; `prove -l t/1215-isf-spawn-parameter-binding.t`; `prove -l t/1215-isf-spawn-parameter-binding.t t/1304-isf-repeat-body-doc-truth-audit.t t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `prove -l t/1103-isf-switch-branch-exits.t t/1215-isf-spawn-parameter-binding.t t/1177-isf-do-child-done-pulse.t t/1184-isf-child-transaction-target-boundary.t t/1203-isf-await-sync-clause-boundary.t t/1204-isf-child-composition-clause-boundary.t t/1241-isf-transaction-port-bindings.t t/1242-isf-port-binding-conflict-semantics.t t/1243-isf-port-binding-schedule-report.t t/1247-isf-clock-domain-partition.t t/1304-isf-repeat-body-doc-truth-audit.t t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `mdbook build docs/book`; `./bin/ci-regression isf --no-book`; `git diff --check` | `syntax, touched repeat/spawn test (Files=1, Tests=46), touched repeat/spawn/doc checks (Files=4, Tests=458), focused activation/domain/doc suite (Files=13, Tests=500), book build, full ISF gate (Files=227, Tests=1271), and diff check passed` |
| `2026-05-18` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.89` | `mdbook build docs/book`; `prove -l t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `git diff --check` | `book, book/doc audits (Files=2, Tests=272), and diff checks passed after selecting top-level when-body nested repeat generated do with static parameter overrides and bind handoffs after prior multi-pending await_any before mandatory await_all drain` |
| `2026-05-18` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.90` | `perl -Iperl -c perl/FSM/Scheduler/ISF/LoweringIR.pm`; `perl -Iperl -c t/1215-isf-spawn-parameter-binding.t`; `perl -Iperl -c t/1304-isf-repeat-body-doc-truth-audit.t`; `perl -Iperl -c t/1305-isf-book-feature-matrix-audit.t`; `perl -Iperl -c t/1307-isf-loop-body-doc-truth-audit.t`; `prove -l t/1215-isf-spawn-parameter-binding.t`; `prove -l t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `prove -l t/1215-isf-spawn-parameter-binding.t t/1304-isf-repeat-body-doc-truth-audit.t t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `prove -l t/1103-isf-switch-branch-exits.t t/1215-isf-spawn-parameter-binding.t t/1177-isf-do-child-done-pulse.t t/1184-isf-child-transaction-target-boundary.t t/1203-isf-await-sync-clause-boundary.t t/1204-isf-child-composition-clause-boundary.t t/1241-isf-transaction-port-bindings.t t/1242-isf-port-binding-conflict-semantics.t t/1243-isf-port-binding-schedule-report.t t/1247-isf-clock-domain-partition.t t/1304-isf-repeat-body-doc-truth-audit.t t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `mdbook build docs/book`; `./bin/ci-regression isf --no-book`; `git diff --check` | `syntax, touched repeat/spawn test (Files=1, Tests=47), doc audits (Files=2, Tests=277), touched repeat/spawn/doc checks (Files=4, Tests=464), focused activation/domain/doc suite (Files=13, Tests=506), book build, full ISF gate (Files=227, Tests=1277), and diff check passed` |
| `2026-05-18` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.91` | `mdbook build docs/book`; `prove -l t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `git diff --check` | `book, book/doc audits (Files=2, Tests=277), and diff checks passed after selecting top-level switch-branch nested repeat generated do with static parameter overrides and bind handoffs after prior multi-pending await_any before mandatory await_all drain` |
| `2026-05-18` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.92` | `perl -Iperl -c perl/FSM/Scheduler/ISF/LoweringIR.pm`; `perl -Iperl -c t/1215-isf-spawn-parameter-binding.t`; `perl -Iperl -c t/1304-isf-repeat-body-doc-truth-audit.t`; `perl -Iperl -c t/1305-isf-book-feature-matrix-audit.t`; `perl -Iperl -c t/1307-isf-loop-body-doc-truth-audit.t`; `prove -l t/1215-isf-spawn-parameter-binding.t`; `prove -l t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `prove -l t/1215-isf-spawn-parameter-binding.t t/1304-isf-repeat-body-doc-truth-audit.t t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `prove -l t/1103-isf-switch-branch-exits.t t/1215-isf-spawn-parameter-binding.t t/1177-isf-do-child-done-pulse.t t/1184-isf-child-transaction-target-boundary.t t/1203-isf-await-sync-clause-boundary.t t/1204-isf-child-composition-clause-boundary.t t/1241-isf-transaction-port-bindings.t t/1242-isf-port-binding-conflict-semantics.t t/1243-isf-port-binding-schedule-report.t t/1247-isf-clock-domain-partition.t t/1304-isf-repeat-body-doc-truth-audit.t t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `mdbook build docs/book`; `./bin/ci-regression isf --no-book`; `git diff --check` | `syntax, touched repeat/spawn test (Files=1, Tests=48), doc audits (Files=2, Tests=282), touched repeat/spawn/doc checks (Files=4, Tests=470), focused activation/domain/doc suite (Files=13, Tests=512), book build, full ISF gate (Files=227, Tests=1283), and diff check passed` |
| `2026-05-18` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.93` | `mdbook build docs/book`; `prove -l t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `git diff --check` | `book, book/doc audits (Files=2, Tests=282), and diff checks passed after selecting top-level when-body nested repeat generated do with static parameter overrides, optional bind handoffs, and same-domain metadata after prior multi-pending await_any before mandatory await_all drain` |
| `2026-05-18` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.94` | `perl -Iperl -c perl/FSM/Scheduler/ISF/LoweringIR.pm`; `perl -Iperl -c t/1215-isf-spawn-parameter-binding.t`; `perl -Iperl -c t/1304-isf-repeat-body-doc-truth-audit.t`; `perl -Iperl -c t/1305-isf-book-feature-matrix-audit.t`; `perl -Iperl -c t/1307-isf-loop-body-doc-truth-audit.t`; `prove -l t/1215-isf-spawn-parameter-binding.t`; `prove -l t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `prove -l t/1215-isf-spawn-parameter-binding.t t/1304-isf-repeat-body-doc-truth-audit.t t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `prove -l t/1103-isf-switch-branch-exits.t t/1215-isf-spawn-parameter-binding.t t/1177-isf-do-child-done-pulse.t t/1184-isf-child-transaction-target-boundary.t t/1203-isf-await-sync-clause-boundary.t t/1204-isf-child-composition-clause-boundary.t t/1241-isf-transaction-port-bindings.t t/1242-isf-port-binding-conflict-semantics.t t/1243-isf-port-binding-schedule-report.t t/1247-isf-clock-domain-partition.t t/1304-isf-repeat-body-doc-truth-audit.t t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `mdbook build docs/book`; `./bin/ci-regression isf --no-book`; `git diff --check` | `syntax, touched repeat/spawn test (Files=1, Tests=49), doc audits (Files=2, Tests=286), touched repeat/spawn/doc checks (Files=4, Tests=475), focused activation/domain/doc suite (Files=13, Tests=517), book build, full ISF gate (Files=227, Tests=1288), and diff check passed` |
| `2026-05-18` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.95` | `mdbook build docs/book`; `prove -l t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `git diff --check` | `book, book/doc audits (Files=2, Tests=286), and diff checks passed after selecting top-level switch-branch nested repeat generated do with static parameter overrides, optional bind handoffs, and same-domain metadata after prior multi-pending await_any before mandatory await_all drain` |
| `2026-05-18` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.96` | `perl -Iperl -c perl/FSM/Scheduler/ISF/LoweringIR.pm`; `perl -Iperl -c t/1215-isf-spawn-parameter-binding.t`; `perl -Iperl -c t/1304-isf-repeat-body-doc-truth-audit.t`; `perl -Iperl -c t/1305-isf-book-feature-matrix-audit.t`; `perl -Iperl -c t/1307-isf-loop-body-doc-truth-audit.t`; `prove -l t/1215-isf-spawn-parameter-binding.t`; `prove -l t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `prove -l t/1215-isf-spawn-parameter-binding.t t/1304-isf-repeat-body-doc-truth-audit.t t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `prove -l t/1103-isf-switch-branch-exits.t t/1215-isf-spawn-parameter-binding.t t/1177-isf-do-child-done-pulse.t t/1184-isf-child-transaction-target-boundary.t t/1203-isf-await-sync-clause-boundary.t t/1204-isf-child-composition-clause-boundary.t t/1241-isf-transaction-port-bindings.t t/1242-isf-port-binding-conflict-semantics.t t/1243-isf-port-binding-schedule-report.t t/1247-isf-clock-domain-partition.t t/1304-isf-repeat-body-doc-truth-audit.t t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `mdbook build docs/book`; `./bin/ci-regression isf --no-book`; `git diff --check` | `syntax, touched repeat/spawn test (Files=1, Tests=50), doc audits (Files=2, Tests=290), touched repeat/spawn/doc checks (Files=4, Tests=480), focused activation/domain/doc suite (Files=13, Tests=522), book build, full ISF gate (Files=227, Tests=1293), and diff check passed` |
| `2026-05-18` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.97` | `mdbook build docs/book`; `prove -l t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `git diff --check` | `book, book/doc audits (Files=2, Tests=290), and diff checks passed after selecting top-level when-body nested repeat local do followed by post-do multi-pending await_any before mandatory await_all drain` |
| `2026-05-18` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.98` | `perl -Iperl -c perl/FSM/Scheduler/ISF/LoweringIR.pm`; `perl -Iperl -c t/1215-isf-spawn-parameter-binding.t`; `perl -Iperl -c t/1305-isf-book-feature-matrix-audit.t`; `perl -Iperl -c t/1307-isf-loop-body-doc-truth-audit.t`; `prove -l t/1215-isf-spawn-parameter-binding.t`; `prove -l t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `prove -l t/1103-isf-switch-branch-exits.t t/1215-isf-spawn-parameter-binding.t t/1177-isf-do-child-done-pulse.t t/1184-isf-child-transaction-target-boundary.t t/1203-isf-await-sync-clause-boundary.t t/1204-isf-child-composition-clause-boundary.t t/1241-isf-transaction-port-bindings.t t/1242-isf-port-binding-conflict-semantics.t t/1243-isf-port-binding-schedule-report.t t/1247-isf-clock-domain-partition.t t/1304-isf-repeat-body-doc-truth-audit.t t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `mdbook build docs/book`; `./bin/ci-regression isf --no-book`; `git diff --check` | `syntax, touched repeat/spawn test (Files=1, Tests=51), doc audits (Files=2, Tests=295), focused activation/domain/doc suite (Files=13, Tests=528), book build, full ISF gate (Files=227, Tests=1299), and diff check passed` |
| `2026-05-18` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.99` | `mdbook build docs/book`; `prove -l t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `git diff --check` | `book, book/doc audits (Files=2, Tests=295), and diff checks passed after selecting top-level switch-branch nested repeat local do followed by post-do multi-pending await_any before mandatory await_all drain` |
| `2026-05-18` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.100` | `perl -Iperl -c perl/FSM/Scheduler/ISF/LoweringIR.pm`; `perl -Iperl -c t/1215-isf-spawn-parameter-binding.t`; `perl -Iperl -c t/1305-isf-book-feature-matrix-audit.t`; `perl -Iperl -c t/1307-isf-loop-body-doc-truth-audit.t`; `prove -l t/1215-isf-spawn-parameter-binding.t t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `mdbook build docs/book`; `./bin/ci-regression isf --no-book`; `git diff --check` | `syntax, focused repeat/spawn/doc checks (Files=3, Tests=352), book build, full ISF gate (Files=227, Tests=1305), and diff check passed` |
| `2026-05-18` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.101` | `mdbook build docs/book`; `prove -l t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `git diff --check` | `book, book/doc audits (Files=2, Tests=300), and diff checks passed after selecting top-level when-body nested repeat generated-child do followed by post-do multi-pending await_any before mandatory await_all drain` |
| `2026-05-18` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.102` | `perl -Iperl -c perl/FSM/Scheduler/ISF/LoweringIR.pm`; `perl -Iperl -c t/1215-isf-spawn-parameter-binding.t`; `perl -Iperl -c t/1305-isf-book-feature-matrix-audit.t`; `perl -Iperl -c t/1307-isf-loop-body-doc-truth-audit.t`; `prove -l t/1215-isf-spawn-parameter-binding.t`; `prove -l t/1215-isf-spawn-parameter-binding.t t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `mdbook build docs/book`; `./bin/ci-regression isf --no-book`; `git diff --check` | `syntax, touched repeat/spawn test (Files=1, Tests=53), focused repeat/spawn/doc checks (Files=3, Tests=358), book build, full ISF gate (Files=227, Tests=1311), and diff check passed` |
| `2026-05-18` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.103` | `mdbook build docs/book`; `prove -l t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `git diff --check` | `book, book/doc audits (Files=2, Tests=305), and diff checks passed after selecting top-level switch-branch nested repeat generated-child do followed by post-do multi-pending await_any before mandatory await_all drain` |
| `2026-05-18` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.104` | `perl -Iperl -c perl/FSM/Scheduler/ISF/LoweringIR.pm`; `perl -Iperl -c t/1215-isf-spawn-parameter-binding.t`; `perl -Iperl -c t/1305-isf-book-feature-matrix-audit.t`; `perl -Iperl -c t/1307-isf-loop-body-doc-truth-audit.t`; `prove -l t/1215-isf-spawn-parameter-binding.t`; `prove -l t/1215-isf-spawn-parameter-binding.t t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `mdbook build docs/book`; `./bin/ci-regression isf --no-book`; `git diff --check` | `syntax, touched repeat/spawn test (Files=1, Tests=54), focused repeat/spawn/doc checks (Files=3, Tests=364), book build, full ISF gate (Files=227, Tests=1317), and diff check passed` |
| `2026-05-18` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.105` | `mdbook build docs/book`; `prove -l t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `git diff --check` | `book, book/doc audits (Files=2, Tests=310), and diff checks passed after selecting top-level when-body nested repeat generated do with static parameter overrides followed by post-do multi-pending await_any before mandatory await_all drain` |
| `2026-05-18` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.106` | `perl -Iperl -c perl/FSM/Scheduler/ISF/LoweringIR.pm`; `perl -Iperl -c t/1215-isf-spawn-parameter-binding.t`; `perl -Iperl -c t/1305-isf-book-feature-matrix-audit.t`; `perl -Iperl -c t/1307-isf-loop-body-doc-truth-audit.t`; `prove -l t/1215-isf-spawn-parameter-binding.t`; `prove -l t/1215-isf-spawn-parameter-binding.t t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `mdbook build docs/book`; `./bin/ci-regression isf --no-book`; `git diff --check` | `syntax, touched repeat/spawn test (Files=1, Tests=55), focused repeat/spawn/doc checks (Files=3, Tests=370), book build, full ISF gate (Files=227, Tests=1323), and diff check passed` |
| `2026-05-18` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.107` | `mdbook build docs/book`; `prove -l t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `git diff --check` | `book, book/doc audits (Files=2, Tests=315), and diff checks passed after selecting top-level switch-branch nested repeat generated do with static parameter overrides followed by post-do multi-pending await_any before mandatory await_all drain` |
| `2026-05-18` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.108` | `perl -Iperl -c perl/FSM/Scheduler/ISF/LoweringIR.pm`; `perl -Iperl -c t/1215-isf-spawn-parameter-binding.t`; `perl -Iperl -c t/1305-isf-book-feature-matrix-audit.t`; `perl -Iperl -c t/1307-isf-loop-body-doc-truth-audit.t`; `prove -l t/1215-isf-spawn-parameter-binding.t`; `prove -l t/1215-isf-spawn-parameter-binding.t t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `mdbook build docs/book`; `./bin/ci-regression isf --no-book`; `git diff --check` | `syntax, touched repeat/spawn test (Files=1, Tests=56), focused repeat/spawn/doc checks (Files=3, Tests=376), book build, full ISF gate (Files=227, Tests=1329), and diff check passed` |
| `2026-05-18` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.109` | `mdbook build docs/book`; `prove -l t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `git diff --check` | `book, book/doc audits (Files=2, Tests=320), and diff checks passed after selecting top-level when-body nested repeat generated do with static parameter overrides and bind handoffs followed by post-do multi-pending await_any before mandatory await_all drain` |
| `2026-05-18` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.110` | `perl -Iperl -c perl/FSM/Scheduler/ISF/LoweringIR.pm`; `perl -Iperl -c t/1215-isf-spawn-parameter-binding.t`; `perl -Iperl -c t/1305-isf-book-feature-matrix-audit.t`; `perl -Iperl -c t/1307-isf-loop-body-doc-truth-audit.t`; `prove -l t/1215-isf-spawn-parameter-binding.t`; `prove -l t/1215-isf-spawn-parameter-binding.t t/1305-isf-book-feature-matrix-audit.t t/1307-isf-loop-body-doc-truth-audit.t`; `mdbook build docs/book`; `./bin/ci-regression isf --no-book`; `git diff --check` | `syntax, touched repeat/spawn test (Files=1, Tests=57), focused repeat/spawn/doc checks (Files=3, Tests=385), book build, full ISF gate (Files=227, Tests=1338), and diff check passed` |
...
| `ISF-REPEAT-BODY-CHILD-ACTIVATION.77` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.77: select when repeat local do after await_any` | `selected when-contained local do after prior multi-pending await_any before mandatory await_all drain` |
| `ISF-REPEAT-BODY-CHILD-ACTIVATION.78` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.78: implement when repeat local do after await_any` | `when-contained local do after prior multi-pending await_any before mandatory await_all drain shipped` |
| `ISF-REPEAT-BODY-CHILD-ACTIVATION.79` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.79: select switch repeat local do after await_any` | `selected switch-contained local do after prior multi-pending await_any before mandatory await_all drain` |
| `ISF-REPEAT-BODY-CHILD-ACTIVATION.80` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.80: implement switch repeat local do after await_any` | `switch-contained local do after prior multi-pending await_any before mandatory await_all drain shipped` |
| `ISF-REPEAT-BODY-CHILD-ACTIVATION.81` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.81: select when repeat generated-child do after await_any` | `selected when-contained generated-child do after prior multi-pending await_any before mandatory await_all drain` |
| `ISF-REPEAT-BODY-CHILD-ACTIVATION.82` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.82: implement when repeat generated-child do after await_any` | `when-contained generated-child do after prior multi-pending await_any before mandatory await_all drain shipped` |
| `ISF-REPEAT-BODY-CHILD-ACTIVATION.83` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.83: select switch repeat generated-child do after await_any` | `selected switch-contained generated-child do after prior multi-pending await_any before mandatory await_all drain` |
| `ISF-REPEAT-BODY-CHILD-ACTIVATION.84` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.84: implement switch repeat generated-child do after await_any` | `switch-contained generated-child do after prior multi-pending await_any before mandatory await_all drain shipped` |
| `ISF-REPEAT-BODY-CHILD-ACTIVATION.85` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.85: select when repeat parameterized do after await_any` | `selected when-contained static-parameter generated do after prior multi-pending await_any before mandatory await_all drain` |
| `ISF-REPEAT-BODY-CHILD-ACTIVATION.86` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.86: implement when repeat parameterized do after await_any` | `when-contained static-parameter generated do after prior multi-pending await_any before mandatory await_all drain shipped` |
| `ISF-REPEAT-BODY-CHILD-ACTIVATION.87` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.87: select switch repeat parameterized do after await_any` | `selected switch-contained static-parameter generated do after prior multi-pending await_any before mandatory await_all drain` |
| `ISF-REPEAT-BODY-CHILD-ACTIVATION.88` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.88: implement switch repeat parameterized do after await_any` | `switch-contained static-parameter generated do after prior multi-pending await_any before mandatory await_all drain shipped` |
| `ISF-REPEAT-BODY-CHILD-ACTIVATION.89` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.89: select when repeat bound do after await_any` | `selected when-contained bound generated do after prior multi-pending await_any before mandatory await_all drain` |
| `ISF-REPEAT-BODY-CHILD-ACTIVATION.90` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.90: implement when repeat bound do after await_any` | `when-contained bound generated do after prior multi-pending await_any before mandatory await_all drain shipped` |
| `ISF-REPEAT-BODY-CHILD-ACTIVATION.91` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.91: select switch repeat bound do after await_any` | `selected switch-contained bound generated do after prior multi-pending await_any before mandatory await_all drain` |
| `ISF-REPEAT-BODY-CHILD-ACTIVATION.92` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.92: implement switch repeat bound do after await_any` | `switch-contained bound generated do after prior multi-pending await_any before mandatory await_all drain shipped` |
| `ISF-REPEAT-BODY-CHILD-ACTIVATION.93` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.93: select when repeat domain do after await_any` | `selected when-contained same-domain generated do after prior multi-pending await_any before mandatory await_all drain` |
| `ISF-REPEAT-BODY-CHILD-ACTIVATION.94` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.94: implement when repeat domain do after await_any` | `when-contained same-domain generated do after prior multi-pending await_any before mandatory await_all drain shipped` |
| `ISF-REPEAT-BODY-CHILD-ACTIVATION.95` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.95: select switch repeat domain do after await_any` | `selected switch-contained same-domain generated do after prior multi-pending await_any before mandatory await_all drain` |
| `ISF-REPEAT-BODY-CHILD-ACTIVATION.96` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.96: implement switch repeat domain do after await_any` | `switch-contained same-domain generated do after prior multi-pending await_any before mandatory await_all drain shipped` |
| `ISF-REPEAT-BODY-CHILD-ACTIVATION.97` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.97: select when repeat local do before await_any` | `selected when-contained local do before post-do multi-pending await_any before mandatory await_all drain` |
| `ISF-REPEAT-BODY-CHILD-ACTIVATION.98` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.98: implement when repeat local do before await_any` | `when-contained local do before post-do multi-pending await_any before mandatory await_all drain shipped` |
| `ISF-REPEAT-BODY-CHILD-ACTIVATION.99` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.99: select switch repeat local do before await_any` | `selected switch-contained local do before post-do multi-pending await_any before mandatory await_all drain` |
| `ISF-REPEAT-BODY-CHILD-ACTIVATION.100` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.100: implement switch repeat local do before await_any` | `switch-contained local do before post-do multi-pending await_any before mandatory await_all drain shipped` |
| `ISF-REPEAT-BODY-CHILD-ACTIVATION.101` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.101: select when repeat generated-child do before await_any` | `selected when-contained generated-child do before post-do multi-pending await_any before mandatory await_all drain` |
| `ISF-REPEAT-BODY-CHILD-ACTIVATION.102` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.102: implement when repeat generated-child do before await_any` | `when-contained generated-child do before post-do multi-pending await_any before mandatory await_all drain shipped` |
| `ISF-REPEAT-BODY-CHILD-ACTIVATION.103` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.103: select switch repeat generated-child do before await_any` | `selected switch-contained generated-child do before post-do multi-pending await_any before mandatory await_all drain` |
| `ISF-REPEAT-BODY-CHILD-ACTIVATION.104` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.104: implement switch repeat generated-child do before await_any` | `switch-contained generated-child do before post-do multi-pending await_any before mandatory await_all drain shipped` |
| `ISF-REPEAT-BODY-CHILD-ACTIVATION.105` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.105: select when repeat parameterized do before await_any` | `selected when-contained static-parameter generated do before post-do multi-pending await_any before mandatory await_all drain` |
| `ISF-REPEAT-BODY-CHILD-ACTIVATION.106` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.106: implement when repeat parameterized do before await_any` | `when-contained static-parameter generated do before post-do multi-pending await_any before mandatory await_all drain shipped` |
| `ISF-REPEAT-BODY-CHILD-ACTIVATION.107` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.107: select switch repeat parameterized do before await_any` | `selected switch-contained static-parameter generated do before post-do multi-pending await_any before mandatory await_all drain` |
| `ISF-REPEAT-BODY-CHILD-ACTIVATION.108` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.108: implement switch repeat parameterized do before await_any` | `switch-contained static-parameter generated do before post-do multi-pending await_any before mandatory await_all drain shipped` |
| `ISF-REPEAT-BODY-CHILD-ACTIVATION.109` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.109: select when repeat bound do before await_any` | `selected when-contained bound generated do before post-do multi-pending await_any before mandatory await_all drain` |
| `ISF-REPEAT-BODY-CHILD-ACTIVATION.110` | `ISF-REPEAT-BODY-CHILD-ACTIVATION.110: implement when repeat bound do before await_any` | `when-contained bound generated do before post-do multi-pending await_any before mandatory await_all drain shipped` |

## Changelog

- `2026-05-18`: Shipped top-level when-body nested repeat generated blocking
  `(do child (params ...) (bind ...))` followed by post-do multi-pending
  `(await_any done)` and a later same-body `(await_all done)` drain. The
  lowerer now accepts only the when-contained static-parameter bound
  generated-do shape in that post-do observation slot, waits for the
  deterministic generated do instance's fresh done handoff before the
  observation, wires generated-top input/output binding handoffs for that
  generated do instance, and keeps the generated-spawn done set live until
  the later drain. Domain metadata, the switch-contained bound analogue, new
  spawn after the do before drain, cross-domain activation, deeper
  branch/loop nesting, and broader outstanding-child semantics remain
  fail-closed. Leaf `.111` is now the selection frontier.
- `2026-05-18`: Selected top-level when-body nested repeat generated blocking
  `(do child (params ...) (bind ...))` followed by post-do multi-pending
  `(await_any done)` as the next bounded repeat-body child activation subset.
  The selected source shape mirrors the shipped when-contained static-
  parameter post-do `await_any` leaf and adds generated-top input/output
  binding handoffs for the generated do instance: multiple generated spawns
  stay pending, the bound generated do instance runs and completes, the
  post-do `await_any` observes that generated-spawn set, and a later
  same-body `(await_all done)` still drains every pending generated child
  before nested repeat re-entry. Domain metadata, the switch-contained bound
  ...
  deferred. Leaf `.110` is now the implementation frontier.
- `2026-05-18`: Shipped top-level switch-branch nested repeat generated
  blocking `(do child (params ...))` followed by post-do multi-pending
  `(await_any done)` and a later same-body `(await_all done)` drain. The
  lowerer now accepts only the static-parameter generated-do shape in that
  switch-contained post-do observation slot, waits for the deterministic
  generated do instance's fresh done handoff before the observation, preserves
  static generated-top parameter binding, and keeps the generated-spawn done
  set live until the later drain. Bind handoffs, domain metadata, new spawn
  after the do before drain, cross-domain activation, deeper branch/loop
  nesting, and broader outstanding-child semantics remain deferred. Leaf
  `.109` is now the selection frontier.
- `2026-05-18`: Selected top-level switch-branch nested repeat generated
  blocking `(do child (params ...))` followed by post-do multi-pending
  `(await_any done)` as the next bounded repeat-body child activation subset.
  The selected source shape mirrors the shipped when-contained
  static-parameter post-do `await_any` leaf: multiple generated spawns stay
  pending, the generated do instance runs and completes, the post-do
  `await_any` observes that generated-spawn set, and a later same-body
  `(await_all done)` still drains every pending generated child before nested
  repeat re-entry. Bind handoffs, domain metadata, new spawn after the do
  before drain, cross-domain activation, deeper branch/loop nesting, and
  broader outstanding-child semantics remain deferred. Leaf `.108` is now
  the implementation frontier.
- `2026-05-18`: Shipped top-level when-body nested repeat generated blocking
  `(do child (params ...))` followed by post-do multi-pending
  `(await_any done)` and a later same-body `(await_all done)` drain. The
  lowerer now allows only the static-parameter generated-do shape in that
  post-do observation slot, waits for the deterministic generated do
  instance's fresh done handoff before the observation, preserves static
  generated-top parameter binding, and keeps the generated-spawn done set
  live until the later drain. Bind handoffs, domain metadata, the
  switch-contained static-parameter analogue, new spawn after the do before
  drain, cross-domain activation, deeper branch/loop nesting, and broader
  outstanding-child semantics remain deferred. Leaf `.107` is now the
  selection frontier.
- `2026-05-18`: Selected top-level when-body nested repeat generated blocking
  `(do child (params ...))` followed by post-do multi-pending
  `(await_any done)` as the next bounded repeat-body child activation subset.
  The selected source shape mirrors the shipped generated-child post-do
  `await_any` leaf but adds static generated-do parameter overrides: multiple
  generated spawns stay pending, the generated do instance runs and completes,
  the post-do `await_any` observes that generated-spawn set, and a later
  same-body `(await_all done)` still drains every pending generated child
  before nested repeat re-entry. Bind handoffs, domain metadata, the
  switch-contained analogue, new spawn after the do before drain,
  cross-domain activation, deeper branch/loop nesting, and broader
  outstanding-child semantics remain deferred. Leaf `.106` is now the
  implementation frontier.
- `2026-05-18`: Shipped top-level switch-branch nested repeat plain
  generated-child `(do child)` before post-do multi-pending
  `(await_any done)`. The generated-child do waits for its deterministic
  generated do instance's fresh done handoff, the post-do await_any observes
  the still-pending generated-spawn done set without draining it, and a later
  same-body `(await_all done)` gates nested repeat re-entry on every pending
  generated child. Static-parameter generated do, bind handoffs, domain
  metadata, new spawn after the do before drain, cross-domain activation,
  deeper branch/loop nesting, and broader outstanding-child semantics remain
  fail-closed. Leaf `.105` is now the selection frontier.
- `2026-05-18`: Selected top-level switch-branch nested repeat plain
  generated-child `(do child)` followed by post-do multi-pending
  `(await_any done)` as the next bounded repeat-body child activation subset.
  The selected source shape mirrors the shipped when-contained leaf: multiple
  generated spawns stay pending, a deterministic generated-child do instance
  runs, the post-do `await_any` observes that generated-spawn set, and a
  later same-body `(await_all done)` still drains every pending generated
  child before nested repeat re-entry. Static-parameter generated do, bind
  handoffs, domain metadata, new spawn after the do before drain,
  cross-domain activation, deeper branch/loop nesting, and broader
  outstanding-child semantics remain deferred. Leaf `.104` is now the
  implementation frontier.
- `2026-05-18`: Shipped top-level when-body nested repeat plain
  generated-child `(do child)` before post-do multi-pending
  `(await_any done)`. Lowering now permits only that selected generated-child
  source shape while generated nested spawns remain pending, waits for the
  generated do instance's fresh done handoff before the post-do observation,
  leaves every generated-spawn done handoff live through that observation,
  and still requires a later same-body `(await_all done)` drain before nested
  repeat re-entry. Static-parameter generated do, bind handoffs, domain
  metadata, the switch-contained generated-child analogue, new spawn after
  the do before drain, cross-domain activation, deeper branch/loop nesting,
  and broader outstanding-child semantics remain fail-closed. Leaf `.103` is
  now the selection frontier.
- `2026-05-18`: Selected top-level when-body nested repeat plain
  generated-child `(do child)` followed by post-do multi-pending
  `(await_any done)` as the next bounded repeat-body child activation subset.
  The selected source shape keeps multiple generated spawns pending, runs a
  deterministic generated-child do instance, observes the still-pending
  generated spawns after that do, and still requires a later same-body
  `(await_all done)` drain before nested repeat re-entry. Static-parameter
  generated do, bind handoffs, domain metadata, the switch-contained
  generated-child analogue, new spawn after the do before drain, cross-domain
  activation, deeper branch/loop nesting, and broader outstanding-child
  semantics remain deferred. Leaf `.102` is now the implementation frontier.
- `2026-05-18`: Shipped top-level switch-branch nested repeat local
  `(do child)` before post-do multi-pending `(await_any done)`. Lowering now
  permits only that selected local-do source shape while generated nested
  spawns remain pending, waits for the local child's fresh done pulse before
  the post-do observation, leaves every generated-spawn done handoff live
  through that observation, and still requires a later same-body
  `(await_all done)` drain before nested repeat re-entry. Generated-do
  post-do `await_any`, new spawn after the do before drain, cross-domain
  activation, deeper branch/loop nesting, and broader outstanding-child
  semantics remain fail-closed. Leaf `.101` is now the selection frontier.
- `2026-05-18`: Selected top-level switch-branch nested repeat local
  `(do child)` followed by post-do multi-pending `(await_any done)` as the
  next bounded repeat-body child activation subset. The selected source shape
  mirrors the shipped when-contained leaf: multiple generated spawns stay
  pending, only a local blocking do runs in the parent scheduled module, the
  post-do `await_any` observes that generated-spawn set, and a later same-body
  `(await_all done)` still drains every pending generated child before nested
  repeat re-entry. Generated-do post-do `await_any`, new spawn after the do
  before drain, cross-domain activation, deeper branch/loop nesting, and
  broader outstanding-child semantics remain deferred. Leaf `.100` is now the
  implementation frontier.
- `2026-05-18`: Shipped top-level when-body nested repeat local `(do child)`
  before post-do multi-pending `(await_any done)`. Lowering now permits only
  that selected local-do source shape while generated nested spawns remain
  pending, waits for the local child's fresh done pulse before the post-do
  observation, leaves every generated-spawn done handoff live through that
  observation, and still requires a later same-body `(await_all done)` drain
  before nested repeat re-entry. Switch-contained post-do `await_any`,
  generated-do post-do `await_any`, new spawn after the do before drain,
  cross-domain activation, deeper branch/loop nesting, and broader
  outstanding-child semantics remain deferred. Leaf `.99` is now the
  selection frontier.
- `2026-05-18`: Selected top-level when-body nested repeat local
  `(do child)` followed by post-do multi-pending `(await_any done)` as the
  next bounded repeat-body child activation subset. The selected source shape
  keeps multiple generated spawns pending, runs only a local blocking do in
  the parent scheduled module, observes the still-pending generated spawns
  with `await_any` after that local do, and then requires a later same-body
  `(await_all done)` drain before nested repeat re-entry.
  Switch-contained post-do `await_any`, generated-do post-do `await_any`, new
  spawn after the do before drain, cross-domain activation, deeper
  branch/loop nesting, and broader outstanding-child semantics remain
  deferred. Leaf `.98` is now the implementation frontier.
- `2026-05-18`: Shipped top-level switch-branch nested repeat generated
  blocking `(do child (params ...) [(bind ...)] (domain NAME))` after a prior
  multi-pending `(await_any done)` observation and before a mandatory later
  same-body `(await_all done)` drain. Lowering now keeps the generated-spawn
  done set live after `await_any` and through the same-domain generated do
  instance, applies that generated do instance's static parameter overrides
  and optional generated-top input/output binding handoffs once, waits for
  its fresh done handoff, records declared ownership metadata without implying
  CDC or cross-domain activation, and drains every pending generated child
  before nested repeat re-entry. `await_any` after the do, new spawn after the
  do before drain, cross-domain activation, deeper branch/loop nesting, and
  broader outstanding-child semantics remain deferred. Leaf `.97` is now the
  selection frontier.
- `2026-05-18`: Selected top-level switch-branch nested repeat generated
  blocking `(do child (params ...) [(bind ...)] (domain NAME))` after a prior
  multi-pending `(await_any done)` observation as the next bounded
  implementation subset. The selected shape has multiple generated nested
  spawns, an `await_any` observation, same-domain static-parameter generated
  blocking do with optional generated-top input/output binding handoffs while
  those generated spawns remain pending, and a later same-body
  `(await_all done)` drain before the nested repeat check can loop. The
  selected contract mirrors the shipped when-contained domain proof and
  records declared same-domain ownership metadata without implying CDC or
  cross-domain activation. `await_any` after the do, new spawn after the do
  before drain, cross-domain activation, deeper branch/loop nesting, and
  broader outstanding-child semantics remain deferred. Leaf `.96` is now the
  implementation frontier.
- `2026-05-18`: Shipped top-level when-body nested repeat generated blocking
  ...
  its fresh done handoff, records declared ownership metadata without implying
  CDC or cross-domain activation, and drains every pending generated child
  before nested repeat re-entry. The switch-contained domain analogue,
  `await_any` after the do, new spawn after the do before drain, cross-domain
  activation, deeper branch/loop nesting, and broader outstanding-child
  semantics remain deferred. Leaf `.95` is now the selection frontier.
- `2026-05-18`: Selected top-level when-body nested repeat generated blocking
  `(do child (params ...) [(bind ...)] (domain NAME))` after a prior
  multi-pending `(await_any done)` observation as the next bounded
  implementation subset. The selected shape has multiple generated nested
  ...
  those generated spawns remain pending, and a later same-body
  `(await_all done)` drain before the nested repeat check can loop. The
  selected contract records declared same-domain ownership metadata without
  implying CDC or cross-domain activation. The switch-contained domain
  analogue, `await_any` after the do, new spawn after the do before drain,
  cross-domain activation, deeper branch/loop nesting, and broader
  outstanding-child semantics remain deferred. Leaf `.94` is now the
  implementation frontier.
- `2026-05-18`: Shipped top-level switch-branch nested repeat generated
  blocking `(do child (params ...) (bind ...))` after a prior multi-pending
  `(await_any done)` observation and before a mandatory later same-body
  `(await_all done)` drain. Lowering now keeps the generated-spawn done set
  live after `await_any` and through the bound generated do instance, applies
  that generated do instance's static parameter overrides and generated-top
  input/output binding handoffs once, waits for its fresh done handoff, and
  drains every pending generated child before nested repeat re-entry. Domain
  metadata after prior `await_any`, `await_any` after the do, new spawn after
  the do before drain, cross-domain activation, deeper branch/loop nesting,
  and broader outstanding-child semantics remain deferred. Leaf `.93` is now
  the selection frontier.
- `2026-05-18`: Selected top-level switch-branch nested repeat generated
  blocking `(do child (params ...) (bind ...))` after a prior multi-pending
  `(await_any done)` observation as the next bounded implementation subset.
  The selected shape has multiple generated nested spawns, an `await_any`
  observation, static-parameter generated blocking do with generated-top
  ...
  check can loop. Domain metadata after prior `await_any`, `await_any` after
  the do, new spawn after the do before drain, cross-domain activation,
  deeper branch/loop nesting, and broader outstanding-child semantics remain
  deferred. Leaf `.92` is now the implementation frontier.
- `2026-05-18`: Shipped top-level when-body nested repeat generated blocking
  ...
  input/output binding handoffs once, waits for its fresh done handoff, and
  drains every pending generated child before nested repeat re-entry. Domain
  metadata after prior `await_any`, the switch-contained bound analogue after
  prior `await_any`, `await_any` after the do, new spawn after the do before
  drain, cross-domain activation, deeper branch/loop nesting, and broader
  outstanding-child semantics remain deferred. Leaf `.91` is now the
  selection frontier.
- `2026-05-18`: Selected top-level when-body nested repeat generated blocking
  `(do child (params ...) (bind ...))` after a prior multi-pending
  `(await_any done)` observation as the next bounded implementation subset.
  ...
  input/output binding handoffs while those generated spawns remain pending,
  and a later same-body `(await_all done)` drain before the nested repeat
  check can loop. Domain metadata, the switch-contained bound analogue,
  `await_any` after the do, new spawn after the do before drain,
  cross-domain activation, deeper branch/loop nesting, and broader
  outstanding-child semantics remain deferred. Leaf `.90` is now the
  implementation frontier.
- `2026-05-18`: Shipped top-level switch-branch nested repeat generated
  blocking `(do child (params ...))` after a prior multi-pending
  `(await_any done)` observation and before a mandatory later same-body
  `(await_all done)` drain. Lowering now keeps the generated-spawn done set
  live after `await_any` and through the static-parameter generated do
  instance, applies that generated do instance's static parameter overrides
  once in the generated top, waits for its fresh done handoff, and drains
  every pending generated child before nested repeat re-entry. Bind handoffs,
  domain metadata, `await_any` after the do, new spawn after the do before
  drain, cross-domain activation, deeper branch/loop nesting, and broader
  outstanding-child semantics remain deferred. Leaf `.89` is now the
  selection frontier.
- `2026-05-18`: Selected top-level switch-branch nested repeat generated
  blocking `(do child (params ...))` after a prior multi-pending
  `(await_any done)` observation as the next bounded implementation subset.
  The selected shape has multiple generated nested spawns, an `await_any`
  observation, static-parameter generated blocking do while those generated
  spawns remain pending, and a later same-body `(await_all done)` drain before
  the nested repeat check can loop. Bind handoffs, domain metadata,
  `await_any` after the do, new spawn after the do before drain,
  cross-domain activation, deeper branch/loop nesting, and broader
  outstanding-child semantics remain deferred. Leaf `.88` is now the
  implementation frontier.
- `2026-05-18`: Shipped top-level when-body nested repeat generated blocking
  `(do child (params ...))` after a prior multi-pending `(await_any done)`
  observation and before a mandatory later same-body `(await_all done)` drain.
  Lowering now keeps the generated-spawn done set live after `await_any` and
  through the static-parameter generated do instance, applies that generated
  do instance's static parameter overrides once in the generated top, waits
  for its fresh done handoff, and drains every pending generated child before
  nested repeat re-entry. Bind handoffs, domain metadata, the switch-contained
  static-parameter analogue, `await_any` after the do, new spawn after the do
  before drain, cross-domain activation, deeper branch/loop nesting, and
  broader outstanding-child semantics remain deferred. Leaf `.87` is now the
  selection frontier.
- `2026-05-18`: Selected top-level when-body nested repeat generated blocking
  `(do child (params ...))` after a prior multi-pending `(await_any done)`
  observation as the next bounded implementation subset. The selected shape
  has multiple generated nested spawns, an `await_any` observation,
  static-parameter generated blocking do while those generated spawns remain
  pending, and a later same-body `(await_all done)` drain before the nested
  repeat check can loop. Bind handoffs, domain metadata, the switch-contained
  analogue, `await_any` after the do, new spawn after the do before drain,
  cross-domain activation, deeper branch/loop nesting, and broader
  outstanding-child semantics remain deferred. Leaf `.86` is now the
  implementation frontier.
- `2026-05-18`: Shipped top-level switch-branch nested repeat plain
  generated-child `(do child)` after a prior multi-pending `(await_any done)`
  observation and before a mandatory later same-body `(await_all done)` drain.
  ...
  fresh done handoff, and drains every pending generated child before nested
  repeat re-entry. Parameterized, bound, or domain-qualified generated `do`
  after prior multi-pending `await_any`, `await_any` after the do, new spawn
  after the do before drain, cross-domain activation, deeper branch/loop
  nesting, and broader outstanding-child semantics remain fail-closed. Leaf
  `.85` is now the next selection frontier.
- `2026-05-18`: Selected top-level switch-branch nested repeat plain
  generated-child `(do child)` after a prior multi-pending `(await_any done)`
  observation as the next bounded implementation subset. The selected shape
  has multiple generated nested spawns, an `await_any` observation,
  generated-child blocking do while those generated spawns remain pending,
  and a later same-body `(await_all done)` drain before the nested repeat
  check can loop. Parameterized, bound, or domain-qualified generated `do`
  after prior multi-pending `await_any`, `await_any` after the do, new spawn
  after the do before drain, cross-domain activation, deeper branch/loop
  nesting, and broader outstanding-child semantics remain deferred. Leaf
  `.84` is now the implementation frontier.
- `2026-05-18`: Shipped top-level when-body nested repeat plain
  generated-child `(do child)` after a prior multi-pending `(await_any done)`
  observation and before a mandatory later same-body `(await_all done)` drain.
  Lowering now keeps the generated-spawn done set live after `await_any` and
  ...
  fresh done handoff, and drains every pending generated child before nested
  repeat re-entry. Parameterized, bound, or domain-qualified generated `do`
  after prior multi-pending `await_any`, the switch-contained generated-child
  analogue, `await_any` after the do, new spawn after the do before drain,
  cross-domain activation, deeper branch/loop nesting, and broader
  outstanding-child semantics remain fail-closed. Leaf `.83` is now the next
  selection frontier.
- `2026-05-18`: Selected top-level when-body nested repeat plain
  generated-child `(do child)` after a prior multi-pending `(await_any done)`
  observation as the next bounded implementation subset. The selected shape
  has multiple generated nested spawns, an `await_any` observation, generated-
  child blocking do while those generated spawns remain pending, and a later
  same-body `(await_all done)` drain before the nested repeat check can loop.
  Parameterized, bound, or domain-qualified generated `do` after prior
  multi-pending `await_any`, the switch-contained analogue, `await_any` after
  the do, new spawn after the do before drain, cross-domain activation,
  deeper branch/loop nesting, and broader outstanding-child semantics remain
  deferred. Leaf `.82` is now the implementation frontier.
- `2026-05-18`: Shipped top-level switch-branch nested repeat local
  `(do child)` after a prior multi-pending `(await_any done)` observation and
  before a mandatory later same-body `(await_all done)` drain. Lowering now
  keeps the generated-spawn done set live after `await_any` and through the
  local do, waits for the local child's fresh done pulse, and drains every
  pending generated child before nested repeat re-entry. Generated `do` after
  prior multi-pending `await_any`, `await_any` after the do, new spawn after
  the do before drain, cross-domain activation, deeper branch/loop nesting,
  and broader outstanding-child semantics remain fail-closed.
- `2026-05-18`: Selected top-level switch-branch nested repeat local
  `(do child)` after a prior multi-pending `(await_any done)` observation as
  the next bounded implementation subset. The selected shape mirrors the
  shipped when-contained proof: multiple generated nested spawns, an
  `await_any` observation, local blocking do while those generated spawns
  remain pending, and a later same-body `(await_all done)` drain before the
  nested repeat check can loop. Generated `do` after prior multi-pending
  `await_any`, `await_any` after the do, new spawn after the do before drain,
  cross-domain activation, deeper branch/loop nesting, and broader
  outstanding-child semantics remain deferred. Leaf `.80` is now the
  implementation frontier.
- `2026-05-18`: Shipped top-level when-body nested repeat local `(do child)`
  after a prior multi-pending `(await_any done)` observation and before a
  mandatory later same-body `(await_all done)` drain. Lowering now keeps the
  generated-spawn done set live after `await_any` and through the local do,
  waits for the local child's fresh done pulse, and drains every pending
  generated child before nested repeat re-entry. Generated `do` after prior
  multi-pending `await_any`, the switch-contained analogue, `await_any` after
  the do, new spawn after the do before drain, cross-domain activation,
  deeper branch/loop nesting, and broader outstanding-child semantics remain
  fail-closed.
- `2026-05-18`: Selected top-level when-body nested repeat local `(do child)`
  after a prior multi-pending `(await_any done)` observation as the next
  bounded implementation subset. The selected shape has multiple generated
  nested spawns, an `await_any` observation, local blocking do while those
  generated spawns remain pending, and a later same-body `(await_all done)`
  drain before the nested repeat check can loop. Generated `do` after prior
  multi-pending `await_any`, the switch-contained analogue, `await_any` after
  the do, new spawn after the do before drain, cross-domain activation,
  deeper branch/loop nesting, and broader outstanding-child semantics remain
  deferred. Leaf `.78` is now the implementation frontier.
- `2026-05-18`: Shipped top-level switch-branch nested repeat generated
