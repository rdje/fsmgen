...
| 36 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.36` | `pending` | Ships the selected switch-contained repeat generated do binding subset. |
...
- After the selected switch-contained repeat generated do binding
  implementation, which deferred repeat-body activation subset should follow:
