...
- ID: `ISF-REPEAT-BODY-CHILD-ACTIVATION.35`
  Status: `pending`
  Goal: `Select the next repeat-body child activation subset.`
  Acceptance: `Task tree, roadmap, and book backlog select the next bounded implementation subset before code; candidate subsets are generated nested do domain metadata, switch-contained bound nested do, spawn nesting, cross-domain activation, deeper branch/loop nesting, or broader outstanding-child semantics.`
...
| 35 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.35` | `pending` | Selects the next bounded repeat-body child activation subset before code. |
...
- Which deferred repeat-body activation subset should leaf `.35` select next:
  generated nested do domain metadata, switch-contained bound nested do,
