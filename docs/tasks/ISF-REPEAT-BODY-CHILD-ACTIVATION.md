...
| 66 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.66` | `pending` | Ships the selected when-contained generated static-parameter do-while-spawn-pending subset. |
...
- None for tracking. Leaf `.66` owns the selected when-contained generated
