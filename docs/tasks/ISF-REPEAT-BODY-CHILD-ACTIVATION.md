...
| 74 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.74` | `pending` | Implements the selected when-contained same-domain pending-spawn generated do subset. |
...
- None for tracking. Leaf `.74` must implement only the selected
