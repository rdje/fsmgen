...
| 76 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.76` | `pending` | Implements the selected switch-contained same-domain pending-spawn generated do subset. |
...
- None for tracking. Leaf `.76` must implement only the selected
  switch-contained same-domain pending-spawn generated do subset.
