...
| 62 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.62` | `pending` | Ships the selected when-contained generated-child do-while-spawn-pending subset. |
...
- None for tracking. Leaf `.62` owns the selected when-contained
