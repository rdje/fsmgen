...
| 87 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.87` | `pending` | Selects the next bounded repeat-body child activation subset before any further implementation. |
...
- None for tracking. Leaf `.87` must select the next bounded repeat-body
