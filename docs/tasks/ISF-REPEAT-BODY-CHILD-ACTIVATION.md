...
| 32 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.32` | `pending` | Ships the selected switch-contained repeat generated do static-parameter subset. |
...
- Which deferred repeat-body activation subset should follow after the
  selected switch-contained repeat generated do static-parameter
  implementation: generated nested do bindings, generated nested do domain
  metadata, spawn nesting, cross-domain activation, deeper branch/loop
  nesting, or broader outstanding-child semantics.
