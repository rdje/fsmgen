...
- ID: `ISF-REPEAT-BODY-CHILD-ACTIVATION.81`
  Status: `pending`
  Goal: `Select the next repeat-body child activation subset.`
  Acceptance: `Task tree, roadmap, and book backlog identify the selected leaf, source shape, exclusions, and validation plan before any further repeat-body child activation code changes.`
...
| 81 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.81` | `pending` | Selects the next bounded repeat-body child activation subset. |
...
- None for tracking. Leaf `.81` must select the next bounded subset before
  any further repeat-body child activation implementation.
