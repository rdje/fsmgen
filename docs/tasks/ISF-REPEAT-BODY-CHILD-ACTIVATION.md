...
| 72 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.72` | `pending` | Ships the selected switch-contained generated bound do-while-spawn-pending subset. |
...
- None for tracking. Leaf `.72` owns the selected switch-contained generated
  bound do-while-spawn-pending implementation before any additional repeat-body
  child activation implementation.
