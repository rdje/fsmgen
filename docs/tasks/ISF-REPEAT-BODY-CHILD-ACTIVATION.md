...
| 79 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.79` | `pending` | Selects the next bounded repeat-body child activation subset. |
...
- None for tracking. Leaf `.79` must select the next bounded subset before any
  further repeat-body child activation implementation.
