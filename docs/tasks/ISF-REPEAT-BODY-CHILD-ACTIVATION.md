...
| 70 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.70` | `pending` | Ships the selected when-contained generated bound do-while-spawn-pending subset. |
...
- None for tracking. Leaf `.70` owns the selected when-contained generated
