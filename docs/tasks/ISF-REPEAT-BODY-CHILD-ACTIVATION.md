...
| 106 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.106` | `pending` | Implements only the selected when-contained static-parameter generated-do-before-post-do-await_any subset. |
...
- None for tracking. Leaf `.106` must implement only the selected
  when-contained static-parameter generated-do-before-post-do-`await_any`
