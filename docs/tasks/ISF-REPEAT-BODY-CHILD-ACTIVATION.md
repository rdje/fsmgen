...
- ID: `ISF-REPEAT-BODY-CHILD-ACTIVATION.17`
  Status: `pending`
  Goal: `Select the next repeat-body child activation subset.`
  Acceptance: `Task tree, roadmap, and book backlog select the next bounded implementation after repeat-body generated-child do; remaining candidates include nested placement, cross-domain activation, multi-pending await_any, sample-before/after-do timing, and broader outstanding-child semantics.`
...
| 17 | `ISF-REPEAT-BODY-CHILD-ACTIVATION.17` | `pending` | Selects the next remaining repeat-body activation subset. |
...
- Which deferred repeat-body activation subset should follow: nested
  branch/loop activation, cross-domain activation, multi-pending `await_any`,
  sample-before/after-do timing, or broader outstanding-child semantics.
