...
- ID: `GITHUB-PUSH-OUTCOME-ASSURANCE.6.2.2`
  ...
  Verification: `Director-authorized push a28e9adf46b7861ee728703662ad18b64f0325d0 has exact local/upstream/remote equality. Knowledge Map run 31494487149 and Publish mdBook run 31494487147 are completed/success. Regression run 31494487181 is terminal completed/failure at 69 success, 15 failure total (14 test jobs plus aggregate), and 3 cancelled test jobs. Children .1-.18.3 map and locally repair or qualify every non-success. The replacement workflow has exact complete/disjoint 16 ordinary, 3 dedicated, 48 supported-corpus, and 68 dynamic coordinates; every matrix disables fail-fast and aggregate success requires doctrine, book, ordinary, dedicated, corpus, and dynamic success. The repaired revision now requires fresh director authorization before push and exact hosted requalification.`
  Commit: `pending`
