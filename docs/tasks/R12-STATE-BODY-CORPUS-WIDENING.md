...
| --- | --- | --- | --- |
| 1 | `R12-STATE-BODY-CORPUS-WIDENING.2` | `pending` | Focused tests already cover empty state and standalone-DT body failures; the maintained corpus does not yet carry them as stable support-accounting entries. |
...
| `R12-STATE-BODY-CORPUS-WIDENING.2` | `pending` | Implementation leaf pending. |
