...
| --- | --- | --- | --- |
| 1 | `R12-COMPOSITION-CHILD-KIND-PORTS-MAPPING-CORPUS-WIDENING.2` | `pending` | Promote focused unsupported child-kind and legacy ports-mapping diagnostics into maintained corpus coverage after ownership is committed. |
...
| `R12-COMPOSITION-CHILD-KIND-PORTS-MAPPING-CORPUS-WIDENING.2` | `pending` | `pending` |
