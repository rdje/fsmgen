...
- direct scalar actuals `=0` and `=1` plus unsized binary/decimal/hex direct actuals such as `=0b10100101`, `=0d170`, `=0xA5`, `=170`, and `=A5` may now target realized child input ports or declared top outputs by widening to the direct binding target width as numeric values, while exact-width binary/decimal/hex literal forms such as `=8'b10100101`, `=8'd165`, or `=8'hA5` must still match the target width exactly,
