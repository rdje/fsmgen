...
- composition generation results now also expose a user-facing provenance summary:
  ...
  - and non-quiet failed composition runs now also print a first bounded composition-failure summary when a blocked composition boundary can be extracted from the raised diagnostic,
