...
Runtime beat-count/`RLAST` validation over that same multiple dynamic
...
Dynamic multi-beat output-bank coverage remains limited to the selected
single-active dynamic read-data owner.
