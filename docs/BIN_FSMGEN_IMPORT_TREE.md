...
- Static trace from [bin/fsmgen](/Users/richarddje/Documents/github/fsmgen/bin/fsmgen) currently reaches `138` project files total, `137` `.pm` packages.
...
as the live owners for schema-versioned capability JSON plus its explicit top-level shell contract and bounded language-surface section contract, bounded check-JSON
...
- [perl/FSM/Support/CapabilityManifest.pm](/Users/richarddje/Documents/github/fsmgen/perl/FSM/Support/CapabilityManifest.pm): `268`
- [perl/FSM/Support/CapabilityManifestContract.pm](/Users/richarddje/Documents/github/fsmgen/perl/FSM/Support/CapabilityManifestContract.pm): `145`
...
`language_surface` section contract, the bounded `--check --json` report shape,
