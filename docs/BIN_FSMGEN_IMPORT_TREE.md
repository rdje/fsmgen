...
- Static trace from [bin/fsmgen](/Users/richarddje/Documents/github/fsmgen/bin/fsmgen) currently reaches `82` project files total, `81` `.pm` packages.
...
now narrows to the loop and termination contract, while
