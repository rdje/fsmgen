...
- Static trace from [bin/fsmgen](/Users/richarddje/Documents/github/fsmgen/bin/fsmgen) currently reaches `140` project files total, `139` `.pm` packages.
...
as the live owners for schema-versioned capability JSON plus its explicit top-level shell contract and bounded producer/documentation/language-surface section contracts, bounded check-JSON
...
- [perl/FSM/Support/CapabilityManifest.pm](/Users/richarddje/Documents/github/fsmgen/perl/FSM/Support/CapabilityManifest.pm): `272`
- [perl/FSM/Support/CapabilityManifestContract.pm](/Users/richarddje/Documents/github/fsmgen/perl/FSM/Support/CapabilityManifestContract.pm): `147`
