...
result contracts plus their nested identity-key slices, bounded `module_info`/`statistics` summary slices, and advertised top-level semantic-layer shells, shared support-accounting match-object contracts, shared public report-producer object contracts, shared public report-source object contracts, shared public report-command object contracts, shared public report-generated-output object contracts, explicit check-success result object contracts, explicit normalized-semantic success-payload object contracts, optional Verilator/Yosys generated-SystemVerilog validation,
