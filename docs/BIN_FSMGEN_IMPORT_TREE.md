...
- Static trace from [bin/fsmgen](/Users/richarddje/Documents/github/fsmgen/bin/fsmgen) currently reaches `137` project files total, `136` `.pm` packages.
...
as the live owners for schema-versioned capability JSON plus its explicit top-level shell contract, bounded check-JSON
...
- [perl/FSM/Support/CapabilityManifest.pm](/Users/richarddje/Documents/github/fsmgen/perl/FSM/Support/CapabilityManifest.pm): `266`
- [perl/FSM/Support/CapabilityManifestContract.pm](/Users/richarddje/Documents/github/fsmgen/perl/FSM/Support/CapabilityManifestContract.pm): `144`
...
`--check --json` report shape, the bounded `--emit-semantic-json` report
shape, the bounded sanitized composition-report contract, the bounded
