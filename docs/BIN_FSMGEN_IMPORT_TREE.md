...
- the next honest seams are no longer the raw recursive flattening cluster in
  ...
  `GenerationPreludeSupport`, the enable-oriented pre-stage preparation
  pocket there, or the live post-stage WEN/EN/assignment/endmodule
  sequence inside `GenerationPipelineSupport`,
