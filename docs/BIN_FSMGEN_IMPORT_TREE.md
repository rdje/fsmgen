...
- Static trace from [bin/fsmgen](/Users/richarddje/Documents/github/fsmgen/bin/fsmgen) currently reaches `139` project files total, `138` `.pm` packages.
...
as the live owners for schema-versioned capability JSON plus its explicit top-level shell contract and bounded documentation/language-surface section contracts, bounded check-JSON
...
- [perl/FSM/Support/CapabilityManifest.pm](/Users/richarddje/Documents/github/fsmgen/perl/FSM/Support/CapabilityManifest.pm): `270`
- [perl/FSM/Support/CapabilityManifestContract.pm](/Users/richarddje/Documents/github/fsmgen/perl/FSM/Support/CapabilityManifestContract.pm): `146`
