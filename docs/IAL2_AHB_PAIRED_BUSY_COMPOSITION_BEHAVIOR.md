...
It proves one BUSY transition episode, exactly one ready-and-grant-qualified
BUSY event, four data beats, held requester fields and counters across BUSY,
held subordinate continuation state and storage across BUSY, clean resumed
