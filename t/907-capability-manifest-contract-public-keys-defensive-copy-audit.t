...
subtest 'manifest contract public top-level presence keys rebuilds cleanly after caller mutation' => sub {
    ...
    is_deeply($contract->{'public_top_level_presence_keys'}, $expected->{'public_top_level_presence_keys'}, 'fresh manifest contract rebuilds clean public_top_level_presence_keys');
};
done_testing();
