...
subtest 'alias emits shared review artifacts and clean HDL' => sub {
    ...
    like(slurp(File::Spec->catfile($outdir, 'ahb_status_subordinate_byte_lane_hburst_seq.isf')), qr/ahb_access_active_q/, 'status IAL1 keeps one-transfer ownership');
    like(slurp(File::Spec->catfile($outdir, 'ahb_control_subordinate_byte_lane_hburst_seq.isf')), qr/ahb_access_active_q/, 'control IAL1 keeps one-transfer ownership');
