...
subtest 'two-subordinate exact-two paired .ahb alias mirrors generic source and lowering' => sub {
    ok(-f alias_path(), 'tracked two-subordinate exact-two paired .ahb alias exists');
    ...
    is($alias->{report}{source_object}{id}, 'fsmgen-ahb-interconnect-two-subordinate-requester-busy-insert-two-byte-lane-hburst-seq-busy-park', 'alias preserves source object');
    is($alias->{report}{source_object}{intent_name}, 'ahb_interconnect_two_subordinate_requester_busy_insert_two_byte_lane_hburst_seq_busy_park', 'alias preserves intent name');
...
subtest 'check, schedule, semantic JSON, and read-only MCP expose alias identity' => sub {
    ...
    is($schedule->{source_object}{id}, 'fsmgen-ahb-interconnect-two-subordinate-requester-busy-insert-two-byte-lane-hburst-seq-busy-park', 'schedule JSON keeps source object');
    is($schedule->{source_object}{intent_name}, 'ahb_interconnect_two_subordinate_requester_busy_insert_two_byte_lane_hburst_seq_busy_park', 'schedule JSON keeps intent name');
    ...
    is_deeply(
        ...
        [qw(ahb_control_subordinate_byte_lane_hburst_seq.isf ahb_interconnect.isf ahb_status_subordinate_byte_lane_hburst_seq.isf amba_requester_busy_insert_two.isf)],
        'schedule JSON keeps exact IAL1 artifacts',
    );
    is_deeply(
        [sort @{$schedule->{generated_artifacts}{ial0}{files}}],
        [qw(ahb_control_subordinate_byte_lane_hburst_seq.fsm ahb_interconnect.fsm ahb_status_subordinate_byte_lane_hburst_seq.fsm ahb_tb.fsm amba_requester_busy_insert_two.fsm)],
...
subtest 'review artifacts, HDL, and verifier preserve two-subordinate exact-two paired identity' => sub {
...
subtest 'profile boundaries and existing aggregate identities remain stable' => sub {
    ...
    is($generic->{support_accounting}{entry_id}, 'intent.ppif_ahb_interconnect_two_subordinate_requester_busy_insert_two_byte_lane_hburst_seq_busy_park', 'generic exact-two source keeps PPIF support identity');
    is($generic->{support_accounting}{source_kind}, 'ppif', 'generic exact-two source keeps PPIF source kind');

    my $two_subordinate_exact_one = run_json_command('./bin/fsmgen', '--quiet', '--strict', '--check', '--json', two_subordinate_exact_one_alias_path());
    is($two_subordinate_exact_one->{support_accounting}{entry_id}, 'intent.ahb_profile_alias_interconnect_requester_busy_insert_two_subordinate_byte_lane_hburst_seq_busy_park', 'two-subordinate exact-one paired alias keeps support identity');
    my $one_subordinate_exact_two = run_json_command('./bin/fsmgen', '--quiet', '--strict', '--check', '--json', one_subordinate_exact_two_alias_path());
    is($one_subordinate_exact_two->{support_accounting}{entry_id}, 'intent.ahb_profile_alias_interconnect_requester_busy_insert_two_byte_lane_hburst_seq_busy_park', 'one-subordinate exact-two paired alias keeps support identity');
...
sub ppif_relpath {
    return 'ppif/ahb_interconnect_two_subordinate_requester_busy_insert_two_byte_lane_hburst_seq_busy_park.ppif';
}

sub alias_relpath {
    return 'ppif/ahb_interconnect_two_subordinate_requester_busy_insert_two_byte_lane_hburst_seq_busy_park.ahb';
}

sub two_subordinate_exact_one_alias_path {
    return File::Spec->catfile($repo_root, 'ppif', 'ahb_interconnect_requester_busy_insert_two_subordinate_byte_lane_hburst_seq_busy_park.ahb');
}

sub one_subordinate_exact_two_alias_path {
    return File::Spec->catfile($repo_root, 'ppif', 'ahb_interconnect_requester_busy_insert_two_byte_lane_hburst_seq_busy_park.ahb');
}
...
sub support_id {
    return 'intent.ahb_profile_alias_interconnect_two_subordinate_requester_busy_insert_two_byte_lane_hburst_seq_busy_park';
}

sub coverage_key {
    return 'ial2_ahb_profile_alias_interconnect_two_subordinate_requester_busy_insert_two_byte_lane_hburst_seq_busy_park_pipeline_cli';
}
