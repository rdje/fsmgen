...
subtest 'alias generated HDL retires one qualified paired BUSY event' => sub {
    ...
    ok($compile_ok, 'Verilator builds the assertion-enabled paired BUSY alias harness')
    ...
    ok($run_ok, 'generated-HDL paired BUSY alias proof passes with assertions enabled')
