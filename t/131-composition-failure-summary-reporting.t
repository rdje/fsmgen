...
RTLIF
    ...
    is(
        $report->{blocked_reason},
        "concat operands currently accept only top-port names, top-port bit/slice forms, and fixed-width literal actuals like '=4'b1010', '=4'd10', or '=4'hA'",
...
RTLIF
    ...
    like(
        $combined_output,
        qr/Reason:\s+concat operands currently accept only top-port names, top-port bit\/slice forms, and fixed-width literal actuals like '=4'b1010', '=4'd10', or '=4'hA'/s,
