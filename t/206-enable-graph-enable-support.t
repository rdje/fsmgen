...
FSM
    ...
    like($dt_block, qr/\bassign watch_watch_1_en = watch_en;\s+\/\/ WATCH <- 1\b/, 'enable support emits simplified DT-specific enable wiring for standalone-DT assignments');
