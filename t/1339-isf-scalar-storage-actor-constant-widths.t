...
(actor unknown_constant_storage_width
  ...
  (storage
    (var counter (width STATE_W))))
ISF
        qr/\AError: actor 'unknown_constant_storage_width' storage 'counter' width token 'STATE_W' is not a declared actor scalar parameter, actor constant, or imported package scalar constant/,
...
ISF
        qr/\AError: actor 'expression_constant_storage_width' storage 'counter' width requires '\(width positive_integer_or_actor_scalar_parameter_or_actor_constant_or_qualified_package_scalar_constant\)'/,
