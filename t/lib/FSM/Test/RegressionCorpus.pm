...
my @REGRESSION_CORPUS = (
    ...
    },
    {
        ...
        coverage => 'strict_section_rejection_pipeline_cli',
        source_kind => 'fsm',
        expected_error_pattern => qr/Strict mode rejects the legacy compact '\(:= signal=value\)' top-level directive.*no strict-mode replacement.*compact ':=' surface/s,
        expected_hint_pattern => qr/no strict-mode replacement.*compact ':=' surface/s,
    },
    {
