...
ISF
    ...
    assert_parse_rejected(
        <<'ISF',
(actor enum_scalar_condition_still_deferred
  (enums
    (mode (IDLE 0) (BUSY 1)))
  (clock clk)
  (reset rst)
