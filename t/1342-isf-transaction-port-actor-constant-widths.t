...
(actor transaction_parameter_port_constant_width
  ...
  (transaction child
    ...
    (ports
      (input addr (width DATA_W)))))
ISF
        qr/\AError: actor 'transaction_parameter_port_constant_width' transaction 'child' port 'addr' width token 'DATA_W' is a transaction parameter; direct transaction-port width parameters remain deferred/,
