...
subtest 'manifest contract guidance list rebuilds cleanly after caller mutation' => sub {
    ...
    is_deeply($contract->{'guidance'}, $expected->{'guidance'}, 'fresh manifest contract rebuilds clean guidance');
};
done_testing();
