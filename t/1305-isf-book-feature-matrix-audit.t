...
my @required_non_claims = (
    ...
    'prior-active-await_any local-do spawn-after-do with a second post-spawn await_any is shipped',
    'prior-active-await_any static-parameter, bound, and same-domain generated-do spawn-after-do are shipped',
    'second post-spawn await_any in generated-do prior-observation shapes remains fail-closed',
