...
my @required_examples = (
    ...
    'top-level when-body nested repeat single generated spawn with optional static params, bind handoffs, same-domain domain metadata, source-order samples, and mandatory same-body await_all',
    ...
    'top-level when-body and switch-branch nested repeat single generated spawn with mandatory same-body await_all subsets',
