...
my @required_examples = (
    ...
    'top-level switch-branch nested repeat generated spawns with optional static params, bind handoffs, same-domain domain metadata, source-order samples, same-body await_all, and single-pending same-body await_any when exactly one generated child is pending',
    ...
    'top-level when-body and switch-branch nested repeat generated spawns with same-body await_all or single-pending same-body await_any when exactly one generated child is pending',
