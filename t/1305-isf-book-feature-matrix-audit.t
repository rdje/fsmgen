...
my @required_examples = (
    ...
    'top-level when-body nested repeat single generated spawn with optional static params, bind handoffs, same-domain domain metadata, source-order samples, same-body await_all, and single-pending same-body await_any',
    'top-level switch-branch nested repeat single generated spawn with optional static params, bind handoffs, same-domain domain metadata, source-order samples, and mandatory same-body await_all',
    ...
    'top-level when-body nested repeat single generated spawn with same-body await_all or single-pending same-body await_any and switch-branch nested repeat single generated spawn with mandatory same-body await_all subsets',
