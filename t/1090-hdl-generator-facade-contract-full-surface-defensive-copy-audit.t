...
my $sentinel = '__hdl_generator_facade_contract_full_surface_mutation__';

subtest 'HDLGenerator facade contract full surface rebuilds cleanly' => sub {
    ...
    is_deeply($second, $expected, 'fresh facade contract rebuilds clean full surface');
};
