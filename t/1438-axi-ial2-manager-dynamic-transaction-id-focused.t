...
my @DYNAMIC_CASES = (
    ...
    {
        label        => 'mixed dynamic/static write BID same-ID issue-order queue',
        relpath      => 'ppif/axi_manager_capacity_status_write_mixed_dynamic_static_same_id_issue_order_queue.ppif',
        object_id    => 'axi-manager-capacity-status-write-mixed-dynamic-static-same-id-issue-order-queue',
        intent_name  => 'axi_manager_capacity_status_write_mixed_dynamic_static_same_id_issue_order_queue',
        entry_id     => 'intent.ppif_axi_manager_capacity_status_write_mixed_dynamic_static_same_id_issue_order_queue',
        coverage     => 'ial2_ppif_manager_capacity_status_write_mixed_dynamic_static_same_id_issue_order_queue_pipeline_cli',
        behavior     => 'mixed_dynamic_static_write_same_id_issue_order_queue',
    },
    {
        label        => 'mixed dynamic/static read RID same-ID issue-order queue',
        relpath      => 'ppif/axi_manager_capacity_status_read_mixed_dynamic_static_same_id_issue_order_queue.ppif',
        object_id    => 'axi-manager-capacity-status-read-mixed-dynamic-static-same-id-issue-order-queue',
        intent_name  => 'axi_manager_capacity_status_read_mixed_dynamic_static_same_id_issue_order_queue',
        entry_id     => 'intent.ppif_axi_manager_capacity_status_read_mixed_dynamic_static_same_id_issue_order_queue',
        coverage     => 'ial2_ppif_manager_capacity_status_read_mixed_dynamic_static_same_id_issue_order_queue_pipeline_cli',
        behavior     => 'mixed_dynamic_static_read_same_id_issue_order_queue',
    },
    {
        label        => 'mixed dynamic/static read RID/RLAST same-ID issue-order queue',
        relpath      => 'ppif/axi_manager_capacity_status_read_mixed_dynamic_static_burst_last_same_id_issue_order_queue.ppif',
        object_id    => 'axi-manager-capacity-status-read-mixed-dynamic-static-burst-last-same-id-issue-order-queue',
        intent_name  => 'axi_manager_capacity_status_read_mixed_dynamic_static_burst_last_same_id_issue_order_queue',
        entry_id     => 'intent.ppif_axi_manager_capacity_status_read_mixed_dynamic_static_burst_last_same_id_issue_order_queue',
        coverage     => 'ial2_ppif_manager_capacity_status_read_mixed_dynamic_static_burst_last_same_id_issue_order_queue_pipeline_cli',
        behavior     => 'mixed_dynamic_static_read_burst_last_same_id_issue_order_queue',
    },
    {
        label        => 'dynamic write BID depth-3 same-ID issue-order queue',
        relpath      => 'ppif/axi_manager_capacity_status_dynamic_write_depth3_same_id_issue_order_queue.ppif',
        object_id    => 'axi-manager-capacity-status-dynamic-write-depth3-same-id-issue-order-queue',
        intent_name  => 'axi_manager_capacity_status_dynamic_write_depth3_same_id_issue_order_queue',
        entry_id     => 'intent.ppif_axi_manager_capacity_status_dynamic_write_depth3_same_id_issue_order_queue',
        coverage     => 'ial2_ppif_manager_capacity_status_dynamic_write_depth3_same_id_issue_order_queue_pipeline_cli',
        behavior     => 'dynamic_write_depth3_same_id_issue_order_queue',
    },
    {
    ...
    {
        label        => 'dynamic read RID depth-3 same-ID issue-order queue',
        relpath      => 'ppif/axi_manager_capacity_status_dynamic_read_depth3_same_id_issue_order_queue.ppif',
        object_id    => 'axi-manager-capacity-status-dynamic-read-depth3-same-id-issue-order-queue',
        intent_name  => 'axi_manager_capacity_status_dynamic_read_depth3_same_id_issue_order_queue',
        entry_id     => 'intent.ppif_axi_manager_capacity_status_dynamic_read_depth3_same_id_issue_order_queue',
        coverage     => 'ial2_ppif_manager_capacity_status_dynamic_read_depth3_same_id_issue_order_queue_pipeline_cli',
        behavior     => 'dynamic_read_depth3_same_id_issue_order_queue',
    },
    {
    ...
    {
        label        => 'dynamic read RID/RLAST depth-3 same-ID issue-order queue',
        relpath      => 'ppif/axi_manager_capacity_status_dynamic_read_burst_last_depth3_same_id_issue_order_queue.ppif',
        object_id    => 'axi-manager-capacity-status-dynamic-read-burst-last-depth3-same-id-issue-order-queue',
        intent_name  => 'axi_manager_capacity_status_dynamic_read_burst_last_depth3_same_id_issue_order_queue',
        entry_id     => 'intent.ppif_axi_manager_capacity_status_dynamic_read_burst_last_depth3_same_id_issue_order_queue',
        coverage     => 'ial2_ppif_manager_capacity_status_dynamic_read_burst_last_depth3_same_id_issue_order_queue_pipeline_cli',
    ...
    {
        label        => 'dynamic read RID/RLAST depth-3 same-ID issue-order queue read-data burst-length',
        relpath      => 'ppif/axi_manager_capacity_status_dynamic_read_burst_last_depth3_same_id_issue_order_queue_read_data_burst_length.ppif',
        object_id    => 'axi-manager-capacity-status-dynamic-read-burst-last-depth3-same-id-issue-order-queue-read-data-burst-length',
        intent_name  => 'axi_manager_capacity_status_dynamic_read_burst_last_depth3_same_id_issue_order_queue_read_data_burst_length',
        entry_id     => 'intent.ppif_axi_manager_capacity_status_dynamic_read_burst_last_depth3_same_id_issue_order_queue_read_data_burst_length',
        coverage     => 'ial2_ppif_manager_capacity_status_dynamic_read_burst_last_depth3_same_id_issue_order_queue_read_data_burst_length_pipeline_cli',
    ...
    {
        label        => 'dynamic read RID/RLAST depth-3 same-ID issue-order queue read-data multi-beat output banks',
        relpath      => 'ppif/axi_manager_capacity_status_dynamic_read_burst_last_depth3_same_id_issue_order_queue_read_data_multi_beat.ppif',
        object_id    => 'axi-manager-capacity-status-dynamic-read-burst-last-depth3-same-id-issue-order-queue-read-data-multi-beat',
        intent_name  => 'axi_manager_capacity_status_dynamic_read_burst_last_depth3_same_id_issue_order_queue_read_data_multi_beat',
        entry_id     => 'intent.ppif_axi_manager_capacity_status_dynamic_read_burst_last_depth3_same_id_issue_order_queue_read_data_multi_beat',
        coverage     => 'ial2_ppif_manager_capacity_status_dynamic_read_burst_last_depth3_same_id_issue_order_queue_read_data_multi_beat_pipeline_cli',
        behavior     => 'dynamic_read_burst_last_depth3_same_id_issue_order_queue_read_data_multi_beat',
    },
    {
    ...
    {
        label        => 'dynamic read RID/RLAST same-ID issue-order queue read-data burst-length',
        relpath      => 'ppif/axi_manager_capacity_status_dynamic_read_burst_last_same_id_issue_order_queue_read_data_burst_length.ppif',
        object_id    => 'axi-manager-capacity-status-dynamic-read-burst-last-same-id-issue-order-queue-read-data-burst-length',
        intent_name  => 'axi_manager_capacity_status_dynamic_read_burst_last_same_id_issue_order_queue_read_data_burst_length',
        entry_id     => 'intent.ppif_axi_manager_capacity_status_dynamic_read_burst_last_same_id_issue_order_queue_read_data_burst_length',
        coverage     => 'ial2_ppif_manager_capacity_status_dynamic_read_burst_last_same_id_issue_order_queue_read_data_burst_length_pipeline_cli',
        behavior     => 'dynamic_read_burst_last_same_id_issue_order_queue_read_data_burst_length',
    },
    {
        label        => 'dynamic read RID/RLAST same-ID issue-order queue read-data runtime burst-length validation',
        relpath      => 'ppif/axi_manager_capacity_status_dynamic_read_burst_last_same_id_issue_order_queue_read_data_burst_length_runtime_assertion.ppif',
        object_id    => 'axi-manager-capacity-status-dynamic-read-burst-last-same-id-issue-order-queue-read-data-burst-length-runtime-assertion',
        intent_name  => 'axi_manager_capacity_status_dynamic_read_burst_last_same_id_issue_order_queue_read_data_burst_length_runtime_assertion',
        entry_id     => 'intent.ppif_axi_manager_capacity_status_dynamic_read_burst_last_same_id_issue_order_queue_read_data_burst_length_runtime_assertion',
        coverage     => 'ial2_ppif_manager_capacity_status_dynamic_read_burst_last_same_id_issue_order_queue_read_data_burst_length_runtime_assertion_pipeline_cli',
        behavior     => 'dynamic_read_burst_last_same_id_issue_order_queue_read_data_burst_length_runtime_assertion',
    },
    {
        label        => 'dynamic read RID/RLAST same-ID issue-order queue read-data multi-beat output bank',
        relpath      => 'ppif/axi_manager_capacity_status_dynamic_read_burst_last_same_id_issue_order_queue_read_data_multi_beat.ppif',
        object_id    => 'axi-manager-capacity-status-dynamic-read-burst-last-same-id-issue-order-queue-read-data-multi-beat',
        intent_name  => 'axi_manager_capacity_status_dynamic_read_burst_last_same_id_issue_order_queue_read_data_multi_beat',
        entry_id     => 'intent.ppif_axi_manager_capacity_status_dynamic_read_burst_last_same_id_issue_order_queue_read_data_multi_beat',
        coverage     => 'ial2_ppif_manager_capacity_status_dynamic_read_burst_last_same_id_issue_order_queue_read_data_multi_beat_pipeline_cli',
        behavior     => 'dynamic_read_burst_last_same_id_issue_order_queue_read_data_multi_beat',
    },
    {
...
sub assert_dynamic_behavior {
    ...
    if ($case->{behavior} eq 'mixed_dynamic_static_write_same_id_issue_order_queue') {
        like($isf, qr/\(input axi0_w0_request\)/, 'mixed write issue-order queue declares dynamic request input');
        like($isf, qr/\(input axi0_w1_request\)/, 'mixed write issue-order queue declares static request input');
        like($isf, qr/\(input axi0_awid \(width 4\)\)/, 'mixed write issue-order queue declares AWID input');
        like($isf, qr/\(input axi0_bid \(width 4\)\)/, 'mixed write issue-order queue declares BID input');
        like($isf, qr/\(output axi0_w0_complete\)/, 'mixed write issue-order queue exposes dynamic completion output');
        like($isf, qr/\(output axi0_w1_complete\)/, 'mixed write issue-order queue exposes static completion output');
        unlike($isf, qr/axi0_w0_dynamic_busy_q/, 'mixed write issue-order queue does not allocate legacy dynamic busy state');
        unlike($isf, qr/axi0_w1_static_busy_q/, 'mixed write issue-order queue does not allocate legacy static busy state');
        like($isf, qr/\(var axi0_write_mixed_dynamic_static_same_id_issue_order_slot0_w0_q \(width 1\)\)/, 'mixed write issue-order queue allocates slot0 dynamic bit');
        like($isf, qr/\(var axi0_write_mixed_dynamic_static_same_id_issue_order_slot0_id_q \(width 4\)\)/, 'mixed write issue-order queue allocates slot0 ID');
        like($isf, qr/\(var axi0_write_mixed_dynamic_static_same_id_issue_order_slot1_w1_q \(width 1\)\)/, 'mixed write issue-order queue allocates slot1 static bit');
        like($isf, qr/\(var axi0_write_mixed_dynamic_static_same_id_issue_order_slot1_id_q \(width 4\)\)/, 'mixed write issue-order queue allocates slot1 ID');
        like($isf, qr/\(rule axi0_write_mixed_dynamic_static_same_id_issue_order_empty_enqueue_w0[\s\S]*\(axi0_write_mixed_dynamic_static_same_id_issue_order_slot0_id_q axi0_awid\)\)/, 'mixed write issue-order queue captures AWID into empty slot0');
        like($isf, qr/\(rule axi0_write_mixed_dynamic_static_same_id_issue_order_empty_enqueue_w1[\s\S]*\(axi0_write_mixed_dynamic_static_same_id_issue_order_slot0_id_q 4'd3\)\)/, 'mixed write issue-order queue captures static literal into empty slot0');
        like($isf, qr/\(rule axi0_write_mixed_dynamic_static_same_id_issue_order_w0_w1_dequeue_enqueue_w1[\s\S]*\(axi0_write_mixed_dynamic_static_same_id_issue_order_slot1_id_q 4'd3\)\)/, 'mixed write issue-order queue recaptures static literal after selected dequeue');
        like($isf, qr/\(rule axi0_w0_response_demux [\s\S]*axi0_write_mixed_dynamic_static_same_id_issue_order_slot0_id_q[\s\S]*axi0_write_mixed_dynamic_static_same_id_issue_order_slot1_id_q[\s\S]*\(pulse axi0_w0_complete\)\)/, 'mixed write issue-order queue emits earliest matching dynamic BID demux');
        like($isf, qr/\(rule axi0_w1_response_demux [\s\S]*axi0_write_mixed_dynamic_static_same_id_issue_order_slot0_id_q[\s\S]*axi0_write_mixed_dynamic_static_same_id_issue_order_slot1_id_q[\s\S]*\(pulse axi0_w1_complete\)\)/, 'mixed write issue-order queue emits earliest matching static BID demux');
        assert_mixed_dynamic_static_write_same_id_issue_order_queue_report($result->{report});
        my $hdl = hdl_for('axi0_capacity_status', $fsm);
        like($hdl, qr/\breg\s+\[3:0\]\s+axi0_write_mixed_dynamic_static_same_id_issue_order_slot0_id_q\b/, 'SystemVerilog declares mixed slot0 ID register');
        like($hdl, qr/\breg\s+\[3:0\]\s+axi0_write_mixed_dynamic_static_same_id_issue_order_slot1_id_q\b/, 'SystemVerilog declares mixed slot1 ID register');
        like($hdl, qr/axi0_write_mixed_dynamic_static_same_id_issue_order_slot1_id_q_next\s*=\s*4'd3\s*;/, 'SystemVerilog recaptures static literal into a queue slot');
        return;
    }

    if ($case->{behavior} eq 'mixed_dynamic_static_read_same_id_issue_order_queue') {
        like($isf, qr/\(input axi0_r0_request\)/, 'mixed read issue-order queue declares dynamic request input');
        like($isf, qr/\(input axi0_r1_request\)/, 'mixed read issue-order queue declares static request input');
        like($isf, qr/\(input axi0_arid \(width 4\)\)/, 'mixed read issue-order queue declares ARID input');
        like($isf, qr/\(input axi0_rid \(width 4\)\)/, 'mixed read issue-order queue declares RID input');
        like($isf, qr/\(output axi0_r0_complete\)/, 'mixed read issue-order queue exposes dynamic completion output');
        like($isf, qr/\(output axi0_r1_complete\)/, 'mixed read issue-order queue exposes static completion output');
        unlike($isf, qr/axi0_r0_dynamic_busy_q/, 'mixed read issue-order queue does not allocate legacy dynamic busy state');
        unlike($isf, qr/axi0_r1_static_busy_q/, 'mixed read issue-order queue does not allocate legacy static busy state');
        like($isf, qr/\(var axi0_read_mixed_dynamic_static_same_id_issue_order_slot0_r0_q \(width 1\)\)/, 'mixed read issue-order queue allocates slot0 dynamic bit');
        like($isf, qr/\(var axi0_read_mixed_dynamic_static_same_id_issue_order_slot0_id_q \(width 4\)\)/, 'mixed read issue-order queue allocates slot0 ID');
        like($isf, qr/\(var axi0_read_mixed_dynamic_static_same_id_issue_order_slot1_r1_q \(width 1\)\)/, 'mixed read issue-order queue allocates slot1 static bit');
        like($isf, qr/\(var axi0_read_mixed_dynamic_static_same_id_issue_order_slot1_id_q \(width 4\)\)/, 'mixed read issue-order queue allocates slot1 ID');
        like($isf, qr/\(rule axi0_read_mixed_dynamic_static_same_id_issue_order_empty_enqueue_r0[\s\S]*\(axi0_read_mixed_dynamic_static_same_id_issue_order_slot0_id_q axi0_arid\)\)/, 'mixed read issue-order queue captures ARID into empty slot0');
        like($isf, qr/\(rule axi0_read_mixed_dynamic_static_same_id_issue_order_empty_enqueue_r1[\s\S]*\(axi0_read_mixed_dynamic_static_same_id_issue_order_slot0_id_q 4'd3\)\)/, 'mixed read issue-order queue captures static literal into empty slot0');
        like($isf, qr/\(rule axi0_read_mixed_dynamic_static_same_id_issue_order_r0_r1_dequeue_enqueue_r1[\s\S]*\(axi0_read_mixed_dynamic_static_same_id_issue_order_slot1_id_q 4'd3\)\)/, 'mixed read issue-order queue recaptures static literal after selected dequeue');
        like($isf, qr/\(rule axi0_r0_response_demux [\s\S]*axi0_read_mixed_dynamic_static_same_id_issue_order_slot0_id_q[\s\S]*axi0_read_mixed_dynamic_static_same_id_issue_order_slot1_id_q[\s\S]*\(pulse axi0_r0_complete\)\)/, 'mixed read issue-order queue emits earliest matching dynamic RID demux');
        like($isf, qr/\(rule axi0_r1_response_demux [\s\S]*axi0_read_mixed_dynamic_static_same_id_issue_order_slot0_id_q[\s\S]*axi0_read_mixed_dynamic_static_same_id_issue_order_slot1_id_q[\s\S]*\(pulse axi0_r1_complete\)\)/, 'mixed read issue-order queue emits earliest matching static RID demux');
        assert_mixed_dynamic_static_read_same_id_issue_order_queue_report($result->{report});
        return;
    }

    if ($case->{behavior} eq 'mixed_dynamic_static_read_burst_last_same_id_issue_order_queue') {
        like($isf, qr/\(input axi0_r0_request\)/, 'mixed read burst-last issue-order queue declares dynamic request input');
        like($isf, qr/\(input axi0_r1_request\)/, 'mixed read burst-last issue-order queue declares static request input');
        like($isf, qr/\(input axi0_arid \(width 4\)\)/, 'mixed read burst-last issue-order queue declares ARID input');
        like($isf, qr/\(input axi0_rid \(width 4\)\)/, 'mixed read burst-last issue-order queue declares RID input');
        like($isf, qr/\(input axi0_rlast\)/, 'mixed read burst-last issue-order queue declares RLAST input');
        like($isf, qr/\(output axi0_r0_complete\)/, 'mixed read burst-last issue-order queue exposes dynamic completion output');
        like($isf, qr/\(output axi0_r1_complete\)/, 'mixed read burst-last issue-order queue exposes static completion output');
        unlike($isf, qr/axi0_r0_dynamic_busy_q/, 'mixed read burst-last issue-order queue does not allocate legacy dynamic busy state');
        unlike($isf, qr/axi0_r1_static_busy_q/, 'mixed read burst-last issue-order queue does not allocate legacy static busy state');
        like($isf, qr/\(var axi0_read_mixed_dynamic_static_same_id_issue_order_slot0_r0_q \(width 1\)\)/, 'mixed read burst-last issue-order queue allocates slot0 dynamic bit');
        like($isf, qr/\(var axi0_read_mixed_dynamic_static_same_id_issue_order_slot0_id_q \(width 4\)\)/, 'mixed read burst-last issue-order queue allocates slot0 ID');
        like($isf, qr/\(var axi0_read_mixed_dynamic_static_same_id_issue_order_slot1_r1_q \(width 1\)\)/, 'mixed read burst-last issue-order queue allocates slot1 static bit');
        like($isf, qr/\(var axi0_read_mixed_dynamic_static_same_id_issue_order_slot1_id_q \(width 4\)\)/, 'mixed read burst-last issue-order queue allocates slot1 ID');
        like($isf, qr/\(rule axi0_read_mixed_dynamic_static_same_id_issue_order_empty_enqueue_r0[\s\S]*\(axi0_read_mixed_dynamic_static_same_id_issue_order_slot0_id_q axi0_arid\)\)/, 'mixed read burst-last issue-order queue captures ARID into empty slot0');
        like($isf, qr/\(rule axi0_read_mixed_dynamic_static_same_id_issue_order_empty_enqueue_r1[\s\S]*\(axi0_read_mixed_dynamic_static_same_id_issue_order_slot0_id_q 4'd3\)\)/, 'mixed read burst-last issue-order queue captures static literal into empty slot0');
        like($isf, qr/\(rule axi0_read_mixed_dynamic_static_same_id_issue_order_r0_r1_dequeue_enqueue_r1[\s\S]*\(axi0_read_mixed_dynamic_static_same_id_issue_order_slot1_id_q 4'd3\)\)/, 'mixed read burst-last issue-order queue recaptures static literal after selected dequeue');
        like($isf, qr/\(rule axi0_r0_response_demux [\s\S]*axi0_read_mixed_dynamic_static_same_id_issue_order_slot0_id_q[\s\S]*axi0_rlast[\s\S]*\(pulse axi0_r0_complete\)\)/, 'mixed read burst-last issue-order queue emits final dynamic RID/RLAST demux');
        like($isf, qr/\(rule axi0_r1_response_demux [\s\S]*axi0_read_mixed_dynamic_static_same_id_issue_order_slot0_id_q[\s\S]*axi0_rlast[\s\S]*\(pulse axi0_r1_complete\)\)/, 'mixed read burst-last issue-order queue emits final static RID/RLAST demux');
        like($isf, qr/read dynamic same-ID non-last response beat does not dequeue/, 'mixed read burst-last issue-order queue emits non-last no-dequeue assertion');
        assert_mixed_dynamic_static_read_same_id_issue_order_queue_report($result->{report}, burst_last => 1);
        my $hdl = hdl_for('axi0_capacity_status', $fsm);
    ...
    if ($case->{behavior} eq 'dynamic_write_depth3_same_id_issue_order_queue') {
        like($isf, qr/\(input axi0_w0_request\)/, 'dynamic write depth-3 issue-order queue declares w0 request input');
        like($isf, qr/\(input axi0_w1_request\)/, 'dynamic write depth-3 issue-order queue declares w1 request input');
        like($isf, qr/\(input axi0_w2_request\)/, 'dynamic write depth-3 issue-order queue declares w2 request input');
        like($isf, qr/\(input axi0_awid \(width 4\)\)/, 'dynamic write depth-3 issue-order queue declares AWID input');
        like($isf, qr/\(input axi0_bid \(width 4\)\)/, 'dynamic write depth-3 issue-order queue declares BID input');
        like($isf, qr/\(output axi0_w2_complete\)/, 'dynamic write depth-3 issue-order queue exposes w2 completion output');
        unlike($isf, qr/axi0_w2_dynamic_id_q/, 'dynamic write depth-3 issue-order queue does not allocate legacy w2 selected-ID storage');
        like($isf, qr/\(var axi0_write_dynamic_same_id_issue_order_slot2_w2_q \(width 1\)\)/, 'dynamic write depth-3 issue-order queue allocates slot2 w2 bit');
        like($isf, qr/\(var axi0_write_dynamic_same_id_issue_order_slot2_id_q \(width 4\)\)/, 'dynamic write depth-3 issue-order queue allocates slot2 captured AWID');
        like($isf, qr/\(rule axi0_write_dynamic_same_id_issue_order_w2_w1_w0_dequeue_enqueue_w0[\s\S]*\(axi0_write_dynamic_same_id_issue_order_slot2_id_q axi0_awid\)\)/, 'dynamic write depth-3 issue-order queue refreshes tail-selected recaptured AWID');
        like($isf, qr/\(rule axi0_write_dynamic_same_id_issue_order_w0_w1_dequeue_w0_enqueue_w2[\s\S]*\(axi0_write_dynamic_same_id_issue_order_slot0_id_q axi0_write_dynamic_same_id_issue_order_slot1_id_q\)[\s\S]*\(axi0_write_dynamic_same_id_issue_order_slot1_id_q axi0_awid\)\)/, 'dynamic write depth-3 issue-order queue disambiguates cross-transaction selected dequeue plus enqueue');
        like($isf, qr/\(rule axi0_w2_response_demux [\s\S]*axi0_write_dynamic_same_id_issue_order_slot0_id_q[\s\S]*axi0_write_dynamic_same_id_issue_order_slot2_id_q[\s\S]*\(pulse axi0_w2_complete\)\)/, 'dynamic write depth-3 issue-order queue emits earliest matching w2 BID demux');
        like($isf, qr/write dynamic same-ID issue-order queue slot 2 is one-hot-or-empty/, 'dynamic write depth-3 issue-order queue emits slot2 onehot assertion');
        like($isf, qr/write dynamic same-ID issue-order queue completion for w2 follows selected runtime-ID match/, 'dynamic write depth-3 issue-order queue emits w2 selected-match assertion');
        assert_dynamic_write_depth3_same_id_issue_order_queue_report($result->{report});
        my $hdl = hdl_for('axi0_capacity_status', $fsm);
        like($hdl, qr/\breg\s+\[3:0\]\s+axi0_write_dynamic_same_id_issue_order_slot2_id_q\b/, 'SystemVerilog declares slot2 captured AWID');
        like($hdl, qr/axi0_write_dynamic_same_id_issue_order_slot1_id_q_next\s*=\s*axi0_awid\s*;/, 'SystemVerilog recaptures AWID into a compacted queue slot');
        return;
    }
    ...
    if ($case->{behavior} eq 'dynamic_read_depth3_same_id_issue_order_queue') {
        like($isf, qr/\(input axi0_r0_request\)/, 'dynamic read depth-3 issue-order queue declares r0 request input');
        like($isf, qr/\(input axi0_r1_request\)/, 'dynamic read depth-3 issue-order queue declares r1 request input');
        like($isf, qr/\(input axi0_r2_request\)/, 'dynamic read depth-3 issue-order queue declares r2 request input');
        like($isf, qr/\(input axi0_arid \(width 4\)\)/, 'dynamic read depth-3 issue-order queue declares ARID input');
        like($isf, qr/\(input axi0_rid \(width 4\)\)/, 'dynamic read depth-3 issue-order queue declares RID input');
        like($isf, qr/\(output axi0_r2_complete\)/, 'dynamic read depth-3 issue-order queue exposes r2 completion output');
        unlike($isf, qr/axi0_r2_dynamic_id_q/, 'dynamic read depth-3 issue-order queue does not allocate legacy r2 selected-ID storage');
        like($isf, qr/\(var axi0_read_dynamic_same_id_issue_order_slot2_r2_q \(width 1\)\)/, 'dynamic read depth-3 issue-order queue allocates slot2 r2 bit');
        like($isf, qr/\(var axi0_read_dynamic_same_id_issue_order_slot2_id_q \(width 4\)\)/, 'dynamic read depth-3 issue-order queue allocates slot2 captured ARID');
        like($isf, qr/\(rule axi0_read_dynamic_same_id_issue_order_r2_r1_r0_dequeue_enqueue_r0[\s\S]*\(axi0_read_dynamic_same_id_issue_order_slot2_id_q axi0_arid\)\)/, 'dynamic read depth-3 issue-order queue refreshes tail-selected recaptured ARID');
        like($isf, qr/\(rule axi0_read_dynamic_same_id_issue_order_r0_r1_dequeue_r0_enqueue_r2[\s\S]*\(axi0_read_dynamic_same_id_issue_order_slot0_id_q axi0_read_dynamic_same_id_issue_order_slot1_id_q\)[\s\S]*\(axi0_read_dynamic_same_id_issue_order_slot1_id_q axi0_arid\)\)/, 'dynamic read depth-3 issue-order queue disambiguates cross-transaction selected dequeue plus enqueue');
        like($isf, qr/\(rule axi0_r2_response_demux [\s\S]*axi0_read_dynamic_same_id_issue_order_slot0_id_q[\s\S]*axi0_read_dynamic_same_id_issue_order_slot2_id_q[\s\S]*\(pulse axi0_r2_complete\)\)/, 'dynamic read depth-3 issue-order queue emits earliest matching r2 RID demux');
        like($isf, qr/read dynamic same-ID issue-order queue slot 2 is one-hot-or-empty/, 'dynamic read depth-3 issue-order queue emits slot2 onehot assertion');
        like($isf, qr/read dynamic same-ID issue-order queue completion for r2 follows selected runtime-ID match/, 'dynamic read depth-3 issue-order queue emits r2 selected-match assertion');
        assert_dynamic_read_depth3_same_id_issue_order_queue_report($result->{report});
        my $hdl = hdl_for('axi0_capacity_status', $fsm);
    ...
    if ($case->{behavior} eq 'dynamic_read_burst_last_depth3_same_id_issue_order_queue') {
        like($isf, qr/\(input axi0_r0_request\)/, 'dynamic read burst-last depth-3 issue-order queue declares r0 request input');
        like($isf, qr/\(input axi0_r1_request\)/, 'dynamic read burst-last depth-3 issue-order queue declares r1 request input');
        like($isf, qr/\(input axi0_r2_request\)/, 'dynamic read burst-last depth-3 issue-order queue declares r2 request input');
        like($isf, qr/\(input axi0_arid \(width 4\)\)/, 'dynamic read burst-last depth-3 issue-order queue declares ARID input');
        like($isf, qr/\(input axi0_rid \(width 4\)\)/, 'dynamic read burst-last depth-3 issue-order queue declares RID input');
        like($isf, qr/\(input axi0_rlast\)/, 'dynamic read burst-last depth-3 issue-order queue declares RLAST input');
        like($isf, qr/\(output axi0_r2_complete\)/, 'dynamic read burst-last depth-3 issue-order queue exposes r2 completion output');
        unlike($isf, qr/axi0_r2_dynamic_id_q/, 'dynamic read burst-last depth-3 issue-order queue does not allocate legacy r2 selected-ID storage');
        unlike($isf, qr/axi0_r2_dynamic_busy_q/, 'dynamic read burst-last depth-3 issue-order queue does not allocate legacy r2 busy storage');
        ...
        like($isf, qr/\(rule axi0_r2_response_demux [\s\S]*axi0_read_dynamic_same_id_issue_order_slot0_id_q[\s\S]*axi0_read_dynamic_same_id_issue_order_slot2_id_q[\s\S]*axi0_rlast[\s\S]*\(pulse axi0_r2_complete\)\)/, 'dynamic read burst-last depth-3 issue-order queue emits final r2 RID/RLAST demux');
    ...
    if ($case->{behavior} eq 'dynamic_read_burst_last_depth3_same_id_issue_order_queue_read_data_burst_length'
        ...
        for my $tx (@transactions) {
            ...
            like($isf, qr/\(output axi0_${tx}_complete\)/, "dynamic read burst-last depth-3 issue-order queue read-data burst-length exposes $tx completion output");
            like($isf, qr/\(output axi0_${tx}_last_rdata \(width 32\)\)/, "dynamic read burst-last depth-3 issue-order queue read-data burst-length exposes $tx scalar last RDATA");
            like($isf, qr/\(output axi0_${tx}_last_rresp \(width 2\)\)/, "dynamic read burst-last depth-3 issue-order queue read-data burst-length exposes $tx scalar last RRESP");
        ...
        like($isf, qr/\(input axi0_rlast\)/, 'dynamic read burst-last depth-3 issue-order queue read-data burst-length declares RLAST input');
        like($isf, qr/\(input axi0_rdata \(width 32\)\)/, 'dynamic read burst-last depth-3 issue-order queue read-data burst-length declares RDATA input');
        like($isf, qr/\(input axi0_rresp \(width 2\)\)/, 'dynamic read burst-last depth-3 issue-order queue read-data burst-length declares RRESP input');
        like($isf, qr/\(input axi0_arlen \(width 8\)\)/, 'dynamic read burst-last depth-3 issue-order queue read-data burst-length declares ARLEN input');
        unlike($isf, qr/axi0_r0_dynamic_id_q/, 'dynamic read burst-last depth-3 issue-order queue read-data burst-length does not allocate legacy selected-ID storage');
        unlike($isf, qr/axi0_r2_dynamic_busy_q/, 'dynamic read burst-last depth-3 issue-order queue read-data burst-length does not allocate legacy busy storage');
        like($isf, qr/\(var axi0_read_dynamic_same_id_issue_order_slot0_id_q \(width 4\)\)/, 'dynamic read burst-last depth-3 issue-order queue read-data burst-length allocates slot0 captured ARID');
        ...
        like($hdl, qr/\breg\s+\[7:0\]\s+axi0_r2_arlen_q\b/, 'SystemVerilog declares r2 depth-3 queue raw ARLEN storage');
    ...
    if ($case->{behavior} eq 'dynamic_read_burst_last_depth3_same_id_issue_order_queue_read_data_multi_beat') {
        my @transactions = qw(r0 r1 r2);
        for my $tx (@transactions) {
            like($isf, qr/\(input axi0_${tx}_request\)/, "dynamic read burst-last depth-3 issue-order queue read-data multi-beat declares $tx request input");
            like($isf, qr/\(output axi0_${tx}_complete\)/, "dynamic read burst-last depth-3 issue-order queue read-data multi-beat exposes $tx completion output");
            like($isf, qr/\(output axi0_${tx}_beat_rdata_15 \(width 32\)\)/, "dynamic read burst-last depth-3 issue-order queue read-data multi-beat exposes $tx final RDATA lane");
            like($isf, qr/\(output axi0_${tx}_beat_rresp_15 \(width 2\)\)/, "dynamic read burst-last depth-3 issue-order queue read-data multi-beat exposes $tx final RRESP lane");
            like($isf, qr/\(output axi0_${tx}_beat_valid \(width 16\)\)/, "dynamic read burst-last depth-3 issue-order queue read-data multi-beat exposes $tx valid mask");
            like($isf, qr/\(output axi0_${tx}_read_beats \(width 5\)\)/, "dynamic read burst-last depth-3 issue-order queue read-data multi-beat exposes $tx length output");
        ...
        like($isf, qr/\(input axi0_rlast\)/, 'dynamic read burst-last depth-3 issue-order queue read-data multi-beat declares RLAST input');
        like($isf, qr/\(input axi0_rdata \(width 32\)\)/, 'dynamic read burst-last depth-3 issue-order queue read-data multi-beat declares RDATA input');
        ...
        is($read_data->{mode}, 'bounded_multi_beat_read_data_contract', 'dynamic read burst-last depth-3 issue-order queue read-data multi-beat reports bounded multi-beat contract');
        is($read->{completion_validity}, 'generated_dynamic_read_issue_order_queue_response_demux_last_beat_completion_pulse', 'dynamic read burst-last depth-3 issue-order queue read-data multi-beat reports queue last-beat completion validity');
        is_deeply([map { $_->{transaction} } @{$read->{transactions}}], \@transactions, 'dynamic read burst-last depth-3 issue-order queue read-data multi-beat reports r0/r1/r2 transaction banks');
        is_deeply($read->{generated_multi_beat_valid_outputs}, [map { "axi0_${_}_beat_valid" } @transactions], 'dynamic read burst-last depth-3 issue-order queue read-data multi-beat reports valid-mask outputs');
        is_deeply($read->{generated_multi_beat_length_outputs}, [map { "axi0_${_}_read_beats" } @transactions], 'dynamic read burst-last depth-3 issue-order queue read-data multi-beat reports length outputs');
        is(scalar(@{$read->{generated_multi_beat_data_outputs}}), 48, 'dynamic read burst-last depth-3 issue-order queue read-data multi-beat reports 48 data lane outputs');
        is(scalar(@{$read->{generated_multi_beat_status_outputs}}), 48, 'dynamic read burst-last depth-3 issue-order queue read-data multi-beat reports 48 status lane outputs');
        is(scalar(@{$read->{generated_multi_beat_capture_rules}}), 48, 'dynamic read burst-last depth-3 issue-order queue read-data multi-beat reports 48 capture rules');
        is(scalar(@{$read->{generated_beat_count_assertions}}), 12, 'dynamic read burst-last depth-3 issue-order queue read-data multi-beat reports 12 runtime assertions');
        is_deeply($read_data->{residue}, [], 'dynamic read burst-last depth-3 issue-order queue read-data multi-beat clears read-data residue');

        like($fsm, qr/axi0_r2_read_beat_15_capture[\s\S]*\(<- \(axi0_r2_beat_rdata_15> axi0_rdata\)\)[\s\S]*\(<- \(axi0_r2_beat_rresp_15> axi0_rresp\)\)/, 'scheduled FSM lowers r2 final multi-beat lane capture');
        my $hdl = hdl_for('axi0_capacity_status', $fsm);
        like($hdl, qr/\boutput\s+(?:reg\s+)?\[31:0\]\s+axi0_r2_beat_rdata_15\b/, 'SystemVerilog exposes r2 final RDATA lane output');
        like($hdl, qr/\boutput\s+(?:reg\s+)?\[1:0\]\s+axi0_r2_beat_rresp_15\b/, 'SystemVerilog exposes r2 final RRESP lane output');
        like($hdl, qr/\boutput\s+(?:reg\s+)?\[15:0\]\s+axi0_r2_beat_valid\b/, 'SystemVerilog exposes r2 valid-mask output');
        return;
    }

    if ($case->{behavior} eq 'dynamic_read_burst_last_same_id_issue_order_queue_read_data_burst_length'
        || $case->{behavior} eq 'dynamic_read_burst_last_same_id_issue_order_queue_read_data_burst_length_runtime_assertion') {
        my $runtime_validation = $case->{behavior} eq 'dynamic_read_burst_last_same_id_issue_order_queue_read_data_burst_length_runtime_assertion';
        my $validation = $runtime_validation ? 'runtime_assertion' : 'report_only';
        like($isf, qr/\(input axi0_r0_request\)/, 'dynamic read burst-last issue-order queue read-data burst-length declares r0 request input');
        like($isf, qr/\(input axi0_r1_request\)/, 'dynamic read burst-last issue-order queue read-data burst-length declares r1 request input');
        like($isf, qr/\(input axi0_arid \(width 4\)\)/, 'dynamic read burst-last issue-order queue read-data burst-length declares ARID input');
        like($isf, qr/\(input axi0_rid \(width 4\)\)/, 'dynamic read burst-last issue-order queue read-data burst-length declares RID input');
        like($isf, qr/\(input axi0_rlast\)/, 'dynamic read burst-last issue-order queue read-data burst-length declares RLAST input');
        like($isf, qr/\(input axi0_rdata \(width 32\)\)/, 'dynamic read burst-last issue-order queue read-data burst-length declares RDATA input');
        like($isf, qr/\(input axi0_rresp \(width 2\)\)/, 'dynamic read burst-last issue-order queue read-data burst-length declares RRESP input');
        like($isf, qr/\(input axi0_arlen \(width 8\)\)/, 'dynamic read burst-last issue-order queue read-data burst-length declares ARLEN input');
        like($isf, qr/\(var axi0_r0_arlen_q \(width 8\)\)/, 'dynamic read burst-last issue-order queue read-data burst-length allocates r0 raw ARLEN storage');
        like($isf, qr/\(var axi0_r1_arlen_q \(width 8\)\)/, 'dynamic read burst-last issue-order queue read-data burst-length allocates r1 raw ARLEN storage');
        like($isf, qr/\(rule axi0_r0_burst_length_capture axi0_r0_request\s+\(axi0_r0_arlen_q axi0_arlen\)\)/, 'dynamic read burst-last issue-order queue read-data burst-length captures r0 ARLEN under request');
        like($isf, qr/\(rule axi0_r1_burst_length_capture axi0_r1_request\s+\(axi0_r1_arlen_q axi0_arlen\)\)/, 'dynamic read burst-last issue-order queue read-data burst-length captures r1 ARLEN under request');
        like($isf, qr/\(rule axi0_r1_response_demux [\s\S]*axi0_read_dynamic_same_id_issue_order_slot0_id_q[\s\S]*axi0_read_dynamic_same_id_issue_order_slot1_id_q[\s\S]*axi0_rlast[\s\S]*\(pulse axi0_r1_complete\)\)/, 'dynamic read burst-last issue-order queue read-data burst-length keeps queue-owned r1 RID/RLAST demux');
        like($isf, qr/\(rule axi0_r1_read_data_capture axi0_r1_complete\s+\(axi0_r1_last_rdata axi0_rdata\)\s+\(axi0_r1_last_rresp axi0_rresp\)\)/, 'dynamic read burst-last issue-order queue read-data burst-length captures r1 payload under queue last-beat completion');
        if ($runtime_validation) {
            for my $transaction (qw(r0 r1)) {
                like($isf, qr/\(var axi0_${transaction}_expected_beats_q \(width 5\)\)/, "dynamic read burst-last issue-order queue runtime burst-length declares $transaction expected-beat storage");
                like($isf, qr/\(var axi0_${transaction}_read_beat_count_q \(width 5\)\)/, "dynamic read burst-last issue-order queue runtime burst-length declares $transaction read-beat counter");
                like($isf, qr/\(rule axi0_${transaction}_beat_count_init axi0_${transaction}_request\s+\(axi0_${transaction}_expected_beats_q \(\+ axi0_arlen\[4:0\] 5'd1\)\)\s+\(axi0_${transaction}_read_beat_count_q 0\)\)/, "dynamic read burst-last issue-order queue runtime burst-length initializes $transaction expected beats and count");
                like($isf, qr/\(rule axi0_${transaction}_read_beat_count \(& \(& axi0_read_complete [\s\S]*axi0_read_dynamic_same_id_issue_order_slot0_${transaction}_q[\s\S]*axi0_read_dynamic_same_id_issue_order_slot1_${transaction}_q[\s\S]*\) \(! axi0_${transaction}_request\)\)\s+\(axi0_${transaction}_read_beat_count_q \(\+ axi0_${transaction}_read_beat_count_q 5'd1\)\)\)/, "dynamic read burst-last issue-order queue runtime burst-length increments $transaction on matched read beats");
                like($isf, qr/"axi0 ${transaction} ARLEN is within configured max beats"/, "dynamic read burst-last issue-order queue runtime burst-length emits $transaction ARLEN max assertion");
                like($isf, qr/"axi0 ${transaction} read beat count is below expected count"/, "dynamic read burst-last issue-order queue runtime burst-length emits $transaction beat-count bound assertion");
                like($isf, qr/"axi0 ${transaction} RLAST appears only on the expected final read beat"/, "dynamic read burst-last issue-order queue runtime burst-length emits $transaction RLAST final-beat assertion");
                like($isf, qr/"axi0 ${transaction} expected final read beat has RLAST"/, "dynamic read burst-last issue-order queue runtime burst-length emits $transaction expected-final RLAST assertion");
            }
        } else {
            unlike($isf, qr/expected_beats|read_beat_count/, 'dynamic read burst-last issue-order queue report-only burst-length keeps runtime beat-count state absent');
        }
        assert_dynamic_read_burst_last_same_id_issue_order_queue_report($result->{report});
        assert_dynamic_read_data_burst_length_report(
            $result->{report}{read_data},
        ...
        like($fsm, qr/axi0_r1_burst_length_capture[\s\S]*\(<- \(axi0_r1_arlen_q axi0_arlen\)\)/, 'scheduled FSM lowers r1 queue raw ARLEN capture');
        if ($runtime_validation) {
            like($fsm, qr/axi0_r1_beat_count_init[\s\S]*\(<- \(axi0_r1_expected_beats_q \(\+ axi0_arlen\[4:0\] 5'd1\)\)\)[\s\S]*\(<- \(axi0_r1_read_beat_count_q 0\)\)/, 'scheduled FSM lowers r1 queue expected-beat init and counter reset');
            like($fsm, qr/axi0_r1_read_beat_count[\s\S]*axi0_read_dynamic_same_id_issue_order_slot0_r1_q[\s\S]*axi0_read_dynamic_same_id_issue_order_slot1_r1_q[\s\S]*\(<- \(axi0_r1_read_beat_count_q \(\+ axi0_r1_read_beat_count_q 5'd1\)\)\)/, 'scheduled FSM lowers r1 queue beat-count increment');
        }
        my $hdl = hdl_for('axi0_capacity_status', $fsm);
        like($hdl, qr/\binput\s+(?:wire\s+)?\[7:0\]\s+axi0_arlen\b/, 'SystemVerilog exposes ARLEN for dynamic queue read-data burst-length');
        like($hdl, qr/assign\s+axi0_r1_burst_length_capture_en\s*=\s*axi0_r1_request\s*;/, 'SystemVerilog guards r1 queue ARLEN capture by request');
        like($hdl, qr/axi0_r1_arlen_q_next\s*=\s*axi0_arlen\s*;/, 'SystemVerilog captures r1 queue ARLEN');
        if ($runtime_validation) {
            like($hdl, qr/\breg\s+\[4:0\]\s+axi0_r1_expected_beats_q\b/, 'SystemVerilog declares r1 queue runtime expected-beat storage');
            like($hdl, qr/\breg\s+\[4:0\]\s+axi0_r1_read_beat_count_q\b/, 'SystemVerilog declares r1 queue runtime beat-count storage');
            like($hdl, qr/assign\s+axi0_r1_beat_count_init_en\s*=\s*axi0_r1_request\s*;/, 'SystemVerilog guards r1 queue runtime beat-count init by request');
            like($hdl, qr/assign\s+axi0_r1_read_beat_count_en\s*=/, 'SystemVerilog emits r1 queue runtime beat-count increment enable');
            like($hdl, qr/axi0_r1_expected_beats_q_next\s*=\s*axi0_arlen\[4:0\]\s*\+\s*5'd1\s*;/, 'SystemVerilog initializes r1 queue expected count from ARLEN+1');
        } else {
            unlike($hdl, qr/axi0_r1_expected_beats_q/, 'SystemVerilog keeps runtime expected-beat storage absent for report-only queue burst-length');
        }
        return;
    }

    if ($case->{behavior} eq 'dynamic_read_burst_last_same_id_issue_order_queue_read_data_multi_beat') {
        my @transactions = qw(r0 r1);

        like($isf, qr/\(input axi0_arlen \(width 8\)\)/, 'dynamic read burst-last issue-order queue multi-beat read-data declares ARLEN input');
        like($isf, qr/\(rule axi0_r1_response_demux [\s\S]*axi0_read_dynamic_same_id_issue_order_slot0_id_q[\s\S]*axi0_read_dynamic_same_id_issue_order_slot1_id_q[\s\S]*axi0_rlast[\s\S]*\(pulse axi0_r1_complete\)\)/, 'dynamic read burst-last issue-order queue multi-beat read-data keeps queue-owned r1 RID/RLAST demux');
        like($isf, qr/\(output axi0_r0_beat_rdata_0 \(width 32\)\)/, 'dynamic read burst-last issue-order queue multi-beat read-data declares r0 first RDATA lane');
        like($isf, qr/\(output axi0_r1_beat_rdata_15 \(width 32\)\)/, 'dynamic read burst-last issue-order queue multi-beat read-data declares r1 final RDATA lane');
        like($isf, qr/\(output axi0_r1_beat_rresp_15 \(width 2\)\)/, 'dynamic read burst-last issue-order queue multi-beat read-data declares r1 final RRESP lane');
        like($isf, qr/\(output axi0_r1_beat_valid \(width 16\)\)/, 'dynamic read burst-last issue-order queue multi-beat read-data declares r1 valid-mask output');
        like($isf, qr/\(output axi0_r1_read_beats \(width 5\)\)/, 'dynamic read burst-last issue-order queue multi-beat read-data declares r1 length output');
        like($isf, qr/\(output axi0_r1_rresp \(width 2\)\)/, 'dynamic read burst-last issue-order queue multi-beat read-data declares r1 scalar aggregate RRESP output');
        for my $tx (@transactions) {
            like($isf, qr/\(var axi0_${tx}_arlen_q \(width 8\)\)/, "dynamic read burst-last issue-order queue multi-beat read-data allocates $tx raw ARLEN storage");
            like($isf, qr/\(var axi0_${tx}_expected_beats_q \(width 5\)\)/, "dynamic read burst-last issue-order queue multi-beat read-data allocates $tx expected-beat storage");
            like($isf, qr/\(var axi0_${tx}_read_beat_count_q \(width 5\)\)/, "dynamic read burst-last issue-order queue multi-beat read-data allocates $tx beat-count storage");
        }
        like($isf, qr/\(rule axi0_r1_burst_length_capture axi0_r1_request\s+\(axi0_r1_arlen_q axi0_arlen\)\)/, 'dynamic read burst-last issue-order queue multi-beat read-data captures r1 raw ARLEN under request');
        like($isf, qr/\(rule axi0_r1_beat_count_init axi0_r1_request\s+\(axi0_r1_expected_beats_q \(\+ axi0_arlen\[4:0\] 5'd1\)\)\s+\(axi0_r1_read_beat_count_q 0\)\)/, 'dynamic read burst-last issue-order queue multi-beat read-data initializes r1 expected count on request');
        like($isf, qr/\(rule axi0_r1_read_beat_count \(& \(& axi0_read_complete [\s\S]*axi0_read_dynamic_same_id_issue_order_slot0_r1_q[\s\S]*axi0_read_dynamic_same_id_issue_order_slot1_r1_q[\s\S]*\) \(! axi0_r1_request\)\)\s+\(axi0_r1_read_beat_count_q \(\+ axi0_r1_read_beat_count_q 5'd1\)\)\)/, 'dynamic read burst-last issue-order queue multi-beat read-data increments r1 on matched raw read beats');
        like($isf, qr/\(rule axi0_r1_read_data_output_init axi0_r1_request\s+\(axi0_r1_beat_rdata_0 32'd0\)[\s\S]*\(axi0_r1_rresp 2'd0\)[\s\S]*\(axi0_r1_beat_valid 16'b0\)\s+\(axi0_r1_read_beats 5'd0\)\)/, 'dynamic read burst-last issue-order queue multi-beat read-data clears r1 output bank on request');
        like($isf, qr/\(rule axi0_r1_read_beat_0_capture \(& \(& axi0_read_complete [\s\S]*axi0_read_dynamic_same_id_issue_order_slot0_r1_q[\s\S]*axi0_read_dynamic_same_id_issue_order_slot1_r1_q[\s\S]*\) \(! axi0_r1_request\) \(== axi0_r1_read_beat_count_q 5'd0\)\)\s+\(axi0_r1_beat_rdata_0 axi0_rdata\)[\s\S]*\(axi0_r1_beat_rresp_0 axi0_rresp\)[\s\S]*\(axi0_r1_beat_valid 16'b0000000000000001\)\s+\(axi0_r1_read_beats 5'd1\)\)/, 'dynamic read burst-last issue-order queue multi-beat read-data captures r1 first matched beat lane');
        like($isf, qr/\(rule axi0_r1_rresp_aggregate \(& \(& axi0_read_complete [\s\S]*axi0_read_dynamic_same_id_issue_order_slot0_r1_q[\s\S]*axi0_read_dynamic_same_id_issue_order_slot1_r1_q[\s\S]*\) \(! axi0_r1_request\) \(< axi0_r1_rresp axi0_rresp\)\)/, 'dynamic read burst-last issue-order queue multi-beat read-data updates r1 scalar RRESP aggregate on worse status');
        like($isf, qr/"axi0 r1 RLAST appears only on the expected final read beat"/, 'dynamic read burst-last issue-order queue multi-beat read-data emits r1 RLAST final-beat assertion');
        like($isf, qr/"axi0 r1 expected final read beat has RLAST"/, 'dynamic read burst-last issue-order queue multi-beat read-data emits r1 expected-final RLAST assertion');
        ...
        is_deeply($result->{report}{response_demux}{residue}, [], 'dynamic read burst-last issue-order queue multi-beat read-data clears demux residue for the covered queue output-bank shape');
        like($fsm, qr/axi0_r1_read_beat_0_capture[\s\S]*\(<- \(axi0_r1_beat_rdata_0> axi0_rdata\)\)[\s\S]*\(<- \(axi0_r1_beat_rresp_0> axi0_rresp\)\)[\s\S]*\(<- \(axi0_r1_beat_valid> 16'b0000000000000001\)\)[\s\S]*\(<- \(axi0_r1_read_beats> 5'd1\)\)/, 'scheduled FSM lowers r1 queue first-beat lane capture');
        like($fsm, qr/axi0_r1_rresp_aggregate[\s\S]*\(<- \(axi0_r1_rresp> axi0_rresp\)\)/, 'scheduled FSM lowers r1 queue scalar RRESP aggregation');
        my $hdl = hdl_for('axi0_capacity_status', $fsm);
        like($hdl, qr/\binput\s+(?:wire\s+)?\[7:0\]\s+axi0_arlen\b/, 'SystemVerilog exposes ARLEN for dynamic queue multi-beat read-data');
        like($hdl, qr/\boutput\s+reg\s+\[31:0\]\s+axi0_r1_beat_rdata_0\b/, 'SystemVerilog exposes r1 first queue multi-beat RDATA lane');
        like($hdl, qr/\boutput\s+reg\s+\[1:0\]\s+axi0_r1_beat_rresp_15\b/, 'SystemVerilog exposes r1 final queue multi-beat RRESP lane');
        like($hdl, qr/\boutput\s+reg\s+\[15:0\]\s+axi0_r1_beat_valid\b/, 'SystemVerilog exposes r1 queue multi-beat valid mask');
        like($hdl, qr/\boutput\s+reg\s+\[4:0\]\s+axi0_r1_read_beats\b/, 'SystemVerilog exposes r1 queue multi-beat length');
        like($hdl, qr/\boutput\s+reg\s+\[1:0\]\s+axi0_r1_rresp\b/, 'SystemVerilog exposes r1 queue scalar aggregate RRESP');
        like($hdl, qr/\breg\s+\[7:0\]\s+axi0_r1_arlen_q\b/, 'SystemVerilog declares r1 queue raw ARLEN storage');
        like($hdl, qr/\breg\s+\[4:0\]\s+axi0_r1_expected_beats_q\b/, 'SystemVerilog declares r1 queue expected-beat storage');
        like($hdl, qr/\breg\s+\[4:0\]\s+axi0_r1_read_beat_count_q\b/, 'SystemVerilog declares r1 queue beat-count storage');
        like($hdl, qr/assign\s+axi0_r1_read_beat_0_capture_en\s*=/, 'SystemVerilog emits r1 queue first-lane capture enable');
        like($hdl, qr/axi0_r1_beat_rdata_0_next\s*=\s*axi0_rdata\s*;/, 'SystemVerilog captures r1 queue first-lane RDATA');
        like($hdl, qr/axi0_r1_beat_rresp_0_next\s*=\s*axi0_rresp\s*;/, 'SystemVerilog captures r1 queue first-lane RRESP');
        like($hdl, qr/axi0_r1_beat_valid_next\s*=\s*16'b1\s*;/, 'SystemVerilog marks r1 queue first beat valid');
        like($hdl, qr/axi0_r1_read_beats_next\s*=\s*5'd1\s*;/, 'SystemVerilog records r1 queue first beat length');
        return;
    }
...
sub assert_dynamic_write_same_id_issue_order_queue_report {
    ...
    ok(grep { $_ eq 'axi0_write_dynamic_same_id_issue_order_w0_dequeue_enqueue_w0' } @{$queue->{generated_update_rules}}, 'dynamic write issue-order queue reports one-entry same-transaction ID-refresh rule');
...
sub assert_mixed_dynamic_static_write_same_id_issue_order_queue_report {
    ...
    is($demux->{mode}, 'bounded_mixed_dynamic_static_write_bid_issue_order_queue_demux_contract', 'mixed write issue-order queue report marks demux contract');
    ok($demux->{generated_behavior}, 'mixed write issue-order queue report marks generated demux behavior');
    is_deeply($demux->{residue}, [qw(read_response_demux read_data_interleaving bursts)], 'mixed write issue-order queue removes same-ID residue from response demux');
    is($write->{transaction_completion_source}, 'generated_mixed_dynamic_static_issue_order_queue_demux', 'mixed write issue-order queue report marks generated queue completion source');
    is($write->{transaction_completion_semantics}, 'earliest_matching_captured_or_static_runtime_id', 'mixed write issue-order queue report marks earliest matching semantics');
    is($write->{queue_state_representation}, 'compact_runtime_id_issue_order_slots', 'mixed write issue-order queue report marks compact runtime-ID slots');
    is($write->{runtime_id_queue_key}, 'captured_or_static_request_id', 'mixed write issue-order queue report marks captured-or-static key');
    is($write->{response_demux_strategy}, 'mixed_dynamic_static_issue_order_earliest_matching_slot', 'mixed write issue-order queue report marks mixed earliest matching strategy');
    is_deeply($write->{dynamic_transactions}, [qw(w0)], 'mixed write issue-order queue report names covered dynamic write');
    is_deeply($write->{static_transactions}, [qw(w1)], 'mixed write issue-order queue report names covered static write');
    is_deeply($write->{mixed_transactions}, { dynamic => 'w0', static => 'w1' }, 'mixed write issue-order queue report names transaction roles');
    is($write->{static_id_overlap_policy}, 'allowed_by_issue_order_queue', 'mixed write issue-order queue report allows ordered static overlap');
    is_deeply($write->{generated_rules}, [qw(axi0_w0_response_demux axi0_w1_response_demux)], 'mixed write issue-order queue report names generated response-demux rules');
    is_deeply($write->{generated_completion_signals}, [qw(axi0_w0_complete axi0_w1_complete)], 'mixed write issue-order queue report names generated completions');

    is($ordering->{mode}, 'dynamic_id_reuse_policy', 'mixed write issue-order queue same-ID report marks dynamic mode');
    ok($ordering->{generated_behavior}, 'mixed write issue-order queue same-ID report is generated');
    is_deeply($ordering->{residue}, [], 'mixed write issue-order queue same-ID report clears dynamic residue');
    is($policy->{implementation_status}, 'generated_mixed_dynamic_static_write_bid_issue_order_queue', 'mixed write issue-order queue policy reports generated implementation');
    is($policy->{enforcement}, 'generated_mixed_dynamic_static_issue_order_queue', 'mixed write issue-order queue policy reports mixed enforcement');
    ok($policy->{accepted_same_id_reuse}, 'mixed write issue-order queue policy accepts same-ID reuse');
    ok($policy->{generated_queue_behavior}, 'mixed write issue-order queue policy marks generated queue behavior');
    ok(!$policy->{generated_scoreboard_behavior}, 'mixed write issue-order queue policy does not mark scoreboard behavior');
    ok($policy->{mixed_dynamic_static_issue_order_queue_covered}, 'mixed write issue-order queue policy marks mixed coverage');
    is_deeply($policy->{covered_dynamic_transactions}, [qw(w0)], 'mixed write issue-order queue policy names covered dynamic transaction');
    is_deeply($policy->{covered_static_transactions}, [qw(w1)], 'mixed write issue-order queue policy names covered static transaction');
    is($policy->{active_id_uniqueness_policy}, 'not_required_for_issue_order_queue', 'mixed write issue-order queue policy does not require active ID uniqueness');
    is($policy->{static_id_conflict_policy}, 'ordered_overlap_allowed', 'mixed write issue-order queue policy reports ordered overlap');
    is($policy->{first_generated_scope}, 'write_bid_one_dynamic_one_static_transaction', 'mixed write issue-order queue policy reports generated scope');

    ok($queue->{mixed_dynamic_static_issue_order_queue}, 'mixed write issue-order queue report marks queue as mixed');
    is_deeply($queue->{transactions}, [qw(w0 w1)], 'mixed write issue-order queue report names queue transactions');
    is_deeply($queue->{dynamic_transactions}, [qw(w0)], 'mixed write issue-order queue report names queue dynamic transaction');
    is_deeply($queue->{static_transactions}, [qw(w1)], 'mixed write issue-order queue report names queue static transaction');
    is($queue->{same_transaction_recapture_id_source}, 'per_transaction_enqueue_id', 'mixed write issue-order queue report names per-transaction recapture ID source');
    is_deeply(
        [map { $_->{request_id_source} } @{$queue->{enqueue_pulses}}],
        ['axi0_awid', "4'd3"],
        'mixed write issue-order queue report names dynamic signal and static literal enqueue sources',
    );
    is_deeply(
        $queue->{slot_storage},
        [
        ...
        'mixed write issue-order queue report names slot-local transaction and ID storage',
    );
    ok(grep { $_ eq 'axi0_write_mixed_dynamic_static_same_id_issue_order_empty_enqueue_w1' } @{$queue->{generated_update_rules}}, 'mixed write issue-order queue reports static literal enqueue rule');
    ok(grep { $_ eq 'axi0_write_mixed_dynamic_static_same_id_issue_order_w0_w1_dequeue_enqueue_w1' } @{$queue->{generated_update_rules}}, 'mixed write issue-order queue reports selected dequeue plus static enqueue rule');
    ok(grep { $_ eq 'axi0_write_mixed_dynamic_static_same_id_issue_order_response_has_selected_match' } @{$queue->{generated_assertions}}, 'mixed write issue-order queue reports selected-match assertion');
    assert_dynamic_residue($report, 'mixed write issue-order queue keeps future dynamic residue visible');
}
...
sub assert_mixed_dynamic_static_read_same_id_issue_order_queue_report {
    ...
    my $expected_response_scope = $burst_last ? 'burst_last' : 'single_beat';
    ...
    is($demux->{mode}, 'bounded_response_demux_contract', 'mixed read issue-order queue report marks bounded response-demux contract');
    ok($demux->{generated_behavior}, 'mixed read issue-order queue report marks generated demux behavior');
    is_deeply($demux->{residue}, [qw(read_data_interleaving bursts)], 'mixed read issue-order queue removes same-ID residue from response demux');
    is($read->{mode}, $expected_read_mode, 'mixed read issue-order queue report marks family demux contract');
    is($read->{transaction_completion_source}, $expected_completion_source, 'mixed read issue-order queue report marks generated queue completion source');
    is($read->{transaction_completion_semantics}, $expected_completion_semantics, 'mixed read issue-order queue report marks earliest matching semantics');
    is($read->{response_scope}, $expected_response_scope, 'mixed read issue-order queue report marks response scope');
    if ($burst_last) {
        is($read->{response_event_role}, 'raw_accepted_read_response_beat', 'mixed read issue-order queue report marks raw response beat role');
        is($read->{last_signal}, 'axi0_rlast', 'mixed read issue-order queue report marks RLAST signal');
        is($read->{last_signal_width}, 1, 'mixed read issue-order queue report marks one-bit RLAST');
        is($read->{beat_valid_output}, 'none', 'mixed read issue-order queue report marks no beat-valid output');
        is($read->{burst_length_source}, 'rlast_only', 'mixed read issue-order queue report marks RLAST-only burst length source');
        is($read->{burst_length_validation}, 'not_generated', 'mixed read issue-order queue report marks no burst-length validation');
        is($read->{generated_queue_behavior_boundary}, 'generated_mixed_dynamic_static_read_rid_rlast_issue_order_queue', 'mixed read issue-order queue report marks RID/RLAST queue boundary');
    }
    is($read->{queue_state_representation}, 'compact_runtime_id_issue_order_slots', 'mixed read issue-order queue report marks compact runtime-ID slots');
    is($read->{runtime_id_queue_key}, 'captured_or_static_request_id', 'mixed read issue-order queue report marks captured-or-static key');
    is($read->{response_demux_strategy}, 'mixed_dynamic_static_issue_order_earliest_matching_slot', 'mixed read issue-order queue report marks mixed earliest matching strategy');
    is_deeply($read->{dynamic_transactions}, [qw(r0)], 'mixed read issue-order queue report names covered dynamic read');
    is_deeply($read->{static_transactions}, [qw(r1)], 'mixed read issue-order queue report names covered static read');
    is_deeply($read->{mixed_transactions}, { dynamic => 'r0', static => 'r1' }, 'mixed read issue-order queue report names transaction roles');
    is($read->{static_id_overlap_policy}, 'allowed_by_issue_order_queue', 'mixed read issue-order queue report allows ordered static overlap');
    is_deeply($read->{generated_rules}, [qw(axi0_r0_response_demux axi0_r1_response_demux)], 'mixed read issue-order queue report names generated response-demux rules');
    is_deeply($read->{generated_completion_signals}, [qw(axi0_r0_complete axi0_r1_complete)], 'mixed read issue-order queue report names generated completions');

    is($ordering->{mode}, 'dynamic_id_reuse_policy', 'mixed read issue-order queue same-ID report marks dynamic mode');
    ok($ordering->{generated_behavior}, 'mixed read issue-order queue same-ID report is generated');
    is_deeply($ordering->{residue}, [], 'mixed read issue-order queue same-ID report clears dynamic residue');
    is($policy->{implementation_status}, $expected_policy_status, 'mixed read issue-order queue policy reports generated implementation');
    is($policy->{enforcement}, 'generated_mixed_dynamic_static_issue_order_queue', 'mixed read issue-order queue policy reports mixed enforcement');
    ok($policy->{accepted_same_id_reuse}, 'mixed read issue-order queue policy accepts same-ID reuse');
    ok($policy->{generated_queue_behavior}, 'mixed read issue-order queue policy marks generated queue behavior');
    ok(!$policy->{generated_scoreboard_behavior}, 'mixed read issue-order queue policy does not mark scoreboard behavior');
    ok($policy->{mixed_dynamic_static_issue_order_queue_covered}, 'mixed read issue-order queue policy marks mixed coverage');
    is_deeply($policy->{covered_dynamic_transactions}, [qw(r0)], 'mixed read issue-order queue policy names covered dynamic transaction');
    is_deeply($policy->{covered_static_transactions}, [qw(r1)], 'mixed read issue-order queue policy names covered static transaction');
    is($policy->{active_id_uniqueness_policy}, 'not_required_for_issue_order_queue', 'mixed read issue-order queue policy does not require active ID uniqueness');
    is($policy->{static_id_conflict_policy}, 'ordered_overlap_allowed', 'mixed read issue-order queue policy reports ordered overlap');
    is($policy->{first_generated_scope}, $expected_first_scope, 'mixed read issue-order queue policy reports generated scope');

    ok($queue->{mixed_dynamic_static_issue_order_queue}, 'mixed read issue-order queue report marks queue as mixed');
    is_deeply($queue->{transactions}, [qw(r0 r1)], 'mixed read issue-order queue report names queue transactions');
    is_deeply($queue->{dynamic_transactions}, [qw(r0)], 'mixed read issue-order queue report names queue dynamic transaction');
    is_deeply($queue->{static_transactions}, [qw(r1)], 'mixed read issue-order queue report names queue static transaction');
    is($queue->{runtime_id_queue_key}, 'captured_or_static_request_id', 'mixed read issue-order queue report names captured-or-static key');
    if ($burst_last) {
        is($queue->{last_signal}, 'axi0_rlast', 'mixed read issue-order queue report names RLAST');
    }
    is($queue->{same_transaction_recapture_id_source}, 'per_transaction_enqueue_id', 'mixed read issue-order queue report names per-transaction recapture ID source');
    is_deeply(
        [map { $_->{request_id_source} } @{$queue->{enqueue_pulses}}],
        ['axi0_arid', "4'd3"],
        'mixed read issue-order queue report names dynamic signal and static literal enqueue sources',
    );
    is_deeply(
        $queue->{slot_storage},
        [
            { name => 'axi0_read_mixed_dynamic_static_same_id_issue_order_slot0_r0_q', width => 1 },
            { name => 'axi0_read_mixed_dynamic_static_same_id_issue_order_slot0_r1_q', width => 1 },
            { name => 'axi0_read_mixed_dynamic_static_same_id_issue_order_slot0_id_q', width => 4 },
            { name => 'axi0_read_mixed_dynamic_static_same_id_issue_order_slot1_r0_q', width => 1 },
            { name => 'axi0_read_mixed_dynamic_static_same_id_issue_order_slot1_r1_q', width => 1 },
            { name => 'axi0_read_mixed_dynamic_static_same_id_issue_order_slot1_id_q', width => 4 },
        ],
        'mixed read issue-order queue report names slot-local transaction and ID storage',
    );
    ok(grep { $_ eq 'axi0_read_mixed_dynamic_static_same_id_issue_order_empty_enqueue_r1' } @{$queue->{generated_update_rules}}, 'mixed read issue-order queue reports static literal enqueue rule');
    ok(grep { $_ eq 'axi0_read_mixed_dynamic_static_same_id_issue_order_r0_r1_dequeue_enqueue_r1' } @{$queue->{generated_update_rules}}, 'mixed read issue-order queue reports selected dequeue plus static enqueue rule');
    ok(grep { $_ eq 'axi0_read_mixed_dynamic_static_same_id_issue_order_response_has_selected_match' } @{$queue->{generated_assertions}}, 'mixed read issue-order queue reports selected-match assertion');
    if ($burst_last) {
        ok(grep { $_ eq 'axi0_read_mixed_dynamic_static_same_id_issue_order_nonlast_no_dequeue' } @{$queue->{generated_assertions}}, 'mixed read issue-order queue reports non-last no-dequeue assertion');
        ok(grep { $_ eq 'axi0_read_mixed_dynamic_static_same_id_issue_order_r0_completion_selected_match' } @{$queue->{generated_assertions}}, 'mixed read issue-order queue reports dynamic completion selected-match assertion');
        ok(grep { $_ eq 'axi0_read_mixed_dynamic_static_same_id_issue_order_r1_completion_selected_match' } @{$queue->{generated_assertions}}, 'mixed read issue-order queue reports static completion selected-match assertion');
    }
    assert_dynamic_residue($report, 'mixed read issue-order queue keeps future dynamic residue visible');
}

sub assert_dynamic_write_depth3_same_id_issue_order_queue_report {
    my ($report) = @_;
    my $demux = $report->{response_demux};
    my $write = $demux->{write};
    my $ordering = $report->{same_id_ordering};
    ...
    is($demux->{mode}, 'bounded_dynamic_write_bid_issue_order_queue_demux_contract', 'dynamic write depth-3 issue-order queue report marks demux contract');
    ok($demux->{generated_behavior}, 'dynamic write depth-3 issue-order queue report marks generated demux behavior');
    is_deeply($demux->{residue}, [qw(read_response_demux read_data_interleaving bursts)], 'dynamic write depth-3 issue-order queue removes same-ID residue from response demux');
    is($write->{transaction_completion_source}, 'generated_dynamic_issue_order_queue_demux', 'dynamic write depth-3 issue-order queue report marks generated queue completion source');
    is($write->{transaction_completion_semantics}, 'earliest_matching_captured_runtime_id', 'dynamic write depth-3 issue-order queue report marks earliest matching semantics');
    is($write->{queue_state_representation}, 'compact_runtime_id_issue_order_slots', 'dynamic write depth-3 issue-order queue report marks compact runtime-ID slots');
    is_deeply($write->{dynamic_transactions}, [qw(w0 w1 w2)], 'dynamic write depth-3 issue-order queue report names covered dynamic writes');
    is_deeply($write->{generated_rules}, [qw(axi0_w0_response_demux axi0_w1_response_demux axi0_w2_response_demux)], 'dynamic write depth-3 issue-order queue report names generated response-demux rules');
    is_deeply($write->{generated_completion_signals}, [qw(axi0_w0_complete axi0_w1_complete axi0_w2_complete)], 'dynamic write depth-3 issue-order queue report names generated completions');
    is_deeply(
        [map { $_->{id}{implementation_status} } @{$report->{transactions}}],
        [qw(generated_issue_order_queue_matching generated_issue_order_queue_matching generated_issue_order_queue_matching)],
        'dynamic write depth-3 issue-order queue transactions report generated queue matching',
    );

    is($ordering->{mode}, 'dynamic_id_reuse_policy', 'dynamic write depth-3 issue-order queue same-ID report marks dynamic mode');
    ok($ordering->{generated_behavior}, 'dynamic write depth-3 issue-order queue same-ID report is generated');
    is_deeply($ordering->{residue}, [], 'dynamic write depth-3 issue-order queue same-ID report clears dynamic residue');
    is($policy->{implementation_status}, 'generated_dynamic_write_bid_issue_order_queue', 'dynamic write depth-3 issue-order queue policy reports generated implementation');
    is($policy->{enforcement}, 'generated_dynamic_issue_order_queue', 'dynamic write depth-3 issue-order queue policy reports generated enforcement');
    ok($policy->{accepted_same_id_reuse}, 'dynamic write depth-3 issue-order queue policy accepts same-ID reuse');
    ok($policy->{generated_queue_behavior}, 'dynamic write depth-3 issue-order queue policy marks generated queue behavior');
    ok($policy->{dynamic_issue_order_queue_covered}, 'dynamic write depth-3 issue-order queue policy marks dynamic coverage');
    is($policy->{first_generated_scope}, 'write_bid_three_dynamic_transactions', 'dynamic write depth-3 issue-order queue policy reports first generated scope');
    is_deeply($policy->{covered_dynamic_transactions}, [qw(w0 w1 w2)], 'dynamic write depth-3 issue-order queue policy names covered transactions');
    is($policy->{active_id_uniqueness_policy}, 'not_required_for_issue_order_queue', 'dynamic write depth-3 issue-order queue policy does not require active ID uniqueness');

    is($queue->{depth}, 3, 'dynamic write depth-3 issue-order queue report names queue depth');
    is($queue->{queue_state_representation}, 'compact_runtime_id_issue_order_slots', 'dynamic write depth-3 issue-order queue report names queue representation');
    is($queue->{request_id_source}, 'axi0_awid', 'dynamic write depth-3 issue-order queue report names AWID capture source');
    is_deeply($queue->{transactions}, [qw(w0 w1 w2)], 'dynamic write depth-3 issue-order queue report names queue transactions');
    assert_dynamic_queue_identity_recapture_report(
        $queue,
        'axi0_awid',
        'dynamic write depth-3 issue-order queue',
    );
    is_deeply(
        $queue->{slot_storage},
        [
            { name => 'axi0_write_dynamic_same_id_issue_order_slot0_w0_q', width => 1 },
            { name => 'axi0_write_dynamic_same_id_issue_order_slot0_w1_q', width => 1 },
            { name => 'axi0_write_dynamic_same_id_issue_order_slot0_w2_q', width => 1 },
            { name => 'axi0_write_dynamic_same_id_issue_order_slot0_id_q', width => 4 },
            { name => 'axi0_write_dynamic_same_id_issue_order_slot1_w0_q', width => 1 },
            { name => 'axi0_write_dynamic_same_id_issue_order_slot1_w1_q', width => 1 },
            { name => 'axi0_write_dynamic_same_id_issue_order_slot1_w2_q', width => 1 },
            { name => 'axi0_write_dynamic_same_id_issue_order_slot1_id_q', width => 4 },
            { name => 'axi0_write_dynamic_same_id_issue_order_slot2_w0_q', width => 1 },
            { name => 'axi0_write_dynamic_same_id_issue_order_slot2_w1_q', width => 1 },
            { name => 'axi0_write_dynamic_same_id_issue_order_slot2_w2_q', width => 1 },
            { name => 'axi0_write_dynamic_same_id_issue_order_slot2_id_q', width => 4 },
        ],
        'dynamic write depth-3 issue-order queue report names slot-local transaction and ID storage',
    );
    ok(grep { $_ eq 'axi0_write_dynamic_same_id_issue_order_w0_dequeue_enqueue_w0' } @{$queue->{generated_update_rules}}, 'dynamic write depth-3 issue-order queue reports one-entry same-transaction ID-refresh rule');
    ok(grep { $_ eq 'axi0_write_dynamic_same_id_issue_order_w2_w1_w0_dequeue_enqueue_w0' } @{$queue->{generated_update_rules}}, 'dynamic write depth-3 issue-order queue reports tail-selected same-transaction ID-refresh rule');
    ok(grep { $_ eq 'axi0_write_dynamic_same_id_issue_order_w0_w1_dequeue_w0_enqueue_w2' } @{$queue->{generated_update_rules}}, 'dynamic write depth-3 issue-order queue reports disambiguated cross-transaction enqueue rule');
    ok(grep { $_ eq 'axi0_write_dynamic_same_id_issue_order_slot2_onehot0' } @{$queue->{generated_assertions}}, 'dynamic write depth-3 issue-order queue reports slot2 onehot assertion');
    ok(grep { $_ eq 'axi0_write_dynamic_same_id_issue_order_w2_completion_selected_match' } @{$queue->{generated_assertions}}, 'dynamic write depth-3 issue-order queue reports w2 completion selected-match assertion');
    assert_dynamic_residue($report, 'dynamic write depth-3 issue-order queue keeps future dynamic residue visible');
}
...
sub assert_dynamic_read_same_id_issue_order_queue_report {
    ...
    ok(grep { $_ eq 'axi0_read_dynamic_same_id_issue_order_r0_dequeue_enqueue_r0' } @{$queue->{generated_update_rules}}, 'dynamic read issue-order queue reports one-entry same-transaction ID-refresh rule');
    ok(grep { $_ eq 'axi0_read_dynamic_same_id_issue_order_r1_r0_dequeue_enqueue_r0' } @{$queue->{generated_update_rules}}, 'dynamic read issue-order queue reports tail-selected same-transaction ID-refresh rule');
...
sub assert_dynamic_read_depth3_same_id_issue_order_queue_report {
    my ($report) = @_;
    my $demux = $report->{response_demux};
    my $read = $demux->{read};
    my $ordering = $report->{same_id_ordering};
    ...
    is($demux->{mode}, 'bounded_dynamic_read_rid_issue_order_queue_demux_contract', 'dynamic read depth-3 issue-order queue report marks demux contract');
    ok($demux->{generated_behavior}, 'dynamic read depth-3 issue-order queue report marks generated demux behavior');
    is_deeply($demux->{residue}, [qw(read_data_interleaving bursts)], 'dynamic read depth-3 issue-order queue removes same-ID residue from response demux');
    is($read->{response_scope}, 'single_beat', 'dynamic read depth-3 issue-order queue report marks single-beat response scope');
    is($read->{transaction_completion_source}, 'generated_dynamic_issue_order_queue_demux', 'dynamic read depth-3 issue-order queue report marks generated queue completion source');
    is($read->{transaction_completion_semantics}, 'earliest_matching_captured_runtime_id', 'dynamic read depth-3 issue-order queue report marks earliest matching semantics');
    is($read->{queue_state_representation}, 'compact_runtime_id_issue_order_slots', 'dynamic read depth-3 issue-order queue report marks compact runtime-ID slots');
    is($read->{runtime_id_queue_key}, 'captured_request_id', 'dynamic read depth-3 issue-order queue report marks captured request ID key');
    is($read->{response_demux_strategy}, 'dynamic_issue_order_earliest_matching_slot', 'dynamic read depth-3 issue-order queue report marks earliest matching strategy');
    is_deeply($read->{dynamic_transactions}, [qw(r0 r1 r2)], 'dynamic read depth-3 issue-order queue report names covered dynamic reads');
    is_deeply($read->{generated_rules}, [qw(axi0_r0_response_demux axi0_r1_response_demux axi0_r2_response_demux)], 'dynamic read depth-3 issue-order queue report names generated response-demux rules');
    is_deeply($read->{generated_completion_signals}, [qw(axi0_r0_complete axi0_r1_complete axi0_r2_complete)], 'dynamic read depth-3 issue-order queue report names generated completions');
    is_deeply(
        [map { $_->{id}{implementation_status} } @{$report->{transactions}}],
        [qw(generated_issue_order_queue_matching generated_issue_order_queue_matching generated_issue_order_queue_matching)],
        'dynamic read depth-3 issue-order queue transactions report generated queue matching',
    );

    is($ordering->{mode}, 'dynamic_id_reuse_policy', 'dynamic read depth-3 issue-order queue same-ID report marks dynamic mode');
    ok($ordering->{generated_behavior}, 'dynamic read depth-3 issue-order queue same-ID report is generated');
    is_deeply($ordering->{residue}, [], 'dynamic read depth-3 issue-order queue same-ID report clears dynamic residue');
    is($policy->{implementation_status}, 'generated_dynamic_read_rid_issue_order_queue', 'dynamic read depth-3 issue-order queue policy reports generated implementation');
    is($policy->{enforcement}, 'generated_dynamic_issue_order_queue', 'dynamic read depth-3 issue-order queue policy reports generated enforcement');
    ok($policy->{accepted_same_id_reuse}, 'dynamic read depth-3 issue-order queue policy accepts same-ID reuse');
    ok($policy->{generated_queue_behavior}, 'dynamic read depth-3 issue-order queue policy marks generated queue behavior');
    ok($policy->{dynamic_issue_order_queue_covered}, 'dynamic read depth-3 issue-order queue policy marks dynamic coverage');
    is_deeply($policy->{covered_dynamic_transactions}, [qw(r0 r1 r2)], 'dynamic read depth-3 issue-order queue policy names covered transactions');
    is($policy->{first_generated_scope}, 'read_rid_three_dynamic_transactions', 'dynamic read depth-3 issue-order queue policy reports first generated scope');
    is($policy->{active_id_uniqueness_policy}, 'not_required_for_issue_order_queue', 'dynamic read depth-3 issue-order queue policy does not require active ID uniqueness');

    is($queue->{depth}, 3, 'dynamic read depth-3 issue-order queue report names queue depth');
    is($queue->{queue_state_representation}, 'compact_runtime_id_issue_order_slots', 'dynamic read depth-3 issue-order queue report names queue representation');
    is($queue->{request_id_source}, 'axi0_arid', 'dynamic read depth-3 issue-order queue report names ARID capture source');
    is_deeply($queue->{transactions}, [qw(r0 r1 r2)], 'dynamic read depth-3 issue-order queue report names queue transactions');
    assert_dynamic_queue_identity_recapture_report(
        $queue,
        'axi0_arid',
        'dynamic read depth-3 issue-order queue',
    );
    is_deeply(
        $queue->{slot_storage},
        [
        ...
        'dynamic read depth-3 issue-order queue report names slot-local transaction and ID storage',
    );
    ok(grep { $_ eq 'axi0_read_dynamic_same_id_issue_order_r0_dequeue_enqueue_r0' } @{$queue->{generated_update_rules}}, 'dynamic read depth-3 issue-order queue reports one-entry same-transaction ID-refresh rule');
    ok(grep { $_ eq 'axi0_read_dynamic_same_id_issue_order_r2_r1_r0_dequeue_enqueue_r0' } @{$queue->{generated_update_rules}}, 'dynamic read depth-3 issue-order queue reports tail-selected same-transaction ID-refresh rule');
    ok(grep { $_ eq 'axi0_read_dynamic_same_id_issue_order_r0_r1_dequeue_r0_enqueue_r2' } @{$queue->{generated_update_rules}}, 'dynamic read depth-3 issue-order queue reports disambiguated cross-transaction enqueue rule');
    ok(grep { $_ eq 'axi0_read_dynamic_same_id_issue_order_slot2_onehot0' } @{$queue->{generated_assertions}}, 'dynamic read depth-3 issue-order queue reports slot2 onehot assertion');
    ok(grep { $_ eq 'axi0_read_dynamic_same_id_issue_order_r2_completion_selected_match' } @{$queue->{generated_assertions}}, 'dynamic read depth-3 issue-order queue reports r2 completion selected-match assertion');
    assert_dynamic_residue($report, 'dynamic read depth-3 issue-order queue keeps future dynamic residue visible');
}
...
sub assert_dynamic_read_burst_last_same_id_issue_order_queue_report {
    ...
    my $expected_generated_assertions = $args{generated_assertions} // [qw(
        axi0_read_dynamic_same_id_issue_order_slot0_onehot0
        axi0_read_dynamic_same_id_issue_order_slot1_onehot0
        axi0_read_dynamic_same_id_issue_order_compact
        axi0_read_dynamic_same_id_issue_order_request_onehot0
    ...
    is_deeply($demux->{residue}, $expected_demux_residue, 'dynamic read burst-last issue-order queue reports expected response-demux residue');
    ...
    is_deeply($read->{dynamic_transactions}, $expected_transactions, 'dynamic read burst-last issue-order queue report names covered dynamic reads');
    is_deeply($read->{generated_rules}, $expected_rules, 'dynamic read burst-last issue-order queue report names generated response-demux rules');
    is_deeply($read->{generated_completion_signals}, $expected_completion_signals, 'dynamic read burst-last issue-order queue report names generated completions');
    is_deeply(
        [map { $_->{id}{implementation_status} } @{$report->{transactions}}],
    ...
    is_deeply($policy->{covered_dynamic_transactions}, $expected_transactions, 'dynamic read burst-last issue-order queue policy names covered transactions');
    is($policy->{first_generated_scope}, $expected_first_generated_scope, 'dynamic read burst-last issue-order queue policy reports first generated scope');
    ...
    is($queue->{depth}, $expected_queue_depth, 'dynamic read burst-last issue-order queue report names queue depth');
    ...
    is_deeply($queue->{transactions}, $expected_transactions, 'dynamic read burst-last issue-order queue report names queue transactions');
    assert_dynamic_queue_identity_recapture_report(
        $queue,
        'axi0_arid',
    ...
    is_deeply(
        $queue->{generated_assertions},
        $expected_generated_assertions,
        'dynamic read burst-last issue-order queue report names generated queue assertions',
    );
    ok(grep { $_ eq 'axi0_read_dynamic_same_id_issue_order_r0_dequeue_enqueue_r0' } @{$queue->{generated_update_rules}}, 'dynamic read burst-last issue-order queue reports one-entry same-transaction ID-refresh rule');
    ok(grep { $_ eq 'axi0_read_dynamic_same_id_issue_order_r1_r0_dequeue_enqueue_r0' } @{$queue->{generated_update_rules}}, 'dynamic read burst-last issue-order queue reports tail-selected same-transaction ID-refresh rule');
...
sub assert_dynamic_read_burst_last_depth3_same_id_issue_order_queue_report {
    ...
    assert_dynamic_read_burst_last_same_id_issue_order_queue_report(
        $report,
        response_demux_residue       => $args{response_demux_residue} // [qw(read_data_interleaving bursts)],
        ...
        generated_assertions         => [qw(
            ...
            axi0_read_dynamic_same_id_issue_order_r1_no_duplicate_after_dequeue
            axi0_read_dynamic_same_id_issue_order_r1_completion_selected_match
            axi0_read_dynamic_same_id_issue_order_r2_unique_slot
            axi0_read_dynamic_same_id_issue_order_r2_no_duplicate_after_dequeue
    ...
    ok(grep { $_ eq 'axi0_read_dynamic_same_id_issue_order_r2_r1_r0_dequeue_enqueue_r0' } @{$queue->{generated_update_rules}}, 'dynamic read burst-last depth-3 issue-order queue reports tail-selected same-transaction ID-refresh rule');
    ok(grep { $_ eq 'axi0_read_dynamic_same_id_issue_order_r0_r1_dequeue_r0_enqueue_r2' } @{$queue->{generated_update_rules}}, 'dynamic read burst-last depth-3 issue-order queue reports disambiguated cross-transaction enqueue rule');
}
