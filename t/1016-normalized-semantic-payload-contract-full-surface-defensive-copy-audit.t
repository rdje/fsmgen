...
my $sentinel = '__normalized_semantic_payload_contract_full_surface_mutation__';

subtest 'normalized semantic payload contract full surface rebuilds cleanly' => sub {
    ...
    is_deeply($second, $expected, 'fresh payload contract rebuilds clean full surface');
};
