...
subtest 'generated HDL pairs requester BUSY with both subordinate windows' => sub {
    ...
    ok($compile_ok, 'Verilator builds the assertion-enabled two-subordinate paired BUSY harness')
    ...
    ok($run_ok, 'generated-HDL two-window paired BUSY proof passes with assertions enabled')
