...
subtest 'list mode advertises concrete quick and ISF test tiers' => sub {
    ...
    like($result->{stdout}, qr/t\/1236-isf-bank-access-lowering\.t/, 'ISF tier includes the latest ISF bank-access test');
...
subtest 'dry-run modes select the expected command families' => sub {
    ...
    like($isf->{stdout}, qr/t\/1236-isf-bank-access-lowering\.t/, 'ISF dry-run includes latest ISF bank-access test');
