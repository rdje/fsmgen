...
subtest 'list mode advertises concrete quick and ISF test tiers' => sub {
    ...
    like($result->{stdout}, qr/t\/1241-isf-transaction-port-bindings\.t/, 'ISF tier includes the latest ISF transaction port binding test');
...
subtest 'dry-run modes select the expected command families' => sub {
    ...
    like($isf->{stdout}, qr/t\/1241-isf-transaction-port-bindings\.t/, 'ISF dry-run includes latest ISF transaction port binding test');
