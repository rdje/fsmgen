...
subtest 'list mode advertises concrete quick and ISF test tiers' => sub {
    ...
    like($result->{stdout}, qr/t\/1237-isf-fifo-library-fixture\.t/, 'ISF tier includes the latest ISF FIFO library fixture test');
...
subtest 'dry-run modes select the expected command families' => sub {
    ...
    like($isf->{stdout}, qr/t\/1237-isf-fifo-library-fixture\.t/, 'ISF dry-run includes latest ISF FIFO library fixture test');
