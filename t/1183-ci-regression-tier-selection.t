...
subtest 'list mode advertises concrete quick and ISF test tiers' => sub {
    ...
    like($result->{stdout}, qr/t\/1235-isf-fifo-same-cycle-update-matrix\.t/, 'ISF tier includes the latest ISF FIFO update-matrix test');
...
subtest 'dry-run modes select the expected command families' => sub {
    ...
    like($isf->{stdout}, qr/t\/1235-isf-fifo-same-cycle-update-matrix\.t/, 'ISF dry-run includes latest ISF FIFO update-matrix test');
