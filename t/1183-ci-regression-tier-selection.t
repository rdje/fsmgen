...
subtest 'list mode advertises concrete quick and ISF test tiers' => sub {
    ...
    like($result->{stdout}, qr/t\/1231-isf-library-generated-top\.t/, 'ISF tier includes the latest ISF library test');
...
subtest 'dry-run modes select the expected command families' => sub {
    ...
    like($isf->{stdout}, qr/t\/1231-isf-library-generated-top\.t/, 'ISF dry-run includes latest ISF library test');
