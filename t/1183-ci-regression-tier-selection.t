...
subtest 'list mode advertises concrete quick and ISF test tiers' => sub {
    ...
    like($result->{stdout}, qr/t\/1239-isf-library-catalog-contract\.t/, 'ISF tier includes the latest ISF library catalog contract test');
...
subtest 'dry-run modes select the expected command families' => sub {
    ...
    like($isf->{stdout}, qr/t\/1239-isf-library-catalog-contract\.t/, 'ISF dry-run includes latest ISF library catalog contract test');
