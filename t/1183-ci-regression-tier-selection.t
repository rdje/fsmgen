...
subtest 'list mode advertises concrete quick and ISF test tiers' => sub {
    ...
    like($result->{stdout}, qr/t\/1240-isf-transaction-port-declarations\.t/, 'ISF tier includes the latest ISF transaction port declaration test');
...
subtest 'dry-run modes select the expected command families' => sub {
    ...
    like($isf->{stdout}, qr/t\/1240-isf-transaction-port-declarations\.t/, 'ISF dry-run includes latest ISF transaction port declaration test');
