...
subtest 'list mode advertises concrete quick and ISF test tiers' => sub {
    ...
    like($result->{stdout}, qr/t\/1238-isf-fifo-library-hdl-generation\.t/, 'ISF tier includes the latest ISF FIFO HDL generation test');
...
subtest 'dry-run modes select the expected command families' => sub {
    ...
    like($isf->{stdout}, qr/t\/1238-isf-fifo-library-hdl-generation\.t/, 'ISF dry-run includes latest ISF FIFO HDL generation test');
