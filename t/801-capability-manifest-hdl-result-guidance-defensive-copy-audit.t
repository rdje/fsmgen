...
subtest 'manifest-embedded HDLGenerator `guidance` list rebuild cleanly after caller mutation' => sub {
    ...
    is_deeply($contract->{'guidance'}, $expected->{'guidance'}, 'fresh manifest result contract rebuilds clean guidance');
