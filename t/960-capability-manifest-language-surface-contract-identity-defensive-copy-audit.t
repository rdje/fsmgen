...
subtest 'manifest language-surface contract identity metadata rebuilds cleanly after caller mutation' => sub {
    ...
    is($contract->{'status'}, $expected->{'status'}, 'fresh manifest language-surface contract rebuilds clean status');
    is($contract->{'contract_source'}, $expected->{'contract_source'}, 'fresh manifest language-surface contract rebuilds clean contract_source');
    is($contract->{'report_source'}, $expected->{'report_source'}, 'fresh manifest language-surface contract rebuilds clean report_source');
