...
subtest 'contract exposes the bounded normalized semantic surface' => sub {
    ...
    is_deeply(
        $contract->{success_forward_ir_structural_rtl_ir_port_target_entry_keys},
        normalized_semantic_forward_ir_structural_rtl_ir_port_target_entry_keys(),
    ...
    is_deeply(
        $contract->{success_forward_ir_structural_rtl_ir_net_source_entry_keys},
        normalized_semantic_forward_ir_structural_rtl_ir_net_source_entry_keys(),
        'contract publishes the bounded forward-ir structural-rtl-ir net source entry key list',
    );
    is_deeply(
        $contract->{success_forward_ir_structural_rtl_ir_net_target_entry_keys},
        normalized_semantic_forward_ir_structural_rtl_ir_net_target_entry_keys(),
    ...
    is_deeply(
        ...
        normalized_semantic_forward_ir_structural_rtl_ir_port_target_extension_keys(),
        'report presence family map publishes structural-rtl-ir port target extension keys',
    );
    is_deeply(
        $contract->{presence_key_family_map}{success_forward_ir_structural_rtl_ir_port_target_entry_keys},
        normalized_semantic_forward_ir_structural_rtl_ir_port_target_entry_keys(),
        'report presence family map publishes structural-rtl-ir port target entry keys',
    );
    is_deeply(
    ...
    is_deeply(
        $contract->{presence_key_family_map}{success_forward_ir_structural_rtl_ir_net_source_entry_keys},
        normalized_semantic_forward_ir_structural_rtl_ir_net_source_entry_keys(),
        'report presence family map publishes structural-rtl-ir net source entry keys',
    );
    is_deeply(
        $contract->{presence_key_family_map}{success_forward_ir_structural_rtl_ir_net_target_entry_keys},
        normalized_semantic_forward_ir_structural_rtl_ir_net_target_entry_keys(),
        'report presence family map publishes structural-rtl-ir net target entry keys',
    );
    is_deeply(
    ...
    for my $case (
        ...
        [
            ...
            normalized_semantic_payload_symbol_contract_enum_entry_value_kinds(),
            FSM::Support::NormalizedSemanticSymbolContract::normalized_semantic_symbol_contract_enum_entry_value_kinds(),
        ...
        [
            ...
            normalized_semantic_payload_symbol_contract_enum_member_value_kinds(),
            FSM::Support::NormalizedSemanticSymbolContract::normalized_semantic_symbol_contract_enum_member_value_kinds(),
        ...
        [
            ...
            normalized_semantic_payload_symbol_contract_package_import_entry_value_kinds(),
            FSM::Support::NormalizedSemanticSymbolContract::normalized_semantic_symbol_contract_package_import_entry_value_kinds(),
        ...
        [
            ...
            normalized_semantic_payload_symbol_contract_package_import_entry_value_meaning(),
            FSM::Support::NormalizedSemanticSymbolContract::normalized_semantic_symbol_contract_package_import_entry_value_meaning(),
        ...
        [
            ...
            normalized_semantic_payload_symbol_contract_type_entry_keys(),
            FSM::Support::NormalizedSemanticSymbolContract::normalized_semantic_symbol_contract_type_entry_keys(),
            'type entry keys',
        ],
        [
            ...
            normalized_semantic_payload_symbol_contract_type_scalar_value_kinds(),
            FSM::Support::NormalizedSemanticSymbolContract::normalized_semantic_symbol_contract_type_scalar_value_kinds(),
        ...
        [
            ...
            normalized_semantic_payload_symbol_contract_type_aggregate_value_kinds(),
            FSM::Support::NormalizedSemanticSymbolContract::normalized_semantic_symbol_contract_type_aggregate_value_kinds(),
        ...
        [
            ...
            normalized_semantic_payload_symbol_contract_type_state_model_extension_keys(),
            FSM::Support::NormalizedSemanticSymbolContract::normalized_semantic_symbol_contract_type_state_model_extension_keys(),
        ...
        [
            ...
            normalized_semantic_payload_symbol_contract_type_list_extension_keys(),
            FSM::Support::NormalizedSemanticSymbolContract::normalized_semantic_symbol_contract_type_list_extension_keys(),
        ...
        [
            ...
            normalized_semantic_payload_symbol_contract_type_record_extension_keys(),
            FSM::Support::NormalizedSemanticSymbolContract::normalized_semantic_symbol_contract_type_record_extension_keys(),
...
subtest 'successful direct semantic JSON conforms to the bounded contract' => sub {
    ...
    my ($direct_source_net) = grep {
        ref($_) eq 'HASH' && ref($_->{source}) eq 'HASH'
    } @{$direct_structural->{nets} || []};
    ok($direct_source_net, 'direct success structural-rtl-ir includes at least one net with structured source connectivity');
    assert_keys_present(
        $direct_source_net->{source},
        normalized_semantic_forward_ir_structural_rtl_ir_net_source_entry_keys(),
        'direct success structural-rtl-ir net source keeps bounded keys',
    );
    my ($direct_target_net) = grep {
        ref($_) eq 'HASH' && ref($_->{targets}) eq 'ARRAY' && @{$_->{targets}}
    } @{$direct_structural->{nets} || []};
    ok($direct_target_net, 'direct success structural-rtl-ir includes at least one net with structured target connectivity');
    assert_keys_present(
        $direct_target_net->{targets}[0],
        normalized_semantic_forward_ir_structural_rtl_ir_net_target_entry_keys(),
        'direct success structural-rtl-ir net target keeps bounded keys',
    );
    ...
    my ($direct_target_port) = grep {
        ref($_) eq 'HASH' && ref($_->{targets}) eq 'ARRAY' && @{$_->{targets}}
    } @{$direct_structural->{ports} || []};
    ok($direct_target_port, 'direct success structural-rtl-ir includes at least one input port with structured target connectivity');
    assert_keys_present(
        $direct_target_port,
        normalized_semantic_forward_ir_structural_rtl_ir_port_target_extension_keys(),
        'direct success structural-rtl-ir input port keeps bounded target extension keys',
    );
    assert_keys_present(
