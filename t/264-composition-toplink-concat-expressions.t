...
subtest 'linked plan builder rejects unsupported concat operands' => sub {
    ...
    like(
        $exception,
        qr/uses top expression 'payload_bus\[3:0\],=open', .*concat operands currently accept only top-port names, top-port bit\/slice forms, and fixed-width literal actuals/s,
