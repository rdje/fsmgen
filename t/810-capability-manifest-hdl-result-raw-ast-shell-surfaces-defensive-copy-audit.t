...
subtest 'manifest-embedded HDLGenerator `raw_ast` shell surfaces rebuild cleanly after caller mutation' => sub {
    ...
    mutate_structure($mutated->{'raw_ast_summary_surfaces'});
    mutate_structure($mutated->{'raw_ast_fallback_surface_map'});
    ...
    is_deeply($contract->{'raw_ast_summary_surfaces'}, $expected->{'raw_ast_summary_surfaces'}, 'fresh manifest result contract rebuilds clean raw_ast_summary_surfaces');
    is_deeply($contract->{'raw_ast_fallback_surface_map'}, $expected->{'raw_ast_fallback_surface_map'}, 'fresh manifest result contract rebuilds clean raw_ast_fallback_surface_map');
