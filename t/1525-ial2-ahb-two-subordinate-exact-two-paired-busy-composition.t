...
subtest 'source is the exact selected two-subordinate exact-two paired BUSY transform' => sub {
    ...
    like(residue_detail($requester, 'ahb_requester_busy_insert_support'), qr/exact-two qualified requester HTRANS BUSY events/, 'requester child keeps exact-two BUSY support residue');
