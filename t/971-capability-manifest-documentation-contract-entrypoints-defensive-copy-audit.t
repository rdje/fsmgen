...
subtest 'manifest documentation contract entrypoint metadata rebuilds cleanly after caller mutation' => sub {
    ...
    is_deeply($contract->{'entrypoints'}, $expected->{'entrypoints'}, 'fresh manifest documentation contract rebuilds clean entrypoints');
};
done_testing();
