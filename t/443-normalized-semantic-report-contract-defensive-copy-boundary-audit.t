...
subtest 'normalized semantic report helper builders return fresh nested structures' => sub {
    for my $case (
        ...
        },
        {
            ...
            build => \&normalized_semantic_forward_ir_intent_hir_composition_child_entry_keys,
        },
        {
            label => 'forward_ir_intent_hir_composition_child_parameter_override_entry_keys',
            build => \&normalized_semantic_forward_ir_intent_hir_composition_child_parameter_override_entry_keys,
        },
        {
            label => 'forward_ir_intent_hir_composition_child_parameter_override_raw_value_extension_keys',
            build => \&normalized_semantic_forward_ir_intent_hir_composition_child_parameter_override_raw_value_extension_keys,
        },
        {
            label => 'forward_ir_intent_hir_composition_child_parameter_override_value_metadata_extension_keys',
            build => \&normalized_semantic_forward_ir_intent_hir_composition_child_parameter_override_value_metadata_extension_keys,
        },
        {
        ...
        },
        {
            ...
            build => \&normalized_semantic_forward_ir_intent_hir_composition_standalone_dt_enable_family_entry_keys,
        },
        {
            label => 'forward_ir_intent_hir_composition_standalone_dt_module_enable_family_keys',
            build => \&normalized_semantic_forward_ir_intent_hir_composition_standalone_dt_module_enable_family_keys,
        },
        {
            label => 'forward_ir_intent_hir_composition_standalone_dt_multi_drive_target_entry_keys',
            build => \&normalized_semantic_forward_ir_intent_hir_composition_standalone_dt_multi_drive_target_entry_keys,
        },
        {
            label => 'forward_ir_intent_hir_composition_standalone_dt_multi_drive_assertion_keys',
            build => \&normalized_semantic_forward_ir_intent_hir_composition_standalone_dt_multi_drive_assertion_keys,
        },
        {
            label => 'forward_ir_intent_hir_symbol_contract_constant_value_entry_keys',
            build => \&normalized_semantic_forward_ir_intent_hir_symbol_contract_constant_value_entry_keys,
        },
        {
            label => 'forward_ir_intent_hir_symbol_contract_constant_scalar_value_extension_keys',
            build => \&normalized_semantic_forward_ir_intent_hir_symbol_contract_constant_scalar_value_extension_keys,
        },
        {
        ...
        },
        {
            ...
            build => \&normalized_semantic_forward_ir_intent_hir_symbol_contract_type_scalar_value_kinds,
        },
        {
            label => 'forward_ir_intent_hir_symbol_contract_type_aggregate_value_kinds',
            build => \&normalized_semantic_forward_ir_intent_hir_symbol_contract_type_aggregate_value_kinds,
        },
        {
            label => 'forward_ir_intent_hir_symbol_contract_type_state_model_extension_keys',
            build => \&normalized_semantic_forward_ir_intent_hir_symbol_contract_type_state_model_extension_keys,
        },
        {
            label => 'forward_ir_intent_hir_symbol_contract_type_list_extension_keys',
            build => \&normalized_semantic_forward_ir_intent_hir_symbol_contract_type_list_extension_keys,
        },
        {
            label => 'forward_ir_intent_hir_symbol_contract_type_record_extension_keys',
            build => \&normalized_semantic_forward_ir_intent_hir_symbol_contract_type_record_extension_keys,
        },
        {
        ...
        },
        {
            ...
            build => \&normalized_semantic_forward_ir_structural_rtl_ir_port_source_extension_keys,
        },
        {
            label => 'forward_ir_structural_rtl_ir_port_source_entry_keys',
            build => \&normalized_semantic_forward_ir_structural_rtl_ir_port_source_entry_keys,
        },
        {
            label => 'forward_ir_structural_rtl_ir_port_target_extension_keys',
            build => \&normalized_semantic_forward_ir_structural_rtl_ir_port_target_extension_keys,
        },
        {
            label => 'forward_ir_structural_rtl_ir_port_target_entry_keys',
            build => \&normalized_semantic_forward_ir_structural_rtl_ir_port_target_entry_keys,
        },
        {
        ...
        },
        {
            ...
            build => \&normalized_semantic_symbol_contract_constant_value_entry_keys,
        },
        {
            label => 'symbol_contract_constant_scalar_value_extension_keys',
            build => \&normalized_semantic_symbol_contract_constant_scalar_value_extension_keys,
        },
        {
        ...
        },
        {
            ...
            build => \&normalized_semantic_symbol_contract_type_scalar_value_kinds,
        },
        {
            label => 'symbol_contract_type_aggregate_value_kinds',
            build => \&normalized_semantic_symbol_contract_type_aggregate_value_kinds,
        },
        {
            label => 'symbol_contract_type_state_model_extension_keys',
            build => \&normalized_semantic_symbol_contract_type_state_model_extension_keys,
        },
        {
            label => 'symbol_contract_type_list_extension_keys',
            build => \&normalized_semantic_symbol_contract_type_list_extension_keys,
        },
        {
            label => 'symbol_contract_type_record_extension_keys',
            build => \&normalized_semantic_symbol_contract_type_record_extension_keys,
        },
        {
        ...
        },
        {
            ...
            build => \&normalized_semantic_composition_child_parameter_override_entry_keys,
        },
        {
            label => 'composition_child_parameter_override_raw_value_extension_keys',
            build => \&normalized_semantic_composition_child_parameter_override_raw_value_extension_keys,
        },
        {
            label => 'composition_child_parameter_override_value_metadata_extension_keys',
            build => \&normalized_semantic_composition_child_parameter_override_value_metadata_extension_keys,
        },
        {
...
subtest 'fresh normalized semantic report maps stay aligned with helper families' => sub {
    ...
    is_deeply($family_map->{symbol_contract_type_state_model_extension_keys}, normalized_semantic_symbol_contract_type_state_model_extension_keys(), 'symbol-contract type state-model extension family matches helper');
    is_deeply($family_map->{symbol_contract_type_list_extension_keys}, normalized_semantic_symbol_contract_type_list_extension_keys(), 'symbol-contract type list extension family matches helper');
    is_deeply($family_map->{symbol_contract_type_record_extension_keys}, normalized_semantic_symbol_contract_type_record_extension_keys(), 'symbol-contract type record extension family matches helper');
    ...
    is_deeply(
        $family_map->{success_forward_ir_structural_rtl_ir_port_source_extension_keys},
        normalized_semantic_forward_ir_structural_rtl_ir_port_source_extension_keys(),
        'structural-RTL port source extension family matches helper',
    );
    is_deeply(
        $family_map->{success_forward_ir_structural_rtl_ir_port_source_entry_keys},
        normalized_semantic_forward_ir_structural_rtl_ir_port_source_entry_keys(),
        'structural-RTL port source entry family matches helper',
    );
    is_deeply(
        $family_map->{success_forward_ir_structural_rtl_ir_port_target_extension_keys},
        normalized_semantic_forward_ir_structural_rtl_ir_port_target_extension_keys(),
        'structural-RTL port target extension family matches helper',
    );
    is_deeply(
        $family_map->{success_forward_ir_structural_rtl_ir_port_target_entry_keys},
        normalized_semantic_forward_ir_structural_rtl_ir_port_target_entry_keys(),
