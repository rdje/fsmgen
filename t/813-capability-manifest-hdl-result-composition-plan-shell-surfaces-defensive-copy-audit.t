...
subtest 'manifest-embedded HDLGenerator `composition_plan` shell surfaces rebuild cleanly after caller mutation' => sub {
    ...
    mutate_structure($mutated->{'composition_plan_summary_surfaces'});
    mutate_structure($mutated->{'composition_plan_fallback_surface_map'});
    ...
    is_deeply($contract->{'composition_plan_summary_surfaces'}, $expected->{'composition_plan_summary_surfaces'}, 'fresh manifest result contract rebuilds clean composition_plan_summary_surfaces');
    is_deeply($contract->{'composition_plan_fallback_surface_map'}, $expected->{'composition_plan_fallback_surface_map'}, 'fresh manifest result contract rebuilds clean composition_plan_fallback_surface_map');
