...
subtest 'manifest-embedded HDLGenerator `resolved_package_imports` shell surfaces rebuild cleanly after caller mutation' => sub {
    ...
    mutate_structure($mutated->{'resolved_package_imports_summary_surface'});
    mutate_structure($mutated->{'resolved_package_imports_fallback_surface_map'});
    ...
    is_deeply($contract->{'resolved_package_imports_summary_surface'}, $expected->{'resolved_package_imports_summary_surface'}, 'fresh manifest result contract rebuilds clean resolved_package_imports_summary_surface');
    is_deeply($contract->{'resolved_package_imports_fallback_surface_map'}, $expected->{'resolved_package_imports_fallback_surface_map'}, 'fresh manifest result contract rebuilds clean resolved_package_imports_fallback_surface_map');
