...
subtest 'manifest-embedded serializable plan reports public top-level key list rebuilds cleanly after caller mutation' => sub {
    ...
    is_deeply($contract->{'public_top_level_presence_keys'}, $expected->{'public_top_level_presence_keys'}, 'fresh manifest serializable plan report contract rebuilds clean public_top_level_presence_keys');
};
done_testing();
