...
my $sentinel = '__normalized_semantic_report_contract_full_surface_mutation__';

subtest 'normalized semantic report contract full surface rebuilds cleanly after caller mutation' => sub {
    ...
    is_deeply($second, $expected, 'fresh normalized semantic report contract rebuilds clean full surface');
};
