...
subtest 'malformed assemble clauses fail before scheduled emission' => sub {
    assert_lower_rejected(<<'ISF', 'assemble without parts', qr/\Aassemble requires '\(assemble part\.\.\. as target \[\(widths N\|TX_PARAM\|PARAM\|CONST\|PACKAGE\.CONSTANT\.\.\.\)\]\)'/);
...
ISF
    ...
    assert_lower_rejected(<<'ISF', 'assemble without as keyword', qr/\Aassemble requires '\(assemble part\.\.\. as target \[\(widths N\|TX_PARAM\|PARAM\|CONST\|PACKAGE\.CONSTANT\.\.\.\)\]\)'/);
...
ISF
    ...
    assert_lower_rejected(<<'ISF', 'extra assemble operand after target', qr/\Aassemble optional arguments must be '\(widths N\|TX_PARAM\|PARAM\|CONST\|PACKAGE\.CONSTANT\.\.\.\)'/);
...
ISF
    ...
    assert_lower_rejected(<<'ISF', 'assemble unknown option', qr/\Aassemble optional arguments must be '\(widths N\|TX_PARAM\|PARAM\|CONST\|PACKAGE\.CONSTANT\.\.\.\)'/);
