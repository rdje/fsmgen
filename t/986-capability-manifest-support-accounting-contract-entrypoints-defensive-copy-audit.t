...
subtest 'manifest support accounting contract entrypoint metadata rebuilds cleanly after caller mutation' => sub {
    ...
    is_deeply($contract->{'entrypoints'}, $expected->{'entrypoints'}, 'fresh manifest support accounting contract rebuilds clean entrypoints');
};
done_testing();
