...
subtest 'manifest captures the first downstream tool contract surface' => sub {
    ...
    like(
        $file_surface_by_suffix{'.ahb'}{current_boundary},
        qr/plus the paired BUSY composition ppif\/ahb_interconnect_requester_busy_insert_byte_lane_hburst_seq_busy_park\.ppif at ppif\/ahb_interconnect_requester_busy_insert_byte_lane_hburst_seq_busy_park\.ahb/,
        'manifest records the shipped paired BUSY composition .ahb profile-alias sample',
    );
    like(
        $file_surface_by_suffix{'.ahb'}{current_boundary},
