...
subtest 'manifest captures the first downstream tool contract surface' => sub {
    ...
    like(
        $file_surface_by_suffix{'.ppif'}{current_boundary},
        qr/\.apb is now the bounded APB requester-transfer\/completer\/composition plus busy-capable, status-capable, selected back-to-back, selected multi-register, selected multi-peripheral interconnect\/decode, selected multi-peripheral back-to-back, sideband-aware, sideband protection, selected sideband protection back-to-back, selected sideband protection multi-peripheral back-to-back, sideband data16, selected sideband data16 back-to-back, sideband data16 protection, and selected sideband data16 protection back-to-back profile-alias file surface/,
    ...
    like(
        $file_surface_by_suffix{'.ppif'}{current_boundary},
        qr/APB address widths other than 32, wait-count widths other than 4, data widths beyond the selected sideband-aware 16\/32-bit boundary, additional APB PPROT policy families, APB back-to-back variants beyond the selected fixed\/status, selected sideband-aware fixed\/status, selected sideband-aware protected fixed multi-register status, selected sideband-aware data16 fixed multi-register status, selected sideband-aware data16-protection fixed multi-register status, no-sideband multi-peripheral status, selected sideband-aware multi-peripheral status, and selected sideband-aware protection multi-peripheral status families/,
