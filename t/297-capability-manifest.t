...
subtest 'manifest captures the first downstream tool contract surface' => sub {
    ...
    like(
        $file_surface_by_suffix{'.ahb'}{current_boundary},
        qr/mirror ppif\/ahb_requester\.ppif at ppif\/ahb_requester\.ahb, ppif\/ahb_requester_busy_insert\.ppif at ppif\/ahb_requester_busy_insert\.ahb, ppif\/ahb_requester_busy_insert_two\.ppif at ppif\/ahb_requester_busy_insert_two\.ahb, ppif\/ahb_lite_subordinate\.ppif at ppif\/ahb_lite_subordinate\.ahb, ppif\/ahb_lite_subordinate_byte_lane\.ppif at ppif\/ahb_lite_subordinate_byte_lane\.ahb, ppif\/ahb_lite_subordinate_byte_lane_seq\.ppif at ppif\/ahb_lite_subordinate_byte_lane_seq\.ahb, ppif\/ahb_lite_subordinate_byte_lane_hburst_seq\.ppif at ppif\/ahb_lite_subordinate_byte_lane_hburst_seq\.ahb, ppif\/ahb_lite_subordinate_byte_lane_hburst_seq_busy_park\.ppif at ppif\/ahb_lite_subordinate_byte_lane_hburst_seq_busy_park\.ahb, ppif\/ahb_interconnect\.ppif at ppif\/ahb_interconnect\.ahb, ppif\/ahb_interconnect_two_subordinate\.ppif at ppif\/ahb_interconnect_two_subordinate\.ahb, ppif\/ahb_interconnect_byte_lane\.ppif at ppif\/ahb_interconnect_byte_lane\.ahb, ppif\/ahb_interconnect_two_subordinate_byte_lane\.ppif at ppif\/ahb_interconnect_two_subordinate_byte_lane\.ahb, ppif\/ahb_interconnect_byte_lane_seq\.ppif at ppif\/ahb_interconnect_byte_lane_seq\.ahb, ppif\/ahb_interconnect_two_subordinate_byte_lane_seq\.ppif at ppif\/ahb_interconnect_two_subordinate_byte_lane_seq\.ahb, ppif\/ahb_interconnect_byte_lane_hburst_seq\.ppif at ppif\/ahb_interconnect_byte_lane_hburst_seq\.ahb, and ppif\/ahb_interconnect_two_subordinate_byte_lane_hburst_seq\.ppif at ppif\/ahb_interconnect_two_subordinate_byte_lane_hburst_seq\.ahb/,
    ...
    like(
        ...
        'manifest records both shipped paired BUSY composition .ahb profile-alias samples',
    );
    like(
        $file_surface_by_suffix{'.ahb'}{current_boundary},
