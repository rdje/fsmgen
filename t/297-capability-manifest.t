...
subtest 'manifest captures the first downstream tool contract surface' => sub {
    ...
    like(
        $file_surface_by_suffix{'.ahb'}{current_boundary},
        qr/support exactly one \(ahb-requester amba_requester \.\.\.\) object, exactly one word-only \(ahb-subordinate ahb_lite_subordinate \.\.\.\) object, exactly one byte-lane\/narrow-transfer \(ahb-subordinate ahb_lite_subordinate_byte_lane \.\.\.\) object, exactly one byte-lane in-word SEQ \(ahb-subordinate ahb_lite_subordinate_byte_lane_seq \.\.\.\) object, exactly one HBURST-aware byte-lane in-word SEQ \(ahb-subordinate ahb_lite_subordinate_byte_lane_hburst_seq \.\.\.\) object, the selected aggregate one-requester\/one-subordinate \(ahb-interconnect ahb_tb \.\.\.\) shape, or the selected aggregate one-requester\/two-subordinate \(ahb-interconnect ahb_tb \.\.\.\) shape in this slice, including aggregate byte-lane subordinate variants/,
    ...
    like(
        $file_surface_by_suffix{'.ahb'}{current_boundary},
        qr/mirror ppif\/ahb_requester\.ppif at ppif\/ahb_requester\.ahb, ppif\/ahb_lite_subordinate\.ppif at ppif\/ahb_lite_subordinate\.ahb, ppif\/ahb_lite_subordinate_byte_lane\.ppif at ppif\/ahb_lite_subordinate_byte_lane\.ahb, ppif\/ahb_lite_subordinate_byte_lane_seq\.ppif at ppif\/ahb_lite_subordinate_byte_lane_seq\.ahb, ppif\/ahb_lite_subordinate_byte_lane_hburst_seq\.ppif at ppif\/ahb_lite_subordinate_byte_lane_hburst_seq\.ahb, ppif\/ahb_interconnect\.ppif at ppif\/ahb_interconnect\.ahb, ppif\/ahb_interconnect_two_subordinate\.ppif at ppif\/ahb_interconnect_two_subordinate\.ahb, ppif\/ahb_interconnect_byte_lane\.ppif at ppif\/ahb_interconnect_byte_lane\.ahb, ppif\/ahb_interconnect_two_subordinate_byte_lane\.ppif at ppif\/ahb_interconnect_two_subordinate_byte_lane\.ahb, ppif\/ahb_interconnect_byte_lane_seq\.ppif at ppif\/ahb_interconnect_byte_lane_seq\.ahb, ppif\/ahb_interconnect_two_subordinate_byte_lane_seq\.ppif at ppif\/ahb_interconnect_two_subordinate_byte_lane_seq\.ahb, ppif\/ahb_interconnect_byte_lane_hburst_seq\.ppif at ppif\/ahb_interconnect_byte_lane_hburst_seq\.ahb, and ppif\/ahb_interconnect_two_subordinate_byte_lane_hburst_seq\.ppif at ppif\/ahb_interconnect_two_subordinate_byte_lane_hburst_seq\.ahb/,
