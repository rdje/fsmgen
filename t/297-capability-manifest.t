...
subtest 'manifest captures the first downstream tool contract surface' => sub {
    ...
    like(
        $file_surface_by_suffix{'.ppif'}{current_boundary},
        qr/bounded AHB requester source, the bounded AHB-Lite word-only subordinate source, the bounded AHB-Lite byte-lane\/narrow-transfer subordinate source, the bounded AHB-Lite byte-lane in-word SEQ subordinate source/,
    ...
    like(
        $file_surface_by_suffix{'.ahb'}{current_boundary},
        qr/mirror ppif\/ahb_requester\.ppif at ppif\/ahb_requester\.ahb, ppif\/ahb_lite_subordinate\.ppif at ppif\/ahb_lite_subordinate\.ahb, ppif\/ahb_lite_subordinate_byte_lane\.ppif at ppif\/ahb_lite_subordinate_byte_lane\.ahb, ppif\/ahb_lite_subordinate_byte_lane_seq\.ppif at ppif\/ahb_lite_subordinate_byte_lane_seq\.ahb, ppif\/ahb_interconnect\.ppif at ppif\/ahb_interconnect\.ahb, ppif\/ahb_interconnect_two_subordinate\.ppif at ppif\/ahb_interconnect_two_subordinate\.ahb, ppif\/ahb_interconnect_byte_lane\.ppif at ppif\/ahb_interconnect_byte_lane\.ahb, ppif\/ahb_interconnect_two_subordinate_byte_lane\.ppif at ppif\/ahb_interconnect_two_subordinate_byte_lane\.ahb, ppif\/ahb_interconnect_byte_lane_seq\.ppif at ppif\/ahb_interconnect_byte_lane_seq\.ahb, and ppif\/ahb_interconnect_two_subordinate_byte_lane_seq\.ppif at ppif\/ahb_interconnect_two_subordinate_byte_lane_seq\.ahb/,
