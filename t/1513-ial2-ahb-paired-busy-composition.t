...
subtest 'adapter composes requester BUSY insertion with subordinate BUSY parking' => sub {
    ...
    like($requester_residue{ahb_requester_busy_insert_support}, qr/exactly 1 qualified requester HTRANS BUSY event/, 'requester child keeps numeric exact-one BUSY-insertion residue');
