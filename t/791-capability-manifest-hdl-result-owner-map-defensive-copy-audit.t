...
subtest 'manifest-embedded HDLGenerator nested-contract owner map rebuild cleanly after caller mutation' => sub {
    ...
    is_deeply($contract->{'nested_contract_source_map'}, $expected->{'nested_contract_source_map'}, 'fresh manifest result contract rebuilds clean nested_contract_source_map');
