...
is(scalar(@protocol_entries), 34, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    71,
    'catalog now keeps seventy-one named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    71,
    'catalog now records seventy-one positive strict-mode supported-smoke acceptance entries',
);
