...
is(scalar(@protocol_entries), 33, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    70,
    'catalog now keeps seventy named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    70,
    'catalog now records seventy positive strict-mode supported-smoke acceptance entries',
);
