...
is(scalar(@protocol_entries), 232, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    273,
    'catalog now keeps two hundred seventy-three named supported-smoke entries including direct, composition, ISF, PPIF, profile-alias, and verification-output fixtures',
);
is(
...
is(
    ...
    273,
    'catalog now records two hundred seventy-three positive strict-mode supported-smoke acceptance entries',
);
