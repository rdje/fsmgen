...
is(scalar(@protocol_entries), 280, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    321,
    'catalog now keeps three hundred twenty-one named supported-smoke entries including direct, composition, ISF, PPIF, profile-alias, and verification-output fixtures',
);
is(
...
is(
    ...
    321,
    'catalog now records three hundred twenty-one positive strict-mode supported-smoke acceptance entries',
);
