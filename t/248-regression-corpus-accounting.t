...
is(scalar(@protocol_entries), 73, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    111,
    'catalog now keeps one hundred eleven named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    111,
    'catalog now records one hundred eleven positive strict-mode supported-smoke acceptance entries',
);
