...
is(scalar(@protocol_entries), 240, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    281,
    'catalog now keeps two hundred eighty-one named supported-smoke entries including direct, composition, ISF, PPIF, profile-alias, and verification-output fixtures',
);
is(
...
is(
    ...
    281,
    'catalog now records two hundred eighty-one positive strict-mode supported-smoke acceptance entries',
);
