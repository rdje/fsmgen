...
is(scalar(@protocol_entries), 262, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    303,
    'catalog now keeps three hundred three named supported-smoke entries including direct, composition, ISF, PPIF, profile-alias, and verification-output fixtures',
);
is(
...
is(
    ...
    303,
    'catalog now records three hundred three positive strict-mode supported-smoke acceptance entries',
);
