...
is(scalar(@protocol_entries), 41, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    79,
    'catalog now keeps seventy-nine named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    79,
    'catalog now records seventy-nine positive strict-mode supported-smoke acceptance entries',
);
