...
is(scalar(@protocol_entries), 254, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    295,
    'catalog now keeps two hundred ninety-five named supported-smoke entries including direct, composition, ISF, PPIF, profile-alias, and verification-output fixtures',
);
is(
...
is(
    ...
    295,
    'catalog now records two hundred ninety-five positive strict-mode supported-smoke acceptance entries',
);
