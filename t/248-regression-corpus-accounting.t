...
is(scalar(@protocol_entries), 310, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    351,
    'catalog now keeps three hundred fifty-one named supported-smoke entries including direct, composition, ISF, PPIF, profile-alias, and verification-output fixtures',
);
is(
...
is(
    ...
    351,
    'catalog now records three hundred fifty-one positive strict-mode supported-smoke acceptance entries',
);
