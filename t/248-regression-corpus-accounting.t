...
is(scalar(@protocol_entries), 117, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    156,
    'catalog now keeps one hundred fifty-six named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    156,
    'catalog now records one hundred fifty-six positive strict-mode supported-smoke acceptance entries',
);
