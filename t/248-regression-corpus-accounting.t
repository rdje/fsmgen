...
is(scalar(@protocol_entries), 35, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    72,
    'catalog now keeps seventy-two named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    72,
    'catalog now records seventy-two positive strict-mode supported-smoke acceptance entries',
);
