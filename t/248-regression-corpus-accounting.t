...
is(scalar(@protocol_entries), 132, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    171,
    'catalog now keeps one hundred seventy-one named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    171,
    'catalog now records one hundred seventy-one positive strict-mode supported-smoke acceptance entries',
);
