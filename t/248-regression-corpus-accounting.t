...
is(scalar(@protocol_entries), 285, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    326,
    'catalog now keeps three hundred twenty-six named supported-smoke entries including direct, composition, ISF, PPIF, profile-alias, and verification-output fixtures',
);
is(
...
is(
    ...
    326,
    'catalog now records three hundred twenty-six positive strict-mode supported-smoke acceptance entries',
);
