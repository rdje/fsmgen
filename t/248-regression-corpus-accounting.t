...
is(scalar(@protocol_entries), 125, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    164,
    'catalog now keeps one hundred sixty-four named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    164,
    'catalog now records one hundred sixty-four positive strict-mode supported-smoke acceptance entries',
);
