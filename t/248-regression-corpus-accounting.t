...
is(scalar(@protocol_entries), 78, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    117,
    'catalog now keeps one hundred seventeen named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    117,
    'catalog now records one hundred seventeen positive strict-mode supported-smoke acceptance entries',
);
