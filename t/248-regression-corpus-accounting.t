...
is(scalar(@protocol_entries), 88, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    127,
    'catalog now keeps one hundred twenty-seven named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    127,
    'catalog now records one hundred twenty-seven positive strict-mode supported-smoke acceptance entries',
);
