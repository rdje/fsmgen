...
is(scalar(@protocol_entries), 135, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    174,
    'catalog now keeps one hundred seventy-four named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    174,
    'catalog now records one hundred seventy-four positive strict-mode supported-smoke acceptance entries',
);
