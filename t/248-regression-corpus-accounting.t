...
is(scalar(@protocol_entries), 265, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    306,
    'catalog now keeps three hundred six named supported-smoke entries including direct, composition, ISF, PPIF, profile-alias, and verification-output fixtures',
);
is(
...
is(
    ...
    306,
    'catalog now records three hundred six positive strict-mode supported-smoke acceptance entries',
);
