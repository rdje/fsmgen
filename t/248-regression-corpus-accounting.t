...
is(scalar(@protocol_entries), 320, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    361,
    'catalog now keeps three hundred sixty-one named supported-smoke entries including direct, composition, ISF, PPIF, profile-alias, and verification-output fixtures',
);
is(
...
is(
    ...
    361,
    'catalog now records three hundred sixty-one positive strict-mode supported-smoke acceptance entries',
);
