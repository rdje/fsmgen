...
is(scalar(@protocol_entries), 305, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    346,
    'catalog now keeps three hundred forty-six named supported-smoke entries including direct, composition, ISF, PPIF, profile-alias, and verification-output fixtures',
);
is(
...
is(
    ...
    346,
    'catalog now records three hundred forty-six positive strict-mode supported-smoke acceptance entries',
);
