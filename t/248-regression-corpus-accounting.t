...
is(scalar(@protocol_entries), 272, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    313,
    'catalog now keeps three hundred thirteen named supported-smoke entries including direct, composition, ISF, PPIF, profile-alias, and verification-output fixtures',
);
is(
...
is(
    ...
    313,
    'catalog now records three hundred thirteen positive strict-mode supported-smoke acceptance entries',
);
