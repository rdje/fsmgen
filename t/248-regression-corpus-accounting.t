...
is(scalar(@protocol_entries), 234, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    275,
    'catalog now keeps two hundred seventy-five named supported-smoke entries including direct, composition, ISF, PPIF, profile-alias, and verification-output fixtures',
);
is(
...
is(
    ...
    275,
    'catalog now records two hundred seventy-five positive strict-mode supported-smoke acceptance entries',
);
