...
my %allowed_coverages = map { $_ => 1 } qw(
    ...
    vial_vhdl_provider_free_selected_matrix_review_private_api
...
my %coverage_classification = (
    ...
    vial_vhdl_provider_free_selected_matrix_review_private_api => 'supported_smoke',
