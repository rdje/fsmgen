...
is(scalar(@protocol_entries), 308, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    349,
    'catalog now keeps three hundred forty-nine named supported-smoke entries including direct, composition, ISF, PPIF, profile-alias, and verification-output fixtures',
);
is(
...
is(
    ...
    349,
    'catalog now records three hundred forty-nine positive strict-mode supported-smoke acceptance entries',
);
