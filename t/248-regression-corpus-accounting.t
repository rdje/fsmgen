...
is(scalar(@protocol_entries), 131, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    170,
    'catalog now keeps one hundred seventy named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    170,
    'catalog now records one hundred seventy positive strict-mode supported-smoke acceptance entries',
);
