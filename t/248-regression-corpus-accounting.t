...
is(scalar(@protocol_entries), 76, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    114,
    'catalog now keeps one hundred fourteen named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    114,
    'catalog now records one hundred fourteen positive strict-mode supported-smoke acceptance entries',
);
