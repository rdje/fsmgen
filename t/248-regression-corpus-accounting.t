...
is(scalar(@protocol_entries), 236, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    277,
    'catalog now keeps two hundred seventy-seven named supported-smoke entries including direct, composition, ISF, PPIF, profile-alias, and verification-output fixtures',
);
is(
...
is(
    ...
    277,
    'catalog now records two hundred seventy-seven positive strict-mode supported-smoke acceptance entries',
);
