...
is(scalar(@protocol_entries), 286, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    327,
    'catalog now keeps three hundred twenty-seven named supported-smoke entries including direct, composition, ISF, PPIF, profile-alias, and verification-output fixtures',
);
is(
...
is(
    ...
    327,
    'catalog now records three hundred twenty-seven positive strict-mode supported-smoke acceptance entries',
);
