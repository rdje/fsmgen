...
is(scalar(@protocol_entries), 97, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    136,
    'catalog now keeps one hundred thirty-five named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    136,
    'catalog now records one hundred thirty-five positive strict-mode supported-smoke acceptance entries',
);
