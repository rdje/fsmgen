...
is(scalar(@protocol_entries), 248, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    289,
    'catalog now keeps two hundred eighty-nine named supported-smoke entries including direct, composition, ISF, PPIF, profile-alias, and verification-output fixtures',
);
is(
...
is(
    ...
    289,
    'catalog now records two hundred eighty-nine positive strict-mode supported-smoke acceptance entries',
);
