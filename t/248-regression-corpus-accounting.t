...
is(scalar(@protocol_entries), 153, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    194,
    'catalog now keeps one hundred ninety-four named supported-smoke entries including direct, composition, ISF, PPIF, profile-alias, and verification-output fixtures',
);
is(
...
is(
    ...
    194,
    'catalog now records one hundred ninety-four positive strict-mode supported-smoke acceptance entries',
);
