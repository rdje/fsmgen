...
is(scalar(@protocol_entries), 56, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    94,
    'catalog now keeps ninety-four named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    94,
    'catalog now records ninety-four positive strict-mode supported-smoke acceptance entries',
);
