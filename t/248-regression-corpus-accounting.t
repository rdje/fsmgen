...
is(scalar(@protocol_entries), 104, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    143,
    'catalog now keeps one hundred forty-three named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    143,
    'catalog now records one hundred forty-three positive strict-mode supported-smoke acceptance entries',
);
