...
is(scalar(@protocol_entries), 58, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    96,
    'catalog now keeps ninety-six named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    96,
    'catalog now records ninety-six positive strict-mode supported-smoke acceptance entries',
);
