...
is(scalar(@protocol_entries), 46, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    84,
    'catalog now keeps eighty-four named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    84,
    'catalog now records eighty-four positive strict-mode supported-smoke acceptance entries',
);
