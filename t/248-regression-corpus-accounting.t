...
is(scalar(@protocol_entries), 38, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    76,
    'catalog now keeps seventy-six named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    76,
    'catalog now records seventy-six positive strict-mode supported-smoke acceptance entries',
);
