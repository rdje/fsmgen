...
is(scalar(@protocol_entries), 128, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    167,
    'catalog now keeps one hundred sixty-seven named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    167,
    'catalog now records one hundred sixty-seven positive strict-mode supported-smoke acceptance entries',
);
