...
is(scalar(@protocol_entries), 250, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    291,
    'catalog now keeps two hundred ninety-one named supported-smoke entries including direct, composition, ISF, PPIF, profile-alias, and verification-output fixtures',
);
is(
...
is(
    ...
    291,
    'catalog now records two hundred ninety-one positive strict-mode supported-smoke acceptance entries',
);
