...
is(scalar(@protocol_entries), 44, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    82,
    'catalog now keeps eighty-two named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    82,
    'catalog now records eighty-two positive strict-mode supported-smoke acceptance entries',
);
