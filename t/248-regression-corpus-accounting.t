...
is(scalar(@protocol_entries), 45, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    83,
    'catalog now keeps eighty-three named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    83,
    'catalog now records eighty-three positive strict-mode supported-smoke acceptance entries',
);
