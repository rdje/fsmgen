...
is(scalar(@protocol_entries), 312, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    353,
    'catalog now keeps three hundred fifty-three named supported-smoke entries including direct, composition, ISF, PPIF, profile-alias, and verification-output fixtures',
);
is(
...
is(
    ...
    353,
    'catalog now records three hundred fifty-three positive strict-mode supported-smoke acceptance entries',
);
