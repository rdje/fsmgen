...
is(scalar(@protocol_entries), 303, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    344,
    'catalog now keeps three hundred forty-four named supported-smoke entries including direct, composition, ISF, PPIF, profile-alias, and verification-output fixtures',
);
is(
...
is(
    ...
    344,
    'catalog now records three hundred forty-four positive strict-mode supported-smoke acceptance entries',
);
