...
is(
    ...
    24,
    'catalog now keeps twenty-four named supported-smoke entries including direct and composition language-feature fixtures',
);
is(
...
is(
    ...
    24,
    'catalog now records twenty-four positive strict-mode supported-smoke acceptance entries',
);
