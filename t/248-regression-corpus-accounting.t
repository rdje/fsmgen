...
is(scalar(@protocol_entries), 112, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    151,
    'catalog now keeps one hundred fifty-one named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    151,
    'catalog now records one hundred fifty-one positive strict-mode supported-smoke acceptance entries',
);
