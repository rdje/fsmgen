...
is(scalar(@protocol_entries), 40, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    78,
    'catalog now keeps seventy-eight named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    78,
    'catalog now records seventy-eight positive strict-mode supported-smoke acceptance entries',
);
