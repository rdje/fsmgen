...
is(scalar(@protocol_entries), 137, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    176,
    'catalog now keeps one hundred seventy-six named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    176,
    'catalog now records one hundred seventy-six positive strict-mode supported-smoke acceptance entries',
);
