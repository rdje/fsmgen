...
is(scalar(@protocol_entries), 43, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    81,
    'catalog now keeps eighty-one named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    81,
    'catalog now records eighty-one positive strict-mode supported-smoke acceptance entries',
);
