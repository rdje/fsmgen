...
is(scalar(@protocol_entries), 39, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    77,
    'catalog now keeps seventy-seven named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    77,
    'catalog now records seventy-seven positive strict-mode supported-smoke acceptance entries',
);
