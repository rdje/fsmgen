...
is(scalar(@protocol_entries), 302, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    343,
    'catalog now keeps three hundred forty-three named supported-smoke entries including direct, composition, ISF, PPIF, profile-alias, and verification-output fixtures',
);
is(
...
is(
    ...
    343,
    'catalog now records three hundred forty-three positive strict-mode supported-smoke acceptance entries',
);
