...
is(scalar(@protocol_entries), 68, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    106,
    'catalog now keeps one hundred six named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    106,
    'catalog now records one hundred six positive strict-mode supported-smoke acceptance entries',
);
