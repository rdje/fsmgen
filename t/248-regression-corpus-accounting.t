...
is(scalar(@protocol_entries), 100, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    139,
    'catalog now keeps one hundred thirty-nine named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    139,
    'catalog now records one hundred thirty-nine positive strict-mode supported-smoke acceptance entries',
);
