...
is(scalar(@protocol_entries), 102, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    141,
    'catalog now keeps one hundred forty-one named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    141,
    'catalog now records one hundred forty-one positive strict-mode supported-smoke acceptance entries',
);
