...
is(scalar(@protocol_entries), 36, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    73,
    'catalog now keeps seventy-three named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    73,
    'catalog now records seventy-three positive strict-mode supported-smoke acceptance entries',
);
