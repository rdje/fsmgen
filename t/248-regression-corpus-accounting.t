...
is(scalar(@protocol_entries), 326, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    367,
    'catalog now keeps three hundred sixty-seven named supported-smoke entries including direct, composition, ISF, PPIF, profile-alias, and verification-output fixtures',
);
is(
...
is(
    ...
    367,
    'catalog now records three hundred sixty-seven positive strict-mode supported-smoke acceptance entries',
);
