...
is(scalar(@protocol_entries), 152, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    193,
    'catalog now keeps one hundred ninety-three named supported-smoke entries including direct, composition, ISF, PPIF, profile-alias, and verification-output fixtures',
);
is(
...
is(
    ...
    193,
    'catalog now records one hundred ninety-three positive strict-mode supported-smoke acceptance entries',
);
