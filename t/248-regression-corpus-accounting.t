...
is(scalar(@protocol_entries), 114, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    153,
    'catalog now keeps one hundred fifty-three named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    153,
    'catalog now records one hundred fifty-three positive strict-mode supported-smoke acceptance entries',
);
