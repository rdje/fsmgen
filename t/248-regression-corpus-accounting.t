...
is(scalar(@protocol_entries), 160, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    201,
    'catalog now keeps two hundred one named supported-smoke entries including direct, composition, ISF, PPIF, profile-alias, and verification-output fixtures',
);
is(
...
is(
    ...
    201,
    'catalog now records two hundred one positive strict-mode supported-smoke acceptance entries',
);
