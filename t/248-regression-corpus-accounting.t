...
is(scalar(@protocol_entries), 101, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    140,
    'catalog now keeps one hundred forty named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    140,
    'catalog now records one hundred forty positive strict-mode supported-smoke acceptance entries',
);
