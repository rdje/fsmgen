...
is(scalar(@protocol_entries), 238, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    279,
    'catalog now keeps two hundred seventy-nine named supported-smoke entries including direct, composition, ISF, PPIF, profile-alias, and verification-output fixtures',
);
is(
...
is(
    ...
    279,
    'catalog now records two hundred seventy-nine positive strict-mode supported-smoke acceptance entries',
);
