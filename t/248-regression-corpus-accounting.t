...
is(scalar(@protocol_entries), 306, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    347,
    'catalog now keeps three hundred forty-seven named supported-smoke entries including direct, composition, ISF, PPIF, profile-alias, and verification-output fixtures',
);
is(
...
is(
    ...
    347,
    'catalog now records three hundred forty-seven positive strict-mode supported-smoke acceptance entries',
);
