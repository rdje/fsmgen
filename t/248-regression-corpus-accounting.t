...
is(scalar(@protocol_entries), 270, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    311,
    'catalog now keeps three hundred eleven named supported-smoke entries including direct, composition, ISF, PPIF, profile-alias, and verification-output fixtures',
);
is(
...
is(
    ...
    311,
    'catalog now records three hundred eleven positive strict-mode supported-smoke acceptance entries',
);
