...
is(scalar(@protocol_entries), 89, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    128,
    'catalog now keeps one hundred twenty-eight named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    128,
    'catalog now records one hundred twenty-eight positive strict-mode supported-smoke acceptance entries',
);
