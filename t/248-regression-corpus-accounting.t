...
is(scalar(@protocol_entries), 98, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    137,
    'catalog now keeps one hundred thirty-seven named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    137,
    'catalog now records one hundred thirty-seven positive strict-mode supported-smoke acceptance entries',
);
