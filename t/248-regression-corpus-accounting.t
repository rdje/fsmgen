...
is(scalar(@protocol_entries), 93, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    132,
    'catalog now keeps one hundred thirty-two named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    132,
    'catalog now records one hundred thirty-two positive strict-mode supported-smoke acceptance entries',
);
