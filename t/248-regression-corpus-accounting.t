...
is(scalar(@protocol_entries), 242, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    283,
    'catalog now keeps two hundred eighty-three named supported-smoke entries including direct, composition, ISF, PPIF, profile-alias, and verification-output fixtures',
);
is(
...
is(
    ...
    283,
    'catalog now records two hundred eighty-three positive strict-mode supported-smoke acceptance entries',
);
