...
is(scalar(@protocol_entries), 264, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    305,
    'catalog now keeps three hundred five named supported-smoke entries including direct, composition, ISF, PPIF, profile-alias, and verification-output fixtures',
);
is(
...
is(
    ...
    305,
    'catalog now records three hundred five positive strict-mode supported-smoke acceptance entries',
);
