...
is(scalar(@protocol_entries), 109, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    148,
    'catalog now keeps one hundred forty-eight named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    148,
    'catalog now records one hundred forty-eight positive strict-mode supported-smoke acceptance entries',
);
