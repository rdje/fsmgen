...
is(scalar(@protocol_entries), 136, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    175,
    'catalog now keeps one hundred seventy-five named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    175,
    'catalog now records one hundred seventy-five positive strict-mode supported-smoke acceptance entries',
);
