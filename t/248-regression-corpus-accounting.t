...
is(scalar(@protocol_entries), 274, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    315,
    'catalog now keeps three hundred fifteen named supported-smoke entries including direct, composition, ISF, PPIF, profile-alias, and verification-output fixtures',
);
is(
...
is(
    ...
    315,
    'catalog now records three hundred fifteen positive strict-mode supported-smoke acceptance entries',
);
