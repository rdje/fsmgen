...
is(scalar(@protocol_entries), 113, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    152,
    'catalog now keeps one hundred fifty-two named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    152,
    'catalog now records one hundred fifty-two positive strict-mode supported-smoke acceptance entries',
);
