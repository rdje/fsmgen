...
is(scalar(@protocol_entries), 145, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    184,
    'catalog now keeps one hundred eighty-four named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    184,
    'catalog now records one hundred eighty-four positive strict-mode supported-smoke acceptance entries',
);
