...
is(scalar(@protocol_entries), 138, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    177,
    'catalog now keeps one hundred seventy-seven named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    177,
    'catalog now records one hundred seventy-seven positive strict-mode supported-smoke acceptance entries',
);
