...
is(scalar(@protocol_entries), 105, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    144,
    'catalog now keeps one hundred forty-four named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    144,
    'catalog now records one hundred forty-four positive strict-mode supported-smoke acceptance entries',
);
