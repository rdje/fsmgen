...
is(scalar(@protocol_entries), 126, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    165,
    'catalog now keeps one hundred sixty-five named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    165,
    'catalog now records one hundred sixty-five positive strict-mode supported-smoke acceptance entries',
);
