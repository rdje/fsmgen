...
is(scalar(@protocol_entries), 130, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    169,
    'catalog now keeps one hundred sixty-nine named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    169,
    'catalog now records one hundred sixty-nine positive strict-mode supported-smoke acceptance entries',
);
