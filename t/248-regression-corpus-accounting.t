...
is(scalar(@protocol_entries), 311, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    352,
    'catalog now keeps three hundred fifty-two named supported-smoke entries including direct, composition, ISF, PPIF, profile-alias, and verification-output fixtures',
);
is(
...
is(
    ...
    352,
    'catalog now records three hundred fifty-two positive strict-mode supported-smoke acceptance entries',
);
