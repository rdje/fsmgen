...
is(scalar(@protocol_entries), 103, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    142,
    'catalog now keeps one hundred forty-two named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    142,
    'catalog now records one hundred forty-two positive strict-mode supported-smoke acceptance entries',
);
