...
is(scalar(@protocol_entries), 313, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    354,
    'catalog now keeps three hundred fifty-four named supported-smoke entries including direct, composition, ISF, PPIF, profile-alias, and verification-output fixtures',
);
is(
...
is(
    ...
    354,
    'catalog now records three hundred fifty-four positive strict-mode supported-smoke acceptance entries',
);
