...
is(scalar(@protocol_entries), 90, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    129,
    'catalog now keeps one hundred twenty-nine named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    129,
    'catalog now records one hundred twenty-nine positive strict-mode supported-smoke acceptance entries',
);
