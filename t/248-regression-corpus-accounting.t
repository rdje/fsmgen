...
is(scalar(@protocol_entries), 92, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    131,
    'catalog now keeps one hundred thirty-one named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    131,
    'catalog now records one hundred thirty-one positive strict-mode supported-smoke acceptance entries',
);
