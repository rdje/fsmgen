...
is(scalar(@protocol_entries), 85, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    124,
    'catalog now keeps one hundred twenty-four named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    124,
    'catalog now records one hundred twenty-four positive strict-mode supported-smoke acceptance entries',
);
