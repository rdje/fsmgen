...
is(scalar(@protocol_entries), 319, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    360,
    'catalog now keeps three hundred sixty named supported-smoke entries including direct, composition, ISF, PPIF, profile-alias, and verification-output fixtures',
);
is(
...
is(
    ...
    360,
    'catalog now records three hundred sixty positive strict-mode supported-smoke acceptance entries',
);
