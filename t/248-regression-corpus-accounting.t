...
is(scalar(@protocol_entries), 307, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    348,
    'catalog now keeps three hundred forty-eight named supported-smoke entries including direct, composition, ISF, PPIF, profile-alias, and verification-output fixtures',
);
is(
...
is(
    ...
    348,
    'catalog now records three hundred forty-eight positive strict-mode supported-smoke acceptance entries',
);
