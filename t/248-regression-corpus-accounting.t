...
is(scalar(@protocol_entries), 121, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    160,
    'catalog now keeps one hundred sixty named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    160,
    'catalog now records one hundred sixty positive strict-mode supported-smoke acceptance entries',
);
