...
is(scalar(@protocol_entries), 252, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    293,
    'catalog now keeps two hundred ninety-three named supported-smoke entries including direct, composition, ISF, PPIF, profile-alias, and verification-output fixtures',
);
is(
...
is(
    ...
    293,
    'catalog now records two hundred ninety-three positive strict-mode supported-smoke acceptance entries',
);
