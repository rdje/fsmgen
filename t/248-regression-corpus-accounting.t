...
is(scalar(@protocol_entries), 42, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    80,
    'catalog now keeps eighty named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    80,
    'catalog now records eighty positive strict-mode supported-smoke acceptance entries',
);
