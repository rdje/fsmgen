...
is(scalar(@protocol_entries), 271, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    312,
    'catalog now keeps three hundred twelve named supported-smoke entries including direct, composition, ISF, PPIF, profile-alias, and verification-output fixtures',
);
is(
...
is(
    ...
    312,
    'catalog now records three hundred twelve positive strict-mode supported-smoke acceptance entries',
);
