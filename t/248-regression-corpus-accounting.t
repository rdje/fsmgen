...
is(scalar(@protocol_entries), 273, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    314,
    'catalog now keeps three hundred fourteen named supported-smoke entries including direct, composition, ISF, PPIF, profile-alias, and verification-output fixtures',
);
is(
...
is(
    ...
    314,
    'catalog now records three hundred fourteen positive strict-mode supported-smoke acceptance entries',
);
