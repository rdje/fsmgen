...
ok(@entries >= 30, 'regression corpus catalog now covers supported language-feature fixtures plus root-level, section-level, child-root, direct-generation, and composition-contract residue families');
...
is(
    ...
    8,
    'catalog now keeps eight named supported-smoke entries including the first language-feature fixtures',
);
is(
...
is(
    ...
    18,
    'catalog now records eighteen explicit expected-failure entries',
);
