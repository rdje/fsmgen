...
is(scalar(@protocol_entries), 304, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    345,
    'catalog now keeps three hundred forty-five named supported-smoke entries including direct, composition, ISF, PPIF, profile-alias, and verification-output fixtures',
);
is(
...
is(
    ...
    345,
    'catalog now records three hundred forty-five positive strict-mode supported-smoke acceptance entries',
);
