...
is(scalar(@protocol_entries), 260, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    301,
    'catalog now keeps three hundred one named supported-smoke entries including direct, composition, ISF, PPIF, profile-alias, and verification-output fixtures',
);
is(
...
is(
    ...
    301,
    'catalog now records three hundred one positive strict-mode supported-smoke acceptance entries',
);
