...
is(scalar(@protocol_entries), 316, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    357,
    'catalog now keeps three hundred fifty-seven named supported-smoke entries including direct, composition, ISF, PPIF, profile-alias, and verification-output fixtures',
);
is(
...
is(
    ...
    357,
    'catalog now records three hundred fifty-seven positive strict-mode supported-smoke acceptance entries',
);
