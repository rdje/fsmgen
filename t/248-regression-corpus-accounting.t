...
is(scalar(@protocol_entries), 275, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    316,
    'catalog now keeps three hundred sixteen named supported-smoke entries including direct, composition, ISF, PPIF, profile-alias, and verification-output fixtures',
);
is(
...
is(
    ...
    316,
    'catalog now records three hundred sixteen positive strict-mode supported-smoke acceptance entries',
);
