...
is(scalar(@protocol_entries), 74, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    112,
    'catalog now keeps one hundred twelve named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    112,
    'catalog now records one hundred twelve positive strict-mode supported-smoke acceptance entries',
);
