...
is(scalar(@protocol_entries), 141, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    180,
    'catalog now keeps one hundred eighty named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    180,
    'catalog now records one hundred eighty positive strict-mode supported-smoke acceptance entries',
);
