...
is(scalar(@protocol_entries), 129, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    168,
    'catalog now keeps one hundred sixty-eight named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    168,
    'catalog now records one hundred sixty-eight positive strict-mode supported-smoke acceptance entries',
);
