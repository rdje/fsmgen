...
is(scalar(@protocol_entries), 309, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    350,
    'catalog now keeps three hundred fifty named supported-smoke entries including direct, composition, ISF, PPIF, profile-alias, and verification-output fixtures',
);
is(
...
is(
    ...
    350,
    'catalog now records three hundred fifty positive strict-mode supported-smoke acceptance entries',
);
