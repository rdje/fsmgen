...
is(scalar(@protocol_entries), 72, 'first visible corpus slice contains the named protocol and public intent fixtures');
...
is(
    ...
    110,
    'catalog now keeps one hundred ten named supported-smoke entries including direct, composition, ISF, and PPIF fixtures',
);
is(
...
is(
    ...
    110,
    'catalog now records one hundred ten positive strict-mode supported-smoke acceptance entries',
);
