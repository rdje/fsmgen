...
subtest 'manifest-embedded HDLGenerator shell-only fallback surface family map survives JSON round trip' => sub {
    ...
    is_deeply(
        ...
        $expected->{shell_only_fallback_surface_family_map},
        'decoded manifest result contract keeps grouped shell fallback surface family map',
    );
