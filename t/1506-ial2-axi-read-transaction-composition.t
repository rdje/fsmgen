...
subtest 'generated structural top joins AR then retires exact raw R outcomes' => sub {
    ...
    my $compile_result = run_verilator_compile(['verilator', '--binary', '--timing', '--no-assert', '-Wno-fatal', '-j', '1', '--top-module', 'axi_read_transaction_composition_tb', '--Mdir', $obj_dir, $hdl, $testbench]);
