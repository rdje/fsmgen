...
subtest 'adapter parses selected generalized five-register sideband no-policy APB multi-peripheral multi-register back-to-back composition PPIF shape' => sub {
    ok(-f sample_apb_composition_multi_peripheral_multi_register_sideband_generalized_five_register_status_back_to_back_ppif_path(), 'tracked runnable generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition PPIF sample exists');

    my $result = FSM::Adapter::IAL2::PPIF->new()->parse_file(sample_apb_composition_multi_peripheral_multi_register_sideband_generalized_five_register_status_back_to_back_ppif_path());

    is($result->{layer}, 'IAL2', 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition adapter result stays IAL2');
    is($result->{kind}, 'protocol_intent.apb_composition', 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back adapter returns the APB composition kind');
    is($result->{mode}, 'requester-multi-peripheral-composition', 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition mode is explicit');
    is($result->{report}{source_object}{id}, 'fsmgen-apb-composition-multi-peripheral-multi-register-sideband-generalized-five-register-status-back-to-back', 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition source object id is preserved');
    is($result->{report}{composition}{topology}, 'multi_peripheral_interconnect', 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back report names the selected topology');
    is($result->{report}{composition}{width_policy}{data_width}, 32, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back report records 32-bit data width');
    is($result->{report}{composition}{width_policy}{strobe_width}, 4, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back report records 4-bit PSTRB width');
    is($result->{report}{composition}{address_map}{alignment_bytes}, 4, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back report records 4-byte address-map alignment');
    is_deeply(
        [map { $_->{base}{default} } @{$result->{report}{composition}{address_map}{windows}}],
        [0, 256],
        'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back report preserves 4-byte-aligned window bases',
    );
    is($result->{report}{back_to_back_policy}{composition_role}, 'propagate_endpoint_policy_through_interconnect', 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back report records aggregate propagation role');
    is($result->{report}{back_to_back_policy}{requester}{timing_policy}{queue_depth}, 1, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back report preserves queue-depth 1');
    is($result->{report}{back_to_back_policy}{requester}{timing_policy}{overflow}, 'reject', 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back report preserves overflow reject');
    is_deeply($result->{report}{children}[2]{transfer}{registers}, [qw(reg0 reg1 reg2 reg3 reg4)], 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back status peripheral reports reg0..reg4 storage');
    is_deeply($result->{report}{children}[3]{transfer}{registers}, [qw(reg0 reg1 reg2 reg3 reg4)], 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back control peripheral reports reg0..reg4 storage');
    is($result->{report}{children}[2]{bindings}{storage}{registers}[3]{address}{value}, 12, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back status reg3 address is 12');
    is($result->{report}{children}[2]{bindings}{storage}{registers}[4]{address}{value}, 16, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back status reg4 address is 16');
    is($result->{report}{children}[3]{bindings}{storage}{registers}[4]{data}{name}, 'control_reg4_data_q', 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back control reg4 data signal is preserved');

    my $top = $result->{generated_ial0}{files}{'apb_tb.fsm'};
    like($top, qr/=accepted>/, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back top exposes accepted output');
    like($top, qr/=req_wstrb<4/, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back top exposes 4-bit requester strobe');
    like($top, qr/\(queued_wdata 32\)/, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back top embeds 32-bit queued data state');
    like($top, qr/\(queued_prot 3\)/, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back top embeds queued PPROT state');
    like($top, qr/\(queued_wstrb 4\)/, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back top embeds queued 4-bit PSTRB state');
    like($top, qr/\(status_reg3_data_q 32 \(reset 0\)\)/, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back top embeds status reg3 storage');
    like($top, qr/\(status_reg4_data_q 32 \(reset 0\)\)/, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back top embeds status reg4 storage');
    like($top, qr/\(control_reg4_data_q 32 \(reset 0\)\)/, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back top embeds control reg4 storage');
    like($top, qr/\(<- \(status_reg4_data_q \(\| \(& status_reg4_data_q 32'hffffff00\) \(& wdata_q 32'h000000ff\)\)\)\)/, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back top embeds status reg4 byte-lane write mask');

    my $interconnect = $result->{generated_ial0}{files}{'apb_interconnect.fsm'};
    like($interconnect, qr/\(PSTRB_CONTROL 4\)/, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back interconnect declares control-window PSTRB width 4');
    like($interconnect, qr/\(<- \(PPROT_STATUS> PPROT\)\)/, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back interconnect fans out PPROT to status');
    like($interconnect, qr/\(<- \(PSTRB_CONTROL> PSTRB\)\)/, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back interconnect fans out PSTRB to control');
    like($interconnect, qr/\(<- \(PADDR_CONTROL> \(- PADDR 256\)\) <\(& PSEL \(>= PADDR 256\) \(< PADDR 512\)\)\)/, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back interconnect subtracts the 256-byte control base');
    unlike($interconnect, qr/prot_q/, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back interconnect remains enforcement-free');

    my %composition_residue = map { $_->{id} => 1 } @{$result->{report}{unsupported_residue}};
    ok(!$composition_residue{apb_back_to_back_policy_deferred}, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back composition report removes broad back-to-back residue');
    ok($composition_residue{apb_additional_back_to_back_policies_deferred}, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back composition report keeps narrowed future timing-policy residue');
    ok($composition_residue{apb_protection_policy_effects_deferred}, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back composition report keeps protection-policy effects residue');
    ok($composition_residue{apb_alternate_widths_deferred}, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back composition report keeps alternate-width residue');

    ok(-f sample_apb_composition_multi_peripheral_multi_register_sideband_generalized_five_register_status_back_to_back_apb_path(), 'tracked runnable generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition .apb sample exists');
    my $alias = FSM::Adapter::IAL2::PPIF->new()->parse_file(sample_apb_composition_multi_peripheral_multi_register_sideband_generalized_five_register_status_back_to_back_apb_path());
    my $ppif = FSM::Adapter::IAL2::PPIF->new()->parse_file(sample_apb_composition_multi_peripheral_multi_register_sideband_generalized_five_register_status_back_to_back_ppif_path());
    is($alias->{kind}, 'protocol_intent.apb_composition', 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back .apb APB composition alias returns the composition kind');
    is($alias->{mode}, 'requester-multi-peripheral-composition', 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back .apb APB composition alias preserves mode');
    is_deeply($alias->{generated_ial1}{items}, $ppif->{generated_ial1}{items}, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back .apb APB composition alias mirrors .ppif generated IAL1 artifacts');
    is_deeply($alias->{generated_ial0}{files}, $ppif->{generated_ial0}{files}, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back .apb APB composition alias mirrors .ppif generated IAL0');
    is_deeply($alias->{report}{children}[3]{transfer}{registers}, [qw(reg0 reg1 reg2 reg3 reg4)], 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back .apb APB composition alias preserves control reg0..reg4 storage');
};
...
subtest 'adapter parses selected generalized five-register sideband protection APB multi-peripheral multi-register back-to-back composition PPIF shape' => sub {
    ok(-f sample_apb_composition_multi_peripheral_multi_register_sideband_protection_generalized_five_register_status_back_to_back_ppif_path(), 'tracked runnable generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition PPIF sample exists');

    my $result = FSM::Adapter::IAL2::PPIF->new()->parse_file(sample_apb_composition_multi_peripheral_multi_register_sideband_protection_generalized_five_register_status_back_to_back_ppif_path());

    is($result->{layer}, 'IAL2', 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition adapter result stays IAL2');
    is($result->{kind}, 'protocol_intent.apb_composition', 'generalized five-register sideband protection multi-peripheral multi-register back-to-back adapter returns the APB composition kind');
    is($result->{mode}, 'requester-multi-peripheral-composition', 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition mode is explicit');
    is($result->{report}{source_object}{id}, 'fsmgen-apb-composition-multi-peripheral-multi-register-sideband-protection-generalized-five-register-status-back-to-back', 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition source object id is preserved');
    is($result->{report}{composition}{topology}, 'multi_peripheral_interconnect', 'generalized five-register sideband protection multi-peripheral multi-register back-to-back report names the selected topology');
    is($result->{report}{composition}{width_policy}{data_width}, 32, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back report records 32-bit data width');
    is($result->{report}{composition}{width_policy}{strobe_width}, 4, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back report records 4-bit PSTRB width');
    is($result->{report}{composition}{address_map}{alignment_bytes}, 4, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back report records 4-byte address-map alignment');
    is_deeply(
        [map { $_->{base}{default} } @{$result->{report}{composition}{address_map}{windows}}],
        [0, 256],
        'generalized five-register sideband protection multi-peripheral multi-register back-to-back report preserves 4-byte-aligned window bases',
    );
    is($result->{report}{protection_policy}{enforcement_owner}, 'peripheral_completers', 'generalized five-register sideband protection multi-peripheral multi-register back-to-back report assigns enforcement to peripheral completers');
    is($result->{report}{protection_policy}{interconnect_role}, 'propagate_pprot_pstrb_and_mux_selected_response_only', 'generalized five-register sideband protection multi-peripheral multi-register back-to-back report keeps interconnect role propagation-only');
    is($result->{report}{back_to_back_policy}{requester}{timing_policy}{queue_depth}, 1, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back report preserves queue-depth 1');
    is($result->{report}{back_to_back_policy}{interconnect}{timing_role}, 'propagate_queued_setup_without_idle_cycle', 'generalized five-register sideband protection multi-peripheral multi-register back-to-back report preserves interconnect timing role');
    is_deeply($result->{report}{children}[2]{transfer}{registers}, [qw(reg0 reg1 reg2 reg3 reg4)], 'generalized five-register sideband protection multi-peripheral multi-register back-to-back status peripheral reports reg0..reg4 storage');
    is_deeply($result->{report}{children}[3]{transfer}{registers}, [qw(reg0 reg1 reg2 reg3 reg4)], 'generalized five-register sideband protection multi-peripheral multi-register back-to-back control peripheral reports reg0..reg4 storage');
    is($result->{report}{children}[2]{bindings}{storage}{registers}[3]{address}{value}, 12, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back status reg3 address is 12');
    is($result->{report}{children}[2]{bindings}{storage}{registers}[4]{address}{value}, 16, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back status reg4 address is 16');
    is($result->{report}{children}[3]{bindings}{storage}{registers}[4]{data}{name}, 'control_reg4_data_q', 'generalized five-register sideband protection multi-peripheral multi-register back-to-back control reg4 data signal is preserved');
    is($result->{report}{children}[2]{protection_policy}{registers}[0]{read}{action}, 'allow', 'generalized five-register sideband protection multi-peripheral multi-register back-to-back status reg0 read policy allows reads');
    is($result->{report}{children}[2]{protection_policy}{registers}[0]{write}{predicate}{value}, 1, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back status reg0 write policy requires privileged PPROT');
    is($result->{report}{children}[2]{protection_policy}{registers}[4]{read}{predicate}{value}, 1, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back status reg4 read policy requires privileged PPROT');
    is($result->{report}{children}[3]{protection_policy}{registers}[4]{write}{predicate}{value}, 1, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back control reg4 write policy requires privileged PPROT');

    my $top = $result->{generated_ial0}{files}{'apb_tb.fsm'};
    like($top, qr/=accepted>/, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back top exposes accepted output');
    like($top, qr/\(queued_wdata 32\)/, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back top embeds 32-bit queued data state');
    like($top, qr/\(queued_prot 3\)/, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back top embeds queued PPROT state');
    like($top, qr/\(queued_wstrb 4\)/, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back top embeds queued 4-bit PSTRB state');
    like($top, qr/\(status_reg3_data_q 32 \(reset 0\)\)/, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back top embeds status reg3 storage');
    like($top, qr/\(status_reg4_data_q 32 \(reset 0\)\)/, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back top embeds status reg4 storage');
    like($top, qr/\(control_reg4_data_q 32 \(reset 0\)\)/, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back top embeds control reg4 storage');
    like($top, qr/\(\?\(& \(! write_q\) \(== addr 16\) \(! \(!= \(& prot_q 3'd1\) 3'd0\)\)\)/, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back top embeds denied protected reg4 read branch');
    like($top, qr/\(\?\(& write_q \(== addr 16\) \(! \(!= \(& prot_q 3'd1\) 3'd0\)\)\)/, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back top embeds denied protected reg4 write branch');
    like($top, qr/\(<- \(control_reg4_data_q \(\| \(& control_reg4_data_q 32'hffffff00\) \(& wdata_q 32'h000000ff\)\)\)\)/, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back top embeds control reg4 byte-lane 0 write mask');
    like($top, qr/\(<- \(control_reg4_data_q \(\| \(& control_reg4_data_q 32'hffff00ff\) \(& wdata_q 32'h0000ff00\)\)\)\)/, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back top embeds control reg4 byte-lane 1 write mask');
    like($top, qr/\(<- \(control_reg4_data_q \(\| \(& control_reg4_data_q 32'hff00ffff\) \(& wdata_q 32'h00ff0000\)\)\)\)/, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back top embeds control reg4 byte-lane 2 write mask');
    like($top, qr/\(<- \(control_reg4_data_q \(\| \(& control_reg4_data_q 32'h00ffffff\) \(& wdata_q 32'hff000000\)\)\)\)/, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back top embeds control reg4 byte-lane 3 write mask');

    my $interconnect = $result->{generated_ial0}{files}{'apb_interconnect.fsm'};
    like($interconnect, qr/\(PSTRB_CONTROL 4\)/, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back interconnect declares control-window PSTRB width 4');
    like($interconnect, qr/\(<- \(PPROT_STATUS> PPROT\)\)/, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back interconnect fans out PPROT to status');
    like($interconnect, qr/\(<- \(PSTRB_CONTROL> PSTRB\)\)/, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back interconnect fans out PSTRB to control');
    like($interconnect, qr/\(<- \(PADDR_CONTROL> \(- PADDR 256\)\) <\(& PSEL \(>= PADDR 256\) \(< PADDR 512\)\)\)/, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back interconnect subtracts the 256-byte control base');
    unlike($interconnect, qr/prot_q/, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back interconnect remains enforcement-free');

    my %composition_residue = map { $_->{id} => 1 } @{$result->{report}{unsupported_residue}};
    ok(!$composition_residue{apb_back_to_back_policy_deferred}, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back composition report removes broad back-to-back residue');
    ok(!$composition_residue{apb_protection_policy_effects_deferred}, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back composition report removes old policy-effects residue');
    ok($composition_residue{apb_additional_back_to_back_policies_deferred}, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back composition report keeps narrowed future timing-policy residue');
    ok($composition_residue{apb_additional_protection_policies_deferred}, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back composition report keeps additional-policy residue');
    ok($composition_residue{apb_alternate_widths_deferred}, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back composition report keeps broad alternate-width residue');

    ok(-f sample_apb_composition_multi_peripheral_multi_register_sideband_protection_generalized_five_register_status_back_to_back_apb_path(), 'tracked runnable generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition .apb sample exists');
    my $alias = FSM::Adapter::IAL2::PPIF->new()->parse_file(sample_apb_composition_multi_peripheral_multi_register_sideband_protection_generalized_five_register_status_back_to_back_apb_path());
    my $ppif = FSM::Adapter::IAL2::PPIF->new()->parse_file(sample_apb_composition_multi_peripheral_multi_register_sideband_protection_generalized_five_register_status_back_to_back_ppif_path());
    is($alias->{kind}, 'protocol_intent.apb_composition', 'generalized five-register sideband protection multi-peripheral multi-register back-to-back .apb APB composition alias returns the composition kind');
    is($alias->{mode}, 'requester-multi-peripheral-composition', 'generalized five-register sideband protection multi-peripheral multi-register back-to-back .apb APB composition alias preserves mode');
    is_deeply($alias->{generated_ial1}{items}, $ppif->{generated_ial1}{items}, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back .apb APB composition alias mirrors .ppif generated IAL1 artifacts');
    is_deeply($alias->{generated_ial0}{files}, $ppif->{generated_ial0}{files}, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back .apb APB composition alias mirrors .ppif generated IAL0');
    is_deeply($alias->{report}{children}[3]{transfer}{registers}, [qw(reg0 reg1 reg2 reg3 reg4)], 'generalized five-register sideband protection multi-peripheral multi-register back-to-back .apb APB composition alias preserves control reg0..reg4 storage');
};
...
subtest 'adapter parses selected generalized five-register sideband data16 no-policy APB multi-peripheral multi-register back-to-back composition PPIF shape' => sub {
    ok(-f sample_apb_composition_multi_peripheral_multi_register_sideband_data16_generalized_five_register_status_back_to_back_ppif_path(), 'tracked runnable generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition PPIF sample exists');

    my $result = FSM::Adapter::IAL2::PPIF->new()->parse_file(sample_apb_composition_multi_peripheral_multi_register_sideband_data16_generalized_five_register_status_back_to_back_ppif_path());

    is($result->{layer}, 'IAL2', 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition adapter result stays IAL2');
    is($result->{kind}, 'protocol_intent.apb_composition', 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back adapter returns the APB composition kind');
    is($result->{mode}, 'requester-multi-peripheral-composition', 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition mode is explicit');
    is($result->{report}{source_object}{id}, 'fsmgen-apb-composition-multi-peripheral-multi-register-sideband-data16-generalized-five-register-status-back-to-back', 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition source object id is preserved');
    is($result->{report}{composition}{topology}, 'multi_peripheral_interconnect', 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back report names the selected topology');
    is($result->{report}{composition}{width_policy}{data_width}, 16, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back report records 16-bit data width');
    is($result->{report}{composition}{width_policy}{strobe_width}, 2, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back report records 2-bit PSTRB width');
    is($result->{report}{composition}{address_map}{alignment_bytes}, 2, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back report records 2-byte address-map alignment');
    is_deeply(
        [map { $_->{base}{default} } @{$result->{report}{composition}{address_map}{windows}}],
        [0, 258],
        'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back report preserves 2-byte-aligned window bases',
    );
    is($result->{report}{back_to_back_policy}{composition_role}, 'propagate_endpoint_policy_through_interconnect', 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back report records aggregate propagation role');
    is($result->{report}{back_to_back_policy}{requester}{timing_policy}{queue_depth}, 1, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back report preserves queue-depth 1');
    is($result->{report}{back_to_back_policy}{requester}{timing_policy}{overflow}, 'reject', 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back report preserves overflow reject');
    is_deeply($result->{report}{children}[2]{transfer}{registers}, [qw(reg0 reg1 reg2 reg3 reg4)], 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back status peripheral reports reg0..reg4 storage');
    is_deeply($result->{report}{children}[3]{transfer}{registers}, [qw(reg0 reg1 reg2 reg3 reg4)], 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back control peripheral reports reg0..reg4 storage');
    is($result->{report}{children}[2]{bindings}{storage}{registers}[3]{address}{value}, 6, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back status reg3 address is 6');
    is($result->{report}{children}[2]{bindings}{storage}{registers}[4]{address}{value}, 8, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back status reg4 address is 8');
    is($result->{report}{children}[3]{bindings}{storage}{registers}[4]{data}{name}, 'control_reg4_data_q', 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back control reg4 data signal is preserved');

    my $top = $result->{generated_ial0}{files}{'apb_tb.fsm'};
    like($top, qr/=accepted>/, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back top exposes accepted output');
    like($top, qr/=req_wstrb<2/, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back top exposes 2-bit requester strobe');
    like($top, qr/\(queued_wdata 16\)/, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back top embeds 16-bit queued data state');
    like($top, qr/\(queued_wstrb 2\)/, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back top embeds queued 2-bit PSTRB state');
    like($top, qr/\(status_reg3_data_q 16 \(reset 0\)\)/, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back top embeds status reg3 storage');
    like($top, qr/\(status_reg4_data_q 16 \(reset 0\)\)/, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back top embeds status reg4 storage');
    like($top, qr/\(control_reg4_data_q 16 \(reset 0\)\)/, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back top embeds control reg4 storage');
    like($top, qr/\(<- \(status_reg4_data_q \(\| \(& status_reg4_data_q 16'hff00\) \(& wdata_q 16'h00ff\)\)\)\)/, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back top embeds status reg4 byte-lane write mask');

    my $interconnect = $result->{generated_ial0}{files}{'apb_interconnect.fsm'};
    like($interconnect, qr/\(PSTRB_CONTROL 2\)/, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back interconnect declares control-window PSTRB width 2');
    like($interconnect, qr/\(<- \(PPROT_STATUS> PPROT\)\)/, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back interconnect fans out PPROT to status');
    like($interconnect, qr/\(<- \(PSTRB_CONTROL> PSTRB\)\)/, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back interconnect fans out PSTRB to control');
    like($interconnect, qr/\(<- \(PADDR_CONTROL> \(- PADDR 258\)\) <\(& PSEL \(>= PADDR 258\) \(< PADDR 516\)\)\)/, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back interconnect subtracts the 258-byte control base');
    unlike($interconnect, qr/prot_q/, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back interconnect remains enforcement-free');

    ok(-f sample_apb_composition_multi_peripheral_multi_register_sideband_data16_generalized_five_register_status_back_to_back_apb_path(), 'tracked runnable generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition .apb sample exists');
    my $alias = FSM::Adapter::IAL2::PPIF->new()->parse_file(sample_apb_composition_multi_peripheral_multi_register_sideband_data16_generalized_five_register_status_back_to_back_apb_path());
    my $ppif = FSM::Adapter::IAL2::PPIF->new()->parse_file(sample_apb_composition_multi_peripheral_multi_register_sideband_data16_generalized_five_register_status_back_to_back_ppif_path());
    is($alias->{kind}, 'protocol_intent.apb_composition', 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back .apb APB composition alias returns the composition kind');
    is($alias->{mode}, 'requester-multi-peripheral-composition', 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back .apb APB composition alias preserves mode');
    is_deeply($alias->{generated_ial1}{items}, $ppif->{generated_ial1}{items}, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back .apb APB composition alias mirrors .ppif generated IAL1 artifacts');
    is_deeply($alias->{generated_ial0}{files}, $ppif->{generated_ial0}{files}, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back .apb APB composition alias mirrors .ppif generated IAL0');
    is_deeply($alias->{report}{children}[3]{transfer}{registers}, [qw(reg0 reg1 reg2 reg3 reg4)], 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back .apb APB composition alias preserves control reg0..reg4 storage');
};

subtest 'adapter parses selected generalized six-register sideband data16 no-policy APB multi-peripheral multi-register back-to-back composition PPIF shape' => sub {
    ok(-f sample_apb_composition_multi_peripheral_multi_register_sideband_data16_generalized_six_register_status_back_to_back_ppif_path(), 'tracked runnable generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition PPIF sample exists');

    my $result = FSM::Adapter::IAL2::PPIF->new()->parse_file(sample_apb_composition_multi_peripheral_multi_register_sideband_data16_generalized_six_register_status_back_to_back_ppif_path());

    is($result->{layer}, 'IAL2', 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition adapter result stays IAL2');
    is($result->{kind}, 'protocol_intent.apb_composition', 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back adapter returns the APB composition kind');
    is($result->{mode}, 'requester-multi-peripheral-composition', 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition mode is explicit');
    is($result->{report}{source_object}{id}, 'fsmgen-apb-composition-multi-peripheral-multi-register-sideband-data16-generalized-six-register-status-back-to-back', 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition source object id is preserved');
    is($result->{report}{composition}{topology}, 'multi_peripheral_interconnect', 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back report names the selected topology');
    is($result->{report}{composition}{width_policy}{data_width}, 16, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back report records 16-bit data width');
    is($result->{report}{composition}{width_policy}{strobe_width}, 2, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back report records 2-bit PSTRB width');
    is($result->{report}{composition}{address_map}{alignment_bytes}, 2, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back report records 2-byte address-map alignment');
    is_deeply(
        [map { $_->{base}{default} } @{$result->{report}{composition}{address_map}{windows}}],
        [0, 258],
        'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back report preserves 2-byte-aligned window bases',
    );
    is($result->{report}{back_to_back_policy}{composition_role}, 'propagate_endpoint_policy_through_interconnect', 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back report records aggregate propagation role');
    is($result->{report}{back_to_back_policy}{requester}{timing_policy}{queue_depth}, 1, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back report preserves queue-depth 1');
    is($result->{report}{back_to_back_policy}{requester}{timing_policy}{overflow}, 'reject', 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back report preserves overflow reject');
    is($result->{report}{back_to_back_policy}{interconnect}{timing_role}, 'propagate_queued_setup_without_idle_cycle', 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back report preserves interconnect timing role');
    is_deeply(
        [map { $_->{timing_policy}{setup_admission} } @{$result->{report}{back_to_back_policy}{peripherals}}],
        [qw(adjacent adjacent)],
        'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back report records adjacent setup admission for both peripherals',
    );
    ok(!exists $result->{report}{protection_policy}, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back report has no protection-policy owner');
    is_deeply($result->{report}{children}[2]{transfer}{registers}, [qw(reg0 reg1 reg2 reg3 reg4 reg5)], 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back status peripheral reports reg0..reg5 storage');
    is_deeply($result->{report}{children}[3]{transfer}{registers}, [qw(reg0 reg1 reg2 reg3 reg4 reg5)], 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back control peripheral reports reg0..reg5 storage');
    is($result->{report}{children}[2]{bindings}{storage}{registers}[5]{address}{value}, 10, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back status reg5 address is 10');
    is($result->{report}{children}[3]{bindings}{storage}{registers}[5]{data}{name}, 'control_reg5_data_q', 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back control reg5 data signal is preserved');

    my $top = $result->{generated_ial0}{files}{'apb_tb.fsm'};
    like($top, qr/=accepted>/, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back top exposes accepted output');
    like($top, qr/=req_wstrb<2/, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back top exposes 2-bit requester strobe');
    like($top, qr/\(queued_wdata 16\)/, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back top embeds 16-bit queued data state');
    like($top, qr/\(queued_wstrb 2\)/, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back top embeds queued 2-bit PSTRB state');
    like($top, qr/\(status_reg5_data_q 16 \(reset 0\)\)/, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back top embeds status reg5 storage');
    like($top, qr/\(control_reg5_data_q 16 \(reset 0\)\)/, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back top embeds control reg5 storage');
    like($top, qr/\(<- \(status_reg5_data_q \(\| \(& status_reg5_data_q 16'hff00\) \(& wdata_q 16'h00ff\)\)\)\)/, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back top embeds status reg5 low-byte write mask');
    like($top, qr/\(<- \(control_reg5_data_q \(\| \(& control_reg5_data_q 16'h00ff\) \(& wdata_q 16'hff00\)\)\)\)/, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back top embeds control reg5 high-byte write mask');

    my $interconnect = $result->{generated_ial0}{files}{'apb_interconnect.fsm'};
    like($interconnect, qr/\(PSTRB_CONTROL 2\)/, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back interconnect declares control-window PSTRB width 2');
    like($interconnect, qr/\(<- \(PPROT_STATUS> PPROT\)\)/, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back interconnect fans out PPROT to status');
    like($interconnect, qr/\(<- \(PSTRB_CONTROL> PSTRB\)\)/, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back interconnect fans out PSTRB to control');
    like($interconnect, qr/\(<- \(PADDR_CONTROL> \(- PADDR 258\)\) <\(& PSEL \(>= PADDR 258\) \(< PADDR 516\)\)\)/, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back interconnect subtracts the 258-byte control base');
    unlike($interconnect, qr/prot_q/, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back interconnect remains enforcement-free');

    my %composition_residue = map { $_->{id} => 1 } @{$result->{report}{unsupported_residue}};
    ok(!$composition_residue{apb_back_to_back_policy_deferred}, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back composition report removes broad back-to-back residue');
    ok(!$composition_residue{apb_alternate_widths_deferred}, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back composition report removes broad alternate-width residue');
    ok($composition_residue{apb_additional_back_to_back_policies_deferred}, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back composition report keeps narrowed future timing-policy residue');
    ok($composition_residue{apb_protection_policy_effects_deferred}, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back composition report keeps protection-policy effects residue');
    ok($composition_residue{apb_remaining_widths_deferred}, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back composition report keeps narrowed remaining-width residue');

    ok(-f sample_apb_composition_multi_peripheral_multi_register_sideband_data16_generalized_six_register_status_back_to_back_apb_path(), 'tracked runnable generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition .apb sample exists');
    my $alias = FSM::Adapter::IAL2::PPIF->new()->parse_file(sample_apb_composition_multi_peripheral_multi_register_sideband_data16_generalized_six_register_status_back_to_back_apb_path());
    my $ppif = FSM::Adapter::IAL2::PPIF->new()->parse_file(sample_apb_composition_multi_peripheral_multi_register_sideband_data16_generalized_six_register_status_back_to_back_ppif_path());
    is($alias->{kind}, 'protocol_intent.apb_composition', 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back .apb APB composition alias returns the composition kind');
    is($alias->{mode}, 'requester-multi-peripheral-composition', 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back .apb APB composition alias preserves mode');
    is_deeply($alias->{generated_ial1}{items}, $ppif->{generated_ial1}{items}, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back .apb APB composition alias mirrors .ppif generated IAL1 artifacts');
    is_deeply($alias->{generated_ial0}{files}, $ppif->{generated_ial0}{files}, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back .apb APB composition alias mirrors .ppif generated IAL0');
    is_deeply($alias->{report}{children}[3]{transfer}{registers}, [qw(reg0 reg1 reg2 reg3 reg4 reg5)], 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back .apb APB composition alias preserves control reg0..reg5 storage');
};
...
subtest 'adapter parses selected generalized sideband data16 protection APB multi-peripheral multi-register back-to-back composition PPIF shape' => sub {
    ok(-f sample_apb_composition_multi_peripheral_multi_register_sideband_data16_protection_generalized_status_back_to_back_ppif_path(), 'tracked runnable generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition PPIF sample exists');

    my $result = FSM::Adapter::IAL2::PPIF->new()->parse_file(sample_apb_composition_multi_peripheral_multi_register_sideband_data16_protection_generalized_status_back_to_back_ppif_path());

    is($result->{layer}, 'IAL2', 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition adapter result stays IAL2');
    is($result->{kind}, 'protocol_intent.apb_composition', 'generalized sideband data16 protection multi-peripheral multi-register back-to-back adapter returns the APB composition kind');
    is($result->{mode}, 'requester-multi-peripheral-composition', 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition mode is explicit');
    is($result->{report}{source_object}{id}, 'fsmgen-apb-composition-multi-peripheral-multi-register-sideband-data16-protection-generalized-status-back-to-back', 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition source object id is preserved');
    is($result->{report}{composition}{topology}, 'multi_peripheral_interconnect', 'generalized sideband data16 protection multi-peripheral multi-register back-to-back report names the selected topology');
    is($result->{report}{composition}{width_policy}{data_width}, 16, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back report records 16-bit data width');
    is($result->{report}{composition}{width_policy}{strobe_width}, 2, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back report records 2-bit PSTRB width');
    is($result->{report}{composition}{address_map}{alignment_bytes}, 2, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back report records 2-byte address-map alignment');
    is_deeply(
        [map { $_->{base}{default} } @{$result->{report}{composition}{address_map}{windows}}],
        [0, 258],
        'generalized sideband data16 protection multi-peripheral multi-register back-to-back report preserves 2-byte-aligned window bases',
    );
    is($result->{report}{protection_policy}{enforcement_owner}, 'peripheral_completers', 'generalized sideband data16 protection multi-peripheral multi-register back-to-back report assigns enforcement to peripheral completers');
    is($result->{report}{protection_policy}{interconnect_role}, 'propagate_pprot_pstrb_and_mux_selected_response_only', 'generalized sideband data16 protection multi-peripheral multi-register back-to-back report keeps interconnect role propagation-only');
    is($result->{report}{back_to_back_policy}{composition_role}, 'propagate_endpoint_policy_through_interconnect', 'generalized sideband data16 protection multi-peripheral multi-register back-to-back report records aggregate propagation role');
    is($result->{report}{back_to_back_policy}{requester}{timing_policy}{queue_depth}, 1, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back report preserves queue-depth 1');
    is($result->{report}{back_to_back_policy}{interconnect}{timing_role}, 'propagate_queued_setup_without_idle_cycle', 'generalized sideband data16 protection multi-peripheral multi-register back-to-back report preserves interconnect timing role');
    is_deeply($result->{report}{children}[2]{transfer}{registers}, [qw(reg0 reg1 reg2)], 'generalized sideband data16 protection multi-peripheral multi-register back-to-back status peripheral reports reg0/reg1/reg2 storage');
    is_deeply($result->{report}{children}[3]{transfer}{registers}, [qw(reg0 reg1 reg2)], 'generalized sideband data16 protection multi-peripheral multi-register back-to-back control peripheral reports reg0/reg1/reg2 storage');
    is($result->{report}{children}[2]{bindings}{storage}{registers}[2]{address}{value}, 4, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back status reg2 address is 4');
    is($result->{report}{children}[3]{bindings}{storage}{registers}[2]{data}{name}, 'control_reg2_data_q', 'generalized sideband data16 protection multi-peripheral multi-register back-to-back control reg2 data signal is preserved');
    is($result->{report}{children}[2]{protection_policy}{registers}[0]{read}{action}, 'allow', 'generalized sideband data16 protection multi-peripheral multi-register back-to-back status reg0 read policy allows reads');
    is($result->{report}{children}[2]{protection_policy}{registers}[2]{read}{predicate}{value}, 1, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back status reg2 read policy requires privileged PPROT');
    is($result->{report}{children}[3]{protection_policy}{registers}[2]{write}{predicate}{value}, 1, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back control reg2 write policy requires privileged PPROT');

    my $top = $result->{generated_ial0}{files}{'apb_tb.fsm'};
    like($top, qr/=accepted>/, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back top exposes accepted output');
    like($top, qr/=req_wstrb<2/, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back top exposes 2-bit requester strobe');
    like($top, qr/\(queued_wdata 16\)/, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back top embeds 16-bit queued data state');
    like($top, qr/\(queued_prot 3\)/, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back top embeds queued PPROT state');
    like($top, qr/\(queued_wstrb 2\)/, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back top embeds queued 2-bit PSTRB state');
    like($top, qr/\(status_reg2_data_q 16 \(reset 0\)\)/, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back top embeds status reg2 storage');
    like($top, qr/\(control_reg2_data_q 16 \(reset 0\)\)/, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back top embeds control reg2 storage');
    like($top, qr/\(\?\(& \(! write_q\) \(== addr 4\) \(! \(!= \(& prot_q 3'd1\) 3'd0\)\)\)/, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back top embeds denied protected reg2 read branch');
    like($top, qr/\(<- \(control_reg2_data_q \(\| \(& control_reg2_data_q 16'h00ff\) \(& wdata_q 16'hff00\)\)\)\)/, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back top embeds control reg2 byte-lane write mask');

    my $interconnect = $result->{generated_ial0}{files}{'apb_interconnect.fsm'};
    like($interconnect, qr/\(PSTRB_CONTROL 2\)/, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back interconnect declares control-window PSTRB width 2');
    like($interconnect, qr/\(<- \(PPROT_STATUS> PPROT\)\)/, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back interconnect fans out PPROT to status');
    like($interconnect, qr/\(<- \(PSTRB_CONTROL> PSTRB\)\)/, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back interconnect fans out PSTRB to control');
    like($interconnect, qr/\(<- \(PADDR_CONTROL> \(- PADDR 258\)\) <\(& PSEL \(>= PADDR 258\) \(< PADDR 516\)\)\)/, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back interconnect subtracts the 258-byte control base');
    unlike($interconnect, qr/prot_q/, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back interconnect remains enforcement-free');

    my %composition_residue = map { $_->{id} => 1 } @{$result->{report}{unsupported_residue}};
    ok(!$composition_residue{apb_back_to_back_policy_deferred}, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back composition report removes broad back-to-back residue');
    ok(!$composition_residue{apb_protection_policy_effects_deferred}, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back composition report removes old policy-effects residue');
    ok(!$composition_residue{apb_alternate_widths_deferred}, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back composition report keeps broad alternate-width residue absent');
    ok($composition_residue{apb_additional_back_to_back_policies_deferred}, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back composition report keeps narrowed future timing-policy residue');
    ok($composition_residue{apb_additional_protection_policies_deferred}, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back composition report keeps additional-policy residue');
    ok($composition_residue{apb_remaining_widths_deferred}, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back composition report keeps narrowed remaining-width residue');
};

subtest 'adapter parses selected generalized five-register sideband data16 protection APB multi-peripheral multi-register back-to-back composition PPIF shape' => sub {
    ok(-f sample_apb_composition_multi_peripheral_multi_register_sideband_data16_protection_generalized_five_register_status_back_to_back_ppif_path(), 'tracked runnable generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition PPIF sample exists');

    my $result = FSM::Adapter::IAL2::PPIF->new()->parse_file(sample_apb_composition_multi_peripheral_multi_register_sideband_data16_protection_generalized_five_register_status_back_to_back_ppif_path());

    is($result->{layer}, 'IAL2', 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition adapter result stays IAL2');
    is($result->{kind}, 'protocol_intent.apb_composition', 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back adapter returns the APB composition kind');
    is($result->{mode}, 'requester-multi-peripheral-composition', 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition mode is explicit');
    is($result->{report}{source_object}{id}, 'fsmgen-apb-composition-multi-peripheral-multi-register-sideband-data16-protection-generalized-five-register-status-back-to-back', 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition source object id is preserved');
    is($result->{report}{composition}{topology}, 'multi_peripheral_interconnect', 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back report names the selected topology');
    is($result->{report}{composition}{width_policy}{data_width}, 16, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back report records 16-bit data width');
    is($result->{report}{composition}{width_policy}{strobe_width}, 2, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back report records 2-bit PSTRB width');
    is($result->{report}{composition}{address_map}{alignment_bytes}, 2, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back report records 2-byte address-map alignment');
    is_deeply(
        [map { $_->{base}{default} } @{$result->{report}{composition}{address_map}{windows}}],
        [0, 258],
        'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back report preserves 2-byte-aligned window bases',
    );
    is($result->{report}{protection_policy}{enforcement_owner}, 'peripheral_completers', 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back report assigns enforcement to peripheral completers');
    is($result->{report}{protection_policy}{interconnect_role}, 'propagate_pprot_pstrb_and_mux_selected_response_only', 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back report keeps interconnect role propagation-only');
    is($result->{report}{back_to_back_policy}{composition_role}, 'propagate_endpoint_policy_through_interconnect', 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back report records aggregate propagation role');
    is($result->{report}{back_to_back_policy}{requester}{timing_policy}{queue_depth}, 1, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back report preserves queue-depth 1');
    is($result->{report}{back_to_back_policy}{interconnect}{timing_role}, 'propagate_queued_setup_without_idle_cycle', 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back report preserves interconnect timing role');
    is_deeply($result->{report}{children}[2]{transfer}{registers}, [qw(reg0 reg1 reg2 reg3 reg4)], 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back status peripheral reports reg0..reg4 storage');
    is_deeply($result->{report}{children}[3]{transfer}{registers}, [qw(reg0 reg1 reg2 reg3 reg4)], 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back control peripheral reports reg0..reg4 storage');
    is($result->{report}{children}[2]{bindings}{storage}{registers}[3]{address}{value}, 6, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back status reg3 address is 6');
    is($result->{report}{children}[2]{bindings}{storage}{registers}[4]{address}{value}, 8, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back status reg4 address is 8');
    is($result->{report}{children}[3]{bindings}{storage}{registers}[4]{data}{name}, 'control_reg4_data_q', 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back control reg4 data signal is preserved');
    is($result->{report}{children}[2]{protection_policy}{registers}[0]{read}{action}, 'allow', 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back status reg0 read policy allows reads');
    is($result->{report}{children}[2]{protection_policy}{registers}[4]{read}{predicate}{value}, 1, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back status reg4 read policy requires privileged PPROT');
    is($result->{report}{children}[3]{protection_policy}{registers}[4]{write}{predicate}{value}, 1, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back control reg4 write policy requires privileged PPROT');

    my $top = $result->{generated_ial0}{files}{'apb_tb.fsm'};
    like($top, qr/=accepted>/, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back top exposes accepted output');
    like($top, qr/=req_wstrb<2/, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back top exposes 2-bit requester strobe');
    like($top, qr/\(queued_wdata 16\)/, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back top embeds 16-bit queued data state');
    like($top, qr/\(queued_prot 3\)/, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back top embeds queued PPROT state');
    like($top, qr/\(queued_wstrb 2\)/, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back top embeds queued 2-bit PSTRB state');
    like($top, qr/\(status_reg4_data_q 16 \(reset 0\)\)/, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back top embeds status reg4 storage');
    like($top, qr/\(control_reg4_data_q 16 \(reset 0\)\)/, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back top embeds control reg4 storage');
    like($top, qr/\(\?\(& \(! write_q\) \(== addr 8\) \(! \(!= \(& prot_q 3'd1\) 3'd0\)\)\)/, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back top embeds denied protected reg4 read branch');
    like($top, qr/\(\?\(& write_q \(== addr 8\) \(! \(!= \(& prot_q 3'd1\) 3'd0\)\)\)/, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back top embeds denied protected reg4 write branch');
    like($top, qr/\(<- \(control_reg4_data_q \(\| \(& control_reg4_data_q 16'h00ff\) \(& wdata_q 16'hff00\)\)\)\)/, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back top embeds control reg4 byte-lane write mask');

    my $interconnect = $result->{generated_ial0}{files}{'apb_interconnect.fsm'};
    like($interconnect, qr/\(PSTRB_CONTROL 2\)/, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back interconnect declares control-window PSTRB width 2');
    like($interconnect, qr/\(<- \(PPROT_STATUS> PPROT\)\)/, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back interconnect fans out PPROT to status');
    like($interconnect, qr/\(<- \(PSTRB_CONTROL> PSTRB\)\)/, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back interconnect fans out PSTRB to control');
    like($interconnect, qr/\(<- \(PADDR_CONTROL> \(- PADDR 258\)\) <\(& PSEL \(>= PADDR 258\) \(< PADDR 516\)\)\)/, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back interconnect subtracts the 258-byte control base');
    unlike($interconnect, qr/prot_q/, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back interconnect remains enforcement-free');

    my %composition_residue = map { $_->{id} => 1 } @{$result->{report}{unsupported_residue}};
    ok(!$composition_residue{apb_back_to_back_policy_deferred}, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back composition report removes broad back-to-back residue');
    ok(!$composition_residue{apb_protection_policy_effects_deferred}, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back composition report removes old policy-effects residue');
    ok(!$composition_residue{apb_alternate_widths_deferred}, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back composition report keeps broad alternate-width residue absent');
    ok($composition_residue{apb_additional_back_to_back_policies_deferred}, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back composition report keeps narrowed future timing-policy residue');
    ok($composition_residue{apb_additional_protection_policies_deferred}, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back composition report keeps additional-policy residue');
    ok($composition_residue{apb_remaining_widths_deferred}, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back composition report keeps narrowed remaining-width residue');

    ok(-f sample_apb_composition_multi_peripheral_multi_register_sideband_data16_protection_generalized_five_register_status_back_to_back_apb_path(), 'tracked runnable generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition .apb sample exists');
    my $alias = FSM::Adapter::IAL2::PPIF->new()->parse_file(sample_apb_composition_multi_peripheral_multi_register_sideband_data16_protection_generalized_five_register_status_back_to_back_apb_path());
    my $ppif = FSM::Adapter::IAL2::PPIF->new()->parse_file(sample_apb_composition_multi_peripheral_multi_register_sideband_data16_protection_generalized_five_register_status_back_to_back_ppif_path());
    is($alias->{kind}, 'protocol_intent.apb_composition', 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back .apb APB composition alias returns the composition kind');
    is($alias->{mode}, 'requester-multi-peripheral-composition', 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back .apb APB composition alias preserves mode');
    is_deeply($alias->{generated_ial1}{items}, $ppif->{generated_ial1}{items}, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back .apb APB composition alias mirrors .ppif generated IAL1 artifacts');
    is_deeply($alias->{generated_ial0}{files}, $ppif->{generated_ial0}{files}, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back .apb APB composition alias mirrors .ppif generated IAL0');
    is_deeply($alias->{report}{children}[3]{transfer}{registers}, [qw(reg0 reg1 reg2 reg3 reg4)], 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back .apb APB composition alias preserves control reg0..reg4 storage');
    is($alias->{report}{children}[3]{protection_policy}{registers}[4]{write}{predicate}{value}, 1, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back .apb APB composition alias preserves control reg4 write policy');
    is($alias->{report}{back_to_back_policy}{interconnect}{timing_role}, 'propagate_queued_setup_without_idle_cycle', 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back .apb APB composition alias preserves interconnect timing policy');
};
...
subtest 'adapter rejects malformed APB composition PPIF shapes with targeted diagnostics' => sub {
    ...
    my $multi_generalized_five_register_no_policy_back_to_back_wrong_status_reg4_address = sample_apb_composition_multi_peripheral_multi_register_sideband_generalized_five_register_status_back_to_back_ppif();
    $multi_generalized_five_register_no_policy_back_to_back_wrong_status_reg4_address =~ s/\(address 16 width 32\)/(address 20 width 32)/;

    my $multi_generalized_five_register_no_policy_back_to_back_with_status_access_policy = sample_apb_composition_multi_peripheral_multi_register_sideband_generalized_five_register_status_back_to_back_ppif();
    $multi_generalized_five_register_no_policy_back_to_back_with_status_access_policy =~ s/\(data status_reg4_data_q width 32 reset 0\)\)/(data status_reg4_data_q width 32 reset 0)\n        (access-policy\n          (read allow)\n          (write require (privileged 1))))/;

    my $multi_generalized_five_register_no_policy_back_to_back_too_many_status_registers = sample_apb_composition_multi_peripheral_multi_register_sideband_generalized_five_register_status_back_to_back_ppif();
    $multi_generalized_five_register_no_policy_back_to_back_too_many_status_registers =~ s/\(data status_reg4_data_q width 32 reset 0\)\)\)/(data status_reg4_data_q width 32 reset 0))\n      (register reg5\n        (address 20 width 32)\n        (data status_reg5_data_q width 32 reset 0))\n      (register reg6\n        (address 24 width 32)\n        (data status_reg6_data_q width 32 reset 0)))/;
    ...
    my $multi_protection_generalized_five_register_back_to_back_wrong_status_reg4_address = sample_apb_composition_multi_peripheral_multi_register_sideband_protection_generalized_five_register_status_back_to_back_ppif();
    $multi_protection_generalized_five_register_back_to_back_wrong_status_reg4_address =~ s/\(address 16 width 32\)/(address 20 width 32)/;

    my $multi_protection_generalized_five_register_back_to_back_wrong_status_reg4_policy = sample_apb_composition_multi_peripheral_multi_register_sideband_protection_generalized_five_register_status_back_to_back_ppif();
    $multi_protection_generalized_five_register_back_to_back_wrong_status_reg4_policy =~ s/\(register reg4\n        \(address 16 width 32\)\n        \(data status_reg4_data_q width 32 reset 0\)\n        \(access-policy\n          \(read require \(privileged 1\)\)/\(register reg4\n        \(address 16 width 32\)\n        \(data status_reg4_data_q width 32 reset 0\)\n        \(access-policy\n          \(read allow\)/;

    my $multi_protection_generalized_five_register_back_to_back_mismatched_register_count = sample_apb_composition_multi_peripheral_multi_register_sideband_protection_generalized_five_register_status_back_to_back_ppif();
    $multi_protection_generalized_five_register_back_to_back_mismatched_register_count =~ s/\n      \(register reg4\n        \(address 16 width 32\)\n        \(data control_reg4_data_q width 32 reset 0\)\n        \(access-policy\n          \(read require \(privileged 1\)\)\n          \(write require \(privileged 1\)\)\)\)\)/\n    \)/;

    my $multi_protection_generalized_five_register_back_to_back_too_many_status_registers = sample_apb_composition_multi_peripheral_multi_register_sideband_protection_generalized_five_register_status_back_to_back_ppif();
    $multi_protection_generalized_five_register_back_to_back_too_many_status_registers =~ s/\n      \(register reg4\n        \(address 16 width 32\)\n        \(data status_reg4_data_q width 32 reset 0\)\n        \(access-policy\n          \(read require \(privileged 1\)\)\n          \(write require \(privileged 1\)\)\)\)/\n      (register reg4\n        (address 16 width 32)\n        (data status_reg4_data_q width 32 reset 0)\n        (access-policy\n          (read require (privileged 1))\n          (write require (privileged 1))))\n      (register reg5\n        (address 20 width 32)\n        (data status_reg5_data_q width 32 reset 0)\n        (access-policy\n          (read require (privileged 1))\n          (write require (privileged 1))))/;
    ...
    my $multi_data16_generalized_five_register_no_policy_back_to_back_wrong_status_reg4_address = sample_apb_composition_multi_peripheral_multi_register_sideband_data16_generalized_five_register_status_back_to_back_ppif();
    $multi_data16_generalized_five_register_no_policy_back_to_back_wrong_status_reg4_address =~ s/\(address 8 width 32\)/(address 10 width 32)/;

    my $multi_data16_generalized_five_register_no_policy_back_to_back_with_status_access_policy = sample_apb_composition_multi_peripheral_multi_register_sideband_data16_generalized_five_register_status_back_to_back_ppif();
    $multi_data16_generalized_five_register_no_policy_back_to_back_with_status_access_policy =~ s/\(data status_reg4_data_q width 16 reset 0\)\)/(data status_reg4_data_q width 16 reset 0)\n        (access-policy\n          (read allow)\n          (write require (privileged 1))))/;

    my $multi_data16_generalized_five_register_no_policy_back_to_back_too_many_status_registers = sample_apb_composition_multi_peripheral_multi_register_sideband_data16_generalized_five_register_status_back_to_back_ppif();
    $multi_data16_generalized_five_register_no_policy_back_to_back_too_many_status_registers =~ s/\n      \(register reg4\n        \(address 8 width 32\)\n        \(data status_reg4_data_q width 16 reset 0\)\)/\n      (register reg4\n        (address 8 width 32)\n        (data status_reg4_data_q width 16 reset 0))\n      (register reg5\n        (address 10 width 32)\n        (data status_reg5_data_q width 16 reset 0))/;

    my $multi_data16_generalized_six_register_no_policy_back_to_back_wrong_status_reg5_address = sample_apb_composition_multi_peripheral_multi_register_sideband_data16_generalized_six_register_status_back_to_back_ppif();
    $multi_data16_generalized_six_register_no_policy_back_to_back_wrong_status_reg5_address =~ s/\(address 10 width 32\)/(address 12 width 32)/;

    my $multi_data16_generalized_six_register_no_policy_back_to_back_with_status_access_policy = sample_apb_composition_multi_peripheral_multi_register_sideband_data16_generalized_six_register_status_back_to_back_ppif();
    $multi_data16_generalized_six_register_no_policy_back_to_back_with_status_access_policy =~ s/\(data status_reg5_data_q width 16 reset 0\)\)/(data status_reg5_data_q width 16 reset 0)\n        (access-policy\n          (read allow)\n          (write require (privileged 1))))/;

    my $multi_data16_generalized_six_register_no_policy_back_to_back_mismatched_register_count = sample_apb_composition_multi_peripheral_multi_register_sideband_data16_generalized_six_register_status_back_to_back_ppif();
    $multi_data16_generalized_six_register_no_policy_back_to_back_mismatched_register_count =~ s/\n      \(register reg5\n        \(address 10 width 32\)\n        \(data control_reg5_data_q width 16 reset 0\)\)//;

    my $multi_data16_generalized_six_register_no_policy_back_to_back_duplicate_status_register_name = sample_apb_composition_multi_peripheral_multi_register_sideband_data16_generalized_six_register_status_back_to_back_ppif();
    $multi_data16_generalized_six_register_no_policy_back_to_back_duplicate_status_register_name =~ s/\(register reg5\n        \(address 10 width 32\)/(register reg4\n        (address 10 width 32)/;

    my $multi_data16_generalized_six_register_no_policy_back_to_back_duplicate_status_register_address = sample_apb_composition_multi_peripheral_multi_register_sideband_data16_generalized_six_register_status_back_to_back_ppif();
    $multi_data16_generalized_six_register_no_policy_back_to_back_duplicate_status_register_address =~ s/\(register reg5\n        \(address 10 width 32\)/(register reg5\n        (address 8 width 32)/;

    my $multi_data16_generalized_six_register_no_policy_back_to_back_duplicate_status_data_signal = sample_apb_composition_multi_peripheral_multi_register_sideband_data16_generalized_six_register_status_back_to_back_ppif();
    $multi_data16_generalized_six_register_no_policy_back_to_back_duplicate_status_data_signal =~ s/\(data status_reg5_data_q width 16 reset 0\)/(data status_reg4_data_q width 16 reset 0)/;

    my $multi_data16_generalized_six_register_no_policy_back_to_back_nonzero_status_reset = sample_apb_composition_multi_peripheral_multi_register_sideband_data16_generalized_six_register_status_back_to_back_ppif();
    $multi_data16_generalized_six_register_no_policy_back_to_back_nonzero_status_reset =~ s/\(data status_reg5_data_q width 16 reset 0\)/(data status_reg5_data_q width 16 reset 1)/;

    my $multi_data16_generalized_six_register_no_policy_back_to_back_too_many_status_registers = sample_apb_composition_multi_peripheral_multi_register_sideband_data16_generalized_six_register_status_back_to_back_ppif();
    $multi_data16_generalized_six_register_no_policy_back_to_back_too_many_status_registers =~ s/\n      \(register reg5\n        \(address 10 width 32\)\n        \(data status_reg5_data_q width 16 reset 0\)\)/\n      (register reg5\n        (address 10 width 32)\n        (data status_reg5_data_q width 16 reset 0))\n      (register reg6\n        (address 12 width 32)\n        (data status_reg6_data_q width 16 reset 0))/;

    my $multi_data16_protection_generalized_back_to_back_wrong_status_reg2_address = sample_apb_composition_multi_peripheral_multi_register_sideband_data16_protection_generalized_status_back_to_back_ppif();
    $multi_data16_protection_generalized_back_to_back_wrong_status_reg2_address =~ s/\(address 4 width 32\)/(address 6 width 32)/;

    my $multi_data16_protection_generalized_back_to_back_missing_status_reg1_policy = sample_apb_composition_multi_peripheral_multi_register_sideband_data16_protection_generalized_status_back_to_back_ppif();
    $multi_data16_protection_generalized_back_to_back_missing_status_reg1_policy =~ s/\n        \(access-policy\n          \(read require \(privileged 1\)\)\n          \(write require \(privileged 1\)\)\)\)/\n      \)/;

    my $multi_data16_protection_generalized_back_to_back_wrong_status_reg2_policy = sample_apb_composition_multi_peripheral_multi_register_sideband_data16_protection_generalized_status_back_to_back_ppif();
    $multi_data16_protection_generalized_back_to_back_wrong_status_reg2_policy =~ s/\(register reg2\n        \(address 4 width 32\)\n        \(data status_reg2_data_q width 16 reset 0\)\n        \(access-policy\n          \(read require \(privileged 1\)\)/\(register reg2\n        \(address 4 width 32\)\n        \(data status_reg2_data_q width 16 reset 0\)\n        \(access-policy\n          \(read allow\)/;

    my $multi_data16_protection_generalized_back_to_back_mismatched_register_count = sample_apb_composition_multi_peripheral_multi_register_sideband_data16_protection_generalized_status_back_to_back_ppif();
    $multi_data16_protection_generalized_back_to_back_mismatched_register_count =~ s/\n      \(register reg2\n        \(address 4 width 32\)\n        \(data control_reg2_data_q width 16 reset 0\)\n        \(access-policy\n          \(read require \(privileged 1\)\)\n          \(write require \(privileged 1\)\)\)\)\)/\n    \)/;

    my $multi_data16_protection_generalized_five_register_back_to_back_wrong_status_reg4_address = sample_apb_composition_multi_peripheral_multi_register_sideband_data16_protection_generalized_five_register_status_back_to_back_ppif();
    $multi_data16_protection_generalized_five_register_back_to_back_wrong_status_reg4_address =~ s/\(address 8 width 32\)/(address 10 width 32)/;

    my $multi_data16_protection_generalized_five_register_back_to_back_wrong_status_reg4_policy = sample_apb_composition_multi_peripheral_multi_register_sideband_data16_protection_generalized_five_register_status_back_to_back_ppif();
    $multi_data16_protection_generalized_five_register_back_to_back_wrong_status_reg4_policy =~ s/\(register reg4\n        \(address 8 width 32\)\n        \(data status_reg4_data_q width 16 reset 0\)\n        \(access-policy\n          \(read require \(privileged 1\)\)/\(register reg4\n        \(address 8 width 32\)\n        \(data status_reg4_data_q width 16 reset 0\)\n        \(access-policy\n          \(read allow\)/;

    my $multi_data16_protection_generalized_five_register_back_to_back_mismatched_register_count = sample_apb_composition_multi_peripheral_multi_register_sideband_data16_protection_generalized_five_register_status_back_to_back_ppif();
    $multi_data16_protection_generalized_five_register_back_to_back_mismatched_register_count =~ s/\n      \(register reg4\n        \(address 8 width 32\)\n        \(data control_reg4_data_q width 16 reset 0\)\n        \(access-policy\n          \(read require \(privileged 1\)\)\n          \(write require \(privileged 1\)\)\)\)\)/\n    \)/;

    my $multi_data16_protection_generalized_five_register_back_to_back_too_many_status_registers = sample_apb_composition_multi_peripheral_multi_register_sideband_data16_protection_generalized_five_register_status_back_to_back_ppif();
    $multi_data16_protection_generalized_five_register_back_to_back_too_many_status_registers =~ s/\n      \(register reg4\n        \(address 8 width 32\)\n        \(data status_reg4_data_q width 16 reset 0\)\n        \(access-policy\n          \(read require \(privileged 1\)\)\n          \(write require \(privileged 1\)\)\)\)/\n      (register reg4\n        (address 8 width 32)\n        (data status_reg4_data_q width 16 reset 0)\n        (access-policy\n          (read require (privileged 1))\n          (write require (privileged 1))))\n      (register reg5\n        (address 10 width 32)\n        (data status_reg5_data_q width 16 reset 0)\n        (access-policy\n          (read require (privileged 1))\n          (write require (privileged 1))))/;
    ...
    my @cases = (
        ...
        ['multi-peripheral generalized five-register no-policy multi-register back-to-back wrong status register address', $multi_generalized_five_register_no_policy_back_to_back_wrong_status_reg4_address, $multi_timing_storage_error],
        ['multi-peripheral generalized five-register no-policy multi-register back-to-back unexpected status access policy', $multi_generalized_five_register_no_policy_back_to_back_with_status_access_policy, $multi_timing_storage_error],
        ['multi-peripheral generalized five-register no-policy multi-register back-to-back too many status registers', $multi_generalized_five_register_no_policy_back_to_back_too_many_status_registers, $multi_timing_storage_error],
        ...
        ['multi-peripheral generalized five-register protection multi-register back-to-back wrong status register address', $multi_protection_generalized_five_register_back_to_back_wrong_status_reg4_address, $multi_timing_storage_error],
        ['multi-peripheral generalized five-register protection multi-register back-to-back wrong status policy', $multi_protection_generalized_five_register_back_to_back_wrong_status_reg4_policy, $multi_timing_storage_error],
        ['multi-peripheral generalized five-register protection multi-register back-to-back mismatched register count', $multi_protection_generalized_five_register_back_to_back_mismatched_register_count, $multi_timing_storage_error],
        ['multi-peripheral generalized five-register protection multi-register back-to-back too many status registers', $multi_protection_generalized_five_register_back_to_back_too_many_status_registers, $multi_timing_storage_error],
        ...
        ['multi-peripheral data16 generalized five-register no-policy multi-register back-to-back wrong status register address', $multi_data16_generalized_five_register_no_policy_back_to_back_wrong_status_reg4_address, $multi_data16_timing_storage_error],
        ['multi-peripheral data16 generalized five-register no-policy multi-register back-to-back unexpected status access policy', $multi_data16_generalized_five_register_no_policy_back_to_back_with_status_access_policy, $multi_data16_timing_storage_error],
        ['multi-peripheral data16 generalized five-register no-policy multi-register back-to-back too many status registers', $multi_data16_generalized_five_register_no_policy_back_to_back_too_many_status_registers, $multi_data16_timing_storage_error],
        ['multi-peripheral data16 generalized six-register no-policy multi-register back-to-back wrong status reg5 address', $multi_data16_generalized_six_register_no_policy_back_to_back_wrong_status_reg5_address, $multi_data16_timing_storage_error],
        ['multi-peripheral data16 generalized six-register no-policy multi-register back-to-back unexpected status reg5 access policy', $multi_data16_generalized_six_register_no_policy_back_to_back_with_status_access_policy, $multi_data16_timing_storage_error],
        ['multi-peripheral data16 generalized six-register no-policy multi-register back-to-back mismatched register count', $multi_data16_generalized_six_register_no_policy_back_to_back_mismatched_register_count, $multi_data16_timing_storage_error],
        ['multi-peripheral data16 generalized six-register no-policy multi-register back-to-back duplicate status register name', $multi_data16_generalized_six_register_no_policy_back_to_back_duplicate_status_register_name, $multi_data16_timing_storage_error],
        ['multi-peripheral data16 generalized six-register no-policy multi-register back-to-back duplicate status register address', $multi_data16_generalized_six_register_no_policy_back_to_back_duplicate_status_register_address, $multi_data16_timing_storage_error],
        ['multi-peripheral data16 generalized six-register no-policy multi-register back-to-back duplicate status data signal', $multi_data16_generalized_six_register_no_policy_back_to_back_duplicate_status_data_signal, qr/(APB completer IAL2 contract duplicate storage register data signal 'status_reg4_data_q'|APB completer IAL2 contract duplicates signal or generated local name 'status_reg4_data_q'|APB multi-peripheral selected back-to-back timing-policy supports only the selected two-peripheral sideband data16 no-policy reg0\/reg1 storage shape)/],
        ['multi-peripheral data16 generalized six-register no-policy multi-register back-to-back nonzero status reset', $multi_data16_generalized_six_register_no_policy_back_to_back_nonzero_status_reset, $multi_data16_timing_storage_error],
        ['multi-peripheral data16 generalized six-register no-policy multi-register back-to-back too many status registers', $multi_data16_generalized_six_register_no_policy_back_to_back_too_many_status_registers, $multi_data16_timing_storage_error],
        ['multi-peripheral data16 generalized protection multi-register back-to-back wrong status register address', $multi_data16_protection_generalized_back_to_back_wrong_status_reg2_address, $multi_data16_timing_storage_error],
        ['multi-peripheral data16 generalized protection multi-register back-to-back missing status access policy', $multi_data16_protection_generalized_back_to_back_missing_status_reg1_policy, $multi_data16_timing_storage_error],
        ['multi-peripheral data16 generalized protection multi-register back-to-back wrong status policy', $multi_data16_protection_generalized_back_to_back_wrong_status_reg2_policy, $multi_data16_timing_storage_error],
        ['multi-peripheral data16 generalized protection multi-register back-to-back mismatched register count', $multi_data16_protection_generalized_back_to_back_mismatched_register_count, $multi_data16_timing_storage_error],
        ['multi-peripheral data16 generalized five-register protection multi-register back-to-back wrong status register address', $multi_data16_protection_generalized_five_register_back_to_back_wrong_status_reg4_address, $multi_data16_timing_storage_error],
        ['multi-peripheral data16 generalized five-register protection multi-register back-to-back wrong status policy', $multi_data16_protection_generalized_five_register_back_to_back_wrong_status_reg4_policy, $multi_data16_timing_storage_error],
        ['multi-peripheral data16 generalized five-register protection multi-register back-to-back mismatched register count', $multi_data16_protection_generalized_five_register_back_to_back_mismatched_register_count, $multi_data16_timing_storage_error],
        ['multi-peripheral data16 generalized five-register protection multi-register back-to-back too many status registers', $multi_data16_protection_generalized_five_register_back_to_back_too_many_status_registers, $multi_data16_timing_storage_error],
...
subtest 'CLI check and semantic JSON support-account generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition PPIF identity' => sub {
    my $path = sample_apb_composition_multi_peripheral_multi_register_sideband_generalized_five_register_status_back_to_back_ppif_path();
    my ($check_success, undef, undef, $check_stdout, $check_stderr) = run(
        command => ['./bin/fsmgen', '--strict', '--check', '--json', $path],
    );
    ok($check_success, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition --check --json succeeds');
    is(join('', @{$check_stderr || []}), '', 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition --check --json keeps stderr clean');
    my $check_report = decode_json(join('', @{$check_stdout || []}));
    ok($check_report->{success}, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition check JSON reports success');
    is($check_report->{source}{resolved_path}, File::Spec->rel2abs($path), 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition check JSON reports the public .ppif source path');
    is($check_report->{support_accounting}{entry_id}, 'intent.ppif_apb_composition_multi_peripheral_multi_register_sideband_generalized_five_register_status_back_to_back', 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition check JSON names the corpus entry');
    is($check_report->{support_accounting}{source_kind}, 'ppif', 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition check JSON records PPIF source kind');
    is($check_report->{result}{composition_child_count}, 4, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition check JSON reports four generated children');

    my ($semantic_success, undef, undef, $semantic_stdout, $semantic_stderr) = run(
        command => ['./bin/fsmgen', '--strict', '--emit-semantic-json', $path],
    );
    ok($semantic_success, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition --emit-semantic-json succeeds');
    is(join('', @{$semantic_stderr || []}), '', 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition --emit-semantic-json keeps stderr clean');
    my $semantic_report = decode_json(join('', @{$semantic_stdout || []}));
    ok($semantic_report->{success}, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition semantic JSON reports success');
    is($semantic_report->{support_accounting}{entry_id}, 'intent.ppif_apb_composition_multi_peripheral_multi_register_sideband_generalized_five_register_status_back_to_back', 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition semantic JSON names the corpus entry');
    is($semantic_report->{semantic}{module}{source_root_kind}, 'top', 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition semantic JSON payload describes the generated composition root');
    is($semantic_report->{semantic}{module}{name}, 'apb_tb', 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition semantic JSON records the generated top module');
    is($semantic_report->{semantic}{module}{composition_child_count}, 4, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition semantic JSON records four generated children');
};

subtest 'CLI check and semantic JSON support-account generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition PPIF identity' => sub {
    my $path = sample_apb_composition_multi_peripheral_multi_register_sideband_generalized_six_register_status_back_to_back_ppif_path();
    my ($check_success, undef, undef, $check_stdout, $check_stderr) = run(
        command => ['./bin/fsmgen', '--strict', '--check', '--json', $path],
    );
    ok($check_success, 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition --check --json succeeds');
    is(join('', @{$check_stderr || []}), '', 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition --check --json keeps stderr clean');
    my $check_report = decode_json(join('', @{$check_stdout || []}));
    ok($check_report->{success}, 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition check JSON reports success');
    is($check_report->{source}{resolved_path}, File::Spec->rel2abs($path), 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition check JSON reports the public .ppif source path');
    is($check_report->{support_accounting}{entry_id}, 'intent.ppif_apb_composition_multi_peripheral_multi_register_sideband_generalized_six_register_status_back_to_back', 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition check JSON names the corpus entry');
    is($check_report->{support_accounting}{source_kind}, 'ppif', 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition check JSON records PPIF source kind');
    is($check_report->{result}{composition_child_count}, 4, 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition check JSON reports four generated children');

    my ($semantic_success, undef, undef, $semantic_stdout, $semantic_stderr) = run(
        command => ['./bin/fsmgen', '--strict', '--emit-semantic-json', $path],
    );
    ok($semantic_success, 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition --emit-semantic-json succeeds');
    is(join('', @{$semantic_stderr || []}), '', 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition --emit-semantic-json keeps stderr clean');
    my $semantic_report = decode_json(join('', @{$semantic_stdout || []}));
    ok($semantic_report->{success}, 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition semantic JSON reports success');
    is($semantic_report->{support_accounting}{entry_id}, 'intent.ppif_apb_composition_multi_peripheral_multi_register_sideband_generalized_six_register_status_back_to_back', 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition semantic JSON names the corpus entry');
    is($semantic_report->{semantic}{module}{source_root_kind}, 'top', 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition semantic JSON payload describes the generated composition root');
    is($semantic_report->{semantic}{module}{name}, 'apb_tb', 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition semantic JSON records the generated top module');
    is($semantic_report->{semantic}{module}{composition_child_count}, 4, 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition semantic JSON records four generated children');
};
...
subtest 'CLI check and semantic JSON support-account generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition PPIF identity' => sub {
    my $path = sample_apb_composition_multi_peripheral_multi_register_sideband_protection_generalized_five_register_status_back_to_back_ppif_path();
    my ($check_success, undef, undef, $check_stdout, $check_stderr) = run(
        command => ['./bin/fsmgen', '--strict', '--check', '--json', $path],
    );
    ok($check_success, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition --check --json succeeds');
    is(join('', @{$check_stderr || []}), '', 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition --check --json keeps stderr clean');
    my $check_report = decode_json(join('', @{$check_stdout || []}));
    ok($check_report->{success}, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition check JSON reports success');
    is($check_report->{source}{resolved_path}, File::Spec->rel2abs($path), 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition check JSON reports the public .ppif source path');
    is($check_report->{support_accounting}{entry_id}, 'intent.ppif_apb_composition_multi_peripheral_multi_register_sideband_protection_generalized_five_register_status_back_to_back', 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition check JSON names the corpus entry');
    is($check_report->{support_accounting}{source_kind}, 'ppif', 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition check JSON records PPIF source kind');
    is($check_report->{result}{composition_child_count}, 4, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition check JSON reports four generated children');

    my ($semantic_success, undef, undef, $semantic_stdout, $semantic_stderr) = run(
        command => ['./bin/fsmgen', '--strict', '--emit-semantic-json', $path],
    );
    ok($semantic_success, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition --emit-semantic-json succeeds');
    is(join('', @{$semantic_stderr || []}), '', 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition --emit-semantic-json keeps stderr clean');
    my $semantic_report = decode_json(join('', @{$semantic_stdout || []}));
    ok($semantic_report->{success}, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition semantic JSON reports success');
    is($semantic_report->{support_accounting}{entry_id}, 'intent.ppif_apb_composition_multi_peripheral_multi_register_sideband_protection_generalized_five_register_status_back_to_back', 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition semantic JSON names the corpus entry');
    is($semantic_report->{semantic}{module}{source_root_kind}, 'top', 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition semantic JSON payload describes the generated composition root');
    is($semantic_report->{semantic}{module}{name}, 'apb_tb', 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition semantic JSON records the generated top module');
    is($semantic_report->{semantic}{module}{composition_child_count}, 4, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition semantic JSON records four generated children');
};
...
subtest 'CLI check and semantic JSON support-account generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition PPIF identity' => sub {
    my $path = sample_apb_composition_multi_peripheral_multi_register_sideband_data16_generalized_five_register_status_back_to_back_ppif_path();
    my ($check_success, undef, undef, $check_stdout, $check_stderr) = run(
        command => ['./bin/fsmgen', '--strict', '--check', '--json', $path],
    );
    ok($check_success, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition --check --json succeeds');
    is(join('', @{$check_stderr || []}), '', 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition --check --json keeps stderr clean');
    my $check_report = decode_json(join('', @{$check_stdout || []}));
    ok($check_report->{success}, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition check JSON reports success');
    is($check_report->{source}{resolved_path}, File::Spec->rel2abs($path), 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition check JSON reports the public .ppif source path');
    is($check_report->{support_accounting}{entry_id}, 'intent.ppif_apb_composition_multi_peripheral_multi_register_sideband_data16_generalized_five_register_status_back_to_back', 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition check JSON names the corpus entry');
    is($check_report->{support_accounting}{source_kind}, 'ppif', 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition check JSON records PPIF source kind');
    is($check_report->{result}{composition_child_count}, 4, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition check JSON reports four generated children');

    my ($semantic_success, undef, undef, $semantic_stdout, $semantic_stderr) = run(
        command => ['./bin/fsmgen', '--strict', '--emit-semantic-json', $path],
    );
    ok($semantic_success, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition --emit-semantic-json succeeds');
    is(join('', @{$semantic_stderr || []}), '', 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition --emit-semantic-json keeps stderr clean');
    my $semantic_report = decode_json(join('', @{$semantic_stdout || []}));
    ok($semantic_report->{success}, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition semantic JSON reports success');
    is($semantic_report->{support_accounting}{entry_id}, 'intent.ppif_apb_composition_multi_peripheral_multi_register_sideband_data16_generalized_five_register_status_back_to_back', 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition semantic JSON names the corpus entry');
    is($semantic_report->{semantic}{module}{source_root_kind}, 'top', 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition semantic JSON payload describes the generated composition root');
    is($semantic_report->{semantic}{module}{name}, 'apb_tb', 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition semantic JSON records the generated top module');
    is($semantic_report->{semantic}{module}{composition_child_count}, 4, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition semantic JSON records four generated children');
};

subtest 'CLI check and semantic JSON support-account generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition PPIF identity' => sub {
    my $path = sample_apb_composition_multi_peripheral_multi_register_sideband_data16_generalized_six_register_status_back_to_back_ppif_path();
    my ($check_success, undef, undef, $check_stdout, $check_stderr) = run(
        command => ['./bin/fsmgen', '--strict', '--check', '--json', $path],
    );
    ok($check_success, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition --check --json succeeds');
    is(join('', @{$check_stderr || []}), '', 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition --check --json keeps stderr clean');
    my $check_report = decode_json(join('', @{$check_stdout || []}));
    ok($check_report->{success}, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition check JSON reports success');
    is($check_report->{source}{resolved_path}, File::Spec->rel2abs($path), 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition check JSON reports the public .ppif source path');
    is($check_report->{support_accounting}{entry_id}, 'intent.ppif_apb_composition_multi_peripheral_multi_register_sideband_data16_generalized_six_register_status_back_to_back', 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition check JSON names the corpus entry');
    is($check_report->{support_accounting}{source_kind}, 'ppif', 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition check JSON records PPIF source kind');
    is($check_report->{result}{composition_child_count}, 4, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition check JSON reports four generated children');

    my ($semantic_success, undef, undef, $semantic_stdout, $semantic_stderr) = run(
        command => ['./bin/fsmgen', '--strict', '--emit-semantic-json', $path],
    );
    ok($semantic_success, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition --emit-semantic-json succeeds');
    is(join('', @{$semantic_stderr || []}), '', 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition --emit-semantic-json keeps stderr clean');
    my $semantic_report = decode_json(join('', @{$semantic_stdout || []}));
    ok($semantic_report->{success}, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition semantic JSON reports success');
    is($semantic_report->{support_accounting}{entry_id}, 'intent.ppif_apb_composition_multi_peripheral_multi_register_sideband_data16_generalized_six_register_status_back_to_back', 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition semantic JSON names the corpus entry');
    is($semantic_report->{semantic}{module}{source_root_kind}, 'top', 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition semantic JSON payload describes the generated composition root');
    is($semantic_report->{semantic}{module}{name}, 'apb_tb', 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition semantic JSON records the generated top module');
    is($semantic_report->{semantic}{module}{composition_child_count}, 4, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition semantic JSON records four generated children');
};
...
subtest 'CLI check and semantic JSON support-account generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition PPIF identity' => sub {
    my $path = sample_apb_composition_multi_peripheral_multi_register_sideband_data16_protection_generalized_status_back_to_back_ppif_path();
    my ($check_success, undef, undef, $check_stdout, $check_stderr) = run(
        command => ['./bin/fsmgen', '--strict', '--check', '--json', $path],
    );
    ok($check_success, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition --check --json succeeds');
    is(join('', @{$check_stderr || []}), '', 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition --check --json keeps stderr clean');
    my $check_report = decode_json(join('', @{$check_stdout || []}));
    ok($check_report->{success}, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition check JSON reports success');
    is($check_report->{source}{resolved_path}, File::Spec->rel2abs($path), 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition check JSON reports the public .ppif source path');
    is($check_report->{support_accounting}{entry_id}, 'intent.ppif_apb_composition_multi_peripheral_multi_register_sideband_data16_protection_generalized_status_back_to_back', 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition check JSON names the corpus entry');
    is($check_report->{support_accounting}{source_kind}, 'ppif', 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition check JSON records PPIF source kind');
    is($check_report->{result}{composition_child_count}, 4, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition check JSON reports four generated children');

    my ($semantic_success, undef, undef, $semantic_stdout, $semantic_stderr) = run(
        command => ['./bin/fsmgen', '--strict', '--emit-semantic-json', $path],
    );
    ok($semantic_success, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition --emit-semantic-json succeeds');
    is(join('', @{$semantic_stderr || []}), '', 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition --emit-semantic-json keeps stderr clean');
    my $semantic_report = decode_json(join('', @{$semantic_stdout || []}));
    ok($semantic_report->{success}, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition semantic JSON reports success');
    is($semantic_report->{support_accounting}{entry_id}, 'intent.ppif_apb_composition_multi_peripheral_multi_register_sideband_data16_protection_generalized_status_back_to_back', 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition semantic JSON names the corpus entry');
    is($semantic_report->{semantic}{module}{source_root_kind}, 'top', 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition semantic JSON payload describes the generated composition root');
    is($semantic_report->{semantic}{module}{name}, 'apb_tb', 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition semantic JSON records the generated top module');
    is($semantic_report->{semantic}{module}{composition_child_count}, 4, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition semantic JSON records four generated children');
};

subtest 'CLI check and semantic JSON support-account generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition PPIF identity' => sub {
    my $path = sample_apb_composition_multi_peripheral_multi_register_sideband_data16_protection_generalized_five_register_status_back_to_back_ppif_path();
    my ($check_success, undef, undef, $check_stdout, $check_stderr) = run(
        command => ['./bin/fsmgen', '--strict', '--check', '--json', $path],
    );
    ok($check_success, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition --check --json succeeds');
    is(join('', @{$check_stderr || []}), '', 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition --check --json keeps stderr clean');
    my $check_report = decode_json(join('', @{$check_stdout || []}));
    ok($check_report->{success}, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition check JSON reports success');
    is($check_report->{source}{resolved_path}, File::Spec->rel2abs($path), 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition check JSON reports the public .ppif source path');
    is($check_report->{support_accounting}{entry_id}, 'intent.ppif_apb_composition_multi_peripheral_multi_register_sideband_data16_protection_generalized_five_register_status_back_to_back', 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition check JSON names the corpus entry');
    is($check_report->{support_accounting}{source_kind}, 'ppif', 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition check JSON records PPIF source kind');
    is($check_report->{result}{composition_child_count}, 4, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition check JSON reports four generated children');

    my ($semantic_success, undef, undef, $semantic_stdout, $semantic_stderr) = run(
        command => ['./bin/fsmgen', '--strict', '--emit-semantic-json', $path],
    );
    ok($semantic_success, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition --emit-semantic-json succeeds');
    is(join('', @{$semantic_stderr || []}), '', 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition --emit-semantic-json keeps stderr clean');
    my $semantic_report = decode_json(join('', @{$semantic_stdout || []}));
    ok($semantic_report->{success}, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition semantic JSON reports success');
    is($semantic_report->{support_accounting}{entry_id}, 'intent.ppif_apb_composition_multi_peripheral_multi_register_sideband_data16_protection_generalized_five_register_status_back_to_back', 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition semantic JSON names the corpus entry');
    is($semantic_report->{semantic}{module}{source_root_kind}, 'top', 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition semantic JSON payload describes the generated composition root');
    is($semantic_report->{semantic}{module}{name}, 'apb_tb', 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition semantic JSON records the generated top module');
    is($semantic_report->{semantic}{module}{composition_child_count}, 4, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition semantic JSON records four generated children');
};
...
subtest 'CLI schedule JSON, outdir, and .apb alias expose generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition review artifacts' => sub {
    my $path = sample_apb_composition_multi_peripheral_multi_register_sideband_generalized_five_register_status_back_to_back_ppif_path();
    my ($schedule_success, undef, undef, $schedule_stdout, $schedule_stderr) = run(
        command => ['./bin/fsmgen', '--emit-schedule-json', $path],
    );
    ok($schedule_success, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition --emit-schedule-json succeeds');
    is(join('', @{$schedule_stderr || []}), '', 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition --emit-schedule-json keeps stderr clean');
    my $schedule_report = decode_json(join('', @{$schedule_stdout || []}));
    is($schedule_report->{schema}, 'fsmgen.ial2.protocol_intent.apb_composition.v1', 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports schema');
    is($schedule_report->{composition}{topology}, 'multi_peripheral_interconnect', 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports topology');
    is($schedule_report->{composition}{width_policy}{data_width}, 32, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports data width 32');
    is($schedule_report->{composition}{width_policy}{strobe_width}, 4, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports strobe width 4');
    is($schedule_report->{composition}{address_map}{alignment_bytes}, 4, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports 4-byte window alignment');
    is($schedule_report->{composition}{address_map}{windows}[0]{base}{default}, 0, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports status base 0');
    is($schedule_report->{composition}{address_map}{windows}[1]{base}{default}, 256, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports control base 256');
    is($schedule_report->{children}[0]{bindings}{bus}{protection}{width}, 3, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports requester PPROT width');
    is_deeply($schedule_report->{children}[2]{transfer}{registers}, [qw(reg0 reg1 reg2 reg3 reg4)], 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports status reg0..reg4 storage');
    is_deeply($schedule_report->{children}[3]{transfer}{registers}, [qw(reg0 reg1 reg2 reg3 reg4)], 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports control reg0..reg4 storage');
    is($schedule_report->{children}[2]{bindings}{storage}{registers}[3]{address}{value}, 12, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports status reg3 address 12');
    is($schedule_report->{children}[2]{bindings}{storage}{registers}[4]{address}{value}, 16, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports status reg4 address 16');
    is($schedule_report->{back_to_back_policy}{requester}{timing_policy}{queue_depth}, 1, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports queue-depth 1');
    is($schedule_report->{back_to_back_policy}{requester}{timing_policy}{accepted}, 'accepted', 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports accepted response field');
    is($schedule_report->{back_to_back_policy}{interconnect}{timing_role}, 'propagate_queued_setup_without_idle_cycle', 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports interconnect timing role');
    is($schedule_report->{back_to_back_policy}{peripherals}[0]{timing_policy}{setup_admission}, 'adjacent', 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports status adjacent setup admission');
    is($schedule_report->{back_to_back_policy}{peripherals}[1]{timing_policy}{setup_admission}, 'adjacent', 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports control adjacent setup admission');
    my %residue = map { $_->{id} => 1 } @{$schedule_report->{unsupported_residue}};
    ok(!$residue{apb_back_to_back_policy_deferred}, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON omits broad back-to-back residue');
    ok($residue{apb_additional_back_to_back_policies_deferred}, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports narrowed future timing-policy residue');
    ok($residue{apb_protection_policy_effects_deferred}, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON keeps protection-policy effects residue');
    ok($residue{apb_alternate_widths_deferred}, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON keeps alternate-width residue');

    my $tempdir = tempdir(CLEANUP => 1);
    my $outdir = File::Spec->catdir($tempdir, 'out');
    my $hdl = File::Spec->catfile($tempdir, 'apb_tb_multi_peripheral_multi_register_sideband_generalized_five_register_status_back_to_back.sv');
    my ($success, undef, undef, undef, $stderr_buf) = run(
        command => ['./bin/fsmgen', '--quiet', '--outdir', $outdir, '--output', $hdl, $path],
    );

    ok($success, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition CLI generation succeeds');
    is(join('', @{$stderr_buf || []}), '', 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition generation keeps stderr clean');
    for my $artifact (qw(apb_requester.isf apb_status_regs.isf apb_control_regs.isf apb_interconnect.isf apb_requester.fsm apb_status_regs.fsm apb_control_regs.fsm apb_interconnect.fsm apb_tb.fsm)) {
        ok(-f File::Spec->catfile($outdir, $artifact), "generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition --outdir writes $artifact");
    }
    ok(-f $hdl, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition --output writes generated HDL');
    my $interconnect = slurp(File::Spec->catfile($outdir, 'apb_interconnect.fsm'));
    like($interconnect, qr/\(PSTRB_CONTROL 4\)/, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back outdir interconnect preserves 4-bit control PSTRB');
    like($interconnect, qr/\(<- \(PPROT_STATUS> PPROT\)\)/, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back outdir interconnect fans out PPROT');
    like($interconnect, qr/\(<- \(PSTRB_CONTROL> PSTRB\)\)/, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back outdir interconnect fans out PSTRB');
    like($interconnect, qr/\(<- \(PADDR_CONTROL> \(- PADDR 256\)\) <\(& PSEL \(>= PADDR 256\) \(< PADDR 512\)\)\)/, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back outdir interconnect uses control base 256');
    unlike($interconnect, qr/prot_q/, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back outdir interconnect remains enforcement-free');
    my $top = slurp(File::Spec->catfile($outdir, 'apb_tb.fsm'));
    like($top, qr/=accepted>/, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back outdir top exposes accepted');
    like($top, qr/\(queued_wstrb 4\)/, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back outdir top embeds queued 4-bit PSTRB');
    like($top, qr/\(status_reg3_data_q 32 \(reset 0\)\)/, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back outdir top embeds status reg3 storage');
    like($top, qr/\(status_reg4_data_q 32 \(reset 0\)\)/, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back outdir top embeds status reg4 storage');
    ...
    like($sv, qr/\breg\s+\[3:0\]\s+queued_wstrb\b/, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition HDL carries 4-bit queued PSTRB');
    unlike($sv, qr/prot_q\s*&\s*3'd1/, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back APB composition HDL has no endpoint PPROT predicate logic');
    ...
    is_deeply($alias->{generated_ial1}{items}, $ppif->{generated_ial1}{items}, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back .apb APB composition alias mirrors .ppif generated IAL1 artifacts');
    is_deeply($alias->{generated_ial0}{files}, $ppif->{generated_ial0}{files}, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back .apb APB composition alias mirrors .ppif generated IAL0');
    is($alias->{report}{composition}{width_policy}{data_width}, 32, 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back .apb APB composition alias preserves data width policy');
    is_deeply($alias->{report}{children}[3]{transfer}{registers}, [qw(reg0 reg1 reg2 reg3 reg4)], 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back .apb APB composition alias preserves control reg0..reg4 storage');
    is($alias->{report}{back_to_back_policy}{interconnect}{timing_role}, 'propagate_queued_setup_without_idle_cycle', 'generalized five-register sideband no-policy multi-peripheral multi-register back-to-back .apb APB composition alias preserves interconnect timing policy');
};

subtest 'CLI schedule JSON, outdir, and .apb alias expose generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition review artifacts' => sub {
    my $path = sample_apb_composition_multi_peripheral_multi_register_sideband_generalized_six_register_status_back_to_back_ppif_path();
    my ($schedule_success, undef, undef, $schedule_stdout, $schedule_stderr) = run(
        command => ['./bin/fsmgen', '--emit-schedule-json', $path],
    );
    ok($schedule_success, 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition --emit-schedule-json succeeds');
    is(join('', @{$schedule_stderr || []}), '', 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition --emit-schedule-json keeps stderr clean');
    my $schedule_report = decode_json(join('', @{$schedule_stdout || []}));
    is($schedule_report->{schema}, 'fsmgen.ial2.protocol_intent.apb_composition.v1', 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports schema');
    is($schedule_report->{composition}{topology}, 'multi_peripheral_interconnect', 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports topology');
    is($schedule_report->{composition}{width_policy}{data_width}, 32, 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports data width 32');
    is($schedule_report->{composition}{width_policy}{strobe_width}, 4, 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports strobe width 4');
    is($schedule_report->{composition}{address_map}{alignment_bytes}, 4, 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports 4-byte window alignment');
    is($schedule_report->{composition}{address_map}{windows}[0]{base}{default}, 0, 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports status base 0');
    is($schedule_report->{composition}{address_map}{windows}[1]{base}{default}, 256, 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports control base 256');
    is($schedule_report->{children}[0]{bindings}{bus}{protection}{width}, 3, 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports requester PPROT width');
    is_deeply($schedule_report->{children}[2]{transfer}{registers}, [qw(reg0 reg1 reg2 reg3 reg4 reg5)], 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports status reg0..reg5 storage');
    is_deeply($schedule_report->{children}[3]{transfer}{registers}, [qw(reg0 reg1 reg2 reg3 reg4 reg5)], 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports control reg0..reg5 storage');
    is($schedule_report->{children}[2]{bindings}{storage}{registers}[4]{address}{value}, 16, 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports status reg4 address 16');
    is($schedule_report->{children}[2]{bindings}{storage}{registers}[5]{address}{value}, 20, 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports status reg5 address 20');
    is($schedule_report->{back_to_back_policy}{requester}{timing_policy}{queue_depth}, 1, 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports queue-depth 1');
    is($schedule_report->{back_to_back_policy}{requester}{timing_policy}{accepted}, 'accepted', 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports accepted response field');
    is($schedule_report->{back_to_back_policy}{interconnect}{timing_role}, 'propagate_queued_setup_without_idle_cycle', 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports interconnect timing role');
    is($schedule_report->{back_to_back_policy}{peripherals}[0]{timing_policy}{setup_admission}, 'adjacent', 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports status adjacent setup admission');
    is($schedule_report->{back_to_back_policy}{peripherals}[1]{timing_policy}{setup_admission}, 'adjacent', 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports control adjacent setup admission');
    my %residue = map { $_->{id} => 1 } @{$schedule_report->{unsupported_residue}};
    ok(!$residue{apb_back_to_back_policy_deferred}, 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON omits broad back-to-back residue');
    ok($residue{apb_additional_back_to_back_policies_deferred}, 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports narrowed future timing-policy residue');
    ok($residue{apb_protection_policy_effects_deferred}, 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON keeps protection-policy effects residue');
    ok($residue{apb_alternate_widths_deferred}, 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON keeps alternate-width residue');

    my $tempdir = tempdir(CLEANUP => 1);
    my $outdir = File::Spec->catdir($tempdir, 'out');
    my $hdl = File::Spec->catfile($tempdir, 'apb_tb_multi_peripheral_multi_register_sideband_generalized_six_register_status_back_to_back.sv');
    my ($success, undef, undef, undef, $stderr_buf) = run(
        command => ['./bin/fsmgen', '--quiet', '--outdir', $outdir, '--output', $hdl, $path],
    );

    ok($success, 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition CLI generation succeeds');
    is(join('', @{$stderr_buf || []}), '', 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition generation keeps stderr clean');
    for my $artifact (qw(apb_requester.isf apb_status_regs.isf apb_control_regs.isf apb_interconnect.isf apb_requester.fsm apb_status_regs.fsm apb_control_regs.fsm apb_interconnect.fsm apb_tb.fsm)) {
        ok(-f File::Spec->catfile($outdir, $artifact), "generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition --outdir writes $artifact");
    }
    ok(-f $hdl, 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition --output writes generated HDL');
    my $interconnect = slurp(File::Spec->catfile($outdir, 'apb_interconnect.fsm'));
    like($interconnect, qr/\(PSTRB_CONTROL 4\)/, 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back outdir interconnect preserves 4-bit control PSTRB');
    like($interconnect, qr/\(<- \(PPROT_STATUS> PPROT\)\)/, 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back outdir interconnect fans out PPROT');
    like($interconnect, qr/\(<- \(PSTRB_CONTROL> PSTRB\)\)/, 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back outdir interconnect fans out PSTRB');
    like($interconnect, qr/\(<- \(PADDR_CONTROL> \(- PADDR 256\)\) <\(& PSEL \(>= PADDR 256\) \(< PADDR 512\)\)\)/, 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back outdir interconnect uses control base 256');
    unlike($interconnect, qr/prot_q/, 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back outdir interconnect remains enforcement-free');
    my $top = slurp(File::Spec->catfile($outdir, 'apb_tb.fsm'));
    like($top, qr/=accepted>/, 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back outdir top exposes accepted');
    like($top, qr/\(queued_wstrb 4\)/, 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back outdir top embeds queued 4-bit PSTRB');
    like($top, qr/\(status_reg4_data_q 32 \(reset 0\)\)/, 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back outdir top embeds status reg4 storage');
    like($top, qr/\(status_reg5_data_q 32 \(reset 0\)\)/, 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back outdir top embeds status reg5 storage');
    ...
    like($sv, qr/\breg\s+\[3:0\]\s+queued_wstrb\b/, 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition HDL carries 4-bit queued PSTRB');
    unlike($sv, qr/prot_q\s*&\s*3'd1/, 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition HDL has no endpoint PPROT predicate logic');

    ok(-f sample_apb_composition_multi_peripheral_multi_register_sideband_generalized_six_register_status_back_to_back_apb_path(), 'tracked runnable generalized six-register sideband no-policy multi-peripheral multi-register back-to-back APB composition .apb sample exists');
    my $alias = FSM::Adapter::IAL2::PPIF->new()->parse_file(sample_apb_composition_multi_peripheral_multi_register_sideband_generalized_six_register_status_back_to_back_apb_path());
    my $ppif = FSM::Adapter::IAL2::PPIF->new()->parse_file(sample_apb_composition_multi_peripheral_multi_register_sideband_generalized_six_register_status_back_to_back_ppif_path());
    is($alias->{kind}, 'protocol_intent.apb_composition', 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back .apb APB composition alias returns the composition kind');
    is($alias->{mode}, 'requester-multi-peripheral-composition', 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back .apb APB composition alias preserves mode');
    is_deeply($alias->{generated_ial1}{items}, $ppif->{generated_ial1}{items}, 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back .apb APB composition alias mirrors .ppif generated IAL1 artifacts');
    is_deeply($alias->{generated_ial0}{files}, $ppif->{generated_ial0}{files}, 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back .apb APB composition alias mirrors .ppif generated IAL0');
    is($alias->{report}{composition}{width_policy}{data_width}, 32, 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back .apb APB composition alias preserves data width policy');
    is_deeply($alias->{report}{children}[3]{transfer}{registers}, [qw(reg0 reg1 reg2 reg3 reg4 reg5)], 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back .apb APB composition alias preserves control reg0..reg5 storage');
    is($alias->{report}{back_to_back_policy}{interconnect}{timing_role}, 'propagate_queued_setup_without_idle_cycle', 'generalized six-register sideband no-policy multi-peripheral multi-register back-to-back .apb APB composition alias preserves interconnect timing policy');
};
...
subtest 'CLI schedule JSON, outdir, and .apb alias expose generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition review artifacts' => sub {
    my $path = sample_apb_composition_multi_peripheral_multi_register_sideband_protection_generalized_five_register_status_back_to_back_ppif_path();
    my ($schedule_success, undef, undef, $schedule_stdout, $schedule_stderr) = run(
        command => ['./bin/fsmgen', '--emit-schedule-json', $path],
    );
    ok($schedule_success, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition --emit-schedule-json succeeds');
    is(join('', @{$schedule_stderr || []}), '', 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition --emit-schedule-json keeps stderr clean');
    my $schedule_report = decode_json(join('', @{$schedule_stdout || []}));
    is($schedule_report->{schema}, 'fsmgen.ial2.protocol_intent.apb_composition.v1', 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports schema');
    is($schedule_report->{composition}{topology}, 'multi_peripheral_interconnect', 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports topology');
    is($schedule_report->{composition}{width_policy}{data_width}, 32, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports data width 32');
    is($schedule_report->{composition}{width_policy}{strobe_width}, 4, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports strobe width 4');
    is($schedule_report->{composition}{address_map}{alignment_bytes}, 4, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports 4-byte window alignment');
    is($schedule_report->{composition}{address_map}{windows}[1]{base}{default}, 256, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports control base 256');
    is($schedule_report->{protection_policy}{enforcement_owner}, 'peripheral_completers', 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports peripheral enforcement owners');
    is_deeply($schedule_report->{children}[2]{transfer}{registers}, [qw(reg0 reg1 reg2 reg3 reg4)], 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports status reg0..reg4 storage');
    is_deeply($schedule_report->{children}[3]{transfer}{registers}, [qw(reg0 reg1 reg2 reg3 reg4)], 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports control reg0..reg4 storage');
    is($schedule_report->{children}[2]{bindings}{storage}{registers}[4]{address}{value}, 16, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports status reg4 address 16');
    is($schedule_report->{children}[2]{protection_policy}{registers}[4]{read}{predicate}{value}, 1, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports protected status reg4 read policy');
    is($schedule_report->{children}[3]{protection_policy}{registers}[4]{write}{predicate}{value}, 1, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports protected control reg4 write policy');
    is($schedule_report->{back_to_back_policy}{requester}{timing_policy}{queue_depth}, 1, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports queue-depth 1');
    is($schedule_report->{back_to_back_policy}{interconnect}{timing_role}, 'propagate_queued_setup_without_idle_cycle', 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports interconnect timing role');
    my %residue = map { $_->{id} => 1 } @{$schedule_report->{unsupported_residue}};
    ok(!$residue{apb_back_to_back_policy_deferred}, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition schedule JSON omits broad back-to-back residue');
    ok(!$residue{apb_protection_policy_effects_deferred}, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition schedule JSON omits old policy-effects residue');
    ok($residue{apb_additional_back_to_back_policies_deferred}, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports narrowed future timing-policy residue');
    ok($residue{apb_additional_protection_policies_deferred}, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports additional-policy residue');
    ok($residue{apb_alternate_widths_deferred}, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition schedule JSON keeps alternate-width residue');

    my $tempdir = tempdir(CLEANUP => 1);
    my $outdir = File::Spec->catdir($tempdir, 'out');
    my $hdl = File::Spec->catfile($tempdir, 'apb_tb_multi_peripheral_multi_register_sideband_protection_generalized_five_register_status_back_to_back.sv');
    my ($success, undef, undef, undef, $stderr_buf) = run(
        command => ['./bin/fsmgen', '--quiet', '--outdir', $outdir, '--output', $hdl, $path],
    );

    ok($success, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition CLI generation succeeds');
    is(join('', @{$stderr_buf || []}), '', 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition generation keeps stderr clean');
    for my $artifact (qw(apb_requester.isf apb_status_regs.isf apb_control_regs.isf apb_interconnect.isf apb_requester.fsm apb_status_regs.fsm apb_control_regs.fsm apb_interconnect.fsm apb_tb.fsm)) {
        ok(-f File::Spec->catfile($outdir, $artifact), "generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition --outdir writes $artifact");
    }
    ok(-f $hdl, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition --output writes generated HDL');
    my $interconnect = slurp(File::Spec->catfile($outdir, 'apb_interconnect.fsm'));
    like($interconnect, qr/\(PSTRB_CONTROL 4\)/, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back outdir interconnect preserves 4-bit control PSTRB');
    like($interconnect, qr/\(<- \(PPROT_STATUS> PPROT\)\)/, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back outdir interconnect fans out PPROT');
    like($interconnect, qr/\(<- \(PSTRB_CONTROL> PSTRB\)\)/, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back outdir interconnect fans out PSTRB');
    like($interconnect, qr/\(<- \(PADDR_CONTROL> \(- PADDR 256\)\) <\(& PSEL \(>= PADDR 256\) \(< PADDR 512\)\)\)/, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back outdir interconnect uses control base 256');
    unlike($interconnect, qr/prot_q/, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back outdir interconnect remains enforcement-free');
    my $top = slurp(File::Spec->catfile($outdir, 'apb_tb.fsm'));
    like($top, qr/=accepted>/, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back outdir top exposes accepted');
    like($top, qr/\(queued_wdata 32\)/, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back outdir top embeds 32-bit queued data');
    like($top, qr/\(queued_wstrb 4\)/, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back outdir top embeds queued 4-bit PSTRB');
    like($top, qr/\(status_reg3_data_q 32 \(reset 0\)\)/, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back outdir top embeds status reg3 storage');
    like($top, qr/\(status_reg4_data_q 32 \(reset 0\)\)/, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back outdir top embeds status reg4 storage');
    like($top, qr/\(control_reg4_data_q 32 \(reset 0\)\)/, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back outdir top embeds control reg4 storage');
    ...
    like($sv, qr/\breg\s+\[3:0\]\s+queued_wstrb\b/, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition HDL carries 4-bit queued PSTRB');
    like($sv, qr/prot_q\s*&\s*3'd1/, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back APB composition HDL preserves endpoint PPROT predicate logic');
    ...
    is_deeply($alias->{generated_ial1}{items}, $ppif->{generated_ial1}{items}, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back .apb APB composition alias mirrors .ppif generated IAL1 artifacts');
    is_deeply($alias->{generated_ial0}{files}, $ppif->{generated_ial0}{files}, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back .apb APB composition alias mirrors .ppif generated IAL0');
    is($alias->{report}{composition}{width_policy}{data_width}, 32, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back .apb APB composition alias preserves data width policy');
    is($alias->{report}{protection_policy}{enforcement_owner}, 'peripheral_completers', 'generalized five-register sideband protection multi-peripheral multi-register back-to-back .apb APB composition alias preserves policy owner');
    is_deeply($alias->{report}{children}[3]{transfer}{registers}, [qw(reg0 reg1 reg2 reg3 reg4)], 'generalized five-register sideband protection multi-peripheral multi-register back-to-back .apb APB composition alias preserves control reg0..reg4 storage');
    is($alias->{report}{children}[3]{protection_policy}{registers}[4]{write}{predicate}{value}, 1, 'generalized five-register sideband protection multi-peripheral multi-register back-to-back .apb APB composition alias preserves control reg4 write policy');
    is($alias->{report}{back_to_back_policy}{interconnect}{timing_role}, 'propagate_queued_setup_without_idle_cycle', 'generalized five-register sideband protection multi-peripheral multi-register back-to-back .apb APB composition alias preserves interconnect timing policy');
};
...
subtest 'CLI schedule JSON, outdir, and .apb alias expose generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition review artifacts' => sub {
    my $path = sample_apb_composition_multi_peripheral_multi_register_sideband_data16_generalized_five_register_status_back_to_back_ppif_path();
    my ($schedule_success, undef, undef, $schedule_stdout, $schedule_stderr) = run(
        command => ['./bin/fsmgen', '--emit-schedule-json', $path],
    );
    ok($schedule_success, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition --emit-schedule-json succeeds');
    is(join('', @{$schedule_stderr || []}), '', 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition --emit-schedule-json keeps stderr clean');
    my $schedule_report = decode_json(join('', @{$schedule_stdout || []}));
    is($schedule_report->{composition}{width_policy}{data_width}, 16, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports data width 16');
    is($schedule_report->{composition}{width_policy}{strobe_width}, 2, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports strobe width 2');
    is($schedule_report->{composition}{address_map}{alignment_bytes}, 2, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports 2-byte window alignment');
    is($schedule_report->{composition}{address_map}{windows}[1]{base}{default}, 258, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports control base 258');
    is_deeply($schedule_report->{children}[2]{transfer}{registers}, [qw(reg0 reg1 reg2 reg3 reg4)], 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports status reg0..reg4 storage');
    is_deeply($schedule_report->{children}[3]{transfer}{registers}, [qw(reg0 reg1 reg2 reg3 reg4)], 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports control reg0..reg4 storage');
    is($schedule_report->{children}[2]{bindings}{storage}{registers}[3]{address}{value}, 6, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports status reg3 address 6');
    is($schedule_report->{children}[2]{bindings}{storage}{registers}[4]{address}{value}, 8, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports status reg4 address 8');
    is($schedule_report->{back_to_back_policy}{interconnect}{timing_role}, 'propagate_queued_setup_without_idle_cycle', 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports interconnect timing role');
    my %residue = map { $_->{id} => 1 } @{$schedule_report->{unsupported_residue}};
    ok(!$residue{apb_back_to_back_policy_deferred}, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON omits broad back-to-back residue');
    ok(!$residue{apb_alternate_widths_deferred}, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON omits broad alternate-width residue');
    ok($residue{apb_additional_back_to_back_policies_deferred}, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports narrowed future timing-policy residue');
    ok($residue{apb_protection_policy_effects_deferred}, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON keeps protection-policy effects residue');

    my $tempdir = tempdir(CLEANUP => 1);
    my $outdir = File::Spec->catdir($tempdir, 'out');
    my $hdl = File::Spec->catfile($tempdir, 'apb_tb_multi_peripheral_multi_register_sideband_data16_generalized_five_register_status_back_to_back.sv');
    my ($success, undef, undef, undef, $stderr_buf) = run(
        command => ['./bin/fsmgen', '--quiet', '--outdir', $outdir, '--output', $hdl, $path],
    );

    ok($success, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition CLI generation succeeds');
    is(join('', @{$stderr_buf || []}), '', 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition generation keeps stderr clean');
    for my $artifact (qw(apb_requester.isf apb_status_regs.isf apb_control_regs.isf apb_interconnect.isf apb_requester.fsm apb_status_regs.fsm apb_control_regs.fsm apb_interconnect.fsm apb_tb.fsm)) {
        ok(-f File::Spec->catfile($outdir, $artifact), "generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition --outdir writes $artifact");
    }
    ok(-f $hdl, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition --output writes generated HDL');
    my $interconnect = slurp(File::Spec->catfile($outdir, 'apb_interconnect.fsm'));
    like($interconnect, qr/\(PSTRB_CONTROL 2\)/, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back outdir interconnect preserves 2-bit control PSTRB');
    like($interconnect, qr/\(<- \(PPROT_STATUS> PPROT\)\)/, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back outdir interconnect fans out PPROT');
    like($interconnect, qr/\(<- \(PSTRB_CONTROL> PSTRB\)\)/, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back outdir interconnect fans out PSTRB');
    like($interconnect, qr/\(<- \(PADDR_CONTROL> \(- PADDR 258\)\) <\(& PSEL \(>= PADDR 258\) \(< PADDR 516\)\)\)/, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back outdir interconnect uses control base 258');
    unlike($interconnect, qr/prot_q/, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back outdir interconnect remains enforcement-free');
    my $top = slurp(File::Spec->catfile($outdir, 'apb_tb.fsm'));
    like($top, qr/=accepted>/, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back outdir top exposes accepted');
    like($top, qr/\(queued_wstrb 2\)/, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back outdir top embeds queued 2-bit PSTRB');
    like($top, qr/\(status_reg3_data_q 16 \(reset 0\)\)/, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back outdir top embeds status reg3 storage');
    like($top, qr/\(status_reg4_data_q 16 \(reset 0\)\)/, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back outdir top embeds status reg4 storage');
    ...
    like($sv, qr/\breg\s+\[1:0\]\s+queued_wstrb\b/, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition HDL carries 2-bit queued PSTRB');
    unlike($sv, qr/prot_q\s*&\s*3'd1/, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition HDL has no endpoint PPROT predicate logic');
    ...
    is_deeply($alias->{generated_ial1}{items}, $ppif->{generated_ial1}{items}, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back .apb APB composition alias mirrors .ppif generated IAL1 artifacts');
    is_deeply($alias->{generated_ial0}{files}, $ppif->{generated_ial0}{files}, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back .apb APB composition alias mirrors .ppif generated IAL0');
    is($alias->{report}{composition}{width_policy}{data_width}, 16, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back .apb APB composition alias preserves data width policy');
    is($alias->{report}{composition}{width_policy}{strobe_width}, 2, 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back .apb APB composition alias preserves strobe width policy');
    is_deeply($alias->{report}{children}[3]{transfer}{registers}, [qw(reg0 reg1 reg2 reg3 reg4)], 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back .apb APB composition alias preserves control reg0..reg4 storage');
    is($alias->{report}{back_to_back_policy}{interconnect}{timing_role}, 'propagate_queued_setup_without_idle_cycle', 'generalized five-register sideband data16 no-policy multi-peripheral multi-register back-to-back .apb APB composition alias preserves interconnect timing policy');
};

subtest 'CLI schedule JSON, outdir, and .apb alias expose generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition review artifacts' => sub {
    my $path = sample_apb_composition_multi_peripheral_multi_register_sideband_data16_generalized_six_register_status_back_to_back_ppif_path();
    my ($schedule_success, undef, undef, $schedule_stdout, $schedule_stderr) = run(
        command => ['./bin/fsmgen', '--emit-schedule-json', $path],
    );
    ok($schedule_success, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition --emit-schedule-json succeeds');
    is(join('', @{$schedule_stderr || []}), '', 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition --emit-schedule-json keeps stderr clean');
    my $schedule_report = decode_json(join('', @{$schedule_stdout || []}));
    is($schedule_report->{schema}, 'fsmgen.ial2.protocol_intent.apb_composition.v1', 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports schema');
    is($schedule_report->{composition}{topology}, 'multi_peripheral_interconnect', 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports topology');
    is($schedule_report->{composition}{width_policy}{data_width}, 16, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports data width 16');
    is($schedule_report->{composition}{width_policy}{strobe_width}, 2, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports strobe width 2');
    is($schedule_report->{composition}{address_map}{alignment_bytes}, 2, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports 2-byte window alignment');
    is($schedule_report->{composition}{address_map}{windows}[0]{base}{default}, 0, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports status base 0');
    is($schedule_report->{composition}{address_map}{windows}[1]{base}{default}, 258, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports control base 258');
    is($schedule_report->{children}[0]{bindings}{bus}{protection}{width}, 3, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports requester PPROT width');
    is_deeply($schedule_report->{children}[2]{transfer}{registers}, [qw(reg0 reg1 reg2 reg3 reg4 reg5)], 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports status reg0..reg5 storage');
    is_deeply($schedule_report->{children}[3]{transfer}{registers}, [qw(reg0 reg1 reg2 reg3 reg4 reg5)], 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports control reg0..reg5 storage');
    is($schedule_report->{children}[2]{bindings}{storage}{registers}[4]{address}{value}, 8, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports status reg4 address 8');
    is($schedule_report->{children}[2]{bindings}{storage}{registers}[5]{address}{value}, 10, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports status reg5 address 10');
    is($schedule_report->{back_to_back_policy}{requester}{timing_policy}{queue_depth}, 1, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports queue-depth 1');
    is($schedule_report->{back_to_back_policy}{requester}{timing_policy}{accepted}, 'accepted', 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports accepted response field');
    is($schedule_report->{back_to_back_policy}{interconnect}{timing_role}, 'propagate_queued_setup_without_idle_cycle', 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports interconnect timing role');
    is($schedule_report->{back_to_back_policy}{peripherals}[0]{timing_policy}{setup_admission}, 'adjacent', 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports status adjacent setup admission');
    is($schedule_report->{back_to_back_policy}{peripherals}[1]{timing_policy}{setup_admission}, 'adjacent', 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports control adjacent setup admission');
    my %residue = map { $_->{id} => 1 } @{$schedule_report->{unsupported_residue}};
    ok(!$residue{apb_back_to_back_policy_deferred}, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON omits broad back-to-back residue');
    ok(!$residue{apb_alternate_widths_deferred}, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON omits broad alternate-width residue');
    ok($residue{apb_additional_back_to_back_policies_deferred}, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON reports narrowed future timing-policy residue');
    ok($residue{apb_protection_policy_effects_deferred}, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition schedule JSON keeps protection-policy effects residue');

    my $tempdir = tempdir(CLEANUP => 1);
    my $outdir = File::Spec->catdir($tempdir, 'out');
    my $hdl = File::Spec->catfile($tempdir, 'apb_tb_multi_peripheral_multi_register_sideband_data16_generalized_six_register_status_back_to_back.sv');
    my ($success, undef, undef, undef, $stderr_buf) = run(
        command => ['./bin/fsmgen', '--quiet', '--outdir', $outdir, '--output', $hdl, $path],
    );

    ok($success, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition CLI generation succeeds');
    is(join('', @{$stderr_buf || []}), '', 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition generation keeps stderr clean');
    for my $artifact (qw(apb_requester.isf apb_status_regs.isf apb_control_regs.isf apb_interconnect.isf apb_requester.fsm apb_status_regs.fsm apb_control_regs.fsm apb_interconnect.fsm apb_tb.fsm)) {
        ok(-f File::Spec->catfile($outdir, $artifact), "generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition --outdir writes $artifact");
    }
    ok(-f $hdl, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition --output writes generated HDL');
    my $interconnect = slurp(File::Spec->catfile($outdir, 'apb_interconnect.fsm'));
    like($interconnect, qr/\(PSTRB_CONTROL 2\)/, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back outdir interconnect preserves 2-bit control PSTRB');
    like($interconnect, qr/\(<- \(PPROT_STATUS> PPROT\)\)/, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back outdir interconnect fans out PPROT');
    like($interconnect, qr/\(<- \(PSTRB_CONTROL> PSTRB\)\)/, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back outdir interconnect fans out PSTRB');
    like($interconnect, qr/\(<- \(PADDR_CONTROL> \(- PADDR 258\)\) <\(& PSEL \(>= PADDR 258\) \(< PADDR 516\)\)\)/, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back outdir interconnect uses control base 258');
    unlike($interconnect, qr/prot_q/, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back outdir interconnect remains enforcement-free');
    my $top = slurp(File::Spec->catfile($outdir, 'apb_tb.fsm'));
    like($top, qr/=accepted>/, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back outdir top exposes accepted');
    like($top, qr/\(queued_wstrb 2\)/, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back outdir top embeds queued 2-bit PSTRB');
    like($top, qr/\(status_reg5_data_q 16 \(reset 0\)\)/, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back outdir top embeds status reg5 storage');
    ...
    like($sv, qr/\breg\s+\[1:0\]\s+queued_wstrb\b/, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition HDL carries 2-bit queued PSTRB');
    unlike($sv, qr/prot_q\s*&\s*3'd1/, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back APB composition HDL has no endpoint PPROT predicate logic');
    ...
    is_deeply($alias->{generated_ial1}{items}, $ppif->{generated_ial1}{items}, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back .apb APB composition alias mirrors .ppif generated IAL1 artifacts');
    is_deeply($alias->{generated_ial0}{files}, $ppif->{generated_ial0}{files}, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back .apb APB composition alias mirrors .ppif generated IAL0');
    is($alias->{report}{composition}{width_policy}{data_width}, 16, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back .apb APB composition alias preserves data width policy');
    is($alias->{report}{composition}{width_policy}{strobe_width}, 2, 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back .apb APB composition alias preserves strobe width policy');
    is_deeply($alias->{report}{children}[3]{transfer}{registers}, [qw(reg0 reg1 reg2 reg3 reg4 reg5)], 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back .apb APB composition alias preserves control reg0..reg5 storage');
    is($alias->{report}{back_to_back_policy}{interconnect}{timing_role}, 'propagate_queued_setup_without_idle_cycle', 'generalized six-register sideband data16 no-policy multi-peripheral multi-register back-to-back .apb APB composition alias preserves interconnect timing policy');
};
...
subtest 'CLI schedule JSON, outdir, and .apb alias expose generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition review artifacts' => sub {
    my $path = sample_apb_composition_multi_peripheral_multi_register_sideband_data16_protection_generalized_status_back_to_back_ppif_path();
    my ($schedule_success, undef, undef, $schedule_stdout, $schedule_stderr) = run(
        command => ['./bin/fsmgen', '--emit-schedule-json', $path],
    );
    ok($schedule_success, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition --emit-schedule-json succeeds');
    is(join('', @{$schedule_stderr || []}), '', 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition --emit-schedule-json keeps stderr clean');
    my $schedule_report = decode_json(join('', @{$schedule_stdout || []}));
    is($schedule_report->{schema}, 'fsmgen.ial2.protocol_intent.apb_composition.v1', 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports schema');
    is($schedule_report->{composition}{topology}, 'multi_peripheral_interconnect', 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports topology');
    is($schedule_report->{composition}{width_policy}{data_width}, 16, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports data width 16');
    is($schedule_report->{composition}{width_policy}{strobe_width}, 2, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports strobe width 2');
    is($schedule_report->{composition}{address_map}{alignment_bytes}, 2, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports 2-byte window alignment');
    is($schedule_report->{composition}{address_map}{windows}[1]{base}{default}, 258, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports control base 258');
    is($schedule_report->{protection_policy}{enforcement_owner}, 'peripheral_completers', 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports peripheral enforcement owners');
    is_deeply($schedule_report->{children}[2]{transfer}{registers}, [qw(reg0 reg1 reg2)], 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports status reg0/reg1/reg2 storage');
    is_deeply($schedule_report->{children}[3]{transfer}{registers}, [qw(reg0 reg1 reg2)], 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports control reg0/reg1/reg2 storage');
    is($schedule_report->{children}[2]{bindings}{storage}{registers}[2]{address}{value}, 4, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports status reg2 address 4');
    is($schedule_report->{children}[2]{protection_policy}{registers}[2]{read}{predicate}{value}, 1, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports protected status reg2 read policy');
    is($schedule_report->{children}[3]{protection_policy}{registers}[2]{write}{predicate}{value}, 1, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports protected control reg2 write policy');
    is($schedule_report->{back_to_back_policy}{requester}{timing_policy}{queue_depth}, 1, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports queue-depth 1');
    is($schedule_report->{back_to_back_policy}{interconnect}{timing_role}, 'propagate_queued_setup_without_idle_cycle', 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports interconnect timing role');
    is($schedule_report->{back_to_back_policy}{peripherals}[0]{timing_policy}{setup_admission}, 'adjacent', 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports status adjacent setup admission');
    is($schedule_report->{back_to_back_policy}{peripherals}[1]{timing_policy}{setup_admission}, 'adjacent', 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports control adjacent setup admission');
    my %residue_by_id = map { $_->{id} => $_ } @{$schedule_report->{unsupported_residue}};
    my %residue = map { $_ => 1 } keys %residue_by_id;
    ok(!$residue{apb_back_to_back_policy_deferred}, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON omits broad back-to-back residue');
    ok(!$residue{apb_protection_policy_effects_deferred}, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON omits old policy-effects residue');
    ok(!$residue{apb_alternate_widths_deferred}, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON omits broad alternate-width residue');
    ok($residue{apb_additional_back_to_back_policies_deferred}, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports narrowed future timing-policy residue');
    unlike($residue_by_id{apb_additional_back_to_back_policies_deferred}{detail}, qr/data16 protected generalized register sets/, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition residue retires stale data16 protected generalized wording');
    ok($residue{apb_additional_protection_policies_deferred}, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports additional-policy residue');
    ok($residue{apb_remaining_widths_deferred}, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports narrowed remaining-width residue');

    my $tempdir = tempdir(CLEANUP => 1);
    my $outdir = File::Spec->catdir($tempdir, 'out');
    my $hdl = File::Spec->catfile($tempdir, 'apb_tb_multi_peripheral_multi_register_sideband_data16_protection_generalized_status_back_to_back.sv');
    my ($success, undef, undef, undef, $stderr_buf) = run(
        command => ['./bin/fsmgen', '--quiet', '--outdir', $outdir, '--output', $hdl, $path],
    );

    ok($success, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition CLI generation succeeds');
    is(join('', @{$stderr_buf || []}), '', 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition generation keeps stderr clean');
    for my $artifact (qw(apb_requester.isf apb_status_regs.isf apb_control_regs.isf apb_interconnect.isf apb_requester.fsm apb_status_regs.fsm apb_control_regs.fsm apb_interconnect.fsm apb_tb.fsm)) {
        ok(-f File::Spec->catfile($outdir, $artifact), "generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition --outdir writes $artifact");
    }
    ok(-f $hdl, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition --output writes generated HDL');
    my $interconnect = slurp(File::Spec->catfile($outdir, 'apb_interconnect.fsm'));
    like($interconnect, qr/\(PSTRB_CONTROL 2\)/, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back outdir interconnect preserves 2-bit control PSTRB');
    like($interconnect, qr/\(<- \(PPROT_STATUS> PPROT\)\)/, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back outdir interconnect fans out PPROT');
    like($interconnect, qr/\(<- \(PSTRB_CONTROL> PSTRB\)\)/, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back outdir interconnect fans out PSTRB');
    like($interconnect, qr/\(<- \(PADDR_CONTROL> \(- PADDR 258\)\) <\(& PSEL \(>= PADDR 258\) \(< PADDR 516\)\)\)/, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back outdir interconnect uses control base 258');
    unlike($interconnect, qr/prot_q/, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back outdir interconnect remains enforcement-free');
    my $top = slurp(File::Spec->catfile($outdir, 'apb_tb.fsm'));
    like($top, qr/=accepted>/, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back outdir top exposes accepted');
    like($top, qr/\(queued_wstrb 2\)/, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back outdir top embeds queued 2-bit PSTRB');
    like($top, qr/\(status_reg2_data_q 16 \(reset 0\)\)/, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back outdir top embeds status reg2 storage');
    like($top, qr/\(control_reg2_data_q 16 \(reset 0\)\)/, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back outdir top embeds control reg2 storage');
    ...
    like($sv, qr/\breg\s+\[1:0\]\s+queued_wstrb\b/, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition HDL carries 2-bit queued PSTRB');
    like($sv, qr/prot_q\s*&\s*3'd1/, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition HDL preserves endpoint PPROT predicate logic');

    ok(-f sample_apb_composition_multi_peripheral_multi_register_sideband_data16_protection_generalized_status_back_to_back_apb_path(), 'tracked runnable generalized sideband data16 protection multi-peripheral multi-register back-to-back APB composition .apb sample exists');
    my $alias = FSM::Adapter::IAL2::PPIF->new()->parse_file(sample_apb_composition_multi_peripheral_multi_register_sideband_data16_protection_generalized_status_back_to_back_apb_path());
    my $ppif = FSM::Adapter::IAL2::PPIF->new()->parse_file(sample_apb_composition_multi_peripheral_multi_register_sideband_data16_protection_generalized_status_back_to_back_ppif_path());
    is($alias->{kind}, 'protocol_intent.apb_composition', 'generalized sideband data16 protection multi-peripheral multi-register back-to-back .apb APB composition alias returns the composition kind');
    is($alias->{mode}, 'requester-multi-peripheral-composition', 'generalized sideband data16 protection multi-peripheral multi-register back-to-back .apb APB composition alias preserves mode');
    is_deeply($alias->{generated_ial1}{items}, $ppif->{generated_ial1}{items}, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back .apb APB composition alias mirrors .ppif generated IAL1 artifacts');
    is_deeply($alias->{generated_ial0}{files}, $ppif->{generated_ial0}{files}, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back .apb APB composition alias mirrors .ppif generated IAL0');
    is($alias->{report}{composition}{width_policy}{data_width}, 16, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back .apb APB composition alias preserves data width policy');
    is($alias->{report}{composition}{width_policy}{strobe_width}, 2, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back .apb APB composition alias preserves strobe width policy');
    is($alias->{report}{protection_policy}{enforcement_owner}, 'peripheral_completers', 'generalized sideband data16 protection multi-peripheral multi-register back-to-back .apb APB composition alias preserves policy owner');
    is_deeply($alias->{report}{children}[3]{transfer}{registers}, [qw(reg0 reg1 reg2)], 'generalized sideband data16 protection multi-peripheral multi-register back-to-back .apb APB composition alias preserves control reg0/reg1/reg2 storage');
    is($alias->{report}{children}[3]{protection_policy}{registers}[2]{write}{predicate}{value}, 1, 'generalized sideband data16 protection multi-peripheral multi-register back-to-back .apb APB composition alias preserves control reg2 write policy');
    is($alias->{report}{back_to_back_policy}{interconnect}{timing_role}, 'propagate_queued_setup_without_idle_cycle', 'generalized sideband data16 protection multi-peripheral multi-register back-to-back .apb APB composition alias preserves interconnect timing policy');
};

subtest 'CLI schedule JSON, outdir, and .apb alias expose generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition review artifacts' => sub {
    my $path = sample_apb_composition_multi_peripheral_multi_register_sideband_data16_protection_generalized_five_register_status_back_to_back_ppif_path();
    my ($schedule_success, undef, undef, $schedule_stdout, $schedule_stderr) = run(
        command => ['./bin/fsmgen', '--emit-schedule-json', $path],
    );
    ok($schedule_success, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition --emit-schedule-json succeeds');
    is(join('', @{$schedule_stderr || []}), '', 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition --emit-schedule-json keeps stderr clean');
    my $schedule_report = decode_json(join('', @{$schedule_stdout || []}));
    is($schedule_report->{schema}, 'fsmgen.ial2.protocol_intent.apb_composition.v1', 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports schema');
    is($schedule_report->{composition}{topology}, 'multi_peripheral_interconnect', 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports topology');
    is($schedule_report->{composition}{width_policy}{data_width}, 16, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports data width 16');
    is($schedule_report->{composition}{width_policy}{strobe_width}, 2, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports strobe width 2');
    is($schedule_report->{composition}{address_map}{alignment_bytes}, 2, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports 2-byte window alignment');
    is($schedule_report->{composition}{address_map}{windows}[1]{base}{default}, 258, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports control base 258');
    is($schedule_report->{protection_policy}{enforcement_owner}, 'peripheral_completers', 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports peripheral enforcement owners');
    is_deeply($schedule_report->{children}[2]{transfer}{registers}, [qw(reg0 reg1 reg2 reg3 reg4)], 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports status reg0..reg4 storage');
    is_deeply($schedule_report->{children}[3]{transfer}{registers}, [qw(reg0 reg1 reg2 reg3 reg4)], 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports control reg0..reg4 storage');
    is($schedule_report->{children}[2]{bindings}{storage}{registers}[4]{address}{value}, 8, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports status reg4 address 8');
    is($schedule_report->{children}[2]{protection_policy}{registers}[4]{read}{predicate}{value}, 1, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports protected status reg4 read policy');
    is($schedule_report->{children}[3]{protection_policy}{registers}[4]{write}{predicate}{value}, 1, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports protected control reg4 write policy');
    is($schedule_report->{back_to_back_policy}{requester}{timing_policy}{queue_depth}, 1, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports queue-depth 1');
    is($schedule_report->{back_to_back_policy}{interconnect}{timing_role}, 'propagate_queued_setup_without_idle_cycle', 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports interconnect timing role');
    is($schedule_report->{back_to_back_policy}{peripherals}[0]{timing_policy}{setup_admission}, 'adjacent', 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports status adjacent setup admission');
    is($schedule_report->{back_to_back_policy}{peripherals}[1]{timing_policy}{setup_admission}, 'adjacent', 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports control adjacent setup admission');
    my %residue_by_id = map { $_->{id} => $_ } @{$schedule_report->{unsupported_residue}};
    my %residue = map { $_ => 1 } keys %residue_by_id;
    ok(!$residue{apb_back_to_back_policy_deferred}, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON omits broad back-to-back residue');
    ok(!$residue{apb_protection_policy_effects_deferred}, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON omits old policy-effects residue');
    ok(!$residue{apb_alternate_widths_deferred}, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON omits broad alternate-width residue');
    ok($residue{apb_additional_back_to_back_policies_deferred}, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports narrowed future timing-policy residue');
    unlike($residue_by_id{apb_additional_back_to_back_policies_deferred}{detail}, qr/data16 protected generalized register sets/, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition residue retires stale data16 protected generalized wording');
    ok($residue{apb_additional_protection_policies_deferred}, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports additional-policy residue');
    ok($residue{apb_remaining_widths_deferred}, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition schedule JSON reports narrowed remaining-width residue');

    my $tempdir = tempdir(CLEANUP => 1);
    my $outdir = File::Spec->catdir($tempdir, 'out');
    my $hdl = File::Spec->catfile($tempdir, 'apb_tb_multi_peripheral_multi_register_sideband_data16_protection_generalized_five_register_status_back_to_back.sv');
    my ($success, undef, undef, undef, $stderr_buf) = run(
        command => ['./bin/fsmgen', '--quiet', '--outdir', $outdir, '--output', $hdl, $path],
    );

    ok($success, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition CLI generation succeeds');
    is(join('', @{$stderr_buf || []}), '', 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition generation keeps stderr clean');
    for my $artifact (qw(apb_requester.isf apb_status_regs.isf apb_control_regs.isf apb_interconnect.isf apb_requester.fsm apb_status_regs.fsm apb_control_regs.fsm apb_interconnect.fsm apb_tb.fsm)) {
        ok(-f File::Spec->catfile($outdir, $artifact), "generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition --outdir writes $artifact");
    }
    ok(-f $hdl, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition --output writes generated HDL');
    my $interconnect = slurp(File::Spec->catfile($outdir, 'apb_interconnect.fsm'));
    like($interconnect, qr/\(PSTRB_CONTROL 2\)/, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back outdir interconnect preserves 2-bit control PSTRB');
    like($interconnect, qr/\(<- \(PPROT_STATUS> PPROT\)\)/, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back outdir interconnect fans out PPROT');
    like($interconnect, qr/\(<- \(PSTRB_CONTROL> PSTRB\)\)/, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back outdir interconnect fans out PSTRB');
    like($interconnect, qr/\(<- \(PADDR_CONTROL> \(- PADDR 258\)\) <\(& PSEL \(>= PADDR 258\) \(< PADDR 516\)\)\)/, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back outdir interconnect uses control base 258');
    unlike($interconnect, qr/prot_q/, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back outdir interconnect remains enforcement-free');
    my $top = slurp(File::Spec->catfile($outdir, 'apb_tb.fsm'));
    like($top, qr/=accepted>/, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back outdir top exposes accepted');
    like($top, qr/\(queued_wstrb 2\)/, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back outdir top embeds queued 2-bit PSTRB');
    like($top, qr/\(status_reg3_data_q 16 \(reset 0\)\)/, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back outdir top embeds status reg3 storage');
    like($top, qr/\(status_reg4_data_q 16 \(reset 0\)\)/, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back outdir top embeds status reg4 storage');
    like($top, qr/\(control_reg4_data_q 16 \(reset 0\)\)/, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back outdir top embeds control reg4 storage');
    like($top, qr/\(\?\(& \(! write_q\) \(== addr 8\) \(! \(!= \(& prot_q 3'd1\) 3'd0\)\)\)/, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back outdir top embeds denied protected reg4 read branch');
    ...
    like($sv, qr/\breg\s+\[1:0\]\s+queued_wstrb\b/, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition HDL carries 2-bit queued PSTRB');
    like($sv, qr/prot_q\s*&\s*3'd1/, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back APB composition HDL preserves endpoint PPROT predicate logic');
    ...
    is_deeply($alias->{generated_ial1}{items}, $ppif->{generated_ial1}{items}, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back .apb APB composition alias mirrors .ppif generated IAL1 artifacts');
    is_deeply($alias->{generated_ial0}{files}, $ppif->{generated_ial0}{files}, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back .apb APB composition alias mirrors .ppif generated IAL0');
    is($alias->{report}{composition}{width_policy}{data_width}, 16, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back .apb APB composition alias preserves data width policy');
    is($alias->{report}{composition}{width_policy}{strobe_width}, 2, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back .apb APB composition alias preserves strobe width policy');
    is($alias->{report}{protection_policy}{enforcement_owner}, 'peripheral_completers', 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back .apb APB composition alias preserves policy owner');
    is_deeply($alias->{report}{children}[3]{transfer}{registers}, [qw(reg0 reg1 reg2 reg3 reg4)], 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back .apb APB composition alias preserves control reg0..reg4 storage');
    is($alias->{report}{children}[3]{protection_policy}{registers}[4]{write}{predicate}{value}, 1, 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back .apb APB composition alias preserves control reg4 write policy');
    is($alias->{report}{back_to_back_policy}{interconnect}{timing_role}, 'propagate_queued_setup_without_idle_cycle', 'generalized five-register sideband data16 protection multi-peripheral multi-register back-to-back .apb APB composition alias preserves interconnect timing policy');
};
...
sub sample_apb_composition_multi_peripheral_multi_register_sideband_generalized_five_register_status_back_to_back_apb_path {
...
sub sample_apb_composition_multi_peripheral_multi_register_sideband_generalized_six_register_status_back_to_back_apb_path {
...
sub sample_apb_composition_multi_peripheral_multi_register_sideband_protection_generalized_five_register_status_back_to_back_apb_path {
...
sub sample_apb_composition_multi_peripheral_multi_register_sideband_data16_generalized_five_register_status_back_to_back_apb_path {
...
sub sample_apb_composition_multi_peripheral_multi_register_sideband_data16_generalized_six_register_status_back_to_back_apb_path {
...
sub sample_apb_composition_multi_peripheral_multi_register_sideband_data16_protection_generalized_status_back_to_back_apb_path {
...
sub sample_apb_composition_multi_peripheral_multi_register_sideband_data16_protection_generalized_five_register_status_back_to_back_apb_path {
...
sub sample_apb_composition_multi_peripheral_multi_register_sideband_generalized_five_register_status_back_to_back_ppif {
    return slurp(sample_apb_composition_multi_peripheral_multi_register_sideband_generalized_five_register_status_back_to_back_ppif_path());
}

sub sample_apb_composition_multi_peripheral_multi_register_sideband_generalized_six_register_status_back_to_back_ppif {
    return slurp(sample_apb_composition_multi_peripheral_multi_register_sideband_generalized_six_register_status_back_to_back_ppif_path());
}
...
sub sample_apb_composition_multi_peripheral_multi_register_sideband_protection_generalized_five_register_status_back_to_back_ppif {
    return slurp(sample_apb_composition_multi_peripheral_multi_register_sideband_protection_generalized_five_register_status_back_to_back_ppif_path());
}
...
sub sample_apb_composition_multi_peripheral_multi_register_sideband_data16_generalized_five_register_status_back_to_back_ppif {
    return slurp(sample_apb_composition_multi_peripheral_multi_register_sideband_data16_generalized_five_register_status_back_to_back_ppif_path());
}

sub sample_apb_composition_multi_peripheral_multi_register_sideband_data16_generalized_six_register_status_back_to_back_ppif {
    return slurp(sample_apb_composition_multi_peripheral_multi_register_sideband_data16_generalized_six_register_status_back_to_back_ppif_path());
}
...
sub sample_apb_composition_multi_peripheral_multi_register_sideband_data16_protection_generalized_status_back_to_back_ppif {
    return slurp(sample_apb_composition_multi_peripheral_multi_register_sideband_data16_protection_generalized_status_back_to_back_ppif_path());
}

sub sample_apb_composition_multi_peripheral_multi_register_sideband_data16_protection_generalized_five_register_status_back_to_back_ppif {
    return slurp(sample_apb_composition_multi_peripheral_multi_register_sideband_data16_protection_generalized_five_register_status_back_to_back_ppif_path());
}
