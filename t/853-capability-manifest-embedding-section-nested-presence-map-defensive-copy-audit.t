...
subtest 'manifest-embedded embedding section contract nested presence key map rebuilds cleanly after caller mutation' => sub {
    ...
    is_deeply($contract->{'nested_presence_key_map'}, $expected->{'nested_presence_key_map'}, 'fresh manifest embedding contract rebuilds clean nested_presence_key_map');
};
done_testing();
