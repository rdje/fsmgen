...
(actor unknown_param_default
  ...
  (interface
    (output data_out)))
ISF
        qr/\AError: actor 'unknown_param_default' parameter 'DATA_W' token 'DEFAULT_WIDTH' is not a declared actor constant, earlier scalar actor parameter, or enum member/,
