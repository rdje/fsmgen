...
| Need to publish an actionable quantitative claim | Use `CLAIM_VERIFICATION.md`; declare its exact record in `doctrine/claim_verification/claims.jsonl`, then run `scripts/check_claim_verification.pl`. |
