...
- latest_commit: current HEAD after this slice is `IAL2-AXI-MANAGER-INITIATOR-FRONTIER.22: ship the bounded AXI full-write composition`; use `git log -1 --oneline` for the exact hash.
