...
- `WORKTREE (pending commit)` Delegate FSM module-reference setter ownership to `EnableGraph` (`set_fsm_module_reference`) with compatibility delegation in `FlattenedDT`
