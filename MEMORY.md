...
- active_work_unit: `DARWIN-INLINE-VERILATOR-RUNTIME-QUALIFICATION.3.2.2` (`active`; consume the exact first hosted push)
...
- in_flight_uncommitted: none; Linux logical-core repair `.3.2.2.2` is committed and verified.
