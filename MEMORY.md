...
- `WORKTREE (pending commit)` Delegate frequent-logical-usage helper ownership to `EnableGraph` (`contains_frequently_used_operations`) with compatibility delegation in `FlattenedDT`
