...
- active_work_unit: `GITHUB-PUSH-OUTCOME-ASSURANCE.5`; director-selected before
...
- current_state: `.1` audits pushed SHA `de9d50a5fb17074d29615ea866cd3cc6af503a3b`;
  ...
  expectations with canonical lowering. Regression `31367105225` still owns
  t/1438, hosted runtime, and an unsigned 1,103-file tail.
- next_action: repair and verify the two observed t/1438 RLAST port checks in `.5`.
