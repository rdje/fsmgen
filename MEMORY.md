...
- `WORKTREE (pending commit)` Delegate intermediate-signal AST tracker ownership to `EnableGraph` (`track_ast_intermediate_signals`) with compatibility delegation in `FlattenedDT`
