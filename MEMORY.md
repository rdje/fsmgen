...
- `WORKTREE (pending commit)` Delegate intermediate-signal classification helper ownership to `EnableGraph` (`is_intermediate_signal`) with compatibility delegation in `FlattenedDT`
