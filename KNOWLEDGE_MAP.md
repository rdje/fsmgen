...
- **answers:** where are structural_rtl_ir instances entry keys advertised? | what keys are in semantic.forward_ir.structural_rtl_ir.instances entries? | what is the normalized semantic structural instance entry schema? | are structural_rtl_ir instance port bindings entry keys advertised?
- **date:** 2026-06-05 · **status:** current
