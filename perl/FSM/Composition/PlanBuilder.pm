...
sub _vhdl_generated_instance_reason ($instances) {
    ...
    return "generated-child composition VHDL is outside the bounded C2 scalar-autowire/scalar-or-bitstring-generic and APB/C4 generated-FSM structural-top leaves";
}
