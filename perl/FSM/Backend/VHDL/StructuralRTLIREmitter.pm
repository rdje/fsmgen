...
for bounded APB/C4 generated-FSM instances, scalar integer and scalar integer
expression, one-bit and multi-bit sized-bitstring, plus packed-list and packed-map
