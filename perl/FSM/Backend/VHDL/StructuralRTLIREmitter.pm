...
expression plus one-bit sized-bitstring generic-map actuals for bounded
standalone-DT C1 instances, and port-map actuals whose connection expressions
already render through the
