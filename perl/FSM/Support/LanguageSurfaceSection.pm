        ...
        file_surfaces => {
            ...
            entries => [
                ...
                },
                {
                    ...
                    current_boundary => 'bounded public .apb is the APB requester-transfer IAL2 profile-alias suffix. .apb sources use the same protocol-platform-intent form as .ppif, must declare explicit (profile apb), support exactly one (apb-requester apb_requester ...) object in this slice, and lower through generated apb_requester.isf before generated apb_requester.fsm. The support-accounted alias fixture mirrors ppif/apb_requester_transfer.ppif at ppif/apb_requester_transfer.apb and generates HDL module apb_requester. Non-APB profiles are rejected as suffix/profile mismatches for .apb. APB completer and one-requester/one-completer APB composition generation are shipped through generic .ppif; APB completer/composition .apb alias exposure, multi-peripheral APB interconnect/decode, sidebands, alternate widths, back-to-back policy, direct IAL2-to-IAL0 lowering, direct backend lowering, verification-output generation, backend-language variants, and VHDL remain deferred.',
                },
            ],
