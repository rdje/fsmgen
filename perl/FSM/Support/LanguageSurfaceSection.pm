        ...
        file_surfaces => {
            ...
            entries => [
                ...
                },
                {
                    ...
                    current_boundary => 'one-channel Valid-Ready sources and one-object AXI manager capacity/status sources with optional static ID-family and transaction-envelope metadata can emit HDL and semantic JSON; multi-channel Valid-Ready bundles emit aggregate reports, check JSON, semantic JSON, and review artifacts while ID allocation, ordering, response matching, bursts, aliases, platform clauses, and full AXI manager behavior remain deferred',
                },
            ],
