            ...
            entries => [
                ...
                },
                {
                    ...
                    current_boundary => join(' ',
                        ...
                        'Current bounded .apb coverage mirrors the APB requester-transfer, APB completer, and one-requester/one-completer APB composition .ppif sources through support-accounted profile-alias fixtures.',
                ...
                },
                {
                    ...
                    current_boundary => join(' ',
                        'bounded public .apb is the APB requester-transfer, APB completer, and fixed one-requester/one-completer APB composition IAL2 profile-alias suffix.',
                        ...
                        'The support-accounted alias fixtures mirror ppif/apb_requester_transfer.ppif, ppif/apb_completer.ppif, and ppif/apb_composition.ppif at ppif/apb_requester_transfer.apb, ppif/apb_completer.apb, and ppif/apb_composition.apb.',
                        'They generate HDL modules apb_requester, apb_completer, and composition top apb_tb respectively.',
