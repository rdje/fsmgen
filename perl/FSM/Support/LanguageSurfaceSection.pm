            ...
            entries => [
                ...
                },
                {
                    ...
                    current_boundary => join(' ',
                        ...
                        'Current bounded .apb coverage mirrors the APB requester-transfer, APB busy-capable requester-transfer, APB completer, one-requester/one-completer APB composition, and busy-capable one-requester/one-completer APB composition .ppif sources through support-accounted profile-alias fixtures.',
                ...
                },
                {
                    ...
                    current_boundary => join(' ',
                        'bounded public .apb is the APB requester-transfer, busy-capable APB requester-transfer, APB completer, fixed one-requester/one-completer APB composition, and busy-capable fixed APB composition IAL2 profile-alias suffix.',
                        '.apb sources use the same protocol-platform-intent form as .ppif, must declare explicit (profile apb), support exactly one (apb-requester apb_requester ...) with optional response (busy NAME), exactly one (apb-completer apb_completer ...), or the explicit one-requester/one-completer/(apb-composition apb_tb ...) shape in this slice, and lower through generated .isf before generated .fsm.',
                        'The support-accounted alias fixtures mirror ppif/apb_requester_transfer.ppif, ppif/apb_requester_transfer_busy.ppif, ppif/apb_completer.ppif, ppif/apb_composition.ppif, and ppif/apb_composition_busy.ppif at ppif/apb_requester_transfer.apb, ppif/apb_requester_transfer_busy.apb, ppif/apb_completer.apb, ppif/apb_composition.apb, and ppif/apb_composition_busy.apb.',
                        'They generate HDL modules apb_requester, apb_completer, and composition top apb_tb respectively; busy-capable requester and composition aliases add the requester busy output.',
