        ...
        file_surfaces => {
            ...
            entries => [
                ...
                },
                {
                    ...
                    current_boundary => 'one-channel Valid-Ready sources and one-object AXI manager capacity/status sources can emit HDL and semantic JSON; multi-channel Valid-Ready bundles emit aggregate reports, check JSON, semantic JSON, and review artifacts while aliases, platform clauses, IDs, ordering, response matching, bursts, and full AXI manager behavior remain deferred',
                },
            ],
