            ...
            entries => [
                ...
                },
                {
                    ...
                    current_boundary => join(' ',
                        ...
                        'They generate HDL modules apb_requester, apb_completer, generated apb_interconnect for multi-peripheral composition, and composition top apb_tb respectively; busy-capable requester and composition aliases add the requester busy output, status-capable requester and composition aliases add busy plus a 2-bit requester status output, multi-register completer/composition aliases decode source-ordered 32-bit aligned register addresses, sideband-aware requester/completer/composition aliases propagate PPROT, drive or sample PSTRB, and apply PSTRB byte-lane writes, and multi-peripheral composition aliases fan out decoded PSEL, translate local PADDR, mux selected responses, and return PSLVERR for unmapped active accesses.',
                        'Non-APB profiles are rejected as suffix/profile mismatches for .apb. APB alternate widths, PPROT access-control effects, back-to-back policy, direct IAL2-to-IAL0 lowering, direct backend lowering, verification-output generation, backend-language variants, and VHDL remain deferred.',
                    ),
                },
            ],
