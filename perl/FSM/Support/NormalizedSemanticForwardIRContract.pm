...
sub build_normalized_semantic_forward_ir_contract {
    return {
        ...
        guidance => [
            ...
            'The nested `structural_rtl_ir` branch now also has one bounded owner for its current direct-root and composition-top object shell plus structural port, net, declared/resolved link, instance shallow, nested instance interface-port, nested instance parameter-override, and nested instance port-binding key families.',
