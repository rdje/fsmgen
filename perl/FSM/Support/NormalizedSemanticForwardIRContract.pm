...
sub build_normalized_semantic_forward_ir_contract {
    return {
        ...
        structural_rtl_ir_net_entry_keys =>
            normalized_semantic_forward_ir_structural_rtl_ir_net_entry_keys(),
        structural_rtl_ir_net_source_entry_keys =>
            normalized_semantic_forward_ir_structural_rtl_ir_net_source_entry_keys(),
        structural_rtl_ir_net_target_entry_keys =>
            normalized_semantic_forward_ir_structural_rtl_ir_net_target_entry_keys(),
        ...
        structural_rtl_ir_port_composition_extension_keys =>
            normalized_semantic_forward_ir_structural_rtl_ir_port_composition_extension_keys(),
        structural_rtl_ir_port_source_extension_keys =>
            normalized_semantic_forward_ir_structural_rtl_ir_port_source_extension_keys(),
        structural_rtl_ir_port_source_entry_keys =>
            normalized_semantic_forward_ir_structural_rtl_ir_port_source_entry_keys(),
        structural_rtl_ir_port_target_extension_keys =>
            normalized_semantic_forward_ir_structural_rtl_ir_port_target_extension_keys(),
        structural_rtl_ir_port_target_entry_keys =>
            normalized_semantic_forward_ir_structural_rtl_ir_port_target_entry_keys(),
        ...
        guidance => [
            ...
            'The nested `structural_rtl_ir` branch now also has one bounded owner for its current direct-root and composition-top object shell plus structural auxiliary-assignment value-kind, assignment-record, port, direct-port source/target extension, net, generated-enable net source/target, declared/resolved link, instance shallow, nested instance interface-port, nested instance parameter-override, and nested instance port-binding key families.',
...
sub normalized_semantic_forward_ir_structural_rtl_ir_assignment_record_entry_keys {
    return normalized_semantic_structural_rtl_ir_assignment_record_entry_keys();
}

sub normalized_semantic_forward_ir_structural_rtl_ir_assignment_record_lhs_entry_keys {
    return normalized_semantic_structural_rtl_ir_assignment_record_lhs_entry_keys();
}

sub normalized_semantic_forward_ir_structural_rtl_ir_assignment_record_rhs_entry_keys {
    return normalized_semantic_structural_rtl_ir_assignment_record_rhs_entry_keys();
}

sub normalized_semantic_forward_ir_structural_rtl_ir_assignment_record_provenance_entry_keys {
    return normalized_semantic_structural_rtl_ir_assignment_record_provenance_entry_keys();
}
...
sub normalized_semantic_forward_ir_structural_rtl_ir_port_source_extension_keys {
    return normalized_semantic_structural_rtl_ir_port_source_extension_keys();
}

sub normalized_semantic_forward_ir_structural_rtl_ir_port_source_entry_keys {
    return normalized_semantic_structural_rtl_ir_port_source_entry_keys();
}

sub normalized_semantic_forward_ir_structural_rtl_ir_port_target_extension_keys {
    return normalized_semantic_structural_rtl_ir_port_target_extension_keys();
}

sub normalized_semantic_forward_ir_structural_rtl_ir_port_target_entry_keys {
    return normalized_semantic_structural_rtl_ir_port_target_entry_keys();
}
...
sub normalized_semantic_forward_ir_structural_rtl_ir_net_source_entry_keys {
    return normalized_semantic_structural_rtl_ir_net_source_entry_keys();
}
