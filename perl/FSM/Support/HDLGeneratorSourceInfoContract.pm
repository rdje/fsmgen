...
sub hdl_generator_source_info_contract_source {
    return 'FSM::Support::HDLGeneratorSourceInfoContract';
}
...
sub build_hdl_generator_source_info_contract {
    return {
        ...
        contract_source => hdl_generator_source_info_contract_source(),
