    ...
    return [
        {
            ...
            limitations => [
                ...
                'no use-site parameter-driven FIFO interface shape, bank shape, or generated-top respecialization yet',
