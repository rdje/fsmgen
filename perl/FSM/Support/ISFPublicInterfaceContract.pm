...
sub isf_public_interface_schedule_report_watchdog_shape {
    return 'scalar watchdog limit; omitted watchdog clauses default to 65535 (2^16 - 1), and actor-level static constants including qualified imported package scalar constants report as resolved integers';
}
