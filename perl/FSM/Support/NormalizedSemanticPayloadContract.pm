...
sub build_normalized_semantic_payload_contract {
    return {
        ...
        forward_ir_structural_rtl_ir_port_composition_extension_keys =>
            normalized_semantic_payload_forward_ir_structural_rtl_ir_port_composition_extension_keys(),
        forward_ir_structural_rtl_ir_port_source_extension_keys =>
            normalized_semantic_payload_forward_ir_structural_rtl_ir_port_source_extension_keys(),
        forward_ir_structural_rtl_ir_port_source_entry_keys =>
            normalized_semantic_payload_forward_ir_structural_rtl_ir_port_source_entry_keys(),
        ...
        guidance => [
            ...
            'The nested `symbol_contract` and `forward_ir.intent_hir.symbol_contract` constant value key families, enum value-kind families, package-import entry families, and type-entry families stay delegated to FSM::Support::NormalizedSemanticSymbolContract.',
...
sub normalized_semantic_payload_forward_ir_intent_hir_symbol_contract_package_import_entry_value_kinds {
    return normalized_semantic_forward_ir_intent_hir_symbol_contract_package_import_entry_value_kinds();
}

sub normalized_semantic_payload_forward_ir_intent_hir_symbol_contract_package_import_entry_value_meaning {
    return normalized_semantic_forward_ir_intent_hir_symbol_contract_package_import_entry_value_meaning();
}
...
sub normalized_semantic_payload_forward_ir_structural_rtl_ir_assignment_record_entry_keys {
    return normalized_semantic_forward_ir_structural_rtl_ir_assignment_record_entry_keys();
}

sub normalized_semantic_payload_forward_ir_structural_rtl_ir_assignment_record_lhs_entry_keys {
    return normalized_semantic_forward_ir_structural_rtl_ir_assignment_record_lhs_entry_keys();
}

sub normalized_semantic_payload_forward_ir_structural_rtl_ir_assignment_record_rhs_entry_keys {
    return normalized_semantic_forward_ir_structural_rtl_ir_assignment_record_rhs_entry_keys();
}

sub normalized_semantic_payload_forward_ir_structural_rtl_ir_assignment_record_provenance_entry_keys {
    return normalized_semantic_forward_ir_structural_rtl_ir_assignment_record_provenance_entry_keys();
}
...
sub normalized_semantic_payload_forward_ir_structural_rtl_ir_port_source_extension_keys {
    return normalized_semantic_forward_ir_structural_rtl_ir_port_source_extension_keys();
}

sub normalized_semantic_payload_forward_ir_structural_rtl_ir_port_source_entry_keys {
    return normalized_semantic_forward_ir_structural_rtl_ir_port_source_entry_keys();
}
...
sub normalized_semantic_payload_symbol_contract_package_import_entry_value_kinds {
    return normalized_semantic_symbol_contract_package_import_entry_value_kinds();
}

sub normalized_semantic_payload_symbol_contract_package_import_entry_value_meaning {
