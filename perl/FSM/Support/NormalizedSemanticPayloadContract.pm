...
sub build_normalized_semantic_payload_contract {
    return {
        ...
        guidance => [
            ...
            'Use the grouped structural port, net, declared/resolved link, and instance shallow entry key families to inspect `forward_ir.structural_rtl_ir.ports`, `forward_ir.structural_rtl_ir.nets`, `forward_ir.structural_rtl_ir.declared_links`, `forward_ir.structural_rtl_ir.resolved_links`, and `forward_ir.structural_rtl_ir.instances` without binding to unrelated structural-RTL collections.',
