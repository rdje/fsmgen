...
sub _apb_additional_back_to_back_policies_residue() {
    return {
        ...
        detail => join(' ',
            ...
            'selected sideband-aware protection requester and adjacent protected status/control peripheral propagation is implemented for bounded two-peripheral composition;',
            ...
            'generalized multi-peripheral multi-register timing, deeper queues, alternate overflow policies, accepted-less requester timing, multiple active APB transfers, bus matrices, scoreboards, direct backend lowering, verification-output, backend-language variants, AXI, AHB, and VHDL remain future work.',
        ),
    };
}
