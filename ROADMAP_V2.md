...
- Forward-IR note: the older direct pre-stage SystemVerilog generation-
  ...
  `GenerationPipelineSupport` now composes
...
- Forward-IR note: the paired live direct pre-stage SystemVerilog
  ...
  so the live pipeline no longer depends on the older generation-prelude shell
  to reach enable-condition generation or the extracted prescan-preparation
  composition before consolidated intermediate generation.
- Forward-IR note: the paired live direct pre-stage SystemVerilog
...
- Forward-IR note: the paired live direct pre-stage SystemVerilog structural
  ...
  so the live pipeline now reaches header/module/state/internal-declaration
  assembly directly instead of routing through the older generation-prelude
  shell.
