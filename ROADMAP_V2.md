...
- Forward-IR note: the paired live direct pre-stage SystemVerilog
  ...
  so `GenerationPreludeSupport` no longer owns enable-condition generation or
  the extracted prescan-preparation composition inline before consolidated
