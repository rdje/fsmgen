...
- The direct SystemVerilog AST-factorization and substituted-AST recovery family now also has an explicit owner in [perl/FSM/HDL/FlattenedDT/Backend/SystemVerilog/ASTFactorizationSupport.pm](/Users/richarddje/Documents/github/fsmgen/perl/FSM/HDL/FlattenedDT/Backend/SystemVerilog/ASTFactorizationSupport.pm), and the old [perl/FSM/HDL/FlattenedDT/Backend/SystemVerilog.pm](/Users/richarddje/Documents/github/fsmgen/perl/FSM/HDL/FlattenedDT/Backend/SystemVerilog.pm) package is now gone from the live direct backend path.
- The direct SystemVerilog consolidated intermediate-signal emission family now also has an explicit owner in [perl/FSM/HDL/FlattenedDT/Backend/SystemVerilog/ConsolidatedIntermediateEmitter.pm](/Users/richarddje/Documents/github/fsmgen/perl/FSM/HDL/FlattenedDT/Backend/SystemVerilog/ConsolidatedIntermediateEmitter.pm), covering AST-factorized plus pre-scanned intermediate-signal merging, dependency-aware filtering, and final wire/assign emission for the direct backend block that appears before unified WEN/EN generation.
...
- The next honest `R11` seam is now deeper cleanup inside the remaining synthesis/factorization core, especially the planning surface still concentrated in [perl/FSM/Synthesis/EnableGraph.pm](/Users/richarddje/Documents/github/fsmgen/perl/FSM/Synthesis/EnableGraph.pm) and the iterative fixpoint/factorization support around [perl/FSM/HDL/Factorization/Fixpoint.pm](/Users/richarddje/Documents/github/fsmgen/perl/FSM/HDL/Factorization/Fixpoint.pm), not more direct SystemVerilog owner splitting.
