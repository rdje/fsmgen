...
- That leaves `HDLGenerator` much closer to the intended thin public facade: shared pipeline configuration plus `generate_hdl_from_file(...)` and a small public source-frontend surface.
- The next honest `R11` seam is now less about more `HDLGenerator` wrapper trimming and more about whether the remaining frontend facade should stay there, or whether deeper cleanup should move under the older direct generated-module backend family centered on [perl/FSM/HDL/FlattenedDT.pm](/Users/richarddje/Documents/github/fsmgen/perl/FSM/HDL/FlattenedDT.pm) and [perl/FSM/Synthesis/EnableGraph.pm](/Users/richarddje/Documents/github/fsmgen/perl/FSM/Synthesis/EnableGraph.pm).
