...
- Forward-IR note: the matching direct-root structural-builder counterpart is
  ...
  top generated-enable condition reroute inline either. Output-drive
  consumers, full direct module rerouting, and VHDL rerouting through
  `StructuralRTLIR` remain later exact owners tracked by
