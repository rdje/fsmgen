...
- `docs/tasks/ISF-TRANSACTION-PORT-TRANSACTION-PARAM-WIDTHS.md` — active `R14` task tree for same-transaction scalar parameter defaults in transaction-local port widths.
