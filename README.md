...
- `docs/tasks/ISF-ATL-PIN-EGRESS-MULTI-ROUTE.md` — active `R14` task tree for bounded generated-child ATL resolved-child pin-egress multi-route scalar movement.
