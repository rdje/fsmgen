...
- `docs/tasks/R12-STANDALONE-DTC-EXPLICIT-SYSTEM-AUTOWIRE-CORPUS-WIDENING.md` — active `R12` task tree for widening maintained supported standalone DTC explicit-system auto-wiring corpus coverage.
