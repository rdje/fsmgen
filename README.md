...
- `docs/tasks/ISF-DATA-OP-ACTIVATION-OVERRIDE-WIDTH-GATE.md` — active `R14` task tree to extend the activation-site parameter override-specialized default-preserving gate from timing parameters (wait, repeat, latency, watchdog, contract) to data-operation width parameters (shift_left, shift_right, assemble, extract).
