...
- `docs/tasks/R8-PARTIAL-LHS-PREFERRED-DUAL-OUTPUT.md` — active `R8` task tree for preferred `<=-` partial-LHS dual-output coverage and the remaining pulse/vector widening decision.
