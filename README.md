...
27. `docs/decisions/0014-protocol-platform-intent-surface-and-layered-lowering.md`: generic IAL2 file-surface candidates and layered lowering decision.
28. `docs/decisions/0015-ial2-profile-extensions-are-vocabulary-aliases.md`: IAL2 protocol-profile extension refinement.
29. `docs/FEATURE_BACKLOG.md`: pointer to the canonical mdBook feature backlog for deferred/not-fully-shipped user-visible work.
30. `CHANGES.md`: chronological technical changes.
31. `DEVELOPMENT_NOTES.md`: design rationale and decisions.
32. `MEMORY.md`: continuity/handoff state.
33. `LIVE_ACHIEVEMENT_STATUS.md`: latest completed roadmap-aligned slice.
34. `WARP.md`: repository-specific agent/development guidance.
