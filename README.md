...
`BACKEND-API-VALIDATION-FRONTIER.130`: select the next exact backend/API edge
after `.129.1` shipped direct VHDL non-signed vector positive numeric-literal
literal-literal multiplication. The shipped literal-literal positive
...
Literal-literal division/modulo still fail closed.
