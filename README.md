...
the structured resource/tool API.
...
- `docs/tasks/SEMANTIC-INTROSPECTION-MCP-FRONTIER.md` — active semantic-introspection/MCP task tree; `.2` made deep semantic introspection a first-class feature, `.11` deferred prompt templates, and `.12` owns resource subscription/list-change selection.
