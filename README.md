...
- `docs/IAL2_AHB_TWO_SUBORDINATE_EXACT_THREE_PAIRED_BUSY_COMPOSITION_PROFILE_ALIAS_BEHAVIOR.md` — documents `.821` shipment of that byte-identical `.ahb` alias, exact support/report/artifact/semantic/read-only-MCP/verifier parity in t1534, shared assertion-enabled t1533 runtime, and current 326/367/50 accounting.
