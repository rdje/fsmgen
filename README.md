...
- `docs/tasks/SEMANTIC-INTROSPECTION-MCP-FRONTIER.md` — active semantic-introspection/MCP task tree; `.2` made deep semantic introspection a first-class feature, `.17` kept transport bounded to one-shot/stdin, and `.18` owns MCP structured tool output selection.
