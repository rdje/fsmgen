...
- `docs/tasks/SEMANTIC-INTROSPECTION-MCP-FRONTIER.md` — active semantic-introspection/MCP task tree; `.2` made deep semantic introspection a first-class feature, `.22` kept progress/cancellation session behavior unshipped, and `.23` owns JSON-RPC batch/envelope selection.
