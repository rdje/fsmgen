...
extension API is selected first. The active `.2.8` leaf now selects the first
Rust/Rust-Wasm, browser JavaScript, Dart/web, Julia, or other host experiment
before code or public contracts change.
