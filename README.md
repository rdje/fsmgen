...
- `docs/tasks/ISF-DOWNSTREAM-CONTRACT-HANDOFF-SYNC.md` — active `R14` task tree propagating the recent diagnostic surface (cross-domain, sub-axis, loop-contained, deeper-nested, `t/1372-1376`) to `ISF_PUBLIC_INTERFACE_CONTRACT.md` and `SPECFORGE_FEEDBACK_RESPONSE.md`.
