...
- `docs/tasks/SEMANTIC-INTROSPECTION-MCP-FRONTIER.md` — active semantic-introspection/MCP task tree; `.2` made deep semantic introspection a first-class feature, `.15` selected bounded unpaginated list responses, and `.16` owns sampling/elicitation selection.
