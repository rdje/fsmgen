...
`ARCHITECTURE-DEBT-FRONTIER.2`, which selects the first safe direct-backend
StructuralRTLIR convergence step beyond identity and ports. The shipped
literal-literal positive modulo edge lowers
