...
- `docs/tasks/ISF-FIELD-STRUCTURED-STORAGE-FRONTIER.md` — active ISF storage-metadata frontier; `.1` audits readiness and selects the first declarative named bit-field storage contract before parser/lowering behavior changes.
