...
as scalar strings for compatibility. Direct port dependency connectivity,
output-drive/always-block consumers, instances, links, and HDL rerouting
through `StructuralRTLIR` remain outside that projection.
