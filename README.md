...
emits scalar integer generic maps such as `WIDTH => 16` and scalar expression
generic maps such as `EXPR_WIDTH => (8 + 1)` before the standalone-DT child
...
standalone-DT scalar integer/expression actuals and generated-FSM scalar
