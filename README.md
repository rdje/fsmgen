...
- `docs/tasks/SEMANTIC-INTROSPECTION-MCP-FRONTIER.md` — active semantic-introspection/MCP task tree; `.2` made deep semantic introspection a first-class feature, `.9` locked newline-delimited MCP stdio framing, and `.10` owns roots/workspace-root negotiation.
