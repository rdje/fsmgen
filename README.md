...
- `docs/tasks/MDBOOK-VHDL-INTRODUCTION-BOUNDARY-SYNC.md` — proposed no-behavior truth-sync tree selected by parent `.833`; `.1` will align Chapters 00 and 10 with Chapter 14's bounded shipped direct/composition VHDL subset without claiming full-backend or external-compiler qualification.
