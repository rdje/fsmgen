...
- `docs/tasks/R12-ASSIGNMENT-BOUNDARY-CORPUS-WIDENING.md` — active `R12` task tree for widening maintained assignment-boundary expected-failure corpus coverage.
