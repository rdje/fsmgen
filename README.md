...
- `docs/tasks/R12-COMPOSITION-EXPLICIT-LINK-TOPOLOGY-CORPUS-WIDENING.md` — active `R12` task tree for widening maintained expected-failure corpus coverage for missing explicit composition wiring diagnostics.
