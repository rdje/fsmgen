...
- `docs/tasks/ISF-BOOK-EXAMPLE-CORRECTNESS-FIX.md` — active `R14` task tree fixing 14 broken ISF examples identified in the example-correctness audit addendum (ellipsis fragments, library/package imports, multi-actor blocks, and one real bug).
