...
`BACKEND-API-VALIDATION-FRONTIER.121`: select the next exact backend/API edge
after `.120.1` shipped direct VHDL non-signed vector negative
numeric-literal multiplication. The shipped non-signed multiplication edge
