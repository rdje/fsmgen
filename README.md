...
- `docs/tasks/SEMANTIC-INTROSPECTION-MCP-FRONTIER.md` — active semantic-introspection/MCP task tree; `.2` made deep semantic introspection a first-class feature, `.19` shipped compact output schemas, and `.20` owns MCP tool annotation/safety metadata selection.
