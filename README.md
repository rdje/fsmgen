...
- `docs/tasks/ISF-ASSERT-NESTED-BITWISE-PRECEDENCE-REPAIR.md` — active correctness tree; clean audit `628ca0c33` activates `.2` continuity-only to group every concurrent-check intermediate substitution and prove t1410-t1412/t1544 plus assertion-enabled legal-`0x00000004` t1507 without changing AXI admission.
