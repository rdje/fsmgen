...
The next active IAL2 frontier is `IAL2-FEATURE-COMPLETENESS-FRONTIER.238`,
generated report-only dynamic raw-`ARLEN` burst-length capture over generated
dynamic last-beat read-data.
