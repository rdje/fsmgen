...
generic maps such as `ENABLE_DEFAULT => '1'` before the standalone-DT child
port map. The bounded C2 generated-FSM scalar-autowire top
...
standalone-DT scalar integer/expression/one-bit sized bitstring actuals and generated-FSM scalar
