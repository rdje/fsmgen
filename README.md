...
- `docs/tasks/ISF-CONTRACT-ACTIVATION-OVERRIDE-WINDOWS.md` — active `R14` task tree for activation-site override diagnostics on generated child temporal contract-window parameters.
