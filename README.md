...
- `docs/tasks/SEMANTIC-INTROSPECTION-MCP-FRONTIER.md` — active semantic-introspection/MCP task tree; `.2` made deep semantic introspection a first-class feature, `.8` shipped schema snapshot fixtures plus the first client compatibility matrix, and `.9` owns the full MCP stdio framing compatibility boundary.
