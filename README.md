...
- `docs/tasks/MDBOOK-VHDL-INTRODUCTION-BOUNDARY-SYNC.md` — active no-behavior truth-sync tree selected by parent `.833`; `.1` aligns Chapters 00 and 10 with Chapter 14's bounded shipped direct/composition VHDL subset without claiming full-backend or external-compiler qualification.
