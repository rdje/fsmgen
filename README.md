...
`BACKEND-API-VALIDATION-FRONTIER.131`: select the next exact backend/API edge
after `.130.1` shipped direct VHDL non-signed vector positive numeric-literal
literal-literal division. The shipped literal-literal positive division edge
...
Literal-literal modulo still fails closed.
