...
28. `docs/FEATURE_BACKLOG.md`: pointer to the canonical mdBook feature backlog for deferred/not-fully-shipped user-visible work.
29. `CHANGES.md`: chronological technical changes.
30. `DEVELOPMENT_NOTES.md`: design rationale and decisions.
31. `MEMORY.md`: continuity/handoff state.
32. `LIVE_ACHIEVEMENT_STATUS.md`: latest completed roadmap-aligned slice.
33. `WARP.md`: repository-specific agent/development guidance.
