...
- `docs/tasks/SEMANTIC-INTROSPECTION-MCP-FRONTIER.md` — active semantic-introspection/MCP task tree; `.2` made deep semantic introspection a first-class feature, `.10` selected explicit workspace-root authority, and `.11` owns read-only prompt/workflow template selection.
