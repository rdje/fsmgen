...
- `docs/tasks/DIRECT-VHDL-REDUCTION-EXPRESSION-LOWERING.md` — active direct-VHDL correctness tree for the discovered unary reduction-token leak; `.1` audits scalar/vector OR/AND/XOR semantics without changing behavior after clean selector commit `5f904d2d2`.
