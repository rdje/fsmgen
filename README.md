...
- `docs/tasks/IR-EXPRESSION-AST-OWNERSHIP.md` — active architecture follow-up for expression representation ownership and conversion boundaries; `.1` inventoried the live expression surfaces and `.2` is classifying deliberate phase boundaries versus actionable duplication.
