...
- `docs/tasks/TASK-TREE-FROZEN-LEGACY-DOC-WORKFLOW-SYNC.md` — active no-behavior continuity-doctrine tree selected by parent `.834`; `.1` removes active instructions to write the four decision-`0007`-frozen blobs while preserving decision `0019` and the commit-per-leaf workflow.
