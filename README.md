...
emits scalar integer generic maps such as `WIDTH => 16` before the
standalone-DT child port map. The bounded C2 generated-FSM scalar-autowire top
...
standalone-DT scalar integer actuals and generated-FSM scalar
