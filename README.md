...
- `docs/tasks/COMPOSITION-TYPE-BACKLOG-EXHAUSTION.md` — active Composition/type backlog tree selected for PNT exhaustion; current frontier selects the first executable Composition/type implementation or deferral leaf from evidence.
