...
active IAL2 frontier is `IAL2-FEATURE-COMPLETENESS-FRONTIER.233`, readiness
audit for dynamic read-data routing over the generated single-active dynamic
read response-demux family selected by `.232`.
