...
- `docs/tasks/ISF-ASSERT-NESTED-BITWISE-PRECEDENCE-REPAIR.md` — active correctness tree; completed audit `.1` proves an all-CoreAST inline-substitution boundary drops nested grouping, selects explicit grouping of every substituted intermediate expression, and freezes t1410-t1412/t1544 plus assertion-enabled legal-`0x00000004` t1507 coverage for separate implementation `.2`.
