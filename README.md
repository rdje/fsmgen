...
- `docs/tasks/R12-COMPOSITION-ENDPOINT-SHAPE-CORPUS-WIDENING.md` — active `R12` task tree for widening maintained expected-failure corpus coverage for composition endpoint-shape diagnostics.
