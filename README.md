...
27. `docs/FEATURE_BACKLOG.md`: pointer to the canonical mdBook feature backlog for deferred/not-fully-shipped user-visible work.
28. `CHANGES.md`: chronological technical changes.
29. `DEVELOPMENT_NOTES.md`: design rationale and decisions.
30. `MEMORY.md`: continuity/handoff state.
31. `LIVE_ACHIEVEMENT_STATUS.md`: latest completed roadmap-aligned slice.
32. `WARP.md`: repository-specific agent/development guidance.
