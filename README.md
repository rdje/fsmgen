...
`BACKEND-API-VALIDATION-FRONTIER.101.1` for fail-closed hardening: composition
tops with declared aggregate ports or nets must not emit VHDL record/array
declarations until a future exact aggregate-lowering leaf owns them.
