...
generic maps beyond the shipped external-RTL literal/resolved-package-constant
subset, VHDL package declaration/emission, GHDL validation, broad expression parity beyond the
