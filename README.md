...
- `docs/tasks/R12-PLUS-FSM-BODY-CORPUS-WIDENING.md` — active `R12` task tree for widening maintained malformed legacy `+fsm` root-body expected-failure corpus coverage.
