...
- `docs/tasks/R12-INIT-DIRECTIVE-SHAPE-CORPUS-WIDENING.md` — active `R12` task tree for widening maintained `:=` init-directive shape expected-failure corpus coverage.
