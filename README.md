...
- `docs/tasks/R12-COMPOSITION-PARSER-TOKEN-CORPUS-WIDENING.md` — active `R12` task tree for widening maintained expected-failure corpus coverage for composition parser token and top-symbol diagnostics.
