...
`LANES => "1010010100111100"` also emit before that port map. The bounded C2 generated-FSM scalar-autowire top
...
standalone-DT scalar integer/expression/one-bit sized bitstring/multi-bit sized bitstring/packed-list actuals and generated-FSM scalar
integer/expression, one-bit sized bitstring, multi-bit sized bitstring, and
resolved packed aggregate actuals, VHDL package
