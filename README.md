...
- `docs/tasks/SEMANTIC-INTROSPECTION-MCP-FRONTIER.md` — active semantic-introspection/MCP task tree; `.2` made deep semantic introspection a first-class feature, `.20` shipped read-only closed-world tool annotations, and `.21` owns MCP content/resource annotation selection.
