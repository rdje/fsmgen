...
- `docs/tasks/ISF-SCALAR-STORAGE-PACKAGE-CONSTANT-WIDTHS.md` — active `R14` task tree for qualified package scalar constants in actor-owned scalar storage widths.
