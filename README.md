...
literal/resolved-package-constant, and resolved packed aggregate actuals plus
generated-FSM scalar integer/expression, one-bit sized bitstring, multi-bit
sized bitstring, and resolved packed aggregate actuals, VHDL package
