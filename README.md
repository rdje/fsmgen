...
- `docs/tasks/ISF-ACTIVATION-PARAM-ACTOR-PARAMS.md` — active `R14` task tree for actor-local scalar parameter defaults as generated activation parameter override values.
