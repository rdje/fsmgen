...
already-prepared direct backend enable registries. Those direct net entries
preserve width, signedness, state-model, and declared-type metadata where
available, but they do not claim DT-specific/LHS WEN/EN wires, direct
