...
- `docs/tasks/R12-SYMBOL-ENTRY-MALFORMED-CORPUS-WIDENING.md` — active `R12` task tree for widening maintained malformed symbol-definition entry expected-failure corpus coverage.
