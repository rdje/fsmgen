...
- `docs/tasks/DIRECT-VHDL-REDUCTION-EXPRESSION-LOWERING.md` — selected direct-VHDL correctness tree for the discovered unary reduction-token leak; `.831` chooses its no-behavior `.1` audit for clean activation after the selector commit.
