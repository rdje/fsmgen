...
- `docs/tasks/R12-INLINE-MODIFIER-CORPUS-WIDENING.md` — active `R12` task tree for widening maintained inline compound modifier expected-failure corpus coverage.
