...
`BACKEND-API-VALIDATION-FRONTIER.124.1`: lower direct VHDL non-signed vector
positive numeric-literal division after `.124` selected that exact edge. The
shipped positive multiplication edge lowers an 8-bit non-signed
`PROD = (* A 2)` fixture to
