...
- `docs/tasks/ISF-CONTRACT-ACTIVATION-OVERRIDE-SAME-VALUE.md` — active `R14` task tree for same-value activation-site overrides on generated child temporal contract-window parameters.
