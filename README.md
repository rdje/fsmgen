...
- `docs/tasks/R12-DELAYED-PULSE-TARGET-CORPUS-WIDENING.md` — active `R12` task tree for widening maintained delayed-pulse LHS target expected-failure corpus coverage.
