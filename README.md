...
26. `docs/FEATURE_BACKLOG.md`: pointer to the canonical mdBook feature backlog for deferred/not-fully-shipped user-visible work.
27. `CHANGES.md`: chronological technical changes.
28. `DEVELOPMENT_NOTES.md`: design rationale and decisions.
29. `MEMORY.md`: continuity/handoff state.
30. `LIVE_ACHIEVEMENT_STATUS.md`: latest completed roadmap-aligned slice.
31. `WARP.md`: repository-specific agent/development guidance.
