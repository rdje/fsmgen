...
`BACKEND-API-VALIDATION-FRONTIER.125.1`: lower direct VHDL non-signed vector
positive numeric-literal modulo after `.125` selected that exact edge. The
shipped positive division edge lowers an 8-bit
...
Literal-first arithmetic still fails closed.
