...
- `docs/tasks/ISF-FIELD-STRUCTURED-STORAGE-RESPONSE.md` — active downstream-response task tree for SPECFORGE's 2026-06-22 declarative field-structured storage request; `.1` created the owner and `.2` edits FSMGen's tracked response before any grammar or lowering behavior changes.
