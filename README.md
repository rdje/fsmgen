...
- `docs/tasks/SEMANTIC-INTROSPECTION-MCP-FRONTIER.md` — active semantic-introspection/MCP task tree; `.2` made deep semantic introspection a first-class feature, `.16` deferred sampling/elicitation, and `.17` owns Streamable HTTP/service-mode transport selection.
