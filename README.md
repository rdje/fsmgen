...
- `docs/tasks/ISF-DATA-OP-PACKAGE-CONSTANT-WIDTHS.md` — active `R14` task tree for qualified package scalar constants in explicit data-operation width evidence.
