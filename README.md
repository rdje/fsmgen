...
`RESET_VALUE => "10100101"` before a generated child port map. The bounded
...
and multi-bit sized bitstring actuals, VHDL package declaration/emission, GHDL validation, broad expression parity beyond the
