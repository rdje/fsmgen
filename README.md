...
`BACKEND-API-VALIDATION-FRONTIER.132`: select the next exact backend/API edge
after `.131.1` shipped direct VHDL non-signed vector positive numeric-literal
literal-literal modulo. The shipped literal-literal positive modulo edge lowers
