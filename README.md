...
explicit passthrough ports. The current active backend/API frontier is
`BACKEND-API-VALIDATION-FRONTIER.70.1`: implement only the bounded C2
generated-FSM child composition VHDL top for
`t/corpus/implicit_composition_system_autowire.fsm`, including the
VHDL-safe generated-child shared-datapath export injection prerequisite and
scalar structural nets. Scalar signed arithmetic remains explicitly
fail-closed; full aggregate VHDL record/array lowering, broader generated-FSM
child composition VHDL, APB/C4 composition VHDL, internal-net-heavy/bus-heavy
tops beyond the selected fixture, generic maps, packages, GHDL validation,
broad expression parity beyond the shipped AMBA wrap family, package-import
