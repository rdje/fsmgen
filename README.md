...
Package-root direct HDL generation is currently owned by
`BACKEND-API-VALIDATION-FRONTIER.100.1` for fail-closed hardening: `?pkg`
roots remain import-only containers, not standalone SystemVerilog or VHDL
