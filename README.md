...
`BACKEND-API-VALIDATION-FRONTIER.123`: select the next exact backend/API edge
after `.122.1` shipped direct VHDL non-signed vector negative
numeric-literal modulo. The shipped non-signed modulo edge lowers an 8-bit
