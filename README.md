...
- `docs/IAL2_AHB_TWO_SUBORDINATE_EXACT_THREE_PAIRED_BUSY_COMPOSITION_PROFILE_ALIAS_BEHAVIOR.md` — documents `.821` shipment of that byte-identical `.ahb` alias, exact support/report/artifact/semantic/read-only-MCP/verifier parity in t1534, shared assertion-enabled t1533 runtime, its 326/367/50 checkpoint, the exact-four requester pair's 328/369/52 checkpoint, and the later generic exact-four pairing's 329/370/53 current boundary.
...
- `docs/IAL2_AHB_EXACT_FOUR_PAIRED_BUSY_COMPOSITION_BEHAVIOR.md` — documents shipment of the generic one-subordinate exact-four paired source, exact 3 IAL1/4 IAL0 architecture, width-three `4 -> 3 -> 2 -> 1 -> 0` retirement, semantic/read-only-MCP/public-verifier parity, assertion-enabled t1537 5/4/1/4/1/`44332211` runtime, same-volume temporary output, and current 329/370/53 accounting.
- `docs/IAL2_POST_EXACT_FOUR_PAIRED_COMPOSITION_NEXT_OWNER_SELECTION.md` — records `.824` selection of the byte-identical matching exact-four paired `.ahb` alias, exact support identity, projected 330/371/54 split 27/27, focused t1538 parity, shared t1537 runtime, and separate two-window/HIAL-VIAL/broader owners.
