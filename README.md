...
- `docs/tasks/ISF-TRANSACTION-PARAM-DEPENDENCY-DEFAULTS.md` — active `R14` task tree for earlier-scalar generated-child transaction parameter dependency defaults.
