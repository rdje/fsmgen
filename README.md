...
`EXPR_WIDTH => (16 + 1)` before a generated child port map. The bounded
...
actuals, VHDL package declaration/emission, GHDL validation, broad expression parity beyond the
