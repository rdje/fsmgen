...
- `docs/tasks/SEMANTIC-INTROSPECTION-MCP-FRONTIER.md` — active semantic-introspection/MCP task tree; `.2` made deep semantic introspection a first-class feature, `.25` keeps JSON-RPC errors message-only and sanitized, and `.26` owns MCP serverInfo/instructions metadata.
