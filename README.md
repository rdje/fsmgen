...
- `docs/tasks/ISF-TRANSACTION-PARAM-PACKAGE-CONSTANT-DEFAULTS.md` — active `R14` task tree for package scalar constants in generated-child transaction parameter defaults.
