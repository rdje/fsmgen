...
- `docs/tasks/R12-GENERATED-CHILD-SOURCE-SHAPE-CORPUS-WIDENING.md` — active `R12` task tree for widening maintained expected-failure corpus coverage for malformed generated-child source count and payload shape.
