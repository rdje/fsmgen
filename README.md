...
- `docs/tasks/R12-FSM-ROOT-BODY-CORPUS-WIDENING.md` — active `R12` task tree for widening maintained structured `?fsm` root-body expected-failure corpus coverage.
