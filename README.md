...
- `docs/tasks/ISF-ASSERT-NESTED-BITWISE-PRECEDENCE-REPAIR.md` — selected proposed correctness tree; `.1` will audit concurrent-property intermediate inlining that drops nested bitwise grouping and falsely rejects legal AXI fixed-four read address `0x00000004` before a separate general repair.
