...
- `docs/tasks/TASK-TREE-FROZEN-LEGACY-DOC-WORKFLOW-SYNC.md` — proposed no-behavior continuity-doctrine tree selected by parent `.834`; `.1` will remove active instructions to write the four decision-`0007`-frozen blobs while preserving decision `0019` and the commit-per-leaf workflow.
