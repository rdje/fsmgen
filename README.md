...
serialized JSON text block; per-tool `outputSchema` metadata remains deferred.
...
- `docs/tasks/SEMANTIC-INTROSPECTION-MCP-FRONTIER.md` — active semantic-introspection/MCP task tree; `.2` made deep semantic introspection a first-class feature, `.18` shipped structured tool content, and `.19` owns per-tool outputSchema selection.
