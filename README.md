...
`WIDTH => 16` before a generated child port map. The bounded APB/C4
generated-FSM top is shipped for `fsm/apb_tb.fsm`, emitting
...
resolved-package-constant subset plus generated-FSM scalar integer actuals,
VHDL package declaration/emission, GHDL validation, broad expression parity beyond the
