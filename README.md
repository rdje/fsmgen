...
- `docs/tasks/R12-COMPOSITION-DUPLICATE-DECLARATION-CORPUS-WIDENING.md` — active `R12` task tree for widening maintained expected-failure corpus coverage for duplicate composition declaration diagnostics.
