...
read-only semantic-introspection profile summary.
...
- `docs/tasks/SEMANTIC-INTROSPECTION-MCP-FRONTIER.md` — active semantic-introspection/MCP task tree; `.2` made deep semantic introspection a first-class feature, `.26` adds stable serverInfo title metadata, and `.27` owns the remaining MCP profile exhaustion audit.
