...
- `docs/tasks/COMPOSITION-TYPE-BACKLOG-EXHAUSTION.md` — active Composition/type backlog tree selected for PNT exhaustion; current frontier tracks VHDL aggregate/generic-map prerequisites after deferring backend-owned struct/record default lowering beyond exact contract-backed Verilog-family surfaces.
