...
- `docs/tasks/R12-STANDALONE-DT-EXPLICIT-SYSTEM-CORPUS-WIDENING.md` — active `R12` task tree for widening maintained supported standalone DT explicit-system corpus coverage.
