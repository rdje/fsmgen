...
- `docs/tasks/BIN-FSMGEN-IMPORT-TREE-JUL29-REFRESH.md` — active no-behavior bootstrap architecture refresh selected by parent `.835`; `.1` is continuity-only until cleanly committed, then will align the maintained 213 / 212 / 5 snapshot with the live 228 / 227 / 19 closure.
