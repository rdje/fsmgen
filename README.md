...
- `docs/tasks/R12-UPDATE-SHORTHAND-VARIANT-CORPUS-WIDENING.md` — active `R12` task tree for widening maintained supported update-shorthand variant corpus coverage.
