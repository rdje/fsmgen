...
active IAL2 frontier is `IAL2-FEATURE-COMPLETENESS-FRONTIER.232`, selector for
the next exact owner after the bounded single-active dynamic write/read demux
family.
