...
`BACKEND-API-VALIDATION-FRONTIER.127`: select the next exact backend/API edge
after `.126.1` shipped direct VHDL non-signed vector positive numeric-literal
literal-first multiplication. The shipped literal-first positive multiplication
