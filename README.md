...
- `docs/tasks/ISF-CROSS-DOMAIN-REPEAT-BODY-DO-DIAGNOSTIC-PRECISION.md` — active `R14` task tree for a targeted cross-domain repeat-body `do` diagnostic; broader cross-domain `do` implementation remains a separate future leaf of this tree.
