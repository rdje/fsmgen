...
- `docs/tasks/COMPOSITION-TYPE-BACKLOG-EXHAUSTION.md` — active Composition/type backlog tree selected for PNT exhaustion; current frontier selects the next shared-datapath route/storage/protocol contract after shipping binary semantic parameter/generic aggregate equality/inequality.
