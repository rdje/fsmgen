...
available, while `structural_rtl_ir.auxiliary_assignments[]` carries the
already-rendered generated enable assignment lines as scalar strings. Direct
instances, links, parsed assignment records, and direct net source/target
