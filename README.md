...
- `docs/tasks/ISF-TRANSACTION-PORT-ACTIVATION-OVERRIDE-WIDTH-GATE.md` — active `R14` task tree to extend the activation-site parameter override-specialized default-preserving gate to transaction port widths (`(ports (input/output NAME (width PARAM)))`).
