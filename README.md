...
- `docs/tasks/COMPOSITION-TYPE-BACKLOG-EXHAUSTION.md` — active Composition/type backlog tree selected for PNT exhaustion; current frontier selects the next repeat-body child-activation variant after deferring activation parameter/value-binding widening behind one exact activation/binding contract.
