...
if [[ -x scripts/check_claim_verification_dispositions.pl ]]; then
  ok "scripts/check_claim_verification_dispositions.pl executable"
else
  note "scripts/check_claim_verification_dispositions.pl is not executable"
fi
...
if grep -q 'CLAIM-DISPOSITIONS|scripts/check_claim_verification_dispositions.pl' scripts/check_doctrines.sh; then
  ok "doctrine registry includes CLAIM-DISPOSITIONS"
else
  note "doctrine registry does not include CLAIM-DISPOSITIONS"
fi
