...
package base_output_arbitration_services_pkg;
  ...
  class base_output_arbitration_success_sequence extends uvm_sequence#(base_output_arbitration_ahb_write_item);
    ...
    virtual task body();
      ...
      request.handle_id = "ahb_subordinate_base_output_arbitration::fixture::base_output_arbitration::scenario::success::handle::success_write";
  ...
  class base_output_arbitration_unsupported_size_sequence extends uvm_sequence#(base_output_arbitration_ahb_write_item);
    ...
    virtual task body();
      ...
      request.handle_id = "ahb_subordinate_base_output_arbitration::fixture::base_output_arbitration::scenario::unsupported_size::handle::error_write";
      request.address = 32'h00000000;
      request.transfer = 2'h2;
      request.write = 1'h1;
      request.size = 3'h2;
